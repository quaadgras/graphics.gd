...
// Call the given builtin method on a value of type T with arguments.
func (builtin BuiltinMethod[T, Args, Result]) Call(self T, args Args) Result {
	panic(unavailable)
}

// Call the given builtin method on a value of type T with arguments.
func (builtin MutableBuiltinMethod[T, Args, Result]) Call(self *T, self_ptr unsafe.Pointer, args Args) Result {
	panic(unavailable)
}
