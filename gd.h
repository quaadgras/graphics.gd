...
extern _Bool gd_on_callable_validation(uintptr_t p0);
extern void gd_on_callable_free(uintptr_t p0);
extern uint32_t gd_on_callable_hash(uintptr_t p0);
extern _Bool gd_on_callable_compare(uintptr_t p0, uintptr_t p1);
extern _Bool gd_on_callable_less_than(uintptr_t p0, uintptr_t p1);
extern uintptr_t gd_on_callable_stringify(uintptr_t p0, void* p1);
extern int64_t gd_on_callable_get_argument_count(uintptr_t p0, void* p1);
extern void gd_on_editor_class_in_use_detection(uint64_t p0, uint64_t p1, void* p2);
extern void gd_on_engine_init(uint32_t p0);
extern void gd_on_engine_exit(uint32_t p0);
extern uintptr_t gd_on_extension_binding_created(uintptr_t p0);
extern void gd_on_extension_binding_removed(uintptr_t p0, uintptr_t p1);
extern _Bool gd_on_extension_binding_reference(uintptr_t p0, _Bool p1);
extern uintptr_t gd_on_extension_class_create(uintptr_t p0, _Bool p1);
extern uintptr_t gd_on_extension_class_method(uintptr_t p0, uintptr_t p1, uint32_t p2);
extern _Bool gd_on_extension_instance_set(uintptr_t p0, uintptr_t p1, uint64_t p2, uint64_t p3, uint64_t p4);
extern _Bool gd_on_extension_instance_get(uintptr_t p0, uintptr_t p1, void* p2);
extern uintptr_t gd_on_extension_instance_property_list(uintptr_t p0);
extern _Bool gd_on_extension_instance_property_has_default(uintptr_t p0, uintptr_t p1);
extern _Bool gd_on_extension_instance_property_get_default(uintptr_t p0, uintptr_t p1, void* p2);
extern _Bool gd_on_extension_instance_property_validation(uintptr_t p0, uintptr_t p1);
extern void gd_on_extension_instance_notification(uintptr_t p0, int32_t p1, _Bool p2);
extern uintptr_t gd_on_extension_instance_stringify(uintptr_t p0);
extern _Bool gd_on_extension_instance_reference(uintptr_t p0, _Bool p1);
extern void gd_on_extension_instance_rid(uintptr_t p0, void* p1);
extern void gd_on_extension_instance_checked_call(uintptr_t p0, uintptr_t p1, void* p2, void* p3);
extern void gd_on_extension_instance_variant_call(uintptr_t p0, uintptr_t p1, void* p2, void* p3);
extern void gd_on_extension_instance_dynamic_call(uintptr_t p0, uintptr_t p1, void* p2, int64_t p3, void* p4, void* p5);
extern void gd_on_extension_instance_free(uintptr_t p0);
extern _Bool gd_on_extension_script_categorization(uintptr_t p0, uintptr_t p1);
extern uint32_t gd_on_extension_script_get_property_type(uintptr_t p0, void* p1);
extern uintptr_t gd_on_extension_script_get_owner(uintptr_t p0);
extern void gd_on_extension_script_get_property_state(uintptr_t p0, uintptr_t p1, uintptr_t p2);
extern uintptr_t gd_on_extension_script_get_methods(uintptr_t p0);
extern _Bool gd_on_extension_script_has_method(uintptr_t p0, uintptr_t p1);
extern int64_t gd_on_extension_script_get_method_argument_count(uintptr_t p0, uintptr_t p1);
extern uintptr_t gd_on_extension_script_get(uintptr_t p0);
extern _Bool gd_on_extension_script_is_placeholder(uintptr_t p0);
extern uintptr_t gd_on_extension_script_get_language(uintptr_t p0);
extern void gd_on_first_frame(void);
extern void gd_on_every_frame(void);
extern void gd_on_final_frame(void);
extern void gd_on_worker_thread_pool_task(uintptr_t p0);
extern void gd_on_worker_thread_pool_group_task(uintptr_t p0, uint32_t p1);
extern uintptr_t gd_on_extension_class_caller(uintptr_t, uintptr_t, uint32_t);
extern void gd_on_extension_instance_called(uintptr_t, uintptr_t, void*, void*);
...
void gd_variant_type_make(uint32_t, void*, int64_t, void*, void*);
void gd_variant_type_call(uint32_t, uintptr_t, void*, int64_t, void*, void*);
...
void gd_variant_type_unsafe_call(void*, uintptr_t, void*, uint64_t, void*);
void gd_variant_type_unsafe_make(uintptr_t, void*, uint64_t, void*);
void gd_variant_type_unsafe_free(uint32_t, uint64_t, void*);
...
void gd_method_list_push(uintptr_t, uintptr_t, uintptr_t, uint32_t, uintptr_t, uintptr_t, int64_t, void*);
...
void gd_iterator_make(uint64_t, uint64_t, uint64_t, void*, void*);
bool gd_iterator_next(uint64_t, uint64_t, uint64_t, void*, void*);
void gd_iterator_load(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, void*, void*);
...
void gd_memory_clear(uintptr_t, int64_t);
...
void gd_memory_edit_128(uintptr_t, uint64_t, uint64_t);
...
void gd_object_call(uintptr_t, uintptr_t, void*, int64_t, void*, void*);
...
void gd_object_id(uintptr_t, void*);
void gd_object_id_inside_variant(uint64_t, uint64_t, uint64_t, void*);
uintptr_t gd_object_method_lookup(uintptr_t, uintptr_t, int64_t);
uintptr_t gd_object_script_make(uintptr_t);
void gd_object_script_call(uintptr_t, uintptr_t, void*, int64_t, void*, void*);
...
void gd_object_unsafe_call(uintptr_t, uintptr_t, void*, uint64_t, void*);
void gd_object_unsafe_free(uintptr_t);
uintptr_t gd_packed_byte_array_unsafe(uint64_t, uint64_t);
uint8_t gd_packed_byte_array_access(uint64_t, uint64_t, int64_t);
uintptr_t gd_packed_color_array_unsafe(uint64_t, uint64_t);
void gd_packed_color_array_access(uint64_t, uint64_t, int64_t, void*);
uintptr_t gd_packed_float32_array_unsafe(uint64_t, uint64_t);
float gd_packed_float32_array_access(uint64_t, uint64_t, int64_t);
uintptr_t gd_packed_float64_array_unsafe(uint64_t, uint64_t);
double gd_packed_float64_array_access(uint64_t, uint64_t, int64_t);
uintptr_t gd_packed_int32_array_unsafe(uint64_t, uint64_t);
int32_t gd_packed_int32_array_access(uint64_t, uint64_t, int64_t);
uintptr_t gd_packed_int64_array_unsafe(uint64_t, uint64_t);
void gd_packed_int64_array_access(uint64_t, uint64_t, int64_t, void*);
uintptr_t gd_packed_string_array_unsafe(uint64_t, uint64_t);
uintptr_t gd_packed_string_array_access(uint64_t, uint64_t, int64_t);
uintptr_t gd_packed_vector2_array_unsafe(uint64_t, uint64_t);
void gd_packed_vector2_array_access(uint64_t, uint64_t, int64_t, void*);
uintptr_t gd_packed_vector3_array_unsafe(uint64_t, uint64_t);
void gd_packed_vector3_array_access(uint64_t, uint64_t, int64_t, void*);
uintptr_t gd_packed_vector4_array_unsafe(uint64_t, uint64_t);
void gd_packed_vector4_array_access(uint64_t, uint64_t, int64_t, void*);
...
void gd_variant_hash(uint64_t, uint64_t, uint64_t, void*);
...
void gd_variant_deep_hash(uint64_t, uint64_t, uint64_t, int64_t, void*);
bool gd_variant_get_index(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, void*);
bool gd_variant_get_array(uint64_t, uint64_t, uint64_t, int64_t, void*, void*);
...
void gd_variant_unsafe_call(uintptr_t, void*, uint64_t, void*);
void gd_variant_unsafe_eval(uintptr_t, void*, uint64_t, void*);
void gd_variant_unsafe_free(uint64_t, uint64_t, uint64_t);
void gd_variant_unsafe_make_native(uint32_t, uint64_t, uint64_t, uint64_t, uint64_t, void*);
void gd_variant_unsafe_from_native(uint32_t, void*, uint64_t, void*);
uintptr_t gd_variant_unsafe_internal_pointer(uint32_t, uint64_t, uint64_t, uint64_t);
void gd_variant_unsafe_get_field(uintptr_t, void*, uint64_t, void*);
void gd_variant_unsafe_get_array(uint32_t, int64_t, void*, uint64_t, void*);
void gd_variant_unsafe_get_index(uint32_t, void*, uint64_t, void*);
void gd_variant_unsafe_set_field(uintptr_t, uint64_t, void*);
void gd_variant_unsafe_set_array(uint32_t, int64_t, uint64_t, void*);
void gd_variant_unsafe_set_index(uint32_t, uint64_t, void*);
