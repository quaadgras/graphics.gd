...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntParameter{gdclass.NewVisualShaderNodeUIntParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
