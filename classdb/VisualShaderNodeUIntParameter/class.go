...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeUIntParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntParameter{gdclass.NewVisualShaderNodeUIntParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
