...
/*
[graphics.gd/classdb/Texture2D] resource that draws only part of its [Instance.Atlas] texture, as defined by the [Instance.Region]. An additional [Instance.Margin] can also be set, which is useful for small adjustments.

Multiple [graphics.gd/classdb/AtlasTexture] resources can be cropped from the same [Instance.Atlas]. Packing many smaller textures into a singular large texture helps to optimize video memory costs and render calls.

Note: [graphics.gd/classdb/AtlasTexture] cannot be used in an [graphics.gd/classdb/AnimatedTexture], and will not tile properly in nodes such as [graphics.gd/classdb/TextureRect] or [graphics.gd/classdb/Sprite2D]. To tile an [graphics.gd/classdb/AtlasTexture], modify its [Instance.Region] instead.
*/
