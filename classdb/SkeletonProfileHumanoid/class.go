...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SkeletonProfileHumanoid")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonProfileHumanoid{gdclass.NewSkeletonProfileHumanoid(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
