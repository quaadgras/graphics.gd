...
func New() Instance {
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				pointers.Set(gdclass.GetSkeletonProfileHumanoid(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SkeletonProfileHumanoid{gdclass.NewSkeletonProfileHumanoid(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("SkeletonProfileHumanoid", func(ptr gd.Object) any { return Instance{gdclass.NewSkeletonProfileHumanoid(ptr)} })
}
