...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonProfileHumanoid{gdclass.NewSkeletonProfileHumanoid(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
