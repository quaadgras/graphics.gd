...
func (self class) AsObject() [1]gd.Object { return gdclass.GetDPITexture(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetDPITexture(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.DPITexture{gdclass.NewDPITexture(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetDPITexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.DPITexture{gdclass.NewDPITexture(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) CreateFromString(source String.Readable, scale float64, saturation float64, color_map Dictionary.Any) [1]gdclass.DPITexture { //gd:DPITexture.create_from_string
	...
	var ret = [1]gdclass.DPITexture{gdclass.NewDPITexture(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsDPITexture() Advanced { return Advanced{gdclass.NewDPITexture(self.AsObject()[0])} }
func (self Instance) AsDPITexture() Instance {
	return Instance{gdclass.NewDPITexture(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("DPITexture", func(ptr gd.Object) any { return Instance{gdclass.NewDPITexture(ptr)} })
}
