...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Image")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Image{gdclass.NewImage(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
