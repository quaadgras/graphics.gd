...
/*
Native image datatype. Contains image data which can be converted to an [ImageTexture] and provides commonly used [i]image processing[/i] methods. The maximum width and height for an [Image] are [MaxWidth] and [MaxHeight].
...
/*
Overwrites data of an existing [Image]. Non-static equivalent of [Instance.CreateFromData].
*/
...
This is the same as [Instance.GetPixel], but with a [Vector2i] argument instead of two integer arguments.
*/
...
This is the same as [Instance.GetPixelv], but with two integer arguments instead of a [Vector2i] argument.
*/
...
This is the same as [Instance.SetPixel], but with a [Vector2i] argument instead of two integer arguments.
*/
...
This is the same as [Instance.SetPixelv], but with a two integer arguments instead of a [Vector2i] argument.
*/
