...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatOp{gdclass.NewVisualShaderNodeFloatOp(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
