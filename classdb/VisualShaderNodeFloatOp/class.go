...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeFloatOp")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatOp{gdclass.NewVisualShaderNodeFloatOp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
