...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EngineProfiler")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EngineProfiler{gdclass.NewEngineProfiler(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
