...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeProximityFade")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeProximityFade{gdclass.NewVisualShaderNodeProximityFade(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
