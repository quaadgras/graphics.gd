...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeProximityFade{gdclass.NewVisualShaderNodeProximityFade(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
