...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorRefract")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorRefract{gdclass.NewVisualShaderNodeVectorRefract(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
