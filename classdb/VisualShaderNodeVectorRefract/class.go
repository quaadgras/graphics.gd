...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorRefract{gdclass.NewVisualShaderNodeVectorRefract(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
