...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeVectorRefract](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVectorRefract{pointers.Add[gdclass.VisualShaderNodeVectorRefract]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorRefract{pointers.New[gdclass.VisualShaderNodeVectorRefract]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeVectorRefract() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeVectorRefract](self[0])}
}
func (self Instance) AsVisualShaderNodeVectorRefract() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeVectorRefract](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeVectorRefract", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeVectorRefract](ptr)} })
}
