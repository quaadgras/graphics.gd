...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Noise")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Noise{gdclass.NewNoise(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
