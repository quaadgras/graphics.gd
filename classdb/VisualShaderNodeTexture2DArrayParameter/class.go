...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTexture2DArrayParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture2DArrayParameter{gdclass.NewVisualShaderNodeTexture2DArrayParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTexture2DArrayParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DArrayParameter{gdclass.NewVisualShaderNodeTexture2DArrayParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTexture2DArrayParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTexture2DArrayParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTexture2DArrayParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeTexture2DArrayParameter(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DArrayParameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture2DArrayParameter(ptr)} })
}
