...
/*
This parameter allows to provide a collection of textures for the shader. You can use [graphics.gd/classdb/VisualShaderNodeTexture2DArray] to extract the textures from array.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeTexture2DArrayParameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture2DArrayParameter{pointers.Add[gdclass.VisualShaderNodeTexture2DArrayParameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DArrayParameter{pointers.New[gdclass.VisualShaderNodeTexture2DArrayParameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeTexture2DArrayParameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeTexture2DArrayParameter](self[0])}
}
func (self Instance) AsVisualShaderNodeTexture2DArrayParameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture2DArrayParameter](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DArrayParameter", func(ptr gd.Object) any {
		return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture2DArrayParameter](ptr)}
	})
}
