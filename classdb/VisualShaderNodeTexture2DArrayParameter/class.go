...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DArrayParameter{gdclass.NewVisualShaderNodeTexture2DArrayParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
