...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTexture2DArrayParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DArrayParameter{gdclass.NewVisualShaderNodeTexture2DArrayParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
