...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("LightmapperRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.LightmapperRD{gdclass.NewLightmapperRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
