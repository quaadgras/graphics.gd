...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("IntervalTweener")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.IntervalTweener{gdclass.NewIntervalTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
