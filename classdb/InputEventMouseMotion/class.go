...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventMouseMotion{gdclass.NewInputEventMouseMotion(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
