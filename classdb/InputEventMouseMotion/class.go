...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.InputEventMouseMotion](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventMouseMotion{pointers.Add[gdclass.InputEventMouseMotion]([3]uint64{})})
	...
	casted := Instance([1]gdclass.InputEventMouseMotion{pointers.New[gdclass.InputEventMouseMotion]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsInputEventMouseMotion() Advanced {
	return Advanced{pointers.AsA[gdclass.InputEventMouseMotion](self[0])}
}
func (self Instance) AsInputEventMouseMotion() Instance {
	return Instance{pointers.AsA[gdclass.InputEventMouseMotion](self[0])}
}
...
func (self class) AsInputEventMouse() InputEventMouse.Advanced {
	return InputEventMouse.Advanced{pointers.AsA[gdclass.InputEventMouse](self[0])}
}
...
func (self Instance) AsInputEventMouse() InputEventMouse.Instance {
	return InputEventMouse.Instance{pointers.AsA[gdclass.InputEventMouse](self[0])}
}
...
func init() {
	gdclass.Register("InputEventMouseMotion", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.InputEventMouseMotion](ptr)} })
}
