...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("JNISingleton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.JNISingleton{gdclass.NewJNISingleton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
