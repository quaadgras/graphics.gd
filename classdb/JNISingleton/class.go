...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.JNISingleton](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.JNISingleton{pointers.Add[gdclass.JNISingleton]([3]uint64{})})
	...
	casted := Instance([1]gdclass.JNISingleton{pointers.New[gdclass.JNISingleton]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsJNISingleton() Advanced {
	return Advanced{pointers.AsA[gdclass.JNISingleton](self[0])}
}
func (self Instance) AsJNISingleton() Instance {
	return Instance{pointers.AsA[gdclass.JNISingleton](self[0])}
}
...
func init() {
	gdclass.Register("JNISingleton", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.JNISingleton](ptr)} })
}
