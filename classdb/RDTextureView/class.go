...
func (self class) SetFormatOverride(p_member Rendering.DataFormat) { //gd:RDTextureView.set_format_override
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_format_override, 0|(gdextension.SizeInt<<4), &struct{ p_member Rendering.DataFormat }{p_member})
}

//go:nosplit
func (self class) GetFormatOverride() Rendering.DataFormat { //gd:RDTextureView.get_format_override
	var r_ret = mainthread.Call[Rendering.DataFormat](gd.ObjectChecked(self.AsObject()), methods.get_format_override, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSwizzleR(p_member Rendering.TextureSwizzle) { //gd:RDTextureView.set_swizzle_r
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_swizzle_r, 0|(gdextension.SizeInt<<4), &struct{ p_member Rendering.TextureSwizzle }{p_member})
}

//go:nosplit
func (self class) GetSwizzleR() Rendering.TextureSwizzle { //gd:RDTextureView.get_swizzle_r
	var r_ret = mainthread.Call[Rendering.TextureSwizzle](gd.ObjectChecked(self.AsObject()), methods.get_swizzle_r, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSwizzleG(p_member Rendering.TextureSwizzle) { //gd:RDTextureView.set_swizzle_g
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_swizzle_g, 0|(gdextension.SizeInt<<4), &struct{ p_member Rendering.TextureSwizzle }{p_member})
}

//go:nosplit
func (self class) GetSwizzleG() Rendering.TextureSwizzle { //gd:RDTextureView.get_swizzle_g
	var r_ret = mainthread.Call[Rendering.TextureSwizzle](gd.ObjectChecked(self.AsObject()), methods.get_swizzle_g, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSwizzleB(p_member Rendering.TextureSwizzle) { //gd:RDTextureView.set_swizzle_b
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_swizzle_b, 0|(gdextension.SizeInt<<4), &struct{ p_member Rendering.TextureSwizzle }{p_member})
}

//go:nosplit
func (self class) GetSwizzleB() Rendering.TextureSwizzle { //gd:RDTextureView.get_swizzle_b
	var r_ret = mainthread.Call[Rendering.TextureSwizzle](gd.ObjectChecked(self.AsObject()), methods.get_swizzle_b, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSwizzleA(p_member Rendering.TextureSwizzle) { //gd:RDTextureView.set_swizzle_a
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_swizzle_a, 0|(gdextension.SizeInt<<4), &struct{ p_member Rendering.TextureSwizzle }{p_member})
}

//go:nosplit
func (self class) GetSwizzleA() Rendering.TextureSwizzle { //gd:RDTextureView.get_swizzle_a
	var r_ret = mainthread.Call[Rendering.TextureSwizzle](gd.ObjectChecked(self.AsObject()), methods.get_swizzle_a, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
