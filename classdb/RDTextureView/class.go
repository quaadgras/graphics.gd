...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDTextureView")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDTextureView{gdclass.NewRDTextureView(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
