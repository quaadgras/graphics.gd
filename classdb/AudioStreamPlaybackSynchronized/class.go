...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackSynchronized{gdclass.NewAudioStreamPlaybackSynchronized(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
