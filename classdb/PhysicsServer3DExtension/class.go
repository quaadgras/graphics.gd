...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsServer3DExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsServer3DExtension{gdclass.NewPhysicsServer3DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
