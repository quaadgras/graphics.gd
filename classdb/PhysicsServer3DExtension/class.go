...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsServer3DExtension{gdclass.NewPhysicsServer3DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
