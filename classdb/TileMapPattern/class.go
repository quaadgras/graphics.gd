...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTileMapPattern(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTileMapPattern(self[0]) }
...
func (self class) AsTileMapPattern() Advanced {
	return Advanced{gdclass.NewTileMapPattern(self.AsObject()[0])}
}
func (self Instance) AsTileMapPattern() Instance {
	return Instance{gdclass.NewTileMapPattern(self.AsObject()[0])}
}
