...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.TileMapPattern](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.TileMapPattern{pointers.Add[gdclass.TileMapPattern]([3]uint64{})})
	...
	casted := Instance([1]gdclass.TileMapPattern{pointers.New[gdclass.TileMapPattern]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) HasCell(coords Vector2i.XY) bool { //gd:TileMapPattern.has_cell
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_cell, gdextension.SizeBool|(gdextension.SizeVector2i<<4), &struct{ coords Vector2i.XY }{coords})
	var ret = r_ret
	return ret
}
...
func (self class) RemoveCell(coords Vector2i.XY, update_size bool) { //gd:TileMapPattern.remove_cell
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.remove_cell, 0|(gdextension.SizeVector2i<<4)|(gdextension.SizeBool<<8), &struct {
		coords      Vector2i.XY
		update_size bool
	}{coords, update_size})
}
...
func (self class) AsTileMapPattern() Advanced {
	return Advanced{pointers.AsA[gdclass.TileMapPattern](self[0])}
}
func (self Instance) AsTileMapPattern() Instance {
	return Instance{pointers.AsA[gdclass.TileMapPattern](self[0])}
}
...
func init() {
	gdclass.Register("TileMapPattern", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.TileMapPattern](ptr)} })
}
