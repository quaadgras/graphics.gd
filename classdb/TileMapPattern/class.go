...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileMapPattern")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileMapPattern{gdclass.NewTileMapPattern(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
