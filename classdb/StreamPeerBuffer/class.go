...
func (self class) AsObject() [1]gd.Object { return gdclass.GetStreamPeerBuffer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetStreamPeerBuffer(self[0]) }
...
func (self class) AsStreamPeerBuffer() Advanced {
	return Advanced{gdclass.NewStreamPeerBuffer(self.AsObject()[0])}
}
func (self Instance) AsStreamPeerBuffer() Instance {
	return Instance{gdclass.NewStreamPeerBuffer(self.AsObject()[0])}
}
