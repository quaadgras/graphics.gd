...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StreamPeerBuffer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeerBuffer{gdclass.NewStreamPeerBuffer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
