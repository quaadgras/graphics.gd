...
Note: This is a low-level API, consider using [graphics.gd/classdb/TextLine], [graphics.gd/classdb/TextParagraph], and [graphics.gd/classdb/Font] classes instead.

This is an abstract class, so to get the currently active [graphics.gd/classdb/TextServer] instance, use the following code:
...
Note: This value is used for font matching only and will not affect font rendering. Use [Instance.FontSetFaceIndex], [Instance.FontSetVariationCoordinates], or [Instance.FontSetEmbolden] instead.
*/
...
Note: This value is used for font matching only and will not affect font rendering. Use [Instance.FontSetFaceIndex], [Instance.FontSetVariationCoordinates], or [Instance.FontSetTransform] instead.
*/
...
/*
Sets variation coordinates for the specified font cache entry. See [Instance.FontSupportedVariationList] for more info.
*/
...
/*
Returns variation coordinates for the specified font cache entry. See [Instance.FontSupportedVariationList] for more info.
*/
...
Note: This function will not remove glyphs associated with the texture, use [Instance.FontRemoveGlyph] to remove them manually.
*/
...
Note: This function will not remove glyphs associated with the texture, remove them manually, using [Instance.FontRemoveGlyph].
*/
...
Note: This function will not remove textures associated with the glyphs, use [Instance.FontRemoveTexture] to remove them manually.
*/
...
/*
Returns the glyph index of a 'char', optionally modified by the 'variation_selector'. See [Instance.FontGetCharFromGlyphIndex].
*/
...
/*
Returns character code associated with 'glyph_index', or 0 if 'glyph_index' is invalid. See [Instance.FontGetGlyphIndex].
*/
...
/*
Creates a new buffer for complex text layout, with the given 'direction' and 'orientation'. To free the resulting buffer, use [Instance.FreeRid] method.

Note: Direction is ignored if server does not support [FeatureBidiLayout] feature (supported by [graphics.gd/classdb/TextServerAdvanced]).
...
Adds text span and font to draw it to the text buffer.
*/
func (self Expanded) ShapedTextAddString(shaped RID.TextBuffer, text string, fonts []RID.TextBuffer, size int, opentype_features map[string]uint32, language string, meta any) bool { //gd:TextServer.shaped_text_add_string
...
Note: This method doesn't detect invisible characters, for spoof detection use it in combination with [Instance.SpoofCheck].
...
Note: Casing is locale dependent and context sensitive if server support [FeatureContextSensitiveCaseConversion] feature (supported by [graphics.gd/classdb/TextServerAdvanced]).
...
const (
	// Trims text before the shaping. e.g, increasing [graphics.gd/classdb/Label.Instance.VisibleCharacters] or [graphics.gd/classdb/RichTextLabel.Instance.VisibleCharacters] value is visually identical to typing the text.
	//
	...
	// Displays glyphs that are mapped to the first [graphics.gd/classdb/Label.Instance.VisibleCharacters] or [graphics.gd/classdb/RichTextLabel.Instance.VisibleCharacters] characters from the beginning of the text.
	VcCharsAfterShaping VisibleCharactersBehavior = 1
	// Displays [graphics.gd/classdb/Label.Instance.VisibleRatio] or [graphics.gd/classdb/RichTextLabel.Instance.VisibleRatio] glyphs, starting from the left or from the right, depending on [graphics.gd/classdb/Control.Instance.LayoutDirection] value.
	VcGlyphsAuto VisibleCharactersBehavior = 2
	// Displays [graphics.gd/classdb/Label.Instance.VisibleRatio] or [graphics.gd/classdb/RichTextLabel.Instance.VisibleRatio] glyphs, starting from the left.
	VcGlyphsLtr VisibleCharactersBehavior = 3
	// Displays [graphics.gd/classdb/Label.Instance.VisibleRatio] or [graphics.gd/classdb/RichTextLabel.Instance.VisibleRatio] glyphs, starting from the right.
...
const (
	...
	// TextServer require external data file for some features, see [Instance.LoadSupportData].
	FeatureUseSupportData Feature = 4096
	// TextServer supports UAX #31 identifier validation, see [Instance.IsValidIdentifier].
