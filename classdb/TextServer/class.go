...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextServer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextServer{gdclass.NewTextServer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
