...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CenterContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CenterContainer{gdclass.NewCenterContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
