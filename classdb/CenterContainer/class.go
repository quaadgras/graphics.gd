...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CenterContainer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CenterContainer{pointers.Add[gdclass.CenterContainer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CenterContainer{pointers.New[gdclass.CenterContainer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetUseTopLeft(enable bool) { //gd:CenterContainer.set_use_top_left
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_top_left, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsUsingTopLeft() bool { //gd:CenterContainer.is_using_top_left
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_using_top_left, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsCenterContainer() Advanced {
	return Advanced{pointers.AsA[gdclass.CenterContainer](self[0])}
}
func (self Instance) AsCenterContainer() Instance {
	return Instance{pointers.AsA[gdclass.CenterContainer](self[0])}
}
...
func init() {
	gdclass.Register("CenterContainer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CenterContainer](ptr)} })
}
