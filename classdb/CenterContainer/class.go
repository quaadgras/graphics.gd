...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCenterContainer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCenterContainer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CenterContainer{gdclass.NewCenterContainer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCenterContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CenterContainer{gdclass.NewCenterContainer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCenterContainer() Advanced {
	return Advanced{gdclass.NewCenterContainer(self.AsObject()[0])}
}
func (self Instance) AsCenterContainer() Instance {
	return Instance{gdclass.NewCenterContainer(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("CenterContainer", func(ptr gd.Object) any { return Instance{gdclass.NewCenterContainer(ptr)} })
}
