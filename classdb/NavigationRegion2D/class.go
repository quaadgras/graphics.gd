...
Two regions can be connected to each other if they share a similar edge. You can set the minimum distance between two vertices required to connect two edges by using [Instance.Navigationserver2d.MapSetEdgeConnectionMargin].
...
/*
Returns the [RID] of this region on the [NavigationServer2D]. Combined with [Instance.Navigationserver2d.MapGetClosestPointOwner] can be used to identify the [NavigationRegion2D] closest to a point on the merged navigation map.
*/
