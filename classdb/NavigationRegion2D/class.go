...
func (self class) AsObject() [1]gd.Object { return gdclass.GetNavigationRegion2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetNavigationRegion2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.NavigationRegion2D{gdclass.NewNavigationRegion2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetNavigationRegion2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.NavigationRegion2D{gdclass.NewNavigationRegion2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) SetNavigationPolygon(navigation_polygon [1]gdclass.NavigationPolygon) { //gd:NavigationRegion2D.set_navigation_polygon
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_navigation_polygon, 0|(gdextension.SizeObject<<4), &struct{ navigation_polygon gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetNavigationPolygon(navigation_polygon[0])))})
}
...
func (self Instance) OnNavigationPolygonChanged(cb func(), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("navigation_polygon_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsNavigationRegion2D() Advanced {
	return Advanced{gdclass.NewNavigationRegion2D(self.AsObject()[0])}
}
func (self Instance) AsNavigationRegion2D() Instance {
	return Instance{gdclass.NewNavigationRegion2D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("NavigationRegion2D", func(ptr gd.Object) any { return Instance{gdclass.NewNavigationRegion2D(ptr)} })
}
