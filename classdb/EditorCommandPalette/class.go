...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorCommandPalette{gdclass.NewEditorCommandPalette(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
