...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorCommandPalette")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorCommandPalette{gdclass.NewEditorCommandPalette(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
