...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MenuBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MenuBar{gdclass.NewMenuBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
