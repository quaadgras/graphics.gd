...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisibleOnScreenEnabler3D{gdclass.NewVisibleOnScreenEnabler3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
