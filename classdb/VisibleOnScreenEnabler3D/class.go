...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisibleOnScreenEnabler3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisibleOnScreenEnabler3D{gdclass.NewVisibleOnScreenEnabler3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
