...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScrollContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScrollContainer{gdclass.NewScrollContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
