...
/*
A container used to provide a child control with scrollbars when needed. Scrollbars will automatically be drawn at the right (for vertical) or bottom (for horizontal) and will enable dragging to move the viewable Control (and its children) within the ScrollContainer. Scrollbars will also automatically resize the grabber based on the [graphics.gd/classdb/Control.Instance.CustomMinimumSize] of the Control relative to the ScrollContainer.
*/
...
/*
Returns the horizontal scrollbar [graphics.gd/classdb/HScrollBar] of this [graphics.gd/classdb/ScrollContainer].

Warning: This is a required internal node, removing and freeing it may cause a crash. If you wish to disable or hide a scrollbar, you can use [Instance.HorizontalScrollMode].
*/
...
/*
Returns the vertical scrollbar [graphics.gd/classdb/VScrollBar] of this [graphics.gd/classdb/ScrollContainer].

Warning: This is a required internal node, removing and freeing it may cause a crash. If you wish to disable or hide a scrollbar, you can use [Instance.VerticalScrollMode].
*/
...
/*
Ensures the given 'control' is visible (must be a direct or indirect child of the ScrollContainer). Used by [Instance.FollowFocus].

Note: This will not work on a node that was just added during the same frame. If you want to scroll to a newly added child, you must wait until the next frame using [Instance.OnScenetree.ProcessFrame]:
*/
