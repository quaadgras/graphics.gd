...
/*
Node used for displaying a [graphics.gd/classdb/Mesh] in 2D. A [graphics.gd/classdb/MeshInstance2D] can be automatically created from an existing [graphics.gd/classdb/Sprite2D] via a tool in the editor toolbar. Select the [graphics.gd/classdb/Sprite2D] node, then choose Sprite2D > Convert to MeshInstance2D at the top of the 2D editor viewport.
*/
