...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FlowContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FlowContainer{gdclass.NewFlowContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
