...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ENetMultiplayerPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ENetMultiplayerPeer{gdclass.NewENetMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
