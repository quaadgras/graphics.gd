...
func New() Instance {
	...
	casted := Instance([1]gdclass.ENetMultiplayerPeer{gdclass.NewENetMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
