...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPlaceholderTexture2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPlaceholderTexture2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetPlaceholderTexture2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsPlaceholderTexture2D() Advanced {
	return Advanced{gdclass.NewPlaceholderTexture2D(self.AsObject()[0])}
}
func (self Instance) AsPlaceholderTexture2D() Instance {
	return Instance{gdclass.NewPlaceholderTexture2D(self.AsObject()[0])}
}
func (self *Extension[T]) AsPlaceholderTexture2D() Instance {
	return self.Super().AsPlaceholderTexture2D()
}
...
func init() {
	gdclass.Register("PlaceholderTexture2D", func(ptr gd.Object) any { return Instance{gdclass.NewPlaceholderTexture2D(ptr)} })
}
