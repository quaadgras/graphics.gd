...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PlaceholderTexture2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PlaceholderTexture2D{pointers.Add[gdclass.PlaceholderTexture2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PlaceholderTexture2D{pointers.New[gdclass.PlaceholderTexture2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self Instance) AsPlaceholderTexture2D() Instance {
	return Instance{pointers.AsA[gdclass.PlaceholderTexture2D](self[0])}
}
...
func init() {
	gdclass.Register("PlaceholderTexture2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PlaceholderTexture2D](ptr)} })
}
