...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("PlaceholderTexture2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
