...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
