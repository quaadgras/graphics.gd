...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderTexture2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2D{gdclass.NewPlaceholderTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
