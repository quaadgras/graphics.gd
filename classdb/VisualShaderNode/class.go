...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNode")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNode{gdclass.NewVisualShaderNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
