...
/*
Virtual method to be implemented by the user. Overrides the value returned by [Instance.GetContentsMinimumSize].
*/
...
Note: Make sure to keep a reference to the node, otherwise it will be orphaned. You also need to manually call [Instance.Node.QueueFree] to free the window if it's not parented.
*/
...
/*
Returns the combined minimum size from the child [Control] nodes of the window. Use [Instance.ChildControlsChanged] to update it when child nodes have changed.
The value returned by this method can be overridden with [Instance.GetContentsMinimumSize].
*/
...
See also [Instance.GetThemeStylebox] and [Instance.Control.AddThemeStyleboxOverride] for more details.
*/
...
See also [Instance.GetThemeColor] and [Instance.Control.AddThemeColorOverride] for more details.
*/
...
See [Instance.Control.GetThemeColor] for details.
*/
...
See [Instance.Control.GetThemeColor] for more details.
*/
...
/*
Attempts to parent this dialog to the last exclusive window relative to 'from_node', and then calls [Instance.Window.Popup] on it. The dialog must have no current parent, otherwise the method fails.
See also [Instance.SetUnparentWhenInvisible] and [Instance.Node.GetLastExclusiveWindow].
*/
...
/*
Attempts to parent this dialog to the last exclusive window relative to 'from_node', and then calls [Instance.Window.PopupOnParent] on it. The dialog must have no current parent, otherwise the method fails.
See also [Instance.SetUnparentWhenInvisible] and [Instance.Node.GetLastExclusiveWindow].
*/
...
/*
Attempts to parent this dialog to the last exclusive window relative to 'from_node', and then calls [Instance.Window.PopupCentered] on it. The dialog must have no current parent, otherwise the method fails.
See also [Instance.SetUnparentWhenInvisible] and [Instance.Node.GetLastExclusiveWindow].
*/
...
/*
Attempts to parent this dialog to the last exclusive window relative to 'from_node', and then calls [Instance.Window.PopupCenteredRatio] on it. The dialog must have no current parent, otherwise the method fails.
See also [Instance.SetUnparentWhenInvisible] and [Instance.Node.GetLastExclusiveWindow].
*/
...
/*
Attempts to parent this dialog to the last exclusive window relative to 'from_node', and then calls [Instance.Window.PopupCenteredClamped] on it. The dialog must have no current parent, otherwise the method fails.
See also [Instance.SetUnparentWhenInvisible] and [Instance.Node.GetLastExclusiveWindow].
*/
