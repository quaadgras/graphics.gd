...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Window")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Window{gdclass.NewWindow(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
