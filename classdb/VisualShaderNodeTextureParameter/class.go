...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTextureParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureParameter{gdclass.NewVisualShaderNodeTextureParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
