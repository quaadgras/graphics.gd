...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTextureParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTextureParameter{gdclass.NewVisualShaderNodeTextureParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTextureParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureParameter{gdclass.NewVisualShaderNodeTextureParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTextureParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTextureParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTextureParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeTextureParameter(self.AsObject()[0])}
}
