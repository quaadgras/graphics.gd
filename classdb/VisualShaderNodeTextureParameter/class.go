...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureParameter{gdclass.NewVisualShaderNodeTextureParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
