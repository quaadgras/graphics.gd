...
/*
Returns the [NavigationMesh] resulting from this navigation polygon. This navigation mesh can be used to update the navigation mesh of a region with the [Instance.Navigationserver3d.RegionSetNavigationMesh] API directly (as 2D uses the 3D server behind the scene).
*/
...
/*
Based on 'value', enables or disables the specified layer in the [member parsed_collision_mask], given a 'layer_number' between 1 and 32.
*/
...
/*
Returns whether or not the specified layer of the [member parsed_collision_mask] is enabled, given a 'layer_number' between 1 and 32.
*/
