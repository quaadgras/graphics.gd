...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationPolygon")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPolygon{gdclass.NewNavigationPolygon(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
