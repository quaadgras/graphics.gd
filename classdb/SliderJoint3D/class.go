...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SliderJoint3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SliderJoint3D{gdclass.NewSliderJoint3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
