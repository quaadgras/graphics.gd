...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ExternalTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ExternalTexture{gdclass.NewExternalTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
