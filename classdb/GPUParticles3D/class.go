...
func (self class) SetDrawPasses(passes int64) { //gd:GPUParticles3D.set_draw_passes
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_draw_passes, 0|(gdextension.SizeInt<<4), &struct{ passes int64 }{passes})
}
...
func (self class) SetDrawPassMesh(pass int64, mesh [1]gdclass.Mesh) { //gd:GPUParticles3D.set_draw_pass_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_draw_pass_mesh, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct {
		pass int64
...
func (self class) GetDrawPasses() int64 { //gd:GPUParticles3D.get_draw_passes
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_draw_passes, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetDrawPassMesh(pass int64) [1]gdclass.Mesh { //gd:GPUParticles3D.get_draw_pass_mesh
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_draw_pass_mesh, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ pass int64 }{pass})
...
func (self class) EmitParticle(xform Transform3D.BasisOrigin, velocity Vector3.XYZ, color Color.RGBA, custom Color.RGBA, flags int64) { //gd:GPUParticles3D.emit_particle
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.emit_particle, 0|(gdextension.SizeTransform3D<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeInt<<20), &struct {
...
func (self class) SetTransformAlign(align TransformAlign) { //gd:GPUParticles3D.set_transform_align
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_transform_align, 0|(gdextension.SizeInt<<4), &struct{ align TransformAlign }{align})
}

//go:nosplit
func (self class) GetTransformAlign() TransformAlign { //gd:GPUParticles3D.get_transform_align
	var r_ret = mainthread.Call[TransformAlign](gd.ObjectChecked(self.AsObject()), methods.get_transform_align, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
