...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PlaceholderMaterial](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PlaceholderMaterial{pointers.Add[gdclass.PlaceholderMaterial]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PlaceholderMaterial{pointers.New[gdclass.PlaceholderMaterial]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsPlaceholderMaterial() Advanced {
	return Advanced{pointers.AsA[gdclass.PlaceholderMaterial](self[0])}
}
func (self Instance) AsPlaceholderMaterial() Instance {
	return Instance{pointers.AsA[gdclass.PlaceholderMaterial](self[0])}
}
...
func init() {
	gdclass.Register("PlaceholderMaterial", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PlaceholderMaterial](ptr)} })
}
