...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderMaterial{gdclass.NewPlaceholderMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
