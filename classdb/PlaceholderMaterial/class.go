...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderMaterial{gdclass.NewPlaceholderMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
