...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OptionButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OptionButton{gdclass.NewOptionButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
