...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RegEx")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RegEx{gdclass.NewRegEx(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
