...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationMeshSourceGeometryData3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationMeshSourceGeometryData3D{gdclass.NewNavigationMeshSourceGeometryData3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
