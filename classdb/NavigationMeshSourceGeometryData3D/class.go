...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationMeshSourceGeometryData3D{gdclass.NewNavigationMeshSourceGeometryData3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
