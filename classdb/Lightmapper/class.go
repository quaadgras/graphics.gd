...
func (self class) AsObject() [1]gd.Object { return gdclass.GetLightmapper(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetLightmapper(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Lightmapper{gdclass.NewLightmapper(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetLightmapper(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Lightmapper{gdclass.NewLightmapper(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsLightmapper() Advanced {
	return Advanced{gdclass.NewLightmapper(self.AsObject()[0])}
}
func (self Instance) AsLightmapper() Instance {
	return Instance{gdclass.NewLightmapper(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("Lightmapper", func(ptr gd.Object) any { return Instance{gdclass.NewLightmapper(ptr)} })
}
