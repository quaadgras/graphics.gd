...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Lightmapper")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Lightmapper{gdclass.NewLightmapper(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
