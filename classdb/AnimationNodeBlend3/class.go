...
/*
A resource to add to an [graphics.gd/classdb/AnimationNodeBlendTree]. Blends two animations out of three linearly out of three based on the amount value.
...
In general, the blend value should be in the [-1.0, 1.0] range. Values outside of this range can blend amplified animations, however, [graphics.gd/classdb/AnimationNodeAdd3] works better for this purpose.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AnimationNodeBlend3](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeBlend3{pointers.Add[gdclass.AnimationNodeBlend3]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AnimationNodeBlend3{pointers.New[gdclass.AnimationNodeBlend3]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsAnimationNodeBlend3() Advanced {
	return Advanced{pointers.AsA[gdclass.AnimationNodeBlend3](self[0])}
}
func (self Instance) AsAnimationNodeBlend3() Instance {
	return Instance{pointers.AsA[gdclass.AnimationNodeBlend3](self[0])}
}
func (self *Extension[T]) AsAnimationNodeBlend3() Instance {
	return self.Super().AsAnimationNodeBlend3()
}
...
func init() {
	gdclass.Register("AnimationNodeBlend3", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AnimationNodeBlend3](ptr)} })
}
