...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlend3{gdclass.NewAnimationNodeBlend3(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
