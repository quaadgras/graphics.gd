...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeBlend3")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlend3{gdclass.NewAnimationNodeBlend3(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
