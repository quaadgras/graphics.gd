...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectChorus")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectChorus{gdclass.NewAudioEffectChorus(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
