...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Thread")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Thread{gdclass.NewThread(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
