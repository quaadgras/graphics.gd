...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventMagnifyGesture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventMagnifyGesture{gdclass.NewInputEventMagnifyGesture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
