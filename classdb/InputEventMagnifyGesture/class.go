...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventMagnifyGesture{gdclass.NewInputEventMagnifyGesture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
