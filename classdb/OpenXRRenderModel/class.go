...
func (self class) GetTopLevelPath() String.Readable { //gd:OpenXRRenderModel.get_top_level_path
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_top_level_path, gdextension.SizeString, &struct{}{})
...
func (self class) GetRenderModel() RID.Any { //gd:OpenXRRenderModel.get_render_model
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_render_model, gdextension.SizeRID, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetRenderModel(render_model RID.Any) { //gd:OpenXRRenderModel.set_render_model
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_render_model, 0|(gdextension.SizeRID<<4), &struct{ render_model RID.Any }{render_model})
}
