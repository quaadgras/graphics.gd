...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRRenderModel")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRRenderModel{gdclass.NewOpenXRRenderModel(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
