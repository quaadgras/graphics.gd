...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectDistortion")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectDistortion{gdclass.NewAudioEffectDistortion(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
