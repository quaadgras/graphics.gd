...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectDistortion{gdclass.NewAudioEffectDistortion(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
