...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ShaderIncludeDB")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShaderIncludeDB{gdclass.NewShaderIncludeDB(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
