...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Theme")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Theme{gdclass.NewTheme(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
