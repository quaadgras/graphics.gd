...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HTTPClient")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HTTPClient{gdclass.NewHTTPClient(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
