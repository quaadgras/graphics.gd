...
func (self class) AsObject() [1]gd.Object { return gdclass.GetHTTPClient(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetHTTPClient(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HTTPClient{gdclass.NewHTTPClient(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetHTTPClient(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HTTPClient{gdclass.NewHTTPClient(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsHTTPClient() Advanced { return Advanced{gdclass.NewHTTPClient(self.AsObject()[0])} }
func (self Instance) AsHTTPClient() Instance {
	return Instance{gdclass.NewHTTPClient(self.AsObject()[0])}
}
