...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpriteFrames")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpriteFrames{gdclass.NewSpriteFrames(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
