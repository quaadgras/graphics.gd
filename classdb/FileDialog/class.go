...
/*
[graphics.gd/classdb/FileDialog] is a preset dialog used to choose files and directories in the filesystem. It supports filter masks. [graphics.gd/classdb/FileDialog] automatically sets its window title according to the [Instance.FileMode]. If you want to use a custom title, disable this by setting [Instance.ModeOverridesTitle] to false.
*/
package FileDialog
...
Note: Changes to this node are ignored by native file dialogs, use [Instance.AddOption] to add custom elements to the dialog instead.
*/
...
const (
	// The dialog only allows accessing files under the [graphics.gd/classdb/Resource] path (res://).
