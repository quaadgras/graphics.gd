...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FileDialog")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FileDialog{gdclass.NewFileDialog(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
