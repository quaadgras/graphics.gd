...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmit{gdclass.NewVisualShaderNodeParticleEmit(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
