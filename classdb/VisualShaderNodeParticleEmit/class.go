...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeParticleEmit(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeParticleEmit(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleEmit{gdclass.NewVisualShaderNodeParticleEmit(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeParticleEmit(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmit{gdclass.NewVisualShaderNodeParticleEmit(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeParticleEmit() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleEmit(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleEmit() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleEmit(self.AsObject()[0])}
}
