...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeParticleEmit](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleEmit{pointers.Add[gdclass.VisualShaderNodeParticleEmit]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmit{pointers.New[gdclass.VisualShaderNodeParticleEmit]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetFlags(flags EmitFlags) { //gd:VisualShaderNodeParticleEmit.set_flags
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_flags, 0|(gdextension.SizeInt<<4), &struct{ flags EmitFlags }{flags})
}

//go:nosplit
func (self class) GetFlags() EmitFlags { //gd:VisualShaderNodeParticleEmit.get_flags
	var r_ret = mainthread.Call[EmitFlags](gd.ObjectChecked(self.AsObject()), methods.get_flags, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeParticleEmit() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeParticleEmit](self[0])}
}
func (self Instance) AsVisualShaderNodeParticleEmit() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeParticleEmit](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleEmit", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeParticleEmit](ptr)} })
}
