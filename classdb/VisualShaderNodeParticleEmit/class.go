...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleEmit")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmit{gdclass.NewVisualShaderNodeParticleEmit(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
