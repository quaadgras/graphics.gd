...
func (self class) GetInertia() float64 { //gd:RigidBody2D.get_inertia
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_inertia, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetInertia(inertia float64) { //gd:RigidBody2D.set_inertia
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_inertia, 0|(gdextension.SizeFloat<<4), &struct{ inertia float64 }{inertia})
}
...
func (self class) SetCenterOfMass(center_of_mass Vector2.XY) { //gd:RigidBody2D.set_center_of_mass
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_center_of_mass, 0|(gdextension.SizeVector2<<4), &struct{ center_of_mass Vector2.XY }{center_of_mass})
}
...
func (self class) SetLinearVelocity(linear_velocity Vector2.XY) { //gd:RigidBody2D.set_linear_velocity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_linear_velocity, 0|(gdextension.SizeVector2<<4), &struct{ linear_velocity Vector2.XY }{linear_velocity})
}
...
func (self class) SetAngularVelocity(angular_velocity float64) { //gd:RigidBody2D.set_angular_velocity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_angular_velocity, 0|(gdextension.SizeFloat<<4), &struct{ angular_velocity float64 }{angular_velocity})
}
...
func (self class) SetContinuousCollisionDetectionMode(mode CCDMode) { //gd:RigidBody2D.set_continuous_collision_detection_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_continuous_collision_detection_mode, 0|(gdextension.SizeInt<<4), &struct{ mode CCDMode }{mode})
}

//go:nosplit
func (self class) GetContinuousCollisionDetectionMode() CCDMode { //gd:RigidBody2D.get_continuous_collision_detection_mode
	var r_ret = mainthread.Call[CCDMode](gd.ObjectChecked(self.AsObject()), methods.get_continuous_collision_detection_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetAxisVelocity(axis_velocity Vector2.XY) { //gd:RigidBody2D.set_axis_velocity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_axis_velocity, 0|(gdextension.SizeVector2<<4), &struct{ axis_velocity Vector2.XY }{axis_velocity})
}
...
func (self class) ApplyTorqueImpulse(torque float64) { //gd:RigidBody2D.apply_torque_impulse
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.apply_torque_impulse, 0|(gdextension.SizeFloat<<4), &struct{ torque float64 }{torque})
}
