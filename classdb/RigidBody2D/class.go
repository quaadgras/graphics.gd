...
Note: Changing the 2D transform or [member linear_velocity] of a [RigidBody2D] very often may lead to some unpredictable behaviors. If you need to directly affect the body, prefer [Instance.IntegrateForces] as it allows you to directly access the physics state.
*/
package RigidBody2D
