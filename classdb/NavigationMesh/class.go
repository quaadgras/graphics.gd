...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationMesh{gdclass.NewNavigationMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
