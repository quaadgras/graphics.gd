...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ParallaxLayer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ParallaxLayer{gdclass.NewParallaxLayer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
