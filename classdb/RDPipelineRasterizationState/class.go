...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDPipelineRasterizationState")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineRasterizationState{gdclass.NewRDPipelineRasterizationState(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
