...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineRasterizationState{gdclass.NewRDPipelineRasterizationState(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
