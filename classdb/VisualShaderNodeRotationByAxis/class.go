...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRotationByAxis{gdclass.NewVisualShaderNodeRotationByAxis(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
