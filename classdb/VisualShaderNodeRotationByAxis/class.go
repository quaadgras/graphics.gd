...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeRotationByAxis")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRotationByAxis{gdclass.NewVisualShaderNodeRotationByAxis(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
