...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformWeb")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformWeb{gdclass.NewEditorExportPlatformWeb(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
