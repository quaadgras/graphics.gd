...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformWeb{gdclass.NewEditorExportPlatformWeb(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
