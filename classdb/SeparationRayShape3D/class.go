...
func (self class) SetSlideOnSlope(active bool) { //gd:SeparationRayShape3D.set_slide_on_slope
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_slide_on_slope, 0|(gdextension.SizeBool<<4), &struct{ active bool }{active})
}

//go:nosplit
func (self class) GetSlideOnSlope() bool { //gd:SeparationRayShape3D.get_slide_on_slope
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_slide_on_slope, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
