...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SeparationRayShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SeparationRayShape3D{gdclass.NewSeparationRayShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
