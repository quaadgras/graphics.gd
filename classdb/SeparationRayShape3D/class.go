...
func New() Instance {
	...
	casted := Instance([1]gdclass.SeparationRayShape3D{gdclass.NewSeparationRayShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
