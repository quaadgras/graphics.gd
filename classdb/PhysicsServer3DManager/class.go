...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsServer3DManager")
...
func singleton() {
	self[0] = gdclass.NewPhysicsServer3DManager(gdreference.RawObject(gdextension.Object(gdunsafe.ObjectGlobal(sname))))
}
