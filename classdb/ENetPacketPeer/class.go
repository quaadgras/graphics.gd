...
This class cannot be instantiated directly but can be retrieved during [graphics.gd/classdb/ENetConnection.Instance.Service] or via [graphics.gd/classdb/ENetConnection.Instance.GetPeers].
...
/*
Request a disconnection from a peer. An [Enetconnection.EventDisconnect] will be generated during [graphics.gd/classdb/ENetConnection.Instance.Service] once the disconnection is complete.
*/
...
/*
Request a disconnection from a peer, but only after all queued outgoing packets are sent. An [Enetconnection.EventDisconnect] will be generated during [graphics.gd/classdb/ENetConnection.Instance.Service] once the disconnection is complete.
*/
...
/*
Returns true if the peer is currently active (i.e. the associated [graphics.gd/classdb/ENetConnection] is still valid).
*/
