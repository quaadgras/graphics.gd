...
This class cannot be instantiated directly but can be retrieved during [Instance.Enetconnection.Service] or via [Instance.Enetconnection.GetPeers].
...
/*
Request a disconnection from a peer. An [Enetconnection.EventDisconnect] will be generated during [Instance.Enetconnection.Service] once the disconnection is complete.
*/
...
/*
Request a disconnection from a peer, but only after all queued outgoing packets are sent. An [Enetconnection.EventDisconnect] will be generated during [Instance.Enetconnection.Service] once the disconnection is complete.
*/
