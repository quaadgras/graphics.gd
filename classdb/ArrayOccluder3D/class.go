...
/*
[graphics.gd/classdb/ArrayOccluder3D] stores an arbitrary 3D polygon shape that can be used by the engine's occlusion culling system. This is analogous to [graphics.gd/classdb/ArrayMesh], but for occluders.
...
/*
Sets [Instance.Indices] and [Instance.Vertices], while updating the final occluder only once after both values are set.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ArrayOccluder3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ArrayOccluder3D{pointers.Add[gdclass.ArrayOccluder3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ArrayOccluder3D{pointers.New[gdclass.ArrayOccluder3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self Instance) AsArrayOccluder3D() Instance {
	return Instance{pointers.AsA[gdclass.ArrayOccluder3D](self[0])}
}
...
func init() {
	gdclass.Register("ArrayOccluder3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ArrayOccluder3D](ptr)} })
}
