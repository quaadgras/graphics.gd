...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextMesh{gdclass.NewTextMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
