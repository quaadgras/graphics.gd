...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SceneTree")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneTree{gdclass.NewSceneTree(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
