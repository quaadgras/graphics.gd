...
/*
Returns the camera limit for the specified [Side]. See also [Instance.LimitBottom], [Instance.LimitTop], [Instance.LimitLeft], and [Instance.LimitRight].
*/
//go:nosplit
...
/*
Sets the specified [Side]'s margin. See also [Instance.DragBottomMargin], [Instance.DragTopMargin], [Instance.DragLeftMargin], and [Instance.DragRightMargin].
*/
//go:nosplit
...
/*
Returns the specified [Side]'s margin. See also [Instance.DragBottomMargin], [Instance.DragTopMargin], [Instance.DragLeftMargin], and [Instance.DragRightMargin].
*/
//go:nosplit
