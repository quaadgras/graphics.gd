...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPolygon2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPolygon2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Polygon2D{gdclass.NewPolygon2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetPolygon2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Polygon2D{gdclass.NewPolygon2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsPolygon2D() Advanced { return Advanced{gdclass.NewPolygon2D(self.AsObject()[0])} }
func (self Instance) AsPolygon2D() Instance {
	return Instance{gdclass.NewPolygon2D(self.AsObject()[0])}
}
