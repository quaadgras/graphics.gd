...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Polygon2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Polygon2D{gdclass.NewPolygon2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
