...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsTestMotionResult2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionResult2D{gdclass.NewPhysicsTestMotionResult2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
