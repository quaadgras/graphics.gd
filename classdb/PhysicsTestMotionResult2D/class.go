...
/*
Describes the motion and collision result from [Instance.Physicsserver2d.BodyTestMotion].
*/
...
/*
Returns the unique instance ID of the colliding body's attached [Object], if a collision occurred. See [Instance.Object.GetInstanceId].
*/
...
func (self class) GetTravel() Vector2.XY { //gd:PhysicsTestMotionResult2D.get_travel
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_travel, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetRemainder() Vector2.XY { //gd:PhysicsTestMotionResult2D.get_remainder
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_remainder, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetColliderVelocity() Vector2.XY { //gd:PhysicsTestMotionResult2D.get_collider_velocity
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_collider_velocity, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetColliderId() int64 { //gd:PhysicsTestMotionResult2D.get_collider_id
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_collider_id, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionLocalShape() int64 { //gd:PhysicsTestMotionResult2D.get_collision_local_shape
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_collision_local_shape, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetCollisionDepth() float64 { //gd:PhysicsTestMotionResult2D.get_collision_depth
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_collision_depth, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
