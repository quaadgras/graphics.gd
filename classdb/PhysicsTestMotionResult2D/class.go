...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionResult2D{gdclass.NewPhysicsTestMotionResult2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
