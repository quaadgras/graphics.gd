...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FontVariation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FontVariation{gdclass.NewFontVariation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
