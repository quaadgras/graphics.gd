...
func (self class) AsObject() [1]gd.Object { return gdclass.GetFontVariation(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetFontVariation(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.FontVariation{gdclass.NewFontVariation(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetFontVariation(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.FontVariation{gdclass.NewFontVariation(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) SetBaseFont(font [1]gdclass.Font) { //gd:FontVariation.set_base_font
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_base_font, 0|(gdextension.SizeObject<<4), &struct{ font gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetFont(font[0])))})
}
...
func (self class) AsFontVariation() Advanced {
	return Advanced{gdclass.NewFontVariation(self.AsObject()[0])}
}
func (self Instance) AsFontVariation() Instance {
	return Instance{gdclass.NewFontVariation(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("FontVariation", func(ptr gd.Object) any { return Instance{gdclass.NewFontVariation(ptr)} })
}
