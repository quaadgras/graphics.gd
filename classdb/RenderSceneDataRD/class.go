...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RenderSceneDataRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneDataRD{gdclass.NewRenderSceneDataRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
