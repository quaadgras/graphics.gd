...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDAttachmentFormat")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDAttachmentFormat{gdclass.NewRDAttachmentFormat(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
