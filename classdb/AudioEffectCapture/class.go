...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectCapture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectCapture{gdclass.NewAudioEffectCapture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
