...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioEffectCapture](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectCapture{pointers.Add[gdclass.AudioEffectCapture]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioEffectCapture{pointers.New[gdclass.AudioEffectCapture]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) CanGetBuffer(frames int64) bool { //gd:AudioEffectCapture.can_get_buffer
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.can_get_buffer, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ frames int64 }{frames})
	var ret = r_ret
	return ret
}
...
func (self class) GetBuffer(frames int64) Packed.Array[Vector2.XY] { //gd:AudioEffectCapture.get_buffer
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_buffer, gdextension.SizePackedArray|(gdextension.SizeInt<<4), &struct{ frames int64 }{frames})
...
func (self class) SetBufferLength(buffer_length_seconds float64) { //gd:AudioEffectCapture.set_buffer_length
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_buffer_length, 0|(gdextension.SizeFloat<<4), &struct{ buffer_length_seconds float64 }{buffer_length_seconds})
}
...
func (self class) GetDiscardedFrames() int64 { //gd:AudioEffectCapture.get_discarded_frames
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_discarded_frames, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetBufferLengthFrames() int64 { //gd:AudioEffectCapture.get_buffer_length_frames
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_buffer_length_frames, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetPushedFrames() int64 { //gd:AudioEffectCapture.get_pushed_frames
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_pushed_frames, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsAudioEffectCapture() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioEffectCapture](self[0])}
}
func (self Instance) AsAudioEffectCapture() Instance {
	return Instance{pointers.AsA[gdclass.AudioEffectCapture](self[0])}
}
...
func init() {
	gdclass.Register("AudioEffectCapture", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioEffectCapture](ptr)} })
}
