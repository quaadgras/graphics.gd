...
Note: The value is updated after [Instance.Skeletonmodifier3d.ProcessModification]. To retrieve this value correctly, we recommend using the signal [signal SkeletonModifier3D.modification_processed].
*/
