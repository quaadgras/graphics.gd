...
func (self class) AsObject() [1]gd.Object { return gdclass.GetNavigationAgent3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetNavigationAgent3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.NavigationAgent3D{gdclass.NewNavigationAgent3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetNavigationAgent3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.NavigationAgent3D{gdclass.NewNavigationAgent3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsNavigationAgent3D() Advanced {
	return Advanced{gdclass.NewNavigationAgent3D(self.AsObject()[0])}
}
func (self Instance) AsNavigationAgent3D() Instance {
	return Instance{gdclass.NewNavigationAgent3D(self.AsObject()[0])}
}
