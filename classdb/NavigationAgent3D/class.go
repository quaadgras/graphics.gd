...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationAgent3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationAgent3D{gdclass.NewNavigationAgent3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
