...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FoldableContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FoldableContainer{gdclass.NewFoldableContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
