...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ShapeCast3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShapeCast3D{gdclass.NewShapeCast3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
