...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SegmentShape2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SegmentShape2D{gdclass.NewSegmentShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
