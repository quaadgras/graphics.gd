...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeDistanceFade")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDistanceFade{gdclass.NewVisualShaderNodeDistanceFade(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
