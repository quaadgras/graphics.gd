...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDistanceFade{gdclass.NewVisualShaderNodeDistanceFade(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
