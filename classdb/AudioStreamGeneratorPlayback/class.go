...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamGeneratorPlayback")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamGeneratorPlayback{gdclass.NewAudioStreamGeneratorPlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
