...
/*
Pushes a single audio data frame to the buffer. This is usually less efficient than [Instance.PushBuffer] in C# and compiled languages via GDExtension, but [Instance.PushFrame] may be [i]more[/i] efficient in GDScript.
*/
...
/*
Pushes several audio data frames to the buffer. This is usually more efficient than [Instance.PushFrame] in C# and compiled languages via GDExtension, but [Instance.PushBuffer] may be [i]less[/i] efficient in GDScript.
*/
