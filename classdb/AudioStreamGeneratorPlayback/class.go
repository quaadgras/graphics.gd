...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamGeneratorPlayback{gdclass.NewAudioStreamGeneratorPlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
