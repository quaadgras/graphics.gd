...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeMultiplyAdd")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeMultiplyAdd{gdclass.NewVisualShaderNodeMultiplyAdd(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
