...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeMultiplyAdd{gdclass.NewVisualShaderNodeMultiplyAdd(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
