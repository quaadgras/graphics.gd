...
MP3 requires more CPU to decode than [graphics.gd/classdb/ResourceImporterWAV]. If you need to play a lot of simultaneous sounds, it's recommended to use WAV for those sounds instead, especially if targeting low-end devices.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ResourceImporterMP3](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterMP3{pointers.Add[gdclass.ResourceImporterMP3]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ResourceImporterMP3{pointers.New[gdclass.ResourceImporterMP3]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsResourceImporterMP3() Advanced {
	return Advanced{pointers.AsA[gdclass.ResourceImporterMP3](self[0])}
}
func (self Instance) AsResourceImporterMP3() Instance {
	return Instance{pointers.AsA[gdclass.ResourceImporterMP3](self[0])}
}
...
func init() {
	gdclass.Register("ResourceImporterMP3", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ResourceImporterMP3](ptr)} })
}
