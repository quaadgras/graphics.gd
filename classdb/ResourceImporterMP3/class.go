...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterMP3")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterMP3{gdclass.NewResourceImporterMP3(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
