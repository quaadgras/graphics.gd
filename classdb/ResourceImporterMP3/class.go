...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterMP3{gdclass.NewResourceImporterMP3(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
