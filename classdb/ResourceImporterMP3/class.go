...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceImporterMP3(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceImporterMP3(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterMP3{gdclass.NewResourceImporterMP3(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceImporterMP3(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterMP3{gdclass.NewResourceImporterMP3(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsResourceImporterMP3() Advanced {
	return Advanced{gdclass.NewResourceImporterMP3(self.AsObject()[0])}
}
func (self Instance) AsResourceImporterMP3() Instance {
	return Instance{gdclass.NewResourceImporterMP3(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("ResourceImporterMP3", func(ptr gd.Object) any { return Instance{gdclass.NewResourceImporterMP3(ptr)} })
}
