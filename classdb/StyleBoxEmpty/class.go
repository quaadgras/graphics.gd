...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StyleBoxEmpty")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StyleBoxEmpty{gdclass.NewStyleBoxEmpty(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
