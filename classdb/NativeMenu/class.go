...
func (self class) HasFeature(feature Feature) bool { //gd:NativeMenu.has_feature
	once.Do(singleton)
	var r_ret = jumponly.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.has_feature, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ feature Feature }{feature})
	var ret = r_ret
	return ret
}
func (self class) HasSystemMenu(menu_id SystemMenus) bool { //gd:NativeMenu.has_system_menu
	once.Do(singleton)
	var r_ret = jumponly.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.has_system_menu, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ menu_id SystemMenus }{menu_id})
	var ret = r_ret
	return ret
}
...
func (self class) GetSystemMenuName(menu_id SystemMenus) String.Readable { //gd:NativeMenu.get_system_menu_name
	once.Do(singleton)
	var r_ret = jumponly.Call[gdextension.String](gdreference.GetObject(self.AsObject()[0]), methods.get_system_menu_name, gdextension.SizeString|(gdextension.SizeInt<<4), &struct{ menu_id SystemMenus }{menu_id})
