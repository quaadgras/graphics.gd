...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationMeshGenerator")
...
func singleton() {
	self[0] = gdclass.NewNavigationMeshGenerator(gdreference.RawObject(gdextension.Object(gdunsafe.ObjectGlobal(sname))))
}
