...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Compositor")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Compositor{gdclass.NewCompositor(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
