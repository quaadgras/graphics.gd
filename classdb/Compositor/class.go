...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCompositor(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCompositor(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Compositor{gdclass.NewCompositor(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCompositor(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Compositor{gdclass.NewCompositor(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCompositor() Advanced { return Advanced{gdclass.NewCompositor(self.AsObject()[0])} }
func (self Instance) AsCompositor() Instance {
	return Instance{gdclass.NewCompositor(self.AsObject()[0])}
}
func (self *Extension[T]) AsCompositor() Instance { return self.Super().AsCompositor() }
...
func init() {
	gdclass.Register("Compositor", func(ptr gd.Object) any { return Instance{gdclass.NewCompositor(ptr)} })
}
