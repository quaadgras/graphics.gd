...
/*
A 1D texture where the red, green, and blue color channels correspond to points on 3 unit [graphics.gd/classdb/Curve] resources. Compared to using separate [graphics.gd/classdb/CurveTexture]s, this further simplifies the task of saving curves as image files.

If you only need to store one curve within a single texture, use [graphics.gd/classdb/CurveTexture] instead. See also [graphics.gd/classdb/GradientTexture1D] and [graphics.gd/classdb/GradientTexture2D].
*/
