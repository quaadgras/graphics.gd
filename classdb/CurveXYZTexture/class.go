...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CurveXYZTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CurveXYZTexture{gdclass.NewCurveXYZTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
