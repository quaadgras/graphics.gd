...
Note: Changing the 3D transform or [Instance.LinearVelocity] of a [graphics.gd/classdb/RigidBody3D] very often may lead to some unpredictable behaviors. If you need to directly affect the body, prefer [Interface.IntegrateForces] as it allows you to directly access the physics state.
*/
package RigidBody3D
