...
func (self class) SetInertia(inertia Vector3.XYZ) { //gd:RigidBody3D.set_inertia
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_inertia, 0|(gdextension.SizeVector3<<4), &struct{ inertia Vector3.XYZ }{inertia})
}

//go:nosplit
func (self class) GetInertia() Vector3.XYZ { //gd:RigidBody3D.get_inertia
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_inertia, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCenterOfMassMode(mode CenterOfMassMode) { //gd:RigidBody3D.set_center_of_mass_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_center_of_mass_mode, 0|(gdextension.SizeInt<<4), &struct{ mode CenterOfMassMode }{mode})
}

//go:nosplit
func (self class) GetCenterOfMassMode() CenterOfMassMode { //gd:RigidBody3D.get_center_of_mass_mode
	var r_ret = mainthread.Call[CenterOfMassMode](gd.ObjectChecked(self.AsObject()), methods.get_center_of_mass_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCenterOfMass(center_of_mass Vector3.XYZ) { //gd:RigidBody3D.set_center_of_mass
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_center_of_mass, 0|(gdextension.SizeVector3<<4), &struct{ center_of_mass Vector3.XYZ }{center_of_mass})
}

//go:nosplit
func (self class) GetCenterOfMass() Vector3.XYZ { //gd:RigidBody3D.get_center_of_mass
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_center_of_mass, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetInverseInertiaTensor() Basis.XYZ { //gd:RigidBody3D.get_inverse_inertia_tensor
	var r_ret = mainthread.Call[Basis.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_inverse_inertia_tensor, gdextension.SizeBasis, &struct{}{})
...
func (self class) SetMaxContactsReported(amount int64) { //gd:RigidBody3D.set_max_contacts_reported
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max_contacts_reported, 0|(gdextension.SizeInt<<4), &struct{ amount int64 }{amount})
}

//go:nosplit
func (self class) GetMaxContactsReported() int64 { //gd:RigidBody3D.get_max_contacts_reported
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_max_contacts_reported, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetContactMonitor(enabled bool) { //gd:RigidBody3D.set_contact_monitor
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_contact_monitor, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsContactMonitorEnabled() bool { //gd:RigidBody3D.is_contact_monitor_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_contact_monitor_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetUseContinuousCollisionDetection(enable bool) { //gd:RigidBody3D.set_use_continuous_collision_detection
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_continuous_collision_detection, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsUsingContinuousCollisionDetection() bool { //gd:RigidBody3D.is_using_continuous_collision_detection
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_using_continuous_collision_detection, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetAxisVelocity(axis_velocity Vector3.XYZ) { //gd:RigidBody3D.set_axis_velocity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_axis_velocity, 0|(gdextension.SizeVector3<<4), &struct{ axis_velocity Vector3.XYZ }{axis_velocity})
}
...
func (self class) ApplyTorqueImpulse(impulse Vector3.XYZ) { //gd:RigidBody3D.apply_torque_impulse
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.apply_torque_impulse, 0|(gdextension.SizeVector3<<4), &struct{ impulse Vector3.XYZ }{impulse})
}
...
func (self class) ApplyForce(force Vector3.XYZ, position Vector3.XYZ) { //gd:RigidBody3D.apply_force
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.apply_force, 0|(gdextension.SizeVector3<<4)|(gdextension.SizeVector3<<8), &struct {
		force    Vector3.XYZ
		position Vector3.XYZ
	}{force, position})
}
...
func (self class) ApplyTorque(torque Vector3.XYZ) { //gd:RigidBody3D.apply_torque
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.apply_torque, 0|(gdextension.SizeVector3<<4), &struct{ torque Vector3.XYZ }{torque})
}
...
func (self class) AddConstantCentralForce(force Vector3.XYZ) { //gd:RigidBody3D.add_constant_central_force
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_constant_central_force, 0|(gdextension.SizeVector3<<4), &struct{ force Vector3.XYZ }{force})
}
...
func (self class) AddConstantForce(force Vector3.XYZ, position Vector3.XYZ) { //gd:RigidBody3D.add_constant_force
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_constant_force, 0|(gdextension.SizeVector3<<4)|(gdextension.SizeVector3<<8), &struct {
		force    Vector3.XYZ
		position Vector3.XYZ
	}{force, position})
}
...
func (self class) AddConstantTorque(torque Vector3.XYZ) { //gd:RigidBody3D.add_constant_torque
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_constant_torque, 0|(gdextension.SizeVector3<<4), &struct{ torque Vector3.XYZ }{torque})
}

//go:nosplit
func (self class) SetConstantForce(force Vector3.XYZ) { //gd:RigidBody3D.set_constant_force
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant_force, 0|(gdextension.SizeVector3<<4), &struct{ force Vector3.XYZ }{force})
}

//go:nosplit
func (self class) GetConstantForce() Vector3.XYZ { //gd:RigidBody3D.get_constant_force
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_constant_force, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetConstantTorque(torque Vector3.XYZ) { //gd:RigidBody3D.set_constant_torque
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant_torque, 0|(gdextension.SizeVector3<<4), &struct{ torque Vector3.XYZ }{torque})
}

//go:nosplit
func (self class) GetConstantTorque() Vector3.XYZ { //gd:RigidBody3D.get_constant_torque
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_constant_torque, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSleeping(sleeping bool) { //gd:RigidBody3D.set_sleeping
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sleeping, 0|(gdextension.SizeBool<<4), &struct{ sleeping bool }{sleeping})
}
...
func (self class) SetLockRotationEnabled(lock_rotation bool) { //gd:RigidBody3D.set_lock_rotation_enabled
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_lock_rotation_enabled, 0|(gdextension.SizeBool<<4), &struct{ lock_rotation bool }{lock_rotation})
}

//go:nosplit
func (self class) IsLockRotationEnabled() bool { //gd:RigidBody3D.is_lock_rotation_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_lock_rotation_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFreezeEnabled(freeze_mode bool) { //gd:RigidBody3D.set_freeze_enabled
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_freeze_enabled, 0|(gdextension.SizeBool<<4), &struct{ freeze_mode bool }{freeze_mode})
}

//go:nosplit
func (self class) IsFreezeEnabled() bool { //gd:RigidBody3D.is_freeze_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_freeze_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFreezeMode(freeze_mode FreezeMode) { //gd:RigidBody3D.set_freeze_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_freeze_mode, 0|(gdextension.SizeInt<<4), &struct{ freeze_mode FreezeMode }{freeze_mode})
}

//go:nosplit
func (self class) GetFreezeMode() FreezeMode { //gd:RigidBody3D.get_freeze_mode
	var r_ret = mainthread.Call[FreezeMode](gd.ObjectChecked(self.AsObject()), methods.get_freeze_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetCollidingBodies() Array.Contains[[1]gdclass.Node3D] { //gd:RigidBody3D.get_colliding_bodies
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_colliding_bodies, gdextension.SizeArray, &struct{}{})
