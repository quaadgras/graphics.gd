...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialCapabilityConfigurationAprilTag")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialCapabilityConfigurationAprilTag{gdclass.NewOpenXRSpatialCapabilityConfigurationAprilTag(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
