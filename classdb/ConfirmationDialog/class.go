...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConfirmationDialog")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConfirmationDialog{gdclass.NewConfirmationDialog(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
