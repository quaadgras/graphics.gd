...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("JavaClass")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.JavaClass{gdclass.NewJavaClass(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
