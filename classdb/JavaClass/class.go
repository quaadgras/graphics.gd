...
/*
Represents a class from the Java Native Interface. It is returned from [Instance.Javaclasswrapper.Wrap].
...
/*
Returns the object's Java methods and their signatures as an [Array] of dictionaries, in the same format as [Instance.Object.GetMethodList].
*/
