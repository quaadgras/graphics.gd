...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionPlane3D{gdclass.NewSpringBoneCollisionPlane3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
