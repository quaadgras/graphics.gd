...
/*
An infinite plane collision that interacts with [graphics.gd/classdb/SpringBoneSimulator3D]. It is an infinite size XZ plane, and the +Y direction is treated as normal.
*/
