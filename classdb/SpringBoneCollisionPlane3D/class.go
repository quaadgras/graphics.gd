...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpringBoneCollisionPlane3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionPlane3D{gdclass.NewSpringBoneCollisionPlane3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
