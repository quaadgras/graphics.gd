...
/*
A control used for visual representation of a percentage. Shows the fill percentage in the center. Can also be used to show indeterminate progress. For more fill modes, use [graphics.gd/classdb/TextureProgressBar] instead.
*/
package ProgressBar
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ProgressBar](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ProgressBar{pointers.Add[gdclass.ProgressBar]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ProgressBar{pointers.New[gdclass.ProgressBar]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsProgressBar() Advanced {
	return Advanced{pointers.AsA[gdclass.ProgressBar](self[0])}
}
func (self Instance) AsProgressBar() Instance {
	return Instance{pointers.AsA[gdclass.ProgressBar](self[0])}
}
...
func init() {
	gdclass.Register("ProgressBar", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ProgressBar](ptr)} })
}
