...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ProgressBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ProgressBar{gdclass.NewProgressBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
