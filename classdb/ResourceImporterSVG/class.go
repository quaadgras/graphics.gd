...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterSVG")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterSVG{gdclass.NewResourceImporterSVG(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
