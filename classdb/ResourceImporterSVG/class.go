...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterSVG{gdclass.NewResourceImporterSVG(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
