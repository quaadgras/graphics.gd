...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceImporterSVG(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceImporterSVG(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterSVG{gdclass.NewResourceImporterSVG(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceImporterSVG(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterSVG{gdclass.NewResourceImporterSVG(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsResourceImporterSVG() Advanced {
	return Advanced{gdclass.NewResourceImporterSVG(self.AsObject()[0])}
}
func (self Instance) AsResourceImporterSVG() Instance {
	return Instance{gdclass.NewResourceImporterSVG(self.AsObject()[0])}
}
func (self *Extension[T]) AsResourceImporterSVG() Instance {
	return self.Super().AsResourceImporterSVG()
}
...
func init() {
	gdclass.Register("ResourceImporterSVG", func(ptr gd.Object) any { return Instance{gdclass.NewResourceImporterSVG(ptr)} })
}
