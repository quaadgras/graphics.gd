...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialMarkerTrackingCapability")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialMarkerTrackingCapability{gdclass.NewOpenXRSpatialMarkerTrackingCapability(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
