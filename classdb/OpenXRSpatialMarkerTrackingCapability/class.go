...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialMarkerTrackingCapability{gdclass.NewOpenXRSpatialMarkerTrackingCapability(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
