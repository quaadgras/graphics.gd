...
/*
Once added to the scene tree and enabled using [Instance.MakeCurrent], this node will override the location sounds are heard from. This can be used to listen from a location different from the [Camera3D].
*/
