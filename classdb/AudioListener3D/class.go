...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioListener3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioListener3D{gdclass.NewAudioListener3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
