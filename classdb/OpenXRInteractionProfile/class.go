...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRInteractionProfile")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfile{gdclass.NewOpenXRInteractionProfile(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
