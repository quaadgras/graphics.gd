...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfile{gdclass.NewOpenXRInteractionProfile(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
