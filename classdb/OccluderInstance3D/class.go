...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOccluderInstance3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOccluderInstance3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OccluderInstance3D{gdclass.NewOccluderInstance3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOccluderInstance3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OccluderInstance3D{gdclass.NewOccluderInstance3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetOccluder() [1]gdclass.Occluder3D { //gd:OccluderInstance3D.get_occluder
	...
	var ret = [1]gdclass.Occluder3D{gdclass.NewOccluder3D(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
func (self class) AsOccluderInstance3D() Advanced {
	return Advanced{gdclass.NewOccluderInstance3D(self.AsObject()[0])}
}
func (self Instance) AsOccluderInstance3D() Instance {
	return Instance{gdclass.NewOccluderInstance3D(self.AsObject()[0])}
}
