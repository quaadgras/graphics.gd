...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MeshDataTool")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MeshDataTool{gdclass.NewMeshDataTool(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
