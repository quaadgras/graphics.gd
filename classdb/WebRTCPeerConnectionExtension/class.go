...
func (self class) AsObject() [1]gd.Object { return gdclass.GetWebRTCPeerConnectionExtension(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetWebRTCPeerConnectionExtension(self[0])
}
...
func (self class) AsWebRTCPeerConnectionExtension() Advanced {
	return Advanced{gdclass.NewWebRTCPeerConnectionExtension(self.AsObject()[0])}
}
func (self Instance) AsWebRTCPeerConnectionExtension() Instance {
	return Instance{gdclass.NewWebRTCPeerConnectionExtension(self.AsObject()[0])}
}
...
func (self class) AsWebRTCPeerConnection() WebRTCPeerConnection.Advanced {
	return WebRTCPeerConnection.Advanced{gdclass.NewWebRTCPeerConnection(self.AsObject()[0])}
}
...
func (self Instance) AsWebRTCPeerConnection() WebRTCPeerConnection.Instance {
	return WebRTCPeerConnection.Instance{gdclass.NewWebRTCPeerConnection(self.AsObject()[0])}
}
...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_get_connection_state":
		return gd.ValueOf(self._get_connection_state)
	case "_get_gathering_state":
		return gd.ValueOf(self._get_gathering_state)
	case "_get_signaling_state":
		return gd.ValueOf(self._get_signaling_state)
	case "_initialize":
		return gd.ValueOf(self._initialize)
	case "_create_data_channel":
		return gd.ValueOf(self._create_data_channel)
	case "_create_offer":
		return gd.ValueOf(self._create_offer)
	case "_set_remote_description":
		return gd.ValueOf(self._set_remote_description)
	case "_set_local_description":
		return gd.ValueOf(self._set_local_description)
	case "_add_ice_candidate":
		return gd.ValueOf(self._add_ice_candidate)
	case "_poll":
...
func init() {
	gdclass.Register("WebRTCPeerConnectionExtension", func(ptr gd.Object) any { return Instance{gdclass.NewWebRTCPeerConnectionExtension(ptr)} })
}
