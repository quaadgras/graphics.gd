...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebRTCPeerConnectionExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCPeerConnectionExtension{gdclass.NewWebRTCPeerConnectionExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
