...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCPeerConnectionExtension{gdclass.NewWebRTCPeerConnectionExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
