...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionParameters3D{gdclass.NewPhysicsTestMotionParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
