...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PhysicsTestMotionParameters3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PhysicsTestMotionParameters3D{pointers.Add[gdclass.PhysicsTestMotionParameters3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PhysicsTestMotionParameters3D{pointers.New[gdclass.PhysicsTestMotionParameters3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) GetFrom() Transform3D.BasisOrigin { //gd:PhysicsTestMotionParameters3D.get_from
	var r_ret = mainthread.Call[Transform3D.BasisOrigin](gd.ObjectChecked(self.AsObject()), methods.get_from, gdextension.SizeTransform3D, &struct{}{})
...
func (self class) SetFrom(from Transform3D.BasisOrigin) { //gd:PhysicsTestMotionParameters3D.set_from
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_from, 0|(gdextension.SizeTransform3D<<4), &struct{ from Transform3D.BasisOrigin }{gd.Transposed(from)})
}

//go:nosplit
func (self class) GetMotion() Vector3.XYZ { //gd:PhysicsTestMotionParameters3D.get_motion
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_motion, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMotion(motion Vector3.XYZ) { //gd:PhysicsTestMotionParameters3D.set_motion
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_motion, 0|(gdextension.SizeVector3<<4), &struct{ motion Vector3.XYZ }{motion})
}
...
func (self class) GetMaxCollisions() int64 { //gd:PhysicsTestMotionParameters3D.get_max_collisions
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_max_collisions, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxCollisions(max_collisions int64) { //gd:PhysicsTestMotionParameters3D.set_max_collisions
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max_collisions, 0|(gdextension.SizeInt<<4), &struct{ max_collisions int64 }{max_collisions})
}

//go:nosplit
func (self class) IsCollideSeparationRayEnabled() bool { //gd:PhysicsTestMotionParameters3D.is_collide_separation_ray_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_collide_separation_ray_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCollideSeparationRayEnabled(enabled bool) { //gd:PhysicsTestMotionParameters3D.set_collide_separation_ray_enabled
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_collide_separation_ray_enabled, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) GetExcludeBodies() Array.Contains[RID.Any] { //gd:PhysicsTestMotionParameters3D.get_exclude_bodies
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_exclude_bodies, gdextension.SizeArray, &struct{}{})
...
func (self class) SetExcludeBodies(exclude_list Array.Contains[RID.Any]) { //gd:PhysicsTestMotionParameters3D.set_exclude_bodies
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_exclude_bodies, 0|(gdextension.SizeArray<<4), &struct{ exclude_list gdextension.Array }{pointers.Get(gd.InternalArray(exclude_list))})
}

//go:nosplit
func (self class) GetExcludeObjects() Array.Contains[int64] { //gd:PhysicsTestMotionParameters3D.get_exclude_objects
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_exclude_objects, gdextension.SizeArray, &struct{}{})
...
func (self class) SetExcludeObjects(exclude_list Array.Contains[int64]) { //gd:PhysicsTestMotionParameters3D.set_exclude_objects
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_exclude_objects, 0|(gdextension.SizeArray<<4), &struct{ exclude_list gdextension.Array }{pointers.Get(gd.InternalArray(exclude_list))})
}

//go:nosplit
func (self class) IsRecoveryAsCollisionEnabled() bool { //gd:PhysicsTestMotionParameters3D.is_recovery_as_collision_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_recovery_as_collision_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetRecoveryAsCollisionEnabled(enabled bool) { //gd:PhysicsTestMotionParameters3D.set_recovery_as_collision_enabled
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_recovery_as_collision_enabled, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}
func (self class) AsPhysicsTestMotionParameters3D() Advanced {
	return Advanced{pointers.AsA[gdclass.PhysicsTestMotionParameters3D](self[0])}
}
func (self Instance) AsPhysicsTestMotionParameters3D() Instance {
	return Instance{pointers.AsA[gdclass.PhysicsTestMotionParameters3D](self[0])}
}
...
func init() {
	gdclass.Register("PhysicsTestMotionParameters3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PhysicsTestMotionParameters3D](ptr)} })
}
