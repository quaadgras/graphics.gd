...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioBusLayout")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioBusLayout{gdclass.NewAudioBusLayout(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
