...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeBlendSpace2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlendSpace2D{gdclass.NewAnimationNodeBlendSpace2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
