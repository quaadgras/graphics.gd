...
You can add vertices to the blend space with [Instance.AddBlendPoint] and automatically triangulate it by setting [member auto_triangles] to true. Otherwise, use [Instance.AddTriangle] and [Instance.RemoveTriangle] to triangulate the blend space by hand.
*/
