...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlendSpace2D{gdclass.NewAnimationNodeBlendSpace2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
