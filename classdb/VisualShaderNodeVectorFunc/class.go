...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorFunc{gdclass.NewVisualShaderNodeVectorFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
