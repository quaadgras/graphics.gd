...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorFunc{gdclass.NewVisualShaderNodeVectorFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
