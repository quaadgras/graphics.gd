...
func (self class) GetBlendShape(blend_shape BlendShapeEntry) float64 { //gd:XRFaceTracker.get_blend_shape
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_blend_shape, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ blend_shape BlendShapeEntry }{blend_shape})
	var ret = r_ret
	return ret
}
...
func (self class) SetBlendShape(blend_shape BlendShapeEntry, weight float64) { //gd:XRFaceTracker.set_blend_shape
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_blend_shape, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
...
func (self class) GetBlendShapes() Packed.Array[float32] { //gd:XRFaceTracker.get_blend_shapes
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_blend_shapes, gdextension.SizePackedArray, &struct{}{})
...
func (self class) SetBlendShapes(weights Packed.Array[float32]) { //gd:XRFaceTracker.set_blend_shapes
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_blend_shapes, 0|(gdextension.SizePackedArray<<4), &struct {
