...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollision3D{gdclass.NewGPUParticlesCollision3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
