...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticlesCollision3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollision3D{gdclass.NewGPUParticlesCollision3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
