...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsServer3DRenderingServerHandler{gdclass.NewPhysicsServer3DRenderingServerHandler(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
