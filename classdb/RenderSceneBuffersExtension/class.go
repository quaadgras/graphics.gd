...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneBuffersExtension{gdclass.NewRenderSceneBuffersExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
