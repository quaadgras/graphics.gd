...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticlesCollisionHeightField3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionHeightField3D{gdclass.NewGPUParticlesCollisionHeightField3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
