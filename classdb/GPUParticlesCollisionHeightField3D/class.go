...
/*
Based on 'value', enables or disables the specified layer in the [member heightfield_mask], given a 'layer_number' between 1 and 20, inclusive.
*/
...
/*
Returns true if the specified layer of the [member heightfield_mask] is enabled, given a 'layer_number' between 1 and 20, inclusive.
*/
