...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionHeightField3D{gdclass.NewGPUParticlesCollisionHeightField3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
