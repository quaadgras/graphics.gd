...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetGPUParticlesCollisionHeightField3D(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GPUParticlesCollisionHeightField3D{gdclass.NewGPUParticlesCollisionHeightField3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGPUParticlesCollisionHeightField3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionHeightField3D{gdclass.NewGPUParticlesCollisionHeightField3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsGPUParticlesCollisionHeightField3D() Advanced {
	return Advanced{gdclass.NewGPUParticlesCollisionHeightField3D(self.AsObject()[0])}
}
func (self Instance) AsGPUParticlesCollisionHeightField3D() Instance {
	return Instance{gdclass.NewGPUParticlesCollisionHeightField3D(self.AsObject()[0])}
}
