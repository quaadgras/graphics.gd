...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("JavaObject")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.JavaObject{gdclass.NewJavaObject(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
