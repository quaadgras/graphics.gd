...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationServer3DManager")
...
func singleton() {
	self[0] = gdclass.NewNavigationServer3DManager(gdreference.RawObject(gdextension.Object(gdunsafe.ObjectGlobal(sname))))
}
