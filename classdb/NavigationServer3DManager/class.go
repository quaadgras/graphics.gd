...
func singleton() {
	self[0] = gdclass.NewNavigationServer3DManager(pointers.Raw[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Global(sname))}))
}
...
func (self class) AsObject() [1]gd.Object { return gdclass.GetNavigationServer3DManager(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetNavigationServer3DManager(self[0]) }
...
func init() {
	gdclass.Register("NavigationServer3DManager", func(ptr gd.Object) any { return Instance{gdclass.NewNavigationServer3DManager(ptr)} })
}
