...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScriptEditorBase")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptEditorBase{gdclass.NewScriptEditorBase(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
