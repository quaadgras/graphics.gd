...
/*
Base editor for editing scripts in the [graphics.gd/classdb/ScriptEditor]. This does not include documentation items.
*/
...
/*
Returns the underlying [graphics.gd/classdb/Control] used for editing scripts. For text scripts, this is a [graphics.gd/classdb/CodeEdit].
*/
