...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCheckButton(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCheckButton(self[0]) }
...
func (self class) AsCheckButton() Advanced {
	return Advanced{gdclass.NewCheckButton(self.AsObject()[0])}
}
func (self Instance) AsCheckButton() Instance {
	return Instance{gdclass.NewCheckButton(self.AsObject()[0])}
}
