...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CheckButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CheckButton{gdclass.NewCheckButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
