...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConvertTransformModifier3D{gdclass.NewConvertTransformModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
