...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialAnchorCapability{gdclass.NewOpenXRSpatialAnchorCapability(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
