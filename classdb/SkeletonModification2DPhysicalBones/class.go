...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DPhysicalBones{gdclass.NewSkeletonModification2DPhysicalBones(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
