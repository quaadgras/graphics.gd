...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("SkeletonModification2DPhysicalBones"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DPhysicalBones{gdclass.NewSkeletonModification2DPhysicalBones(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
