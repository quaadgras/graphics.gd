...
/*
This modification takes the transforms of [graphics.gd/classdb/PhysicalBone2D] nodes and applies them to [graphics.gd/classdb/Bone2D] nodes. This allows the [graphics.gd/classdb/Bone2D] nodes to react to physics thanks to the linked [graphics.gd/classdb/PhysicalBone2D] nodes.
*/
...
/*
Sets the [graphics.gd/classdb/PhysicalBone2D] node at 'joint_idx'.

Note: This is just the index used for this modification, not the bone index used in the [graphics.gd/classdb/Skeleton2D].
*/
...
/*
Returns the [graphics.gd/classdb/PhysicalBone2D] node at 'joint_idx'.
*/
...
/*
Empties the list of [graphics.gd/classdb/PhysicalBone2D] nodes and populates it with all [graphics.gd/classdb/PhysicalBone2D] nodes that are children of the [graphics.gd/classdb/Skeleton2D].
*/
...
/*
Tell the [graphics.gd/classdb/PhysicalBone2D] nodes to start simulating and interacting with the physics world.

Optionally, an array of bone names can be passed to this function, and that will cause only [graphics.gd/classdb/PhysicalBone2D] nodes with those names to start simulating.
*/
...
/*
Tell the [graphics.gd/classdb/PhysicalBone2D] nodes to stop simulating and interacting with the physics world.

Optionally, an array of bone names can be passed to this function, and that will cause only [graphics.gd/classdb/PhysicalBone2D] nodes with those names to stop simulating.
*/
