...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioEffectPanner](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectPanner{pointers.Add[gdclass.AudioEffectPanner]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioEffectPanner{pointers.New[gdclass.AudioEffectPanner]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetPan(cpanume float64) { //gd:AudioEffectPanner.set_pan
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_pan, 0|(gdextension.SizeFloat<<4), &struct{ cpanume float64 }{cpanume})
}

//go:nosplit
func (self class) GetPan() float64 { //gd:AudioEffectPanner.get_pan
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_pan, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsAudioEffectPanner() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioEffectPanner](self[0])}
}
func (self Instance) AsAudioEffectPanner() Instance {
	return Instance{pointers.AsA[gdclass.AudioEffectPanner](self[0])}
}
func (self *Extension[T]) AsAudioEffectPanner() Instance { return self.Super().AsAudioEffectPanner() }
...
func init() {
	gdclass.Register("AudioEffectPanner", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioEffectPanner](ptr)} })
}
