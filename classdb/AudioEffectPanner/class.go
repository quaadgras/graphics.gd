...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectPanner")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectPanner{gdclass.NewAudioEffectPanner(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
