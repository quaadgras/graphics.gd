...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialPlaneTrackingCapability{gdclass.NewOpenXRSpatialPlaneTrackingCapability(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
