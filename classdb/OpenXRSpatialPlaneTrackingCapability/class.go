...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialPlaneTrackingCapability")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialPlaneTrackingCapability{gdclass.NewOpenXRSpatialPlaneTrackingCapability(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
