...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Sprite2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Sprite2D{gdclass.NewSprite2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
