...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StreamPeerTCP")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeerTCP{gdclass.NewStreamPeerTCP(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
