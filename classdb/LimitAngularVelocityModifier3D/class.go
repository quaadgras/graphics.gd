...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("LimitAngularVelocityModifier3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.LimitAngularVelocityModifier3D{gdclass.NewLimitAngularVelocityModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
