...
func New() Instance {
	...
	casted := Instance([1]gdclass.LimitAngularVelocityModifier3D{gdclass.NewLimitAngularVelocityModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
