...
func (self class) AsObject() [1]gd.Object { return gdclass.GetLimitAngularVelocityModifier3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetLimitAngularVelocityModifier3D(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.LimitAngularVelocityModifier3D{gdclass.NewLimitAngularVelocityModifier3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetLimitAngularVelocityModifier3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.LimitAngularVelocityModifier3D{gdclass.NewLimitAngularVelocityModifier3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsLimitAngularVelocityModifier3D() Advanced {
	return Advanced{gdclass.NewLimitAngularVelocityModifier3D(self.AsObject()[0])}
}
func (self Instance) AsLimitAngularVelocityModifier3D() Instance {
	return Instance{gdclass.NewLimitAngularVelocityModifier3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsLimitAngularVelocityModifier3D() Instance {
	return self.Super().AsLimitAngularVelocityModifier3D()
}
...
func init() {
	gdclass.Register("LimitAngularVelocityModifier3D", func(ptr gd.Object) any { return Instance{gdclass.NewLimitAngularVelocityModifier3D(ptr)} })
}
