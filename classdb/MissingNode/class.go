...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MissingNode")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MissingNode{gdclass.NewMissingNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
