...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.MissingNode](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MissingNode{pointers.Add[gdclass.MissingNode]([3]uint64{})})
	...
	casted := Instance([1]gdclass.MissingNode{pointers.New[gdclass.MissingNode]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetOriginalClass(name String.Readable) { //gd:MissingNode.set_original_class
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_original_class, 0|(gdextension.SizeString<<4), &struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))})
}

//go:nosplit
func (self class) GetOriginalClass() String.Readable { //gd:MissingNode.get_original_class
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_original_class, gdextension.SizeString, &struct{}{})
...
func (self class) SetOriginalScene(name String.Readable) { //gd:MissingNode.set_original_scene
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_original_scene, 0|(gdextension.SizeString<<4), &struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))})
}

//go:nosplit
func (self class) GetOriginalScene() String.Readable { //gd:MissingNode.get_original_scene
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_original_scene, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetRecordingProperties(enable bool) { //gd:MissingNode.set_recording_properties
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_recording_properties, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsRecordingProperties() bool { //gd:MissingNode.is_recording_properties
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_recording_properties, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsMissingNode() Advanced {
	return Advanced{pointers.AsA[gdclass.MissingNode](self[0])}
}
func (self Instance) AsMissingNode() Instance {
	return Instance{pointers.AsA[gdclass.MissingNode](self[0])}
}
...
func init() {
	gdclass.Register("MissingNode", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.MissingNode](ptr)} })
}
