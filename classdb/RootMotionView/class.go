...
/*
Root motion refers to an animation technique where a mesh's skeleton is used to give impulse to a character. When working with 3D animations, a popular technique is for animators to use the root skeleton bone to give motion to the rest of the skeleton. This allows animating characters in a way where steps actually match the floor below. It also allows precise interaction with objects during cinematics. See also [graphics.gd/classdb/AnimationMixer].

Note: [graphics.gd/classdb/RootMotionView] is only visible in the editor. It will be hidden automatically in the running project.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.RootMotionView](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RootMotionView{pointers.Add[gdclass.RootMotionView]([3]uint64{})})
	...
	casted := Instance([1]gdclass.RootMotionView{pointers.New[gdclass.RootMotionView]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetAnimationPath(path Path.ToNode) { //gd:RootMotionView.set_animation_path
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_animation_path, 0|(gdextension.SizeNodePath<<4), &struct{ path gdextension.NodePath }{pointers.Get(gd.InternalNodePath(path))})
}

//go:nosplit
func (self class) GetAnimationPath() Path.ToNode { //gd:RootMotionView.get_animation_path
	var r_ret = gdextension.Call[gdextension.NodePath](gd.ObjectChecked(self.AsObject()), methods.get_animation_path, gdextension.SizeNodePath, &struct{}{})
...
func (self class) SetCellSize(size float64) { //gd:RootMotionView.set_cell_size
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cell_size, 0|(gdextension.SizeFloat<<4), &struct{ size float64 }{size})
}
...
func (self class) SetRadius(size float64) { //gd:RootMotionView.set_radius
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_radius, 0|(gdextension.SizeFloat<<4), &struct{ size float64 }{size})
}
...
func (self class) SetZeroY(enable bool) { //gd:RootMotionView.set_zero_y
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_zero_y, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) GetZeroY() bool { //gd:RootMotionView.get_zero_y
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_zero_y, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsRootMotionView() Advanced {
	return Advanced{pointers.AsA[gdclass.RootMotionView](self[0])}
}
func (self Instance) AsRootMotionView() Instance {
	return Instance{pointers.AsA[gdclass.RootMotionView](self[0])}
}
...
func init() {
	gdclass.Register("RootMotionView", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.RootMotionView](ptr)} })
}
