...
func (self class) SetAnimationPath(path Path.ToNode) { //gd:RootMotionView.set_animation_path
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_animation_path, 0|(gdextension.SizeNodePath<<4), &struct{ path gdextension.NodePath }{pointers.Get(gd.InternalNodePath(path))})
}

//go:nosplit
func (self class) GetAnimationPath() Path.ToNode { //gd:RootMotionView.get_animation_path
	var r_ret = mainthread.Call[gdextension.NodePath](gd.ObjectChecked(self.AsObject()), methods.get_animation_path, gdextension.SizeNodePath, &struct{}{})
...
func (self class) SetCellSize(size float64) { //gd:RootMotionView.set_cell_size
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cell_size, 0|(gdextension.SizeFloat<<4), &struct{ size float64 }{size})
}
...
func (self class) SetRadius(size float64) { //gd:RootMotionView.set_radius
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_radius, 0|(gdextension.SizeFloat<<4), &struct{ size float64 }{size})
}
...
func (self class) SetZeroY(enable bool) { //gd:RootMotionView.set_zero_y
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_zero_y, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) GetZeroY() bool { //gd:RootMotionView.get_zero_y
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_zero_y, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
