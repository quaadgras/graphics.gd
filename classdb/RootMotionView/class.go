...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RootMotionView")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RootMotionView{gdclass.NewRootMotionView(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
