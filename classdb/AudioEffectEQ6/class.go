...
func New() Instance {
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				pointers.Set(gdclass.GetAudioEffectEQ6(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectEQ6{gdclass.NewAudioEffectEQ6(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("AudioEffectEQ6", func(ptr gd.Object) any { return Instance{gdclass.NewAudioEffectEQ6(ptr)} })
}
