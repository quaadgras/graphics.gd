...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureSDFNormal{gdclass.NewVisualShaderNodeTextureSDFNormal(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
