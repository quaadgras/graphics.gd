...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTextureSDFNormal")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureSDFNormal{gdclass.NewVisualShaderNodeTextureSDFNormal(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
