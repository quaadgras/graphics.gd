...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConcavePolygonShape2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConcavePolygonShape2D{gdclass.NewConcavePolygonShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
