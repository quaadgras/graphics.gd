...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConcavePolygonShape2D{gdclass.NewConcavePolygonShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
