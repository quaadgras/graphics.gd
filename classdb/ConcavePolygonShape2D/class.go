...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("ConcavePolygonShape2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConcavePolygonShape2D{gdclass.NewConcavePolygonShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
