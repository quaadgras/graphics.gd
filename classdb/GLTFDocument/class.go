...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFDocument")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFDocument{gdclass.NewGLTFDocument(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
