...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFCamera")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFCamera{gdclass.NewGLTFCamera(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
