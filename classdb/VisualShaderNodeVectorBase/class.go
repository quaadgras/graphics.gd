...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorBase{gdclass.NewVisualShaderNodeVectorBase(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
