...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorBase")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorBase{gdclass.NewVisualShaderNodeVectorBase(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
