...
func New() Instance {
	...
	casted := Instance([1]gdclass.PanoramaSkyMaterial{gdclass.NewPanoramaSkyMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
