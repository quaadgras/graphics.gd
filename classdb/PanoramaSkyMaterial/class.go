...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PanoramaSkyMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PanoramaSkyMaterial{gdclass.NewPanoramaSkyMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
