...
/*
A resource referenced in a [graphics.gd/classdb/Sky] that is used to draw a background. [graphics.gd/classdb/PanoramaSkyMaterial] functions similar to skyboxes in other engines, except it uses an equirectangular sky map instead of a [graphics.gd/classdb/Cubemap].
