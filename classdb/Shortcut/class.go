...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Shortcut")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Shortcut{gdclass.NewShortcut(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
