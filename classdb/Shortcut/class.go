...
/*
Shortcuts are commonly used for interacting with a [graphics.gd/classdb/Control] element from an [graphics.gd/classdb/InputEvent] (also known as hotkeys).

One shortcut can contain multiple [graphics.gd/classdb/InputEvent]s, allowing the possibility of triggering one action with multiple different inputs.
*/
package Shortcut
