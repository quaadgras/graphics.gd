...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CollisionShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CollisionShape3D{gdclass.NewCollisionShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
