...
/*
A node that provides a [graphics.gd/classdb/Shape3D] to a [graphics.gd/classdb/CollisionObject3D] parent and allows to edit it. This can give a detection shape to an [graphics.gd/classdb/Area3D] or turn a [graphics.gd/classdb/PhysicsBody3D] into a solid object.

Warning: A non-uniformly scaled [graphics.gd/classdb/CollisionShape3D] will likely not behave as expected. Make sure to keep its scale the same on all axes and adjust its [Instance.Shape] resource instead.
*/
...
/*
Sets the collision shape's shape to the addition of all its convexed [graphics.gd/classdb/MeshInstance3D] siblings geometry.
*/
...
func (self class) SetDisabled(enable bool) { //gd:CollisionShape3D.set_disabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_disabled, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}
...
func (self class) MakeConvexFromSiblings() { //gd:CollisionShape3D.make_convex_from_siblings
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.make_convex_from_siblings, 0, &struct{}{})
}
