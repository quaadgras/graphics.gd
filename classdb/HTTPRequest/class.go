...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HTTPRequest")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HTTPRequest{gdclass.NewHTTPRequest(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
