...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StyleBox")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StyleBox{gdclass.NewStyleBox(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
