...
The [Resource.ID] value can either be the result of [graphics.gd/classdb/CanvasItem.Instance.GetCanvasItem] called on an existing [graphics.gd/classdb/CanvasItem]-derived node, or directly from creating a canvas item in the [graphics.gd/classdb/RenderingServer] with [graphics.gd/classdb/RenderingServer.CanvasItemCreate].
*/
//go:nosplit
