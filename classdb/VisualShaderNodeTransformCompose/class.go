...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTransformCompose")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformCompose{gdclass.NewVisualShaderNodeTransformCompose(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
