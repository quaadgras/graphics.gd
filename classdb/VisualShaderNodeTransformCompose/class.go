...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformCompose{gdclass.NewVisualShaderNodeTransformCompose(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
