...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTransformCompose(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTransformCompose{gdclass.NewVisualShaderNodeTransformCompose(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTransformCompose(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformCompose{gdclass.NewVisualShaderNodeTransformCompose(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTransformCompose() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTransformCompose(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTransformCompose() Instance {
	return Instance{gdclass.NewVisualShaderNodeTransformCompose(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeTransformCompose() Instance {
	return self.Super().AsVisualShaderNodeTransformCompose()
}
...
func init() {
	gdclass.Register("VisualShaderNodeTransformCompose", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformCompose(ptr)} })
}
