...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileSetScenesCollectionSource{gdclass.NewTileSetScenesCollectionSource(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
