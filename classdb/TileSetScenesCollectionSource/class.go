...
/*
When placed on a [graphics.gd/classdb/TileMap], tiles from [graphics.gd/classdb/TileSetScenesCollectionSource] will automatically instantiate an associated scene at the cell's position in the TileMap.

Scenes are instantiated as children of the [graphics.gd/classdb/TileMap] when it enters the tree. If you add/remove a scene tile in the [graphics.gd/classdb/TileMap] that is already inside the tree, the [graphics.gd/classdb/TileMap] will automatically instantiate/free the scene accordingly.

Note: Scene tiles all occupy one tile slot and instead use alternate tile ID to identify scene index. [graphics.gd/classdb/TileSetSource.Instance.GetTilesCount] will always return 1. Use [Instance.GetSceneTilesCount] to get a number of scenes in a [graphics.gd/classdb/TileSetScenesCollectionSource].

Use this code if you want to find the scene path at a given tile in [graphics.gd/classdb/TileMapLayer]:
...
/*
Assigns a [graphics.gd/classdb/PackedScene] resource to the scene tile with 'id'. This will fail if the scene does not extend CanvasItem, as positioning properties are needed to place the scene on the TileMap.
*/
...
/*
Returns the [graphics.gd/classdb/PackedScene] resource of scene tile with 'id'.
*/
...
/*
Returns the scene ID a following call to [Instance.CreateSceneTile] would return.
*/
