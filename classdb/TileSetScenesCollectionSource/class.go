...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileSetScenesCollectionSource")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileSetScenesCollectionSource{gdclass.NewTileSetScenesCollectionSource(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
