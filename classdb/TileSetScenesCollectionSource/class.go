...
Scenes are instantiated as children of the [graphics.gd/classdb/TileMapLayer] after it enters the tree, at the end of the frame (their creation is deferred). If you add/remove a scene tile in the [graphics.gd/classdb/TileMapLayer] that is already inside the tree, the [graphics.gd/classdb/TileMapLayer] will automatically instantiate/free the scene accordingly.
...
/*
Assigns a [graphics.gd/classdb/PackedScene] resource to the scene tile with 'id'. This will fail if the scene does not extend [graphics.gd/classdb/CanvasItem], as positioning properties are needed to place the scene on the [graphics.gd/classdb/TileMapLayer].
*/
