...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRRenderModelExtension{gdclass.NewOpenXRRenderModelExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
