...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourcePreloader(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourcePreloader(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourcePreloader{gdclass.NewResourcePreloader(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourcePreloader(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourcePreloader{gdclass.NewResourcePreloader(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AddResource(name String.Name, resource [1]gdclass.Resource) { //gd:ResourcePreloader.add_resource
	...
	}{pointers.Get(gd.InternalStringName(name)), gdextension.Object(gd.ObjectChecked(gdclass.GetResource(resource[0])))})
}
...
func (self class) AsResourcePreloader() Advanced {
	return Advanced{gdclass.NewResourcePreloader(self.AsObject()[0])}
}
func (self Instance) AsResourcePreloader() Instance {
	return Instance{gdclass.NewResourcePreloader(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("ResourcePreloader", func(ptr gd.Object) any { return Instance{gdclass.NewResourcePreloader(ptr)} })
}
