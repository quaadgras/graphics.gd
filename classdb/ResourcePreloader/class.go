...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourcePreloader")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourcePreloader{gdclass.NewResourcePreloader(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
