...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SoftBody3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SoftBody3D{gdclass.NewSoftBody3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
