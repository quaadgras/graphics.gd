...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSoftBody3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSoftBody3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SoftBody3D{gdclass.NewSoftBody3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetSoftBody3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SoftBody3D{gdclass.NewSoftBody3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsSoftBody3D() Advanced { return Advanced{gdclass.NewSoftBody3D(self.AsObject()[0])} }
func (self Instance) AsSoftBody3D() Instance {
	return Instance{gdclass.NewSoftBody3D(self.AsObject()[0])}
}
...
func (self class) AsMeshInstance3D() MeshInstance3D.Advanced {
	return MeshInstance3D.Advanced{gdclass.NewMeshInstance3D(self.AsObject()[0])}
}
...
func (self Instance) AsMeshInstance3D() MeshInstance3D.Instance {
	return MeshInstance3D.Instance{gdclass.NewMeshInstance3D(self.AsObject()[0])}
}
