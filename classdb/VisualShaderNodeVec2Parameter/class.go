...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeVec2Parameter"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Parameter{gdclass.NewVisualShaderNodeVec2Parameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
