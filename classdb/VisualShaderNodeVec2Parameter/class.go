...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Parameter{gdclass.NewVisualShaderNodeVec2Parameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
