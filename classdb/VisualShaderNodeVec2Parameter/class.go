...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVec2Parameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Parameter{gdclass.NewVisualShaderNodeVec2Parameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
