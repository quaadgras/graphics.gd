...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderCubemapArray")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderCubemapArray{gdclass.NewPlaceholderCubemapArray(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
