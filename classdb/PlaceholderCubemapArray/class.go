...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderCubemapArray{gdclass.NewPlaceholderCubemapArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
