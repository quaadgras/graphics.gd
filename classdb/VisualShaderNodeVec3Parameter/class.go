...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVec3Parameter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeVec3Parameter(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec3Parameter{gdclass.NewVisualShaderNodeVec3Parameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeVec3Parameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Parameter{gdclass.NewVisualShaderNodeVec3Parameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeVec3Parameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVec3Parameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVec3Parameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeVec3Parameter(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeVec3Parameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeVec3Parameter(ptr)} })
}
