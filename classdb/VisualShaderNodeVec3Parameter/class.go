...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVec3Parameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Parameter{gdclass.NewVisualShaderNodeVec3Parameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
