...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeVec3Parameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec3Parameter{pointers.Add[gdclass.VisualShaderNodeVec3Parameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Parameter{pointers.New[gdclass.VisualShaderNodeVec3Parameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetDefaultValue(value Vector3.XYZ) { //gd:VisualShaderNodeVec3Parameter.set_default_value
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeVector3<<4), &struct{ value Vector3.XYZ }{value})
}

//go:nosplit
func (self class) GetDefaultValue() Vector3.XYZ { //gd:VisualShaderNodeVec3Parameter.get_default_value
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeVec3Parameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeVec3Parameter](self[0])}
}
func (self Instance) AsVisualShaderNodeVec3Parameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeVec3Parameter](self[0])}
}
func (self *Extension[T]) AsVisualShaderNodeVec3Parameter() Instance {
	return self.Super().AsVisualShaderNodeVec3Parameter()
}
...
func init() {
	gdclass.Register("VisualShaderNodeVec3Parameter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeVec3Parameter](ptr)} })
}
