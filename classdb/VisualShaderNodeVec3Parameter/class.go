...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Parameter{gdclass.NewVisualShaderNodeVec3Parameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
