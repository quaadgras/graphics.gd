...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBillboard{gdclass.NewVisualShaderNodeBillboard(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
