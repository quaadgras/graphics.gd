...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeBillboard")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBillboard{gdclass.NewVisualShaderNodeBillboard(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
