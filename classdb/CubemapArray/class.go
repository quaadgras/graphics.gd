...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CubemapArray")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CubemapArray{gdclass.NewCubemapArray(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
