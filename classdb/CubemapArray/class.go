...
To create such a texture file yourself, reimport your image files using the Godot Editor import presets. To create a CubemapArray from code, use [Instance.Imagetexturelayered.CreateFromImages] on an instance of the CubemapArray class.
