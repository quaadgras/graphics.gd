...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackOggVorbis{gdclass.NewAudioStreamPlaybackOggVorbis(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
