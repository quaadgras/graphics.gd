...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlaybackOggVorbis")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackOggVorbis{gdclass.NewAudioStreamPlaybackOggVorbis(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
