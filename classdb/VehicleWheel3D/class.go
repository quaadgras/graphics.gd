...
func (self class) SetRadius(length float64) { //gd:VehicleWheel3D.set_radius
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_radius, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}
...
func (self class) SetSuspensionRestLength(length float64) { //gd:VehicleWheel3D.set_suspension_rest_length
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_suspension_rest_length, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetSuspensionRestLength() float64 { //gd:VehicleWheel3D.get_suspension_rest_length
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_suspension_rest_length, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSuspensionTravel(length float64) { //gd:VehicleWheel3D.set_suspension_travel
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_suspension_travel, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetSuspensionTravel() float64 { //gd:VehicleWheel3D.get_suspension_travel
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_suspension_travel, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSuspensionStiffness(length float64) { //gd:VehicleWheel3D.set_suspension_stiffness
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_suspension_stiffness, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetSuspensionStiffness() float64 { //gd:VehicleWheel3D.get_suspension_stiffness
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_suspension_stiffness, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSuspensionMaxForce(length float64) { //gd:VehicleWheel3D.set_suspension_max_force
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_suspension_max_force, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetSuspensionMaxForce() float64 { //gd:VehicleWheel3D.get_suspension_max_force
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_suspension_max_force, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDampingCompression(length float64) { //gd:VehicleWheel3D.set_damping_compression
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_damping_compression, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetDampingCompression() float64 { //gd:VehicleWheel3D.get_damping_compression
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_damping_compression, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDampingRelaxation(length float64) { //gd:VehicleWheel3D.set_damping_relaxation
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_damping_relaxation, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetDampingRelaxation() float64 { //gd:VehicleWheel3D.get_damping_relaxation
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_damping_relaxation, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetUseAsTraction(enable bool) { //gd:VehicleWheel3D.set_use_as_traction
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_as_traction, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsUsedAsTraction() bool { //gd:VehicleWheel3D.is_used_as_traction
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_used_as_traction, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetUseAsSteering(enable bool) { //gd:VehicleWheel3D.set_use_as_steering
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_as_steering, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsUsedAsSteering() bool { //gd:VehicleWheel3D.is_used_as_steering
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_used_as_steering, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFrictionSlip(length float64) { //gd:VehicleWheel3D.set_friction_slip
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_friction_slip, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}

//go:nosplit
func (self class) GetFrictionSlip() float64 { //gd:VehicleWheel3D.get_friction_slip
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_friction_slip, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) IsInContact() bool { //gd:VehicleWheel3D.is_in_contact
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_in_contact, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetContactBody() [1]gdclass.Node3D { //gd:VehicleWheel3D.get_contact_body
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_contact_body, gdextension.SizeObject, &struct{}{})
...
func (self class) GetContactPoint() Vector3.XYZ { //gd:VehicleWheel3D.get_contact_point
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_contact_point, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetContactNormal() Vector3.XYZ { //gd:VehicleWheel3D.get_contact_normal
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_contact_normal, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetRollInfluence(roll_influence float64) { //gd:VehicleWheel3D.set_roll_influence
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_roll_influence, 0|(gdextension.SizeFloat<<4), &struct{ roll_influence float64 }{roll_influence})
}

//go:nosplit
func (self class) GetRollInfluence() float64 { //gd:VehicleWheel3D.get_roll_influence
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_roll_influence, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetSkidinfo() float64 { //gd:VehicleWheel3D.get_skidinfo
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_skidinfo, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetRpm() float64 { //gd:VehicleWheel3D.get_rpm
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_rpm, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
