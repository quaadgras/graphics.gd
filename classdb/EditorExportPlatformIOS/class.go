...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformIOS")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformIOS{gdclass.NewEditorExportPlatformIOS(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
