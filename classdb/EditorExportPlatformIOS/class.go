...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformIOS{gdclass.NewEditorExportPlatformIOS(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
