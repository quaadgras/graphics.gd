...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRIPBindingModifier{gdclass.NewOpenXRIPBindingModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
