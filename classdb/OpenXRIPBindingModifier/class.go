...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRIPBindingModifier")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRIPBindingModifier{gdclass.NewOpenXRIPBindingModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
