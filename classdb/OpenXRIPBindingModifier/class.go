...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRIPBindingModifier(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRIPBindingModifier(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRIPBindingModifier{gdclass.NewOpenXRIPBindingModifier(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRIPBindingModifier(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRIPBindingModifier{gdclass.NewOpenXRIPBindingModifier(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsOpenXRIPBindingModifier() Advanced {
	return Advanced{gdclass.NewOpenXRIPBindingModifier(self.AsObject()[0])}
}
func (self Instance) AsOpenXRIPBindingModifier() Instance {
	return Instance{gdclass.NewOpenXRIPBindingModifier(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRIPBindingModifier() Instance {
...
func init() {
	gdclass.Register("OpenXRIPBindingModifier", func(ptr gd.Object) any { return Instance{gdclass.NewOpenXRIPBindingModifier(ptr)} })
}
