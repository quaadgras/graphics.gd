...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Texture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture{gdclass.NewTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
