...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Area3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Area3D{gdclass.NewArea3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
