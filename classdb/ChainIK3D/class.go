...
func (self class) AsObject() [1]gd.Object { return gdclass.GetChainIK3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetChainIK3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ChainIK3D{gdclass.NewChainIK3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetChainIK3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ChainIK3D{gdclass.NewChainIK3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsChainIK3D() Advanced { return Advanced{gdclass.NewChainIK3D(self.AsObject()[0])} }
func (self Instance) AsChainIK3D() Instance {
	return Instance{gdclass.NewChainIK3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsChainIK3D() Instance { return self.Super().AsChainIK3D() }
...
func init() {
	gdclass.Register("ChainIK3D", func(ptr gd.Object) any { return Instance{gdclass.NewChainIK3D(ptr)} })
}
