...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeClamp(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeClamp(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeClamp{gdclass.NewVisualShaderNodeClamp(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeClamp(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeClamp{gdclass.NewVisualShaderNodeClamp(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeClamp() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeClamp(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeClamp() Instance {
	return Instance{gdclass.NewVisualShaderNodeClamp(self.AsObject()[0])}
}
