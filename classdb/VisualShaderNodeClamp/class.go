...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeClamp")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeClamp{gdclass.NewVisualShaderNodeClamp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
