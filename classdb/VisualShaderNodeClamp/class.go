...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeClamp{gdclass.NewVisualShaderNodeClamp(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
