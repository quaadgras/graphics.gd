...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntFunc{gdclass.NewVisualShaderNodeIntFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
