...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeIntFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntFunc{gdclass.NewVisualShaderNodeIntFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
