...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.InputEventFromWindow](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventFromWindow{pointers.Add[gdclass.InputEventFromWindow]([3]uint64{})})
	...
	casted := Instance([1]gdclass.InputEventFromWindow{pointers.New[gdclass.InputEventFromWindow]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetWindowId(id int64) { //gd:InputEventFromWindow.set_window_id
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_window_id, 0|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
}
...
func (self class) AsInputEventFromWindow() Advanced {
	return Advanced{pointers.AsA[gdclass.InputEventFromWindow](self[0])}
}
func (self Instance) AsInputEventFromWindow() Instance {
	return Instance{pointers.AsA[gdclass.InputEventFromWindow](self[0])}
}
...
func init() {
	gdclass.Register("InputEventFromWindow", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.InputEventFromWindow](ptr)} })
}
