...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventFromWindow{gdclass.NewInputEventFromWindow(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
