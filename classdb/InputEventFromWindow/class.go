...
func (self class) AsObject() [1]gd.Object { return gdclass.GetInputEventFromWindow(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetInputEventFromWindow(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventFromWindow{gdclass.NewInputEventFromWindow(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetInputEventFromWindow(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.InputEventFromWindow{gdclass.NewInputEventFromWindow(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsInputEventFromWindow() Advanced {
	return Advanced{gdclass.NewInputEventFromWindow(self.AsObject()[0])}
}
func (self Instance) AsInputEventFromWindow() Instance {
	return Instance{gdclass.NewInputEventFromWindow(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("InputEventFromWindow", func(ptr gd.Object) any { return Instance{gdclass.NewInputEventFromWindow(ptr)} })
}
