...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventFromWindow")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventFromWindow{gdclass.NewInputEventFromWindow(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
