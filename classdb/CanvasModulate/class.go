...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CanvasModulate")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CanvasModulate{gdclass.NewCanvasModulate(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
