...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Viewport")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Viewport{gdclass.NewViewport(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
