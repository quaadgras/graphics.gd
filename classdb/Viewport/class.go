...
/*
Returns a list of the visible embedded [graphics.gd/classdb/Window]s inside the viewport.

Note: [graphics.gd/classdb/Window]s inside other viewports will not be listed.
*/
//go:nosplit
...
const (
	...
	// This quadrant will be split 256 ways and used by up to 256 shadow maps. Unless the [Instance.PositionalShadowAtlasSize] is very high, the shadows in this quadrant will be very low resolution.
	ShadowAtlasQuadrantSubdiv256 PositionalShadowAtlasQuadrantSubdiv = 5
	// This quadrant will be split 1024 ways and used by up to 1024 shadow maps. Unless the [Instance.PositionalShadowAtlasSize] is very high, the shadows in this quadrant will be very low resolution.
...
const (
	...
	// Variable Rate Shading's texture is supplied by the primary [graphics.gd/classdb/XRInterface].
	VrsXr VRSMode = 2
