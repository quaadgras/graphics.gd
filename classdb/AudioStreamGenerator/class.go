...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamGenerator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamGenerator{gdclass.NewAudioStreamGenerator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
