...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamGenerator{gdclass.NewAudioStreamGenerator(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
