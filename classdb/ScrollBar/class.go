...
func (self class) AsObject() [1]gd.Object { return gdclass.GetScrollBar(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetScrollBar(self[0]) }
...
func (self class) AsScrollBar() Advanced { return Advanced{gdclass.NewScrollBar(self.AsObject()[0])} }
func (self Instance) AsScrollBar() Instance {
	return Instance{gdclass.NewScrollBar(self.AsObject()[0])}
}
func (self *Extension[T]) AsScrollBar() Instance { return self.Super().AsScrollBar() }
