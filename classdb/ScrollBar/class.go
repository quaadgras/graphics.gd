...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ScrollBar](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ScrollBar{pointers.Add[gdclass.ScrollBar]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ScrollBar{pointers.New[gdclass.ScrollBar]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetCustomStep(step float64) { //gd:ScrollBar.set_custom_step
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_custom_step, 0|(gdextension.SizeFloat<<4), &struct{ step float64 }{step})
}

//go:nosplit
func (self class) GetCustomStep() float64 { //gd:ScrollBar.get_custom_step
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_custom_step, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self Instance) AsScrollBar() Instance {
	return Instance{pointers.AsA[gdclass.ScrollBar](self[0])}
}
...
func init() {
	gdclass.Register("ScrollBar", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ScrollBar](ptr)} })
}
