...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScrollBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScrollBar{gdclass.NewScrollBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
