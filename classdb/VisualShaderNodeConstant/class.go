...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeConstant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeConstant{gdclass.NewVisualShaderNodeConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
