...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeConstant{gdclass.NewVisualShaderNodeConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
