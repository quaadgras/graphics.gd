...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeIs")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIs{gdclass.NewVisualShaderNodeIs(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
