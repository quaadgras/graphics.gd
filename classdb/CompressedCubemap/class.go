...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CompressedCubemap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedCubemap{gdclass.NewCompressedCubemap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
