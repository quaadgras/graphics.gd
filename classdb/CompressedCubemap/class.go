...
/*
A cubemap that is loaded from a .ccube file. This file format is internal to Godot; it is created by importing other image formats with the import system. [graphics.gd/classdb/CompressedCubemap] can use one of 4 compression methods:
...
See [graphics.gd/classdb/Cubemap] for a general description of cubemaps.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CompressedCubemap](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedCubemap{pointers.Add[gdclass.CompressedCubemap]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CompressedCubemap{pointers.New[gdclass.CompressedCubemap]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsCompressedCubemap() Advanced {
	return Advanced{pointers.AsA[gdclass.CompressedCubemap](self[0])}
}
func (self Instance) AsCompressedCubemap() Instance {
	return Instance{pointers.AsA[gdclass.CompressedCubemap](self[0])}
}
...
func init() {
	gdclass.Register("CompressedCubemap", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CompressedCubemap](ptr)} })
}
