...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MobileVRInterface")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MobileVRInterface{gdclass.NewMobileVRInterface(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
