...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeSDFToScreenUV")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFToScreenUV{gdclass.NewVisualShaderNodeSDFToScreenUV(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
