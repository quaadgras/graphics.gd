...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFToScreenUV{gdclass.NewVisualShaderNodeSDFToScreenUV(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
