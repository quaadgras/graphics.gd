...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VBoxContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VBoxContainer{gdclass.NewVBoxContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
