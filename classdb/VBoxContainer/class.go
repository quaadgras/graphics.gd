...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VBoxContainer"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VBoxContainer{gdclass.NewVBoxContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
