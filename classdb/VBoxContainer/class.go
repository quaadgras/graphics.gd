...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVBoxContainer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVBoxContainer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VBoxContainer{gdclass.NewVBoxContainer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVBoxContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VBoxContainer{gdclass.NewVBoxContainer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVBoxContainer() Advanced {
	return Advanced{gdclass.NewVBoxContainer(self.AsObject()[0])}
}
func (self Instance) AsVBoxContainer() Instance {
	return Instance{gdclass.NewVBoxContainer(self.AsObject()[0])}
}
func (self *Extension[T]) AsVBoxContainer() Instance { return self.Super().AsVBoxContainer() }
...
func init() {
	gdclass.Register("VBoxContainer", func(ptr gd.Object) any { return Instance{gdclass.NewVBoxContainer(ptr)} })
}
