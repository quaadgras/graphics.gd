...
/*
A variant of [graphics.gd/classdb/BoxContainer] that can only arrange its child controls vertically. Child controls are rearranged automatically when their minimum size changes.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VBoxContainer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VBoxContainer{pointers.Add[gdclass.VBoxContainer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VBoxContainer{pointers.New[gdclass.VBoxContainer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVBoxContainer() Advanced {
	return Advanced{pointers.AsA[gdclass.VBoxContainer](self[0])}
}
func (self Instance) AsVBoxContainer() Instance {
	return Instance{pointers.AsA[gdclass.VBoxContainer](self[0])}
}
...
func init() {
	gdclass.Register("VBoxContainer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VBoxContainer](ptr)} })
}
