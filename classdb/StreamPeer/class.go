...
func (self class) AsObject() [1]gd.Object { return gdclass.GetStreamPeer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetStreamPeer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StreamPeer{gdclass.NewStreamPeer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetStreamPeer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StreamPeer{gdclass.NewStreamPeer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsStreamPeer() Advanced { return Advanced{gdclass.NewStreamPeer(self.AsObject()[0])} }
func (self Instance) AsStreamPeer() Instance {
	return Instance{gdclass.NewStreamPeer(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("StreamPeer", func(ptr gd.Object) any { return Instance{gdclass.NewStreamPeer(ptr)} })
}
