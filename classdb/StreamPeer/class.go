...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StreamPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeer{gdclass.NewStreamPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
