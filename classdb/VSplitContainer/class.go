...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VSplitContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VSplitContainer{gdclass.NewVSplitContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
