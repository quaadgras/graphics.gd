...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVSplitContainer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVSplitContainer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VSplitContainer{gdclass.NewVSplitContainer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVSplitContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VSplitContainer{gdclass.NewVSplitContainer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVSplitContainer() Advanced {
	return Advanced{gdclass.NewVSplitContainer(self.AsObject()[0])}
}
func (self Instance) AsVSplitContainer() Instance {
	return Instance{gdclass.NewVSplitContainer(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VSplitContainer", func(ptr gd.Object) any { return Instance{gdclass.NewVSplitContainer(ptr)} })
}
