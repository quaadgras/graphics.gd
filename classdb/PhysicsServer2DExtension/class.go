...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsServer2DExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsServer2DExtension{gdclass.NewPhysicsServer2DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
