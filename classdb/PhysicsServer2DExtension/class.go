...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsServer2DExtension{gdclass.NewPhysicsServer2DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
