...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventMouseButton{gdclass.NewInputEventMouseButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
