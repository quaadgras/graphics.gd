...
/*
Stores information about mouse click events. See [Instance.Node.Input].
Note: On Wear OS devices, rotary input is mapped to [MouseButtonWheelUp] and [MouseButtonWheelDown]. This can be changed to [MouseButtonWheelLeft] and [MouseButtonWheelRight] with the [member ProjectSettings.input_devices/pointing/android/rotary_input_scroll_axis] setting.
*/
