...
/*
Stores information about mouse click events. See [graphics.gd/classdb/Node.Instance.Input].

Note: On Wear OS devices, rotary input is mapped to [MouseButtonWheelUp] and [MouseButtonWheelDown]. This can be changed to [MouseButtonWheelLeft] and [MouseButtonWheelRight] with the [graphics.gd/classdb/ProjectSettings] "input_devices/pointing/android/rotary_input_scroll_axis" setting.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.InputEventMouseButton](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventMouseButton{pointers.Add[gdclass.InputEventMouseButton]([3]uint64{})})
	...
	casted := Instance([1]gdclass.InputEventMouseButton{pointers.New[gdclass.InputEventMouseButton]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsInputEventMouseButton() Advanced {
	return Advanced{pointers.AsA[gdclass.InputEventMouseButton](self[0])}
}
func (self Instance) AsInputEventMouseButton() Instance {
	return Instance{pointers.AsA[gdclass.InputEventMouseButton](self[0])}
}
...
func init() {
	gdclass.Register("InputEventMouseButton", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.InputEventMouseButton](ptr)} })
}
