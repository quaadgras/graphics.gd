...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SceneMultiplayer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneMultiplayer{gdclass.NewSceneMultiplayer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
