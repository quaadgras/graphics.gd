...
This implementation supports RPCs via [Instance.Node.Rpc] and [Instance.Node.RpcId] and requires [Instance.Multiplayerapi.Rpc] to be passed a [Node] (it will fail for other object types).
...
If a peer disconnects before completing authentication, either due to a network issue, the [member auth_timeout] expiring, or manually calling [Instance.DisconnectPeer], the [signal peer_authentication_failed] signal will be emitted instead of [signal MultiplayerAPI.peer_disconnected].
*/
...
/*
Sends the given raw 'bytes' to a specific peer identified by 'id' (see [Instance.Multiplayerpeer.SetTargetPeer]). Default ID is 0, i.e. broadcast to all peers.
*/
