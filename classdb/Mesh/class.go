...
Virtual method to override the surface LODs for a custom class extending [Mesh].
*/
func (Instance) _surface_get_lods(impl func(ptr gdclass.Receiver, index int) map[any]any) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var index = gd.UnsafeGet[int64](p_args, 0)
		self := gdclass.Receiver(reflect.ValueOf(class).UnsafePointer())
		ret := impl(self, int(index))
...
/*
Returns the number of surfaces that the [Mesh] holds. This is equivalent to [Instance.Meshinstance3d.GetSurfaceOverrideMaterialCount].
*/
...
/*
Returns the arrays for the vertices, normals, UVs, etc. that make up the requested surface (see [Instance.Arraymesh.AddSurfaceFromArrays]).
*/
...
Note: This assigns the material within the [Mesh] resource, not the [Material] associated to the [MeshInstance3D]'s Surface Material Override properties. To set the [Material] associated to the [MeshInstance3D]'s Surface Material Override properties, use [Instance.Meshinstance3d.SetSurfaceOverrideMaterial] instead.
*/
...
Note: This returns the material within the [Mesh] resource, not the [Material] associated to the [MeshInstance3D]'s Surface Material Override properties. To get the [Material] associated to the [MeshInstance3D]'s Surface Material Override properties, use [Instance.Meshinstance3d.GetSurfaceOverrideMaterial] instead.
*/
