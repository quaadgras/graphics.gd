...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Mesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Mesh{gdclass.NewMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
