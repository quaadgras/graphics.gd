...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("UniformSetCacheRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.UniformSetCacheRD{gdclass.NewUniformSetCacheRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
