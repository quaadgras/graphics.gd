...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformConstant{gdclass.NewVisualShaderNodeTransformConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
