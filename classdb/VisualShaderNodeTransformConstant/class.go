...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeTransformConstant"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformConstant{gdclass.NewVisualShaderNodeTransformConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
