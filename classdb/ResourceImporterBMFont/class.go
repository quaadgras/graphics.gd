...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterBMFont")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterBMFont{gdclass.NewResourceImporterBMFont(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
