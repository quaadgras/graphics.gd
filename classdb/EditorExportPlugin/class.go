...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlugin{gdclass.NewEditorExportPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
