...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture3D{gdclass.NewPlaceholderTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
