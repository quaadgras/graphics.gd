...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderTexture3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture3D{gdclass.NewPlaceholderTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
