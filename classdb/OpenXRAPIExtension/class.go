...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRAPIExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAPIExtension{gdclass.NewOpenXRAPIExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
