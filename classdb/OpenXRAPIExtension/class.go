...
/*
[OpenXRAPIExtension] makes OpenXR available for GDExtension. It provides the OpenXR API to GDExtension through the [Instance.GetInstanceProcAddr] method, and the OpenXR instance through [Instance.GetInstance].
