...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeWorldPositionFromDepth")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeWorldPositionFromDepth{gdclass.NewVisualShaderNodeWorldPositionFromDepth(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
