...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeWorldPositionFromDepth{gdclass.NewVisualShaderNodeWorldPositionFromDepth(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
