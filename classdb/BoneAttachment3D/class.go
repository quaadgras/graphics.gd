...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoneAttachment3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoneAttachment3D{gdclass.NewBoneAttachment3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
