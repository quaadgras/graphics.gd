...
/*
Sets whether the BoneAttachment3D node will use an external [Skeleton3D] node rather than attempting to use its parent node as the [Skeleton3D]. When set to true, the BoneAttachment3D node will use the external [Skeleton3D] node set in [Instance.SetExternalSkeleton].
*/
...
/*
Sets the [NodePath] to the external skeleton that the BoneAttachment3D node should use. See [Instance.SetUseExternalSkeleton] to enable the external [Skeleton3D] node.
*/
