...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeOneShot{gdclass.NewAnimationNodeOneShot(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
