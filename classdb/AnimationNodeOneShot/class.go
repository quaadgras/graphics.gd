...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeOneShot")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeOneShot{gdclass.NewAnimationNodeOneShot(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
