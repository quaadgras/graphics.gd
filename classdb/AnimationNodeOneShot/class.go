...
/*
A resource to add to an [graphics.gd/classdb/AnimationNodeBlendTree]. This animation node will execute a sub-animation and return once it finishes. Blend times for fading in and out can be customized, as well as filters.
...
const (
	// Blends two animations. See also [graphics.gd/classdb/AnimationNodeBlend2].
	MixModeBlend MixMode = 0
	// Blends two animations additively. See also [graphics.gd/classdb/AnimationNodeAdd2].
