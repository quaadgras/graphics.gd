...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFSkin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFSkin{gdclass.NewGLTFSkin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
