...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.Shape3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Shape3D{pointers.Add[gdclass.Shape3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.Shape3D{pointers.New[gdclass.Shape3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) GetDebugMesh() [1]gdclass.ArrayMesh { //gd:Shape3D.get_debug_mesh
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_debug_mesh, gdextension.SizeObject, &struct{}{})
	var ret = [1]gdclass.ArrayMesh{gd.PointerWithOwnershipTransferredToGo[gdclass.ArrayMesh](r_ret)}
	return ret
}
func (self class) AsShape3D() Advanced         { return Advanced{pointers.AsA[gdclass.Shape3D](self[0])} }
func (self Instance) AsShape3D() Instance      { return Instance{pointers.AsA[gdclass.Shape3D](self[0])} }
...
func init() {
	gdclass.Register("Shape3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.Shape3D](ptr)} })
}
