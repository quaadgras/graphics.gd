...
/*
Contains the results of a single [graphics.gd/classdb/RegEx] match returned by [graphics.gd/classdb/RegEx.Instance.Search] and [graphics.gd/classdb/RegEx.Instance.SearchAll]. It can be used to find the position and range of the match and its capturing groups, and it can extract its substring for you.
*/
package RegExMatch
