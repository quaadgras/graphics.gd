...
func (self class) AsObject() [1]gd.Object { return gdclass.GetRegExMatch(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetRegExMatch(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RegExMatch{gdclass.NewRegExMatch(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetRegExMatch(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RegExMatch{gdclass.NewRegExMatch(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsRegExMatch() Advanced { return Advanced{gdclass.NewRegExMatch(self.AsObject()[0])} }
func (self Instance) AsRegExMatch() Instance {
	return Instance{gdclass.NewRegExMatch(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("RegExMatch", func(ptr gd.Object) any { return Instance{gdclass.NewRegExMatch(ptr)} })
}
