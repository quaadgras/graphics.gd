...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RegExMatch")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RegExMatch{gdclass.NewRegExMatch(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
