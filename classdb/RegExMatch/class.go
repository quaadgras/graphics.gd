...
/*
Contains the results of a single [RegEx] match returned by [Instance.Regex.Search] and [Instance.Regex.SearchAll]. It can be used to find the position and range of the match and its capturing groups, and it can extract its substring for you.
*/
package RegExMatch
