...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AESContext")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AESContext{gdclass.NewAESContext(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
