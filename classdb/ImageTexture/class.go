...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ImageTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageTexture{gdclass.NewImageTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
