...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptLanguageExtension{gdclass.NewScriptLanguageExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
