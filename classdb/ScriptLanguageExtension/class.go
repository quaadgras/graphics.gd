...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScriptLanguageExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptLanguageExtension{gdclass.NewScriptLanguageExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
