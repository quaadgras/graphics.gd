...
Internally, [MultiplayerSynchronizer] uses [Instance.Multiplayerapi.ObjectConfigurationAdd] to notify synchronization start passing the [Node] at [member root_path] as the object and itself as the configuration, and uses [Instance.Multiplayerapi.ObjectConfigurationRemove] to notify synchronization end in a similar way.
Note: Synchronization is not supported for [Object] type properties, like [Resource]. Properties that are unique to each peer, like the instance IDs of [Object]s (see [Instance.Object.GetInstanceId]) or [RID]s, will also not work in synchronization.
*/
...
/*
Sets the visibility of 'peer' to 'visible'. If 'peer' is 0, the value of [member public_visibility] will be updated instead.
*/
