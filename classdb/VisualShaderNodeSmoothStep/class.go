...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeSmoothStep(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeSmoothStep(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeSmoothStep{gdclass.NewVisualShaderNodeSmoothStep(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeSmoothStep(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSmoothStep{gdclass.NewVisualShaderNodeSmoothStep(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeSmoothStep() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeSmoothStep(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeSmoothStep() Instance {
	return Instance{gdclass.NewVisualShaderNodeSmoothStep(self.AsObject()[0])}
}
