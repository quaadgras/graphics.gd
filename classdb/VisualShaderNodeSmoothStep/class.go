...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSmoothStep{gdclass.NewVisualShaderNodeSmoothStep(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
