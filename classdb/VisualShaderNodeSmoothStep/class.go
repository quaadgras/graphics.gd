...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeSmoothStep")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSmoothStep{gdclass.NewVisualShaderNodeSmoothStep(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
