...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.BoxMesh](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.BoxMesh{pointers.Add[gdclass.BoxMesh]([3]uint64{})})
	...
	casted := Instance([1]gdclass.BoxMesh{pointers.New[gdclass.BoxMesh]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetSubdivideHeight(divisions int64) { //gd:BoxMesh.set_subdivide_height
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_subdivide_height, 0|(gdextension.SizeInt<<4), &struct{ divisions int64 }{divisions})
}
...
func (self class) SetSubdivideDepth(divisions int64) { //gd:BoxMesh.set_subdivide_depth
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_subdivide_depth, 0|(gdextension.SizeInt<<4), &struct{ divisions int64 }{divisions})
}
...
func (self class) AsBoxMesh() Advanced         { return Advanced{pointers.AsA[gdclass.BoxMesh](self[0])} }
func (self Instance) AsBoxMesh() Instance      { return Instance{pointers.AsA[gdclass.BoxMesh](self[0])} }
...
func init() {
	gdclass.Register("BoxMesh", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.BoxMesh](ptr)} })
}
