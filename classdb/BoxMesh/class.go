...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoxMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoxMesh{gdclass.NewBoxMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
