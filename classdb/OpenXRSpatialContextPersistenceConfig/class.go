...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialContextPersistenceConfig{gdclass.NewOpenXRSpatialContextPersistenceConfig(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
