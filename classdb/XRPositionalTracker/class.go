...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRPositionalTracker{gdclass.NewXRPositionalTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
