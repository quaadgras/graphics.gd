...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("XRPositionalTracker"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRPositionalTracker{gdclass.NewXRPositionalTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetTrackerProfile() String.Readable { //gd:XRPositionalTracker.get_tracker_profile
	var r_ret = jumponly.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_tracker_profile, gdextension.SizeString, &struct{}{})
