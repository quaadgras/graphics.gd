...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRPositionalTracker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRPositionalTracker{gdclass.NewXRPositionalTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
