...
func (self class) LoadFromBuffer(stream_data Packed.Bytes, options Dictionary.Any) [1]gdclass.AudioStreamWAV { //gd:AudioStreamWAV.load_from_buffer
	var r_ret = mainthread.CallStatic[gdextension.Object](methods.load_from_buffer, gdextension.SizeObject|(gdextension.SizePackedArray<<4)|(gdextension.SizeDictionary<<8), &struct {
...
func (self class) LoadFromFile(path String.Readable, options Dictionary.Any) [1]gdclass.AudioStreamWAV { //gd:AudioStreamWAV.load_from_file
	var r_ret = mainthread.CallStatic[gdextension.Object](methods.load_from_file, gdextension.SizeObject|(gdextension.SizeString<<4)|(gdextension.SizeDictionary<<8), &struct {
...
func (self class) SetFormat(format Format) { //gd:AudioStreamWAV.set_format
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_format, 0|(gdextension.SizeInt<<4), &struct{ format Format }{format})
}
...
func (self class) SetLoopBegin(loop_begin int64) { //gd:AudioStreamWAV.set_loop_begin
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_loop_begin, 0|(gdextension.SizeInt<<4), &struct{ loop_begin int64 }{loop_begin})
}

//go:nosplit
func (self class) GetLoopBegin() int64 { //gd:AudioStreamWAV.get_loop_begin
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_loop_begin, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetLoopEnd(loop_end int64) { //gd:AudioStreamWAV.set_loop_end
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_loop_end, 0|(gdextension.SizeInt<<4), &struct{ loop_end int64 }{loop_end})
}

//go:nosplit
func (self class) GetLoopEnd() int64 { //gd:AudioStreamWAV.get_loop_end
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_loop_end, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMixRate(mix_rate int64) { //gd:AudioStreamWAV.set_mix_rate
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_mix_rate, 0|(gdextension.SizeInt<<4), &struct{ mix_rate int64 }{mix_rate})
}

//go:nosplit
func (self class) GetMixRate() int64 { //gd:AudioStreamWAV.get_mix_rate
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_mix_rate, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetStereo(stereo bool) { //gd:AudioStreamWAV.set_stereo
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_stereo, 0|(gdextension.SizeBool<<4), &struct{ stereo bool }{stereo})
}

//go:nosplit
func (self class) IsStereo() bool { //gd:AudioStreamWAV.is_stereo
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_stereo, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SaveToWav(path String.Readable) Error.Code { //gd:AudioStreamWAV.save_to_wav
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.save_to_wav, gdextension.SizeInt|(gdextension.SizeString<<4), &struct{ path gdextension.String }{pointers.Get(gd.InternalString(path))})
