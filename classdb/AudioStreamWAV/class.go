...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamWAV")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamWAV{gdclass.NewAudioStreamWAV(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
