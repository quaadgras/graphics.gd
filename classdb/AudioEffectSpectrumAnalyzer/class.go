...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectSpectrumAnalyzer{gdclass.NewAudioEffectSpectrumAnalyzer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
