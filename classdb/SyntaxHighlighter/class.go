...
/*
Returns the syntax highlighting data for the line at index 'line'. If the line is not cached, calls [Instance.GetLineSyntaxHighlighting] first to calculate the data.
...
/*
Clears then updates the [SyntaxHighlighter] caches. Override [Instance.UpdateCache] for a callback.
...
Then calls overridable method [Instance.ClearHighlightingCache].
*/
