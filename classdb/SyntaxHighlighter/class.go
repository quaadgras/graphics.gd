...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSyntaxHighlighter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSyntaxHighlighter(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SyntaxHighlighter{gdclass.NewSyntaxHighlighter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetSyntaxHighlighter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SyntaxHighlighter{gdclass.NewSyntaxHighlighter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsSyntaxHighlighter() Advanced {
	return Advanced{gdclass.NewSyntaxHighlighter(self.AsObject()[0])}
}
func (self Instance) AsSyntaxHighlighter() Instance {
	return Instance{gdclass.NewSyntaxHighlighter(self.AsObject()[0])}
}
...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_get_line_syntax_highlighting":
		return gd.ValueOf(self._get_line_syntax_highlighting)
	case "_clear_highlighting_cache":
		return gd.ValueOf(self._clear_highlighting_cache)
	case "_update_cache":
		return gd.ValueOf(self._update_cache)
	default:
...
func init() {
	gdclass.Register("SyntaxHighlighter", func(ptr gd.Object) any { return Instance{gdclass.NewSyntaxHighlighter(ptr)} })
}
