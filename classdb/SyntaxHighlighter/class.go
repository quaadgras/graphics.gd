...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SyntaxHighlighter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SyntaxHighlighter{gdclass.NewSyntaxHighlighter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
