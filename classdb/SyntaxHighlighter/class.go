...
/*
Base class for syntax highlighters. Provides syntax highlighting data to a [graphics.gd/classdb/TextEdit]. The associated [graphics.gd/classdb/TextEdit] will call into the [graphics.gd/classdb/SyntaxHighlighter] on an as-needed basis.

Note: A [graphics.gd/classdb/SyntaxHighlighter] instance should not be used across multiple [graphics.gd/classdb/TextEdit] nodes.
*/
...
type Interface interface {
	...
	//
	// See [Instance.GetLineSyntaxHighlighting] for more details.
...
/*
Returns the syntax highlighting data for the line at index 'line'. If the line is not cached, calls [Interface.GetLineSyntaxHighlighting] first to calculate the data.
...
/*
Clears then updates the [graphics.gd/classdb/SyntaxHighlighter] caches. Override [Interface.UpdateCache] for a callback.

Note: This is called automatically when the associated [graphics.gd/classdb/TextEdit] node, updates its own cache.
*/
...
Then calls overridable method [Interface.ClearHighlightingCache].
*/
...
/*
Returns the associated [graphics.gd/classdb/TextEdit] node.
*/
