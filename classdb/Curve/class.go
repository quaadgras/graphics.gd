...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Curve")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Curve{gdclass.NewCurve(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
