...
Note: You will need to use the Skeleton2D from [Instance.Skeletonmodificationstack2d.GetSkeleton] and it's draw functions, as the [SkeletonModification2D] resource cannot draw on its own.
*/
...
/*
Sets whether this modification will call [Instance.DrawEditorGizmo] in the Godot editor to draw modification-specific gizmos.
*/
...
/*
Returns whether this modification will call [Instance.DrawEditorGizmo] in the Godot editor to draw modification-specific gizmos.
*/
