...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2D{gdclass.NewSkeletonModification2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
