...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVSlider(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVSlider(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VSlider{gdclass.NewVSlider(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVSlider(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VSlider{gdclass.NewVSlider(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVSlider() Advanced         { return Advanced{gdclass.NewVSlider(self.AsObject()[0])} }
func (self Instance) AsVSlider() Instance      { return Instance{gdclass.NewVSlider(self.AsObject()[0])} }
func (self *Extension[T]) AsVSlider() Instance { return self.Super().AsVSlider() }
func (self class) AsSlider() Slider.Advanced {
	return Slider.Advanced{gdclass.NewSlider(self.AsObject()[0])}
}
func (self *Extension[T]) AsSlider() Slider.Instance { return self.Super().AsSlider() }
func (self Instance) AsSlider() Slider.Instance {
	return Slider.Instance{gdclass.NewSlider(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VSlider", func(ptr gd.Object) any { return Instance{gdclass.NewVSlider(ptr)} })
}
