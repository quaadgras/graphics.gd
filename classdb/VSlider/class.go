...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VSlider")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VSlider{gdclass.NewVSlider(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
