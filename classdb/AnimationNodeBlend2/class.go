...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlend2{gdclass.NewAnimationNodeBlend2(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
