...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AnimationNodeBlend2"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlend2{gdclass.NewAnimationNodeBlend2(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
