...
They can be used as the server certificate in [Instance.Streampeertls.AcceptStream] (along with the proper [CryptoKey]), and to specify the only certificate that should be accepted when connecting to a TLS server via [Instance.Streampeertls.ConnectToStream].
*/
