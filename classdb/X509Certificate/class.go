...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("X509Certificate")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.X509Certificate{gdclass.NewX509Certificate(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
