...
/*
The X509Certificate class represents an X509 certificate. Certificates can be loaded and saved like any other [graphics.gd/classdb/Resource].

They can be used as the server certificate in [graphics.gd/classdb/StreamPeerTLS.Instance.AcceptStream] (along with the proper [graphics.gd/classdb/CryptoKey]), and to specify the only certificate that should be accepted when connecting to a TLS server via [graphics.gd/classdb/StreamPeerTLS.Instance.ConnectToStream].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.X509Certificate](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.X509Certificate{pointers.Add[gdclass.X509Certificate]([3]uint64{})})
	...
	casted := Instance([1]gdclass.X509Certificate{pointers.New[gdclass.X509Certificate]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsX509Certificate() Advanced {
	return Advanced{pointers.AsA[gdclass.X509Certificate](self[0])}
}
func (self Instance) AsX509Certificate() Instance {
	return Instance{pointers.AsA[gdclass.X509Certificate](self[0])}
}
...
func init() {
	gdclass.Register("X509Certificate", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.X509Certificate](ptr)} })
}
