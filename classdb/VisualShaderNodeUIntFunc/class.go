...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeUIntFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntFunc{gdclass.NewVisualShaderNodeUIntFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
