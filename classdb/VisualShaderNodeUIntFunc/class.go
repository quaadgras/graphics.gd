...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntFunc{gdclass.NewVisualShaderNodeUIntFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
