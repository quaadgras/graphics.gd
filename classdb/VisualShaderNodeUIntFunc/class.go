...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeUIntFunc](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeUIntFunc{pointers.Add[gdclass.VisualShaderNodeUIntFunc]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntFunc{pointers.New[gdclass.VisualShaderNodeUIntFunc]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeUIntFunc() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeUIntFunc](self[0])}
}
func (self Instance) AsVisualShaderNodeUIntFunc() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeUIntFunc](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeUIntFunc", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeUIntFunc](ptr)} })
}
