...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioEffectEQ10](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectEQ10{pointers.Add[gdclass.AudioEffectEQ10]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioEffectEQ10{pointers.New[gdclass.AudioEffectEQ10]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsAudioEffectEQ10() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioEffectEQ10](self[0])}
}
func (self Instance) AsAudioEffectEQ10() Instance {
	return Instance{pointers.AsA[gdclass.AudioEffectEQ10](self[0])}
}
...
func (self class) AsAudioEffectEQ() AudioEffectEQ.Advanced {
	return AudioEffectEQ.Advanced{pointers.AsA[gdclass.AudioEffectEQ](self[0])}
}
...
func (self Instance) AsAudioEffectEQ() AudioEffectEQ.Instance {
	return AudioEffectEQ.Instance{pointers.AsA[gdclass.AudioEffectEQ](self[0])}
}
...
func init() {
	gdclass.Register("AudioEffectEQ10", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioEffectEQ10](ptr)} })
}
