...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioEffectEQ10(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioEffectEQ10(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectEQ10{gdclass.NewAudioEffectEQ10(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioEffectEQ10(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectEQ10{gdclass.NewAudioEffectEQ10(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsAudioEffectEQ10() Advanced {
	return Advanced{gdclass.NewAudioEffectEQ10(self.AsObject()[0])}
}
func (self Instance) AsAudioEffectEQ10() Instance {
	return Instance{gdclass.NewAudioEffectEQ10(self.AsObject()[0])}
}
func (self *Extension[T]) AsAudioEffectEQ10() Instance { return self.Super().AsAudioEffectEQ10() }
...
func init() {
	gdclass.Register("AudioEffectEQ10", func(ptr gd.Object) any { return Instance{gdclass.NewAudioEffectEQ10(ptr)} })
}
