...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("Texture2DArrayRD"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture2DArrayRD{gdclass.NewTexture2DArrayRD(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
