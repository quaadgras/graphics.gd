...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Texture2DArrayRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture2DArrayRD{gdclass.NewTexture2DArrayRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
