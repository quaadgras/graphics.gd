...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GraphEdit")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GraphEdit{gdclass.NewGraphEdit(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
