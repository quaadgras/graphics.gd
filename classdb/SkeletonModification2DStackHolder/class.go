...
Note: The modifications in the held [graphics.gd/classdb/SkeletonModificationStack2D] will only be executed if their execution mode matches the execution mode of the SkeletonModification2DStackHolder.
*/
...
/*
Sets the [graphics.gd/classdb/SkeletonModificationStack2D] that this modification is holding. This modification stack will then be executed when this modification is executed.
*/
...
/*
Returns the [graphics.gd/classdb/SkeletonModificationStack2D] that this modification is holding.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.SkeletonModification2DStackHolder](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SkeletonModification2DStackHolder{pointers.Add[gdclass.SkeletonModification2DStackHolder]([3]uint64{})})
	...
	casted := Instance([1]gdclass.SkeletonModification2DStackHolder{pointers.New[gdclass.SkeletonModification2DStackHolder]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsSkeletonModification2DStackHolder() Advanced {
	return Advanced{pointers.AsA[gdclass.SkeletonModification2DStackHolder](self[0])}
}
func (self Instance) AsSkeletonModification2DStackHolder() Instance {
	return Instance{pointers.AsA[gdclass.SkeletonModification2DStackHolder](self[0])}
}
...
func init() {
	gdclass.Register("SkeletonModification2DStackHolder", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.SkeletonModification2DStackHolder](ptr)} })
}
