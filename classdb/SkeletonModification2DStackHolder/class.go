...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SkeletonModification2DStackHolder")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DStackHolder{gdclass.NewSkeletonModification2DStackHolder(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
