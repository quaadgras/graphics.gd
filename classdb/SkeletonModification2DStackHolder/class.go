...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetSkeletonModification2DStackHolder(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SkeletonModification2DStackHolder{gdclass.NewSkeletonModification2DStackHolder(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetSkeletonModification2DStackHolder(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SkeletonModification2DStackHolder{gdclass.NewSkeletonModification2DStackHolder(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsSkeletonModification2DStackHolder() Advanced {
	return Advanced{gdclass.NewSkeletonModification2DStackHolder(self.AsObject()[0])}
}
func (self Instance) AsSkeletonModification2DStackHolder() Instance {
	return Instance{gdclass.NewSkeletonModification2DStackHolder(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("SkeletonModification2DStackHolder", func(ptr gd.Object) any { return Instance{gdclass.NewSkeletonModification2DStackHolder(ptr)} })
}
