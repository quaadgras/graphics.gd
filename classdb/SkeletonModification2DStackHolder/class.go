...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DStackHolder{gdclass.NewSkeletonModification2DStackHolder(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
