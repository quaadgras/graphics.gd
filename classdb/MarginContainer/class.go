...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MarginContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MarginContainer{gdclass.NewMarginContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
