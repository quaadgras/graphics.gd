...
/*
[graphics.gd/classdb/MarginContainer] adds an adjustable margin on each side of its child controls. The margins are added around all children, not around each individual one. To control the [graphics.gd/classdb/MarginContainer]'s margins, use the margin_* theme properties listed below.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.MarginContainer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MarginContainer{pointers.Add[gdclass.MarginContainer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.MarginContainer{pointers.New[gdclass.MarginContainer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsMarginContainer() Advanced {
	return Advanced{pointers.AsA[gdclass.MarginContainer](self[0])}
}
func (self Instance) AsMarginContainer() Instance {
	return Instance{pointers.AsA[gdclass.MarginContainer](self[0])}
}
...
func init() {
	gdclass.Register("MarginContainer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.MarginContainer](ptr)} })
}
