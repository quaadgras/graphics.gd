...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVideoStreamTheora(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVideoStreamTheora(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VideoStreamTheora{gdclass.NewVideoStreamTheora(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVideoStreamTheora(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VideoStreamTheora{gdclass.NewVideoStreamTheora(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVideoStreamTheora() Advanced {
	return Advanced{gdclass.NewVideoStreamTheora(self.AsObject()[0])}
}
func (self Instance) AsVideoStreamTheora() Instance {
	return Instance{gdclass.NewVideoStreamTheora(self.AsObject()[0])}
}
...
func (self class) AsVideoStream() VideoStream.Advanced {
	return VideoStream.Advanced{gdclass.NewVideoStream(self.AsObject()[0])}
}
...
func (self Instance) AsVideoStream() VideoStream.Instance {
	return VideoStream.Instance{gdclass.NewVideoStream(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VideoStreamTheora", func(ptr gd.Object) any { return Instance{gdclass.NewVideoStreamTheora(ptr)} })
}
