...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VideoStreamTheora")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VideoStreamTheora{gdclass.NewVideoStreamTheora(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
