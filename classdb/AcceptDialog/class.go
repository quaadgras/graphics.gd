...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AcceptDialog")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AcceptDialog{gdclass.NewAcceptDialog(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
