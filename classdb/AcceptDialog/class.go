...
/*
The default use of [AcceptDialog] is to allow it to only be accepted or closed, with the same result. However, the [signal confirmed] and [signal canceled] signals allow to make the two actions different, and the [Instance.AddButton] method allows to add custom buttons and actions.
*/
...
/*
Removes the 'button' from the dialog. Does NOT free the 'button'. The 'button' must be a [Button] added with [Instance.AddButton] or [Instance.AddCancelButton] method. After removal, pressing the 'button' will no longer emit this dialog's [signal custom_action] or [signal canceled] signals.
*/
