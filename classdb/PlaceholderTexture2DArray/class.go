...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("PlaceholderTexture2DArray"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2DArray{gdclass.NewPlaceholderTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
