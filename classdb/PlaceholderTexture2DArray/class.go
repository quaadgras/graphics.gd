...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderTexture2DArray")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2DArray{gdclass.NewPlaceholderTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
