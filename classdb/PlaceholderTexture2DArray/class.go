...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTexture2DArray{gdclass.NewPlaceholderTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
