...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ZIPReader")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ZIPReader{gdclass.NewZIPReader(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
