...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoneMap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoneMap{gdclass.NewBoneMap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
