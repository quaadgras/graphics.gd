...
By assigning the actual [graphics.gd/classdb/Skeleton3D] bone name as the key value, it maps the [graphics.gd/classdb/Skeleton3D] to the [graphics.gd/classdb/SkeletonProfile].
*/
package BoneMap
