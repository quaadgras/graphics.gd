...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SubViewportContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SubViewportContainer{gdclass.NewSubViewportContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
