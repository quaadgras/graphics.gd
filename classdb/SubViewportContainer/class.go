...
func New() Instance {
	...
	casted := Instance([1]gdclass.SubViewportContainer{gdclass.NewSubViewportContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
