...
/*
A 3D capsule shape, intended for use in physics. Usually used to provide a shape for a [graphics.gd/classdb/CollisionShape3D].

Performance: [graphics.gd/classdb/CapsuleShape3D] is fast to check collisions against. It is faster than [graphics.gd/classdb/CylinderShape3D], but slower than [graphics.gd/classdb/SphereShape3D] and [graphics.gd/classdb/BoxShape3D].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CapsuleShape3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CapsuleShape3D{pointers.Add[gdclass.CapsuleShape3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CapsuleShape3D{pointers.New[gdclass.CapsuleShape3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsCapsuleShape3D() Advanced {
	return Advanced{pointers.AsA[gdclass.CapsuleShape3D](self[0])}
}
func (self Instance) AsCapsuleShape3D() Instance {
	return Instance{pointers.AsA[gdclass.CapsuleShape3D](self[0])}
}
...
func init() {
	gdclass.Register("CapsuleShape3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CapsuleShape3D](ptr)} })
}
