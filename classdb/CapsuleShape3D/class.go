...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CapsuleShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CapsuleShape3D{gdclass.NewCapsuleShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
