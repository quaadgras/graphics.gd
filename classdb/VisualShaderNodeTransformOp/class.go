...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformOp{gdclass.NewVisualShaderNodeTransformOp(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
