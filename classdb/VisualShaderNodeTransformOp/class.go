...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeTransformOp(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeTransformOp(self[0]) }
...
func (self class) AsVisualShaderNodeTransformOp() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTransformOp(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTransformOp() Instance {
	return Instance{gdclass.NewVisualShaderNodeTransformOp(self.AsObject()[0])}
}
