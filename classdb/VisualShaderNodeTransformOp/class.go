...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTransformOp")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformOp{gdclass.NewVisualShaderNodeTransformOp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
