...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FoldableGroup")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FoldableGroup{gdclass.NewFoldableGroup(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
