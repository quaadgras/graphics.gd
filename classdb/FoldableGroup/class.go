...
/*
A group of [graphics.gd/classdb/FoldableContainer]-derived nodes. Only one container can be expanded at a time.
*/
...
/*
Returns an slice of [graphics.gd/classdb/FoldableContainer]s that have this as their FoldableGroup (see [graphics.gd/classdb/FoldableContainer.Instance.FoldableGroup]). This is equivalent to [graphics.gd/classdb/ButtonGroup] but for FoldableContainers.
*/
