...
func (self class) AsObject() [1]gd.Object { return gdclass.GetFoldableGroup(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetFoldableGroup(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.FoldableGroup{gdclass.NewFoldableGroup(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetFoldableGroup(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.FoldableGroup{gdclass.NewFoldableGroup(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnExpanded(cb func(container FoldableContainer.Instance), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("expanded"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsFoldableGroup() Advanced {
	return Advanced{gdclass.NewFoldableGroup(self.AsObject()[0])}
}
func (self Instance) AsFoldableGroup() Instance {
	return Instance{gdclass.NewFoldableGroup(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("FoldableGroup", func(ptr gd.Object) any { return Instance{gdclass.NewFoldableGroup(ptr)} })
}
