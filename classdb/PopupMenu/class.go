...
Note: The provided 'id' is used only in [signal id_pressed] and [signal id_focused] signals. It's not related to the index arguments in e.g. [Instance.SetItemChecked].
*/
