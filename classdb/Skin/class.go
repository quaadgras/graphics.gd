...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Skin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Skin{gdclass.NewSkin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
