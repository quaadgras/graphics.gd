...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSkin(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSkin(self[0]) }
...
func (self class) AsSkin() Advanced         { return Advanced{gdclass.NewSkin(self.AsObject()[0])} }
func (self Instance) AsSkin() Instance      { return Instance{gdclass.NewSkin(self.AsObject()[0])} }
