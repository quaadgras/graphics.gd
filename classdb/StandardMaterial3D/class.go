...
func (self class) AsObject() [1]gd.Object { return gdclass.GetStandardMaterial3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetStandardMaterial3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StandardMaterial3D{gdclass.NewStandardMaterial3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetStandardMaterial3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StandardMaterial3D{gdclass.NewStandardMaterial3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsStandardMaterial3D() Advanced {
	return Advanced{gdclass.NewStandardMaterial3D(self.AsObject()[0])}
}
func (self Instance) AsStandardMaterial3D() Instance {
	return Instance{gdclass.NewStandardMaterial3D(self.AsObject()[0])}
}
...
func (self class) AsBaseMaterial3D() BaseMaterial3D.Advanced {
	return BaseMaterial3D.Advanced{gdclass.NewBaseMaterial3D(self.AsObject()[0])}
}
...
func (self Instance) AsBaseMaterial3D() BaseMaterial3D.Instance {
	return BaseMaterial3D.Instance{gdclass.NewBaseMaterial3D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("StandardMaterial3D", func(ptr gd.Object) any { return Instance{gdclass.NewStandardMaterial3D(ptr)} })
}
