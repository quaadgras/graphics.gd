...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGeneric6DOFJoint3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGeneric6DOFJoint3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Generic6DOFJoint3D{gdclass.NewGeneric6DOFJoint3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGeneric6DOFJoint3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Generic6DOFJoint3D{gdclass.NewGeneric6DOFJoint3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsGeneric6DOFJoint3D() Advanced {
	return Advanced{gdclass.NewGeneric6DOFJoint3D(self.AsObject()[0])}
}
func (self Instance) AsGeneric6DOFJoint3D() Instance {
	return Instance{gdclass.NewGeneric6DOFJoint3D(self.AsObject()[0])}
}
