...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CSGShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CSGShape3D{gdclass.NewCSGShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
