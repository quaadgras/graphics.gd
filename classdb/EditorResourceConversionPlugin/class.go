...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourceConversionPlugin{gdclass.NewEditorResourceConversionPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
