...
To use an [EditorResourceConversionPlugin], register it using the [Instance.Editorplugin.AddResourceConversionPlugin] method first.
*/
...
/*
Takes an input [Resource] and converts it to the type given in [Instance.ConvertsTo]. The returned [Resource] is the result of the conversion, and the input [Resource] remains unchanged.
*/
