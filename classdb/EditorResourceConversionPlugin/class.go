...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorResourceConversionPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourceConversionPlugin{gdclass.NewEditorResourceConversionPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
