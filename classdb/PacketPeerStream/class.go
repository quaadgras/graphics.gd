...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PacketPeerStream")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PacketPeerStream{gdclass.NewPacketPeerStream(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
