...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CSGTorus3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CSGTorus3D{gdclass.NewCSGTorus3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
