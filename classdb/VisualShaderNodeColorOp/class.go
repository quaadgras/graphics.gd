...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorOp{gdclass.NewVisualShaderNodeColorOp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
