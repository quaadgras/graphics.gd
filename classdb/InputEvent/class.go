...
/*
Abstract base class of all types of input events. See [Instance.Node.Input].
*/
package InputEvent
...
Note: Due to keyboard ghosting, [Instance.IsPressed] may return false even if one of the action's keys is pressed. See [url=$DOCS_URL/tutorials/inputs/input_examples.html#keyboard-events]Input examples[/url] in the documentation for more information.
*/
