...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEvent")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEvent{gdclass.NewInputEvent(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
