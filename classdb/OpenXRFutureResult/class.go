...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRFutureResult")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRFutureResult{gdclass.NewOpenXRFutureResult(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
