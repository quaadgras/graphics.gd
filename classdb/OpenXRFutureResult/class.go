...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRFutureResult(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRFutureResult(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRFutureResult{gdclass.NewOpenXRFutureResult(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRFutureResult(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRFutureResult{gdclass.NewOpenXRFutureResult(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnCompleted(cb func(result Instance), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("completed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsOpenXRFutureResult() Advanced {
	return Advanced{gdclass.NewOpenXRFutureResult(self.AsObject()[0])}
}
func (self Instance) AsOpenXRFutureResult() Instance {
	return Instance{gdclass.NewOpenXRFutureResult(self.AsObject()[0])}
}
