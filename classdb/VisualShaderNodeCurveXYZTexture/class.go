...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveXYZTexture{gdclass.NewVisualShaderNodeCurveXYZTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
