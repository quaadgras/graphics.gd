...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTextureParameterTriplanar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureParameterTriplanar{gdclass.NewVisualShaderNodeTextureParameterTriplanar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
