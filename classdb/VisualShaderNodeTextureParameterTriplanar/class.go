...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureParameterTriplanar{gdclass.NewVisualShaderNodeTextureParameterTriplanar(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
