...
/*
[graphics.gd/classdb/Translation]s are resources that can be loaded and unloaded on demand. They map a collection of strings to their individual translations, and they also provide convenience methods for pluralization.
*/
package Translation
...
type Interface interface {
	// Virtual method to override [Instance.GetPluralMessage].
	GetPluralMessage(src_message string, src_plural_message string, n int, context string) string
	// Virtual method to override [Instance.GetMessage].
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.Translation](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Translation{pointers.Add[gdclass.Translation]([3]uint64{})})
	...
	casted := Instance([1]gdclass.Translation{pointers.New[gdclass.Translation]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsTranslation() Advanced {
	return Advanced{pointers.AsA[gdclass.Translation](self[0])}
}
func (self Instance) AsTranslation() Instance {
	return Instance{pointers.AsA[gdclass.Translation](self[0])}
}
...
func init() {
	gdclass.Register("Translation", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.Translation](ptr)} })
}
