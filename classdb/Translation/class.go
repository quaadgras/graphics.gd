...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Translation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Translation{gdclass.NewTranslation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
