...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.NinePatchRect](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.NinePatchRect{pointers.Add[gdclass.NinePatchRect]([3]uint64{})})
	...
	casted := Instance([1]gdclass.NinePatchRect{pointers.New[gdclass.NinePatchRect]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetPatchMargin(margin Rect2.Side, value int64) { //gd:NinePatchRect.set_patch_margin
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_patch_margin, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		margin Rect2.Side
		value  int64
	}{margin, value})
}
...
func (self class) GetPatchMargin(margin Rect2.Side) int64 { //gd:NinePatchRect.get_patch_margin
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_patch_margin, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ margin Rect2.Side }{margin})
	var ret = r_ret
	return ret
}
...
func (self class) AsNinePatchRect() Advanced {
	return Advanced{pointers.AsA[gdclass.NinePatchRect](self[0])}
}
func (self Instance) AsNinePatchRect() Instance {
	return Instance{pointers.AsA[gdclass.NinePatchRect](self[0])}
}
...
func init() {
	gdclass.Register("NinePatchRect", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.NinePatchRect](ptr)} })
}
