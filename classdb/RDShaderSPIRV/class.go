...
func (self class) AsObject() [1]gd.Object { return gdclass.GetRDShaderSPIRV(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetRDShaderSPIRV(self[0]) }
...
func (self class) AsRDShaderSPIRV() Advanced {
	return Advanced{gdclass.NewRDShaderSPIRV(self.AsObject()[0])}
}
func (self Instance) AsRDShaderSPIRV() Instance {
	return Instance{gdclass.NewRDShaderSPIRV(self.AsObject()[0])}
}
