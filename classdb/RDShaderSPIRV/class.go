...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDShaderSPIRV")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDShaderSPIRV{gdclass.NewRDShaderSPIRV(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
