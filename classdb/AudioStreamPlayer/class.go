...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlayer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlayer{gdclass.NewAudioStreamPlayer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
