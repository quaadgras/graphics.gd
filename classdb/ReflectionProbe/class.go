...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ReflectionProbe")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ReflectionProbe{gdclass.NewReflectionProbe(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
