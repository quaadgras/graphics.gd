...
It is possible to override the MultiplayerAPI instance used by specific tree branches by calling the [Instance.Scenetree.SetMultiplayer] method, effectively allowing to run both client and server in the same scene.
...
/*
Sends an RPC to the target 'peer'. The given 'method' will be called on the remote 'object' with the provided 'arguments'. The RPC may also be called locally depending on the implementation and RPC configuration. See [Instance.Node.Rpc] and [Instance.Node.RpcConfig].
Note: Prefer using [Instance.Node.Rpc], [Instance.Node.RpcId], or my_method.rpc(peer, arg1, arg2, ...) (in GDScript), since they are faster. This method is mostly useful in conjunction with [MultiplayerAPIExtension] when extending or replacing the multiplayer capabilities.
*/
...
/*
Returns the default MultiplayerAPI implementation class name. This is usually "SceneMultiplayer" when [SceneMultiplayer] is available. See [Instance.SetDefaultInterface].
*/
