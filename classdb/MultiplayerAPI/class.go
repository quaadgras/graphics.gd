...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MultiplayerAPI")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiplayerAPI{gdclass.NewMultiplayerAPI(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
