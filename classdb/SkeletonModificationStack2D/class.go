...
This resource also controls how strongly all of the modifications are applied to the [graphics.gd/classdb/Skeleton2D].
*/
...
/*
Sets up the modification stack so it can execute. This function should be called by [graphics.gd/classdb/Skeleton2D] and shouldn't be manually called unless you know what you are doing.
*/
...
/*
Executes all of the [graphics.gd/classdb/SkeletonModification2D]s in the stack that use the same execution mode as the passed-in 'execution_mode', starting from index 0 to [Instance.ModificationCount].
...
/*
Enables all [graphics.gd/classdb/SkeletonModification2D]s in the stack.
*/
...
/*
Deletes the [graphics.gd/classdb/SkeletonModification2D] at the index position 'mod_idx', if it exists.
*/
...
/*
Returns the [graphics.gd/classdb/SkeletonModification2D] at the passed-in index, 'mod_idx'.
*/
//go:nosplit
...
/*
Adds the passed-in [graphics.gd/classdb/SkeletonModification2D] to the stack.
*/
//go:nosplit
...
/*
Returns the [graphics.gd/classdb/Skeleton2D] node that the SkeletonModificationStack2D is bound to.
*/
//go:nosplit
