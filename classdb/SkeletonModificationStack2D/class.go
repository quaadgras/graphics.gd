...
/*
Executes all of the [SkeletonModification2D]s in the stack that use the same execution mode as the passed-in 'execution_mode', starting from index 0 to [member modification_count].
