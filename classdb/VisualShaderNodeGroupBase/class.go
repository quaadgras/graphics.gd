...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeGroupBase")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeGroupBase{gdclass.NewVisualShaderNodeGroupBase(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
