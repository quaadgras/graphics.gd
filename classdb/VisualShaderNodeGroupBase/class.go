...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeGroupBase{gdclass.NewVisualShaderNodeGroupBase(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
