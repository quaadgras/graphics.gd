...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FogMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FogMaterial{gdclass.NewFogMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
