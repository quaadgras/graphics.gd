...
func (self class) SetDensity(density float64) { //gd:FogMaterial.set_density
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_density, 0|(gdextension.SizeFloat<<4), &struct{ density float64 }{density})
}

//go:nosplit
func (self class) GetDensity() float64 { //gd:FogMaterial.get_density
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_density, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetHeightFalloff(height_falloff float64) { //gd:FogMaterial.set_height_falloff
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_height_falloff, 0|(gdextension.SizeFloat<<4), &struct{ height_falloff float64 }{height_falloff})
}

//go:nosplit
func (self class) GetHeightFalloff() float64 { //gd:FogMaterial.get_height_falloff
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_height_falloff, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetEdgeFade(edge_fade float64) { //gd:FogMaterial.set_edge_fade
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_edge_fade, 0|(gdextension.SizeFloat<<4), &struct{ edge_fade float64 }{edge_fade})
}

//go:nosplit
func (self class) GetEdgeFade() float64 { //gd:FogMaterial.get_edge_fade
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_edge_fade, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDensityTexture(density_texture [1]gdclass.Texture3D) { //gd:FogMaterial.set_density_texture
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_density_texture, 0|(gdextension.SizeObject<<4), &struct{ density_texture gdextension.Object }{gdextension.Object(gd.ObjectChecked(density_texture[0].AsObject()))})
}

//go:nosplit
func (self class) GetDensityTexture() [1]gdclass.Texture3D { //gd:FogMaterial.get_density_texture
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_density_texture, gdextension.SizeObject, &struct{}{})
