...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDSamplerState")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDSamplerState{gdclass.NewRDSamplerState(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
