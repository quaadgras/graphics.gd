...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamSynchronized{gdclass.NewAudioStreamSynchronized(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
