...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamSynchronized")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamSynchronized{gdclass.NewAudioStreamSynchronized(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
