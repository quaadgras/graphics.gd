...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeColorParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorParameter{gdclass.NewVisualShaderNodeColorParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
