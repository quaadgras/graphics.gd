...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeColorParameter"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorParameter{gdclass.NewVisualShaderNodeColorParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
