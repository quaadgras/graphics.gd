...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeColorParameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeColorParameter{pointers.Add[gdclass.VisualShaderNodeColorParameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorParameter{pointers.New[gdclass.VisualShaderNodeColorParameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetDefaultValue(value Color.RGBA) { //gd:VisualShaderNodeColorParameter.set_default_value
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeColor<<4), &struct{ value Color.RGBA }{value})
}

//go:nosplit
func (self class) GetDefaultValue() Color.RGBA { //gd:VisualShaderNodeColorParameter.get_default_value
	var r_ret = gdextension.Call[Color.RGBA](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeColor, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeColorParameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeColorParameter](self[0])}
}
func (self Instance) AsVisualShaderNodeColorParameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeColorParameter](self[0])}
}
func (self *Extension[T]) AsVisualShaderNodeColorParameter() Instance {
	return self.Super().AsVisualShaderNodeColorParameter()
}
...
func init() {
	gdclass.Register("VisualShaderNodeColorParameter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeColorParameter](ptr)} })
}
