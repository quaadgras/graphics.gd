...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorParameter{gdclass.NewVisualShaderNodeColorParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
