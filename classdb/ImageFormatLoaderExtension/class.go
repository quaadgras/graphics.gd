...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ImageFormatLoaderExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageFormatLoaderExtension{gdclass.NewImageFormatLoaderExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
