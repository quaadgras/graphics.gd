...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageFormatLoaderExtension{gdclass.NewImageFormatLoaderExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
