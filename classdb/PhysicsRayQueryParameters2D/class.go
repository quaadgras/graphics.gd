...
/*
Returns a new, pre-configured [graphics.gd/classdb/PhysicsRayQueryParameters2D] object. Use it to quickly create query parameters using the most common options.
*/
