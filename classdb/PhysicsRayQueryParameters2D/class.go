...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsRayQueryParameters2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsRayQueryParameters2D{gdclass.NewPhysicsRayQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
