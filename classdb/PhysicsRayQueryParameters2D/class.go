...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPhysicsRayQueryParameters2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPhysicsRayQueryParameters2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PhysicsRayQueryParameters2D{gdclass.NewPhysicsRayQueryParameters2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetPhysicsRayQueryParameters2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.PhysicsRayQueryParameters2D{gdclass.NewPhysicsRayQueryParameters2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) Create(from Vector2.XY, to Vector2.XY, collision_mask int64, exclude Array.Contains[RID.Any]) [1]gdclass.PhysicsRayQueryParameters2D { //gd:PhysicsRayQueryParameters2D.create
	...
	var ret = [1]gdclass.PhysicsRayQueryParameters2D{gdclass.NewPhysicsRayQueryParameters2D(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsPhysicsRayQueryParameters2D() Advanced {
	return Advanced{gdclass.NewPhysicsRayQueryParameters2D(self.AsObject()[0])}
}
func (self Instance) AsPhysicsRayQueryParameters2D() Instance {
	return Instance{gdclass.NewPhysicsRayQueryParameters2D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("PhysicsRayQueryParameters2D", func(ptr gd.Object) any { return Instance{gdclass.NewPhysicsRayQueryParameters2D(ptr)} })
}
