...
func New() Instance {
	...
	casted := Instance([1]gdclass.OptimizedTranslation{gdclass.NewOptimizedTranslation(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
