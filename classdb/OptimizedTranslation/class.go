...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OptimizedTranslation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OptimizedTranslation{gdclass.NewOptimizedTranslation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
