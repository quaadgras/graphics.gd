...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorDistance{gdclass.NewVisualShaderNodeVectorDistance(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
