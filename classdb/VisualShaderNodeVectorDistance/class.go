...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVectorDistance(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeVectorDistance(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVectorDistance{gdclass.NewVisualShaderNodeVectorDistance(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeVectorDistance(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorDistance{gdclass.NewVisualShaderNodeVectorDistance(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeVectorDistance() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVectorDistance(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVectorDistance() Instance {
	return Instance{gdclass.NewVisualShaderNodeVectorDistance(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeVectorDistance() Instance {
	return self.Super().AsVisualShaderNodeVectorDistance()
}
...
func init() {
	gdclass.Register("VisualShaderNodeVectorDistance", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorDistance(ptr)} })
}
