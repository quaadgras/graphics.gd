...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorDistance")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorDistance{gdclass.NewVisualShaderNodeVectorDistance(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
