...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionBox3D{gdclass.NewGPUParticlesCollisionBox3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
