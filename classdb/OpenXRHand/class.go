...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.OpenXRHand](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRHand{pointers.Add[gdclass.OpenXRHand]([3]uint64{})})
	...
	casted := Instance([1]gdclass.OpenXRHand{pointers.New[gdclass.OpenXRHand]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetHand(hand Hands) { //gd:OpenXRHand.set_hand
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_hand, 0|(gdextension.SizeInt<<4), &struct{ hand Hands }{hand})
}

//go:nosplit
func (self class) GetHand() Hands { //gd:OpenXRHand.get_hand
	var r_ret = mainthread.Call[Hands](gd.ObjectChecked(self.AsObject()), methods.get_hand, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetHandSkeleton(hand_skeleton Path.ToNode) { //gd:OpenXRHand.set_hand_skeleton
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_hand_skeleton, 0|(gdextension.SizeNodePath<<4), &struct{ hand_skeleton gdextension.NodePath }{pointers.Get(gd.InternalNodePath(hand_skeleton))})
}

//go:nosplit
func (self class) GetHandSkeleton() Path.ToNode { //gd:OpenXRHand.get_hand_skeleton
	var r_ret = mainthread.Call[gdextension.NodePath](gd.ObjectChecked(self.AsObject()), methods.get_hand_skeleton, gdextension.SizeNodePath, &struct{}{})
...
func (self class) SetMotionRange(motion_range MotionRange) { //gd:OpenXRHand.set_motion_range
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_motion_range, 0|(gdextension.SizeInt<<4), &struct{ motion_range MotionRange }{motion_range})
}

//go:nosplit
func (self class) GetMotionRange() MotionRange { //gd:OpenXRHand.get_motion_range
	var r_ret = mainthread.Call[MotionRange](gd.ObjectChecked(self.AsObject()), methods.get_motion_range, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSkeletonRig(skeleton_rig SkeletonRig) { //gd:OpenXRHand.set_skeleton_rig
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_skeleton_rig, 0|(gdextension.SizeInt<<4), &struct{ skeleton_rig SkeletonRig }{skeleton_rig})
}

//go:nosplit
func (self class) GetSkeletonRig() SkeletonRig { //gd:OpenXRHand.get_skeleton_rig
	var r_ret = mainthread.Call[SkeletonRig](gd.ObjectChecked(self.AsObject()), methods.get_skeleton_rig, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsOpenXRHand() Advanced { return Advanced{pointers.AsA[gdclass.OpenXRHand](self[0])} }
func (self Instance) AsOpenXRHand() Instance {
	return Instance{pointers.AsA[gdclass.OpenXRHand](self[0])}
}
...
func init() {
	gdclass.Register("OpenXRHand", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.OpenXRHand](ptr)} })
}
