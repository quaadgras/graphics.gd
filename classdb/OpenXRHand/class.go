...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRHand")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRHand{gdclass.NewOpenXRHand(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
