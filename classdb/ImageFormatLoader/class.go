...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ImageFormatLoader")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageFormatLoader{gdclass.NewImageFormatLoader(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
