...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeAnimation{gdclass.NewAnimationNodeAnimation(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
