...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeAnimation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeAnimation{gdclass.NewAnimationNodeAnimation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
