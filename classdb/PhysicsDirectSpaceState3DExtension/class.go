...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsDirectSpaceState3DExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsDirectSpaceState3DExtension{gdclass.NewPhysicsDirectSpaceState3DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
