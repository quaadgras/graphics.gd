...
/*
If true, the column will have the "Expand" flag of [Control]. Columns that have the "Expand" flag will use their expand ratio in a similar fashion to [member Control.size_flags_stretch_ratio] (see [Instance.SetColumnExpandRatio]).
*/
...
To tell whether a column of an item is selected, use [Instance.Treeitem.IsSelected].
*/
...
Either the item must be set editable with [Instance.Treeitem.SetEditable] or 'force_edit' must be true.
...
/*
Returns the rectangle for custom popups. Helper to create custom cell controls that display a popup. See [Instance.Treeitem.SetCellMode].
*/
