...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Tree")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Tree{gdclass.NewTree(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
