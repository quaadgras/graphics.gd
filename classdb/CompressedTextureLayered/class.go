...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTextureLayered{gdclass.NewCompressedTextureLayered(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
