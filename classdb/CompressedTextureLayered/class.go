...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CompressedTextureLayered")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTextureLayered{gdclass.NewCompressedTextureLayered(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
