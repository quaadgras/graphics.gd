...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCompressedTextureLayered(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCompressedTextureLayered(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedTextureLayered{gdclass.NewCompressedTextureLayered(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCompressedTextureLayered(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CompressedTextureLayered{gdclass.NewCompressedTextureLayered(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCompressedTextureLayered() Advanced {
	return Advanced{gdclass.NewCompressedTextureLayered(self.AsObject()[0])}
}
func (self Instance) AsCompressedTextureLayered() Instance {
	return Instance{gdclass.NewCompressedTextureLayered(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("CompressedTextureLayered", func(ptr gd.Object) any { return Instance{gdclass.NewCompressedTextureLayered(ptr)} })
}
