...
/*
Base class for [graphics.gd/classdb/CompressedTexture2DArray] and [graphics.gd/classdb/CompressedTexture3D]. Cannot be used directly, but contains all the functions necessary for accessing the derived resource types. See also [graphics.gd/classdb/TextureLayered].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CompressedTextureLayered](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedTextureLayered{pointers.Add[gdclass.CompressedTextureLayered]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CompressedTextureLayered{pointers.New[gdclass.CompressedTextureLayered]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsCompressedTextureLayered() Advanced {
	return Advanced{pointers.AsA[gdclass.CompressedTextureLayered](self[0])}
}
func (self Instance) AsCompressedTextureLayered() Instance {
	return Instance{pointers.AsA[gdclass.CompressedTextureLayered](self[0])}
}
func (self *Extension[T]) AsCompressedTextureLayered() Instance {
...
func init() {
	gdclass.Register("CompressedTextureLayered", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CompressedTextureLayered](ptr)} })
}
