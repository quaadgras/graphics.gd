...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("SkeletonModification2DLookAt"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DLookAt{gdclass.NewSkeletonModification2DLookAt(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
