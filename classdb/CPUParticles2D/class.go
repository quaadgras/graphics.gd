...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CPUParticles2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CPUParticles2D{gdclass.NewCPUParticles2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
