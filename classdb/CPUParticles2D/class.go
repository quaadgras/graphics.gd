...
func (self class) SetDirection(direction Vector2.XY) { //gd:CPUParticles2D.set_direction
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_direction, 0|(gdextension.SizeVector2<<4), &struct{ direction Vector2.XY }{direction})
}

//go:nosplit
func (self class) GetDirection() Vector2.XY { //gd:CPUParticles2D.get_direction
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_direction, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSpread(spread float64) { //gd:CPUParticles2D.set_spread
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_spread, 0|(gdextension.SizeFloat<<4), &struct{ spread float64 }{spread})
}
...
func (self class) SetEmissionRectExtents(extents Vector2.XY) { //gd:CPUParticles2D.set_emission_rect_extents
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_emission_rect_extents, 0|(gdextension.SizeVector2<<4), &struct{ extents Vector2.XY }{extents})
}

//go:nosplit
func (self class) GetEmissionRectExtents() Vector2.XY { //gd:CPUParticles2D.get_emission_rect_extents
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_emission_rect_extents, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetGravity() Vector2.XY { //gd:CPUParticles2D.get_gravity
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_gravity, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetGravity(accel_vec Vector2.XY) { //gd:CPUParticles2D.set_gravity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_gravity, 0|(gdextension.SizeVector2<<4), &struct{ accel_vec Vector2.XY }{accel_vec})
}
