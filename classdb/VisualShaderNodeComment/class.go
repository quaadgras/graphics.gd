...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeComment{gdclass.NewVisualShaderNodeComment(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
