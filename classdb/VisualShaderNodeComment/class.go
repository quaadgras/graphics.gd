...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeComment"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeComment{gdclass.NewVisualShaderNodeComment(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetDescription() String.Readable { //gd:VisualShaderNodeComment.get_description
	var r_ret = jumponly.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_description, gdextension.SizeString, &struct{}{})
