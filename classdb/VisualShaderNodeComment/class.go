...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeComment")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeComment{gdclass.NewVisualShaderNodeComment(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
