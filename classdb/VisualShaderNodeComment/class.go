...
/*
This node was replaced by [graphics.gd/classdb/VisualShaderNodeFrame] and only exists to preserve compatibility. In the [graphics.gd/classdb/VisualShader] editor it behaves exactly like [graphics.gd/classdb/VisualShaderNodeFrame].
*/
