...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CameraFeed")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CameraFeed{gdclass.NewCameraFeed(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
