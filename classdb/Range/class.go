...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Range")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Range{gdclass.NewRange(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
