...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureRect")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureRect{gdclass.NewTextureRect(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
