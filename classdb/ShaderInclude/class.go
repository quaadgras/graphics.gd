...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ShaderInclude")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShaderInclude{gdclass.NewShaderInclude(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
