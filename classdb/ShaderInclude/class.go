...
/*
A shader include file, saved with the .gdshaderinc extension. This class allows you to define a custom shader snippet that can be included in a [graphics.gd/classdb/Shader] by using the preprocessor directive #include, followed by the file path (e.g. #include "res://shader_lib.gdshaderinc"). The snippet doesn't have to be a valid shader on its own.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ShaderInclude](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ShaderInclude{pointers.Add[gdclass.ShaderInclude]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ShaderInclude{pointers.New[gdclass.ShaderInclude]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsShaderInclude() Advanced {
	return Advanced{pointers.AsA[gdclass.ShaderInclude](self[0])}
}
func (self Instance) AsShaderInclude() Instance {
	return Instance{pointers.AsA[gdclass.ShaderInclude](self[0])}
}
...
func init() {
	gdclass.Register("ShaderInclude", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ShaderInclude](ptr)} })
}
