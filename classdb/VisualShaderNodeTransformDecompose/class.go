...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformDecompose{gdclass.NewVisualShaderNodeTransformDecompose(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
