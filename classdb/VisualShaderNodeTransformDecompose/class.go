...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTransformDecompose")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformDecompose{gdclass.NewVisualShaderNodeTransformDecompose(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
