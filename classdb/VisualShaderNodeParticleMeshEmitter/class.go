...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleMeshEmitter{gdclass.NewVisualShaderNodeParticleMeshEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
