...
/*
[graphics.gd/classdb/VisualShaderNodeParticleEmitter] that makes the particles emitted in a shape of the assigned [Instance.Mesh]. It will emit from the mesh's surfaces, either all or only the specified one.
*/
