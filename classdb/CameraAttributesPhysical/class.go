...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCameraAttributesPhysical(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCameraAttributesPhysical(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CameraAttributesPhysical{gdclass.NewCameraAttributesPhysical(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCameraAttributesPhysical(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CameraAttributesPhysical{gdclass.NewCameraAttributesPhysical(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCameraAttributesPhysical() Advanced {
	return Advanced{gdclass.NewCameraAttributesPhysical(self.AsObject()[0])}
}
func (self Instance) AsCameraAttributesPhysical() Instance {
	return Instance{gdclass.NewCameraAttributesPhysical(self.AsObject()[0])}
}
...
func (self class) AsCameraAttributes() CameraAttributes.Advanced {
	return CameraAttributes.Advanced{gdclass.NewCameraAttributes(self.AsObject()[0])}
}
...
func (self Instance) AsCameraAttributes() CameraAttributes.Instance {
	return CameraAttributes.Instance{gdclass.NewCameraAttributes(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("CameraAttributesPhysical", func(ptr gd.Object) any { return Instance{gdclass.NewCameraAttributesPhysical(ptr)} })
}
