...
func New() Instance {
	...
	casted := Instance([1]gdclass.CameraAttributesPhysical{gdclass.NewCameraAttributesPhysical(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
