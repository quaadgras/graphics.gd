...
/*
MeshInstance3D is a node that takes a [graphics.gd/classdb/Mesh] resource and adds it to the current scenario by creating an instance of it. This is the class most often used to render 3D geometry and can be used to instance a single [graphics.gd/classdb/Mesh] in many places. This allows reusing geometry, which can save on resources. When a [graphics.gd/classdb/Mesh] has to be instantiated more than thousands of times at close proximity, consider using a [graphics.gd/classdb/MultiMesh] in a [graphics.gd/classdb/MultiMeshInstance3D] instead.
*/
...
/*
Returns the internal [graphics.gd/classdb/SkinReference] containing the skeleton's [Resource.ID] attached to this RID. See also [graphics.gd/classdb/Resource.Instance.GetRid], [graphics.gd/classdb/SkinReference.Instance.GetSkeleton], and [graphics.gd/classdb/RenderingServer.InstanceAttachSkeleton].
*/
...
/*
Returns the number of surface override materials. This is equivalent to [graphics.gd/classdb/Mesh.Instance.GetSurfaceCount]. See also [Instance.GetSurfaceOverrideMaterial].
*/
...
/*
Sets the override 'material' for the specified 'surface' of the [graphics.gd/classdb/Mesh] resource. This material is associated with this [graphics.gd/classdb/MeshInstance3D] rather than with [Instance.Mesh].

Note: This assigns the [graphics.gd/classdb/Material] associated to the [graphics.gd/classdb/MeshInstance3D]'s Surface Material Override properties, not the material within the [graphics.gd/classdb/Mesh] resource. To set the material within the [graphics.gd/classdb/Mesh] resource, use [graphics.gd/classdb/Mesh.Instance.SurfaceSetMaterial] instead.
*/
...
/*
Returns the override [graphics.gd/classdb/Material] for the specified 'surface' of the [graphics.gd/classdb/Mesh] resource. See also [Instance.GetSurfaceOverrideMaterialCount].

Note: This returns the [graphics.gd/classdb/Material] associated to the [graphics.gd/classdb/MeshInstance3D]'s Surface Material Override properties, not the material within the [graphics.gd/classdb/Mesh] resource. To get the material within the [graphics.gd/classdb/Mesh] resource, use [graphics.gd/classdb/Mesh.Instance.SurfaceGetMaterial] instead.
*/
...
/*
Returns the [graphics.gd/classdb/Material] that will be used by the [graphics.gd/classdb/Mesh] when drawing. This can return the [graphics.gd/classdb/GeometryInstance3D.Instance.MaterialOverride], the surface override [graphics.gd/classdb/Material] defined in this [graphics.gd/classdb/MeshInstance3D], or the surface [graphics.gd/classdb/Material] defined in the [Instance.Mesh]. For example, if [graphics.gd/classdb/GeometryInstance3D.Instance.MaterialOverride] is used, all surfaces will return the override material.

Returns null if no material is active, including when [Instance.Mesh] is null.
*/
...
/*
This helper creates a [graphics.gd/classdb/StaticBody3D] child node with a [graphics.gd/classdb/ConcavePolygonShape3D] collision shape calculated from the mesh geometry. It's mainly used for testing.
*/
...
/*
This helper creates a [graphics.gd/classdb/StaticBody3D] child node with a [graphics.gd/classdb/ConvexPolygonShape3D] collision shape calculated from the mesh geometry. It's mainly used for testing.
...
/*
This helper creates a [graphics.gd/classdb/StaticBody3D] child node with multiple [graphics.gd/classdb/ConvexPolygonShape3D] collision shapes calculated from the mesh geometry via convex decomposition. The convex decomposition operation can be controlled with parameters from the optional 'settings'.
*/
...
/*
Returns the number of blend shapes available. Produces an error if [Instance.Mesh] is null.
*/
...
/*
Returns the index of the blend shape with the given 'name'. Returns -1 if no blend shape with this name exists, including when [Instance.Mesh] is null.
*/
...
/*
Returns the value of the blend shape at the given 'blend_shape_idx'. Returns 0.0 and produces an error if [Instance.Mesh] is null or doesn't have a blend shape at that index.
*/
...
/*
Sets the value of the blend shape at 'blend_shape_idx' to 'value'. Produces an error if [Instance.Mesh] is null or doesn't have a blend shape at that index.
*/
...
/*
This helper creates a [graphics.gd/classdb/MeshInstance3D] child node with gizmos at every vertex calculated from the mesh geometry. It's mainly used for testing.
*/
...
/*
Takes a snapshot from the current [graphics.gd/classdb/ArrayMesh] with all blend shapes applied according to their current weights and bakes it to the provided 'existing' mesh. If no 'existing' mesh is provided a new [graphics.gd/classdb/ArrayMesh] is created, baked and returned. Mesh surface materials are not copied.

Performance: [graphics.gd/classdb/Mesh] data needs to be received from the GPU, stalling the [graphics.gd/classdb/RenderingServer] in the process.
*/
...
/*
Takes a snapshot of the current animated skeleton pose of the skinned mesh and bakes it to the provided 'existing' mesh. If no 'existing' mesh is provided a new [graphics.gd/classdb/ArrayMesh] is created, baked, and returned. Requires a skeleton with a registered skin to work. Blendshapes are ignored. Mesh surface materials are not copied.

Performance: [graphics.gd/classdb/Mesh] data needs to be retrieved from the GPU, stalling the [graphics.gd/classdb/RenderingServer] in the process.
*/
...
func (self class) SetSkeletonPath(skeleton_path Path.ToNode) { //gd:MeshInstance3D.set_skeleton_path
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_skeleton_path, 0|(gdextension.SizeNodePath<<4), &struct{ skeleton_path gdextension.NodePath }{pointers.Get(gd.InternalNodePath(skeleton_path))})
}

//go:nosplit
func (self class) GetSkeletonPath() Path.ToNode { //gd:MeshInstance3D.get_skeleton_path
	var r_ret = gdextension.Call[gdextension.NodePath](gd.ObjectChecked(self.AsObject()), methods.get_skeleton_path, gdextension.SizeNodePath, &struct{}{})
...
func (self class) SetSkin(skin [1]gdclass.Skin) { //gd:MeshInstance3D.set_skin
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_skin, 0|(gdextension.SizeObject<<4), &struct{ skin gdextension.Object }{gdextension.Object(gd.ObjectChecked(skin[0].AsObject()))})
}
...
func (self class) GetSkinReference() [1]gdclass.SkinReference { //gd:MeshInstance3D.get_skin_reference
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_skin_reference, gdextension.SizeObject, &struct{}{})
...
func (self class) GetSurfaceOverrideMaterialCount() int64 { //gd:MeshInstance3D.get_surface_override_material_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_surface_override_material_count, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSurfaceOverrideMaterial(surface int64, material [1]gdclass.Material) { //gd:MeshInstance3D.set_surface_override_material
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_surface_override_material, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct {
		surface  int64
...
func (self class) GetSurfaceOverrideMaterial(surface int64) [1]gdclass.Material { //gd:MeshInstance3D.get_surface_override_material
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_surface_override_material, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ surface int64 }{surface})
...
func (self class) GetActiveMaterial(surface int64) [1]gdclass.Material { //gd:MeshInstance3D.get_active_material
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_active_material, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ surface int64 }{surface})
	var ret = [1]gdclass.Material{gd.PointerWithOwnershipTransferredToGo[gdclass.Material](r_ret)}
	return ret
}
...
func (self class) CreateTrimeshCollision() { //gd:MeshInstance3D.create_trimesh_collision
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.create_trimesh_collision, 0, &struct{}{})
}
...
func (self class) CreateConvexCollision(clean bool, simplify bool) { //gd:MeshInstance3D.create_convex_collision
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.create_convex_collision, 0|(gdextension.SizeBool<<4)|(gdextension.SizeBool<<8), &struct {
		clean    bool
		simplify bool
	}{clean, simplify})
}
...
func (self class) CreateMultipleConvexCollisions(settings [1]gdclass.MeshConvexDecompositionSettings) { //gd:MeshInstance3D.create_multiple_convex_collisions
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.create_multiple_convex_collisions, 0|(gdextension.SizeObject<<4), &struct{ settings gdextension.Object }{gdextension.Object(gd.ObjectChecked(settings[0].AsObject()))})
}
...
func (self class) FindBlendShapeByName(name String.Name) int64 { //gd:MeshInstance3D.find_blend_shape_by_name
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.find_blend_shape_by_name, gdextension.SizeInt|(gdextension.SizeStringName<<4), &struct{ name gdextension.StringName }{pointers.Get(gd.InternalStringName(name))})
	var ret = r_ret
	return ret
}
...
func (self class) GetBlendShapeValue(blend_shape_idx int64) float64 { //gd:MeshInstance3D.get_blend_shape_value
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_blend_shape_value, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ blend_shape_idx int64 }{blend_shape_idx})
	var ret = r_ret
	return ret
}
...
func (self class) SetBlendShapeValue(blend_shape_idx int64, value float64) { //gd:MeshInstance3D.set_blend_shape_value
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_blend_shape_value, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
...
func (self class) CreateDebugTangents() { //gd:MeshInstance3D.create_debug_tangents
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.create_debug_tangents, 0, &struct{}{})
}
...
func (self class) BakeMeshFromCurrentBlendShapeMix(existing [1]gdclass.ArrayMesh) [1]gdclass.ArrayMesh { //gd:MeshInstance3D.bake_mesh_from_current_blend_shape_mix
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.bake_mesh_from_current_blend_shape_mix, gdextension.SizeObject|(gdextension.SizeObject<<4), &struct{ existing gdextension.Object }{gdextension.Object(gd.ObjectChecked(existing[0].AsObject()))})
...
func (self class) BakeMeshFromCurrentSkeletonPose(existing [1]gdclass.ArrayMesh) [1]gdclass.ArrayMesh { //gd:MeshInstance3D.bake_mesh_from_current_skeleton_pose
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.bake_mesh_from_current_skeleton_pose, gdextension.SizeObject|(gdextension.SizeObject<<4), &struct{ existing gdextension.Object }{gdextension.Object(gd.ObjectChecked(existing[0].AsObject()))})
	var ret = [1]gdclass.ArrayMesh{gd.PointerWithOwnershipTransferredToGo[gdclass.ArrayMesh](r_ret)}
	return ret
}
