...
/*
Returns the internal [SkinReference] containing the skeleton's [RID] attached to this RID. See also [Instance.Resource.GetRid], [Instance.Skinreference.GetSkeleton], and [Instance.Renderingserver.InstanceAttachSkeleton].
*/
...
/*
Returns the number of surface override materials. This is equivalent to [Instance.Mesh.GetSurfaceCount]. See also [Instance.GetSurfaceOverrideMaterial].
*/
...
/*
Sets the override 'material' for the specified 'surface' of the [Mesh] resource. This material is associated with this [MeshInstance3D] rather than with [member mesh].
Note: This assigns the [Material] associated to the [MeshInstance3D]'s Surface Material Override properties, not the material within the [Mesh] resource. To set the material within the [Mesh] resource, use [Instance.Mesh.SurfaceSetMaterial] instead.
*/
...
/*
Returns the override [Material] for the specified 'surface' of the [Mesh] resource. See also [Instance.GetSurfaceOverrideMaterialCount].
Note: This returns the [Material] associated to the [MeshInstance3D]'s Surface Material Override properties, not the material within the [Mesh] resource. To get the material within the [Mesh] resource, use [Instance.Mesh.SurfaceGetMaterial] instead.
*/
...
/*
Returns the index of the blend shape with the given 'name'. Returns -1 if no blend shape with this name exists, including when [member mesh] is null.
*/
...
/*
Returns the value of the blend shape at the given 'blend_shape_idx'. Returns 0.0 and produces an error if [member mesh] is null or doesn't have a blend shape at that index.
*/
...
/*
Sets the value of the blend shape at 'blend_shape_idx' to 'value'. Produces an error if [member mesh] is null or doesn't have a blend shape at that index.
*/
