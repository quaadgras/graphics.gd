...
This importer is only used if [member ProjectSettings.filesystem/import/fbx2gltf/enabled] is set to true.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.EditorSceneFormatImporterFBX2GLTF](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorSceneFormatImporterFBX2GLTF{pointers.Add[gdclass.EditorSceneFormatImporterFBX2GLTF]([3]uint64{})})
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterFBX2GLTF{pointers.New[gdclass.EditorSceneFormatImporterFBX2GLTF]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsEditorSceneFormatImporterFBX2GLTF() Advanced {
	return Advanced{pointers.AsA[gdclass.EditorSceneFormatImporterFBX2GLTF](self[0])}
}
func (self Instance) AsEditorSceneFormatImporterFBX2GLTF() Instance {
	return Instance{pointers.AsA[gdclass.EditorSceneFormatImporterFBX2GLTF](self[0])}
}
func (self *Extension[T]) AsEditorSceneFormatImporterFBX2GLTF() Instance {
	return self.Super().AsEditorSceneFormatImporterFBX2GLTF()
}
...
func init() {
	gdclass.Register("EditorSceneFormatImporterFBX2GLTF", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.EditorSceneFormatImporterFBX2GLTF](ptr)} })
}
