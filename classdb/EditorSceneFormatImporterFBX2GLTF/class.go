...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetEditorSceneFormatImporterFBX2GLTF(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorSceneFormatImporterFBX2GLTF{gdclass.NewEditorSceneFormatImporterFBX2GLTF(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetEditorSceneFormatImporterFBX2GLTF(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterFBX2GLTF{gdclass.NewEditorSceneFormatImporterFBX2GLTF(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsEditorSceneFormatImporterFBX2GLTF() Advanced {
	return Advanced{gdclass.NewEditorSceneFormatImporterFBX2GLTF(self.AsObject()[0])}
}
func (self Instance) AsEditorSceneFormatImporterFBX2GLTF() Instance {
	return Instance{gdclass.NewEditorSceneFormatImporterFBX2GLTF(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("EditorSceneFormatImporterFBX2GLTF", func(ptr gd.Object) any { return Instance{gdclass.NewEditorSceneFormatImporterFBX2GLTF(ptr)} })
}
