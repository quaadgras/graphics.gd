...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterFBX2GLTF{gdclass.NewEditorSceneFormatImporterFBX2GLTF(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
