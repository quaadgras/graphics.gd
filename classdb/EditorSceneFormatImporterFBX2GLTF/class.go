...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSceneFormatImporterFBX2GLTF")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterFBX2GLTF{gdclass.NewEditorSceneFormatImporterFBX2GLTF(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
