...
func New() Instance {
	...
	casted := Instance([1]gdclass.MeshConvexDecompositionSettings{gdclass.NewMeshConvexDecompositionSettings(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
