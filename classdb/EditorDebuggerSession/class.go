...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorDebuggerSession")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorDebuggerSession{gdclass.NewEditorDebuggerSession(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
