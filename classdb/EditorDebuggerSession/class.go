...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorDebuggerSession{gdclass.NewEditorDebuggerSession(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
