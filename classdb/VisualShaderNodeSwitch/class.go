...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSwitch{gdclass.NewVisualShaderNodeSwitch(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
