...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeSwitch")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSwitch{gdclass.NewVisualShaderNodeSwitch(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
