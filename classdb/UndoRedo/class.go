...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("UndoRedo")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.UndoRedo{gdclass.NewUndoRedo(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
