...
/*
An obstacle needs a navigation map and outline [Instance.Vertices] defined to work correctly. The outlines can not cross or overlap.

Obstacles can be included in the navigation mesh baking process when [Instance.AffectNavigationMesh] is enabled. They do not add walkable geometry, instead their role is to discard other source geometry inside the shape. This can be used to prevent navigation mesh from appearing in unwanted places. If [Instance.CarveNavigationMesh] is enabled the baked shape will not be affected by offsets of the navigation mesh baking, e.g. the agent radius.
...
/*
Returns the [Resource.ID] of this obstacle on the [graphics.gd/classdb/NavigationServer2D].
*/
