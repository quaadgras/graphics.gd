...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationObstacle2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationObstacle2D{gdclass.NewNavigationObstacle2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
