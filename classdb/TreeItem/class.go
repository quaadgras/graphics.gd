...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TreeItem")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TreeItem{gdclass.NewTreeItem(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
