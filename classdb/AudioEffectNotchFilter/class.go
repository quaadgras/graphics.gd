...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectNotchFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectNotchFilter{gdclass.NewAudioEffectNotchFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
