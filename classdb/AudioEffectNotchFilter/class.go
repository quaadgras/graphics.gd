...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectNotchFilter{gdclass.NewAudioEffectNotchFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
