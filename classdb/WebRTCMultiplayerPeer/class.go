...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebRTCMultiplayerPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCMultiplayerPeer{gdclass.NewWebRTCMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
