...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCMultiplayerPeer{gdclass.NewWebRTCMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
