...
You can add each [graphics.gd/classdb/WebRTCPeerConnection] via [Instance.AddPeer] or remove them via [Instance.RemovePeer]. Peers must be added in [Webrtcpeerconnection.StateNew] state to allow it to create the appropriate channels. This class will not create offers nor set descriptions, it will only poll them, and notify connections and disconnections.

When creating the peer via [Instance.CreateClient] or [Instance.CreateServer] the [graphics.gd/classdb/MultiplayerPeer.Instance.IsServerRelaySupported] method will return true enabling peer exchange and packet relaying when supported by the [graphics.gd/classdb/MultiplayerAPI] implementation.
...
/*
Initialize the multiplayer peer as a server (with unique ID of 1). This mode enables [graphics.gd/classdb/MultiplayerPeer.Instance.IsServerRelaySupported], allowing the upper [graphics.gd/classdb/MultiplayerAPI] layer to perform peer exchange and packet relaying.
...
/*
Initialize the multiplayer peer as a client with the given 'peer_id' (must be between 2 and 2147483647). In this mode, you should only call [Instance.AddPeer] once and with 'peer_id' of 1. This mode enables [graphics.gd/classdb/MultiplayerPeer.Instance.IsServerRelaySupported], allowing the upper [graphics.gd/classdb/MultiplayerAPI] layer to perform peer exchange and packet relaying.
...
/*
Add a new peer to the mesh with the given 'peer_id'. The [graphics.gd/classdb/WebRTCPeerConnection] must be in state [Webrtcpeerconnection.StateNew].

Three channels will be created for reliable, unreliable, and ordered transport. The value of 'unreliable_lifetime' will be passed to the "maxPacketLifetime" option when creating unreliable and ordered channels (see [graphics.gd/classdb/WebRTCPeerConnection.Instance.CreateDataChannel]).
*/
...
/*
Remove the peer with given 'peer_id' from the mesh. If the peer was connected, and [Instance.OnMultiplayerpeer.PeerConnected] was emitted for it, then [Instance.OnMultiplayerpeer.PeerDisconnected] will be emitted.
*/
...
/*
Returns a dictionary representation of the peer with given 'peer_id' with three keys. "connection" containing the [graphics.gd/classdb/WebRTCPeerConnection] to this peer, "channels" an array of three [graphics.gd/classdb/WebRTCDataChannel], and "connected" a boolean representing if the peer connection is currently connected (all three channels are open).
*/
...
/*
Returns a dictionary which keys are the peer ids and values the peer representation as in [Instance.GetPeer].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.WebRTCMultiplayerPeer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.WebRTCMultiplayerPeer{pointers.Add[gdclass.WebRTCMultiplayerPeer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.WebRTCMultiplayerPeer{pointers.New[gdclass.WebRTCMultiplayerPeer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) CreateServer(channels_config Array.Any) Error.Code { //gd:WebRTCMultiplayerPeer.create_server
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.create_server, gdextension.SizeInt|(gdextension.SizeArray<<4), &struct{ channels_config gdextension.Array }{pointers.Get(gd.InternalArray(channels_config))})
...
func (self class) CreateClient(peer_id int64, channels_config Array.Any) Error.Code { //gd:WebRTCMultiplayerPeer.create_client
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.create_client, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeArray<<8), &struct {
		peer_id         int64
...
func (self class) CreateMesh(peer_id int64, channels_config Array.Any) Error.Code { //gd:WebRTCMultiplayerPeer.create_mesh
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.create_mesh, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeArray<<8), &struct {
		peer_id         int64
		channels_config gdextension.Array
	}{peer_id, pointers.Get(gd.InternalArray(channels_config))})
	var ret = Error.Code(r_ret)
...
func (self class) AddPeer(peer [1]gdclass.WebRTCPeerConnection, peer_id int64, unreliable_lifetime int64) Error.Code { //gd:WebRTCMultiplayerPeer.add_peer
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.add_peer, gdextension.SizeInt|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12), &struct {
...
func (self class) RemovePeer(peer_id int64) { //gd:WebRTCMultiplayerPeer.remove_peer
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.remove_peer, 0|(gdextension.SizeInt<<4), &struct{ peer_id int64 }{peer_id})
}
...
func (self class) HasPeer(peer_id int64) bool { //gd:WebRTCMultiplayerPeer.has_peer
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_peer, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ peer_id int64 }{peer_id})
	var ret = r_ret
	return ret
}
...
func (self class) GetPeer(peer_id int64) Dictionary.Any { //gd:WebRTCMultiplayerPeer.get_peer
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.get_peer, gdextension.SizeDictionary|(gdextension.SizeInt<<4), &struct{ peer_id int64 }{peer_id})
...
func (self class) GetPeers() Dictionary.Any { //gd:WebRTCMultiplayerPeer.get_peers
	var r_ret = gdextension.Call[gdextension.Dictionary](gd.ObjectChecked(self.AsObject()), methods.get_peers, gdextension.SizeDictionary, &struct{}{})
	var ret = Dictionary.Through(gd.DictionaryProxy[variant.Any, variant.Any]{}, pointers.Pack(pointers.New[gd.Dictionary](r_ret)))
	return ret
}
func (self class) AsWebRTCMultiplayerPeer() Advanced {
	return Advanced{pointers.AsA[gdclass.WebRTCMultiplayerPeer](self[0])}
}
func (self Instance) AsWebRTCMultiplayerPeer() Instance {
	return Instance{pointers.AsA[gdclass.WebRTCMultiplayerPeer](self[0])}
}
...
func init() {
	gdclass.Register("WebRTCMultiplayerPeer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.WebRTCMultiplayerPeer](ptr)} })
}
