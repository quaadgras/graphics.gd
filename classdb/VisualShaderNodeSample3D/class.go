...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSample3D{gdclass.NewVisualShaderNodeSample3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
