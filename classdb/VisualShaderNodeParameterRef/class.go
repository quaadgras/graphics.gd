...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameterRef{gdclass.NewVisualShaderNodeParameterRef(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
