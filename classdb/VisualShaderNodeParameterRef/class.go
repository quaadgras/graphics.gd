...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeParameterRef"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameterRef{gdclass.NewVisualShaderNodeParameterRef(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
