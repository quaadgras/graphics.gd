...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeParameterRef](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParameterRef{pointers.Add[gdclass.VisualShaderNodeParameterRef]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameterRef{pointers.New[gdclass.VisualShaderNodeParameterRef]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeParameterRef() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeParameterRef](self[0])}
}
func (self Instance) AsVisualShaderNodeParameterRef() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeParameterRef](self[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParameterRef() Instance {
	return self.Super().AsVisualShaderNodeParameterRef()
}
...
func init() {
	gdclass.Register("VisualShaderNodeParameterRef", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeParameterRef](ptr)} })
}
