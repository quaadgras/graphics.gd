...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParameterRef")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameterRef{gdclass.NewVisualShaderNodeParameterRef(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
