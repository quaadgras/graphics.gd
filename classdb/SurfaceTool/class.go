...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SurfaceTool")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SurfaceTool{gdclass.NewSurfaceTool(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
