...
/*
Generates normals from vertices so you do not have to do it manually. If 'flip' is true, the resulting normals will be inverted. [Instance.GenerateNormals] should be called [i]after[/i] generating geometry and [i]before[/i] committing the mesh using [Instance.Commit] or [Instance.CommitToArrays]. For correct display of normal-mapped surfaces, you will also have to generate tangents using [Instance.GenerateTangents].
...
/*
Creates this SurfaceTool from existing vertex arrays such as returned by [Instance.CommitToArrays], [Instance.Mesh.SurfaceGetArrays], [Instance.Mesh.SurfaceGetBlendShapeArrays], [Instance.Importermesh.GetSurfaceArrays], and [Instance.Importermesh.GetSurfaceBlendShapeArrays]. 'primitive_type' controls the type of mesh data, defaulting to [Mesh.PrimitiveTriangles].
*/
...
/*
Commits the data to the same format used by [Instance.Arraymesh.AddSurfaceFromArrays], [Instance.Importermesh.AddSurface], and [Instance.CreateFromArrays]. This way you can further process the mesh data using the [ArrayMesh] or [ImporterMesh] APIs.
*/
