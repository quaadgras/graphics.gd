...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceFormatLoader")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceFormatLoader{gdclass.NewResourceFormatLoader(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
