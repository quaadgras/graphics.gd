...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceFormatLoader(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceFormatLoader(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceFormatLoader{gdclass.NewResourceFormatLoader(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceFormatLoader(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceFormatLoader{gdclass.NewResourceFormatLoader(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsResourceFormatLoader() Advanced {
	return Advanced{gdclass.NewResourceFormatLoader(self.AsObject()[0])}
}
func (self Instance) AsResourceFormatLoader() Instance {
	return Instance{gdclass.NewResourceFormatLoader(self.AsObject()[0])}
}
...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_handles_type":
		return gd.ValueOf(self._handles_type)
	case "_get_resource_type":
		return gd.ValueOf(self._get_resource_type)
	case "_get_resource_script_class":
		return gd.ValueOf(self._get_resource_script_class)
	case "_get_resource_uid":
		return gd.ValueOf(self._get_resource_uid)
	case "_get_dependencies":
		return gd.ValueOf(self._get_dependencies)
	case "_rename_dependencies":
		return gd.ValueOf(self._rename_dependencies)
	case "_exists":
		return gd.ValueOf(self._exists)
	case "_get_classes_used":
		return gd.ValueOf(self._get_classes_used)
	case "_load":
		return gd.ValueOf(self._load)
	default:
