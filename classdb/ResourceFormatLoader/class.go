...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceFormatLoader{gdclass.NewResourceFormatLoader(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
