...
/*
Turning on the option Load As Placeholder for an instantiated scene in the editor causes it to be replaced by an [InstancePlaceholder] when running the game, this will not replace the node in the editor. This makes it possible to delay actually loading the scene until calling [Instance.CreateInstance]. This is useful to avoid loading large scenes all at once by loading parts of it selectively.
...
Note: [Instance.CreateInstance] is not thread-safe. Use [Instance.Object.CallDeferred] if calling from a thread.
*/
...
/*
Gets the path to the [PackedScene] resource file that is loaded by default when calling [Instance.CreateInstance]. Not thread-safe. Use [Instance.Object.CallDeferred] if calling from a thread.
*/
