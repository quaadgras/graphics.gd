...
func (self class) AsObject() [1]gd.Object { return gdclass.GetInstancePlaceholder(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetInstancePlaceholder(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InstancePlaceholder{gdclass.NewInstancePlaceholder(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetInstancePlaceholder(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.InstancePlaceholder{gdclass.NewInstancePlaceholder(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsInstancePlaceholder() Advanced {
	return Advanced{gdclass.NewInstancePlaceholder(self.AsObject()[0])}
}
func (self Instance) AsInstancePlaceholder() Instance {
	return Instance{gdclass.NewInstancePlaceholder(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("InstancePlaceholder", func(ptr gd.Object) any { return Instance{gdclass.NewInstancePlaceholder(ptr)} })
}
