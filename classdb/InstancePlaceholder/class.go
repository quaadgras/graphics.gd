...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InstancePlaceholder")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InstancePlaceholder{gdclass.NewInstancePlaceholder(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
