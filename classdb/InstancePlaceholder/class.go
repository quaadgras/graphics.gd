...
func New() Instance {
	...
	casted := Instance([1]gdclass.InstancePlaceholder{gdclass.NewInstancePlaceholder(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
