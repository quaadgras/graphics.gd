...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("IKModifier3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.IKModifier3D{gdclass.NewIKModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
