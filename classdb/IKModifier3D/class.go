...
func (self class) AsObject() [1]gd.Object { return gdclass.GetIKModifier3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetIKModifier3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.IKModifier3D{gdclass.NewIKModifier3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetIKModifier3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.IKModifier3D{gdclass.NewIKModifier3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsIKModifier3D() Advanced {
	return Advanced{gdclass.NewIKModifier3D(self.AsObject()[0])}
}
func (self Instance) AsIKModifier3D() Instance {
	return Instance{gdclass.NewIKModifier3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsIKModifier3D() Instance { return self.Super().AsIKModifier3D() }
...
func init() {
	gdclass.Register("IKModifier3D", func(ptr gd.Object) any { return Instance{gdclass.NewIKModifier3D(ptr)} })
}
