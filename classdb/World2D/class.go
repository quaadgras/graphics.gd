...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("World2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.World2D{gdclass.NewWorld2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
