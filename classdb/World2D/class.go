...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.World2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.World2D{pointers.Add[gdclass.World2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.World2D{pointers.New[gdclass.World2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) GetSpace() RID.Any { //gd:World2D.get_space
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_space, gdextension.SizeRID, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetDirectSpaceState() [1]gdclass.PhysicsDirectSpaceState2D { //gd:World2D.get_direct_space_state
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_direct_space_state, gdextension.SizeObject, &struct{}{})
	var ret = [1]gdclass.PhysicsDirectSpaceState2D{gd.PointerMustAssertInstanceID[gdclass.PhysicsDirectSpaceState2D](r_ret)}
	return ret
}
func (self class) AsWorld2D() Advanced         { return Advanced{pointers.AsA[gdclass.World2D](self[0])} }
func (self Instance) AsWorld2D() Instance      { return Instance{pointers.AsA[gdclass.World2D](self[0])} }
...
func init() {
	gdclass.Register("World2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.World2D](ptr)} })
}
