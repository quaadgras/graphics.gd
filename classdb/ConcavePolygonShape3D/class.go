...
func (self class) AsObject() [1]gd.Object { return gdclass.GetConcavePolygonShape3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetConcavePolygonShape3D(self[0]) }
...
func (self class) AsConcavePolygonShape3D() Advanced {
	return Advanced{gdclass.NewConcavePolygonShape3D(self.AsObject()[0])}
}
func (self Instance) AsConcavePolygonShape3D() Instance {
	return Instance{gdclass.NewConcavePolygonShape3D(self.AsObject()[0])}
}
