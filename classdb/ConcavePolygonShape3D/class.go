...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConcavePolygonShape3D{gdclass.NewConcavePolygonShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
