...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ConcavePolygonShape3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ConcavePolygonShape3D{pointers.Add[gdclass.ConcavePolygonShape3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ConcavePolygonShape3D{pointers.New[gdclass.ConcavePolygonShape3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetFaces(faces Packed.Array[Vector3.XYZ]) { //gd:ConcavePolygonShape3D.set_faces
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_faces, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) SetBackfaceCollisionEnabled(enabled bool) { //gd:ConcavePolygonShape3D.set_backface_collision_enabled
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_backface_collision_enabled, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsBackfaceCollisionEnabled() bool { //gd:ConcavePolygonShape3D.is_backface_collision_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_backface_collision_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsConcavePolygonShape3D() Advanced {
	return Advanced{pointers.AsA[gdclass.ConcavePolygonShape3D](self[0])}
}
func (self Instance) AsConcavePolygonShape3D() Instance {
	return Instance{pointers.AsA[gdclass.ConcavePolygonShape3D](self[0])}
}
...
func init() {
	gdclass.Register("ConcavePolygonShape3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ConcavePolygonShape3D](ptr)} })
}
