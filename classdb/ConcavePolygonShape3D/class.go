...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConcavePolygonShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConcavePolygonShape3D{gdclass.NewConcavePolygonShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
