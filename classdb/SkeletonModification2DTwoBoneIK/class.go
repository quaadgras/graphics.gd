...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DTwoBoneIK{gdclass.NewSkeletonModification2DTwoBoneIK(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
