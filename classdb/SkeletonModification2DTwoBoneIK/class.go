...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SkeletonModification2DTwoBoneIK")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DTwoBoneIK{gdclass.NewSkeletonModification2DTwoBoneIK(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
