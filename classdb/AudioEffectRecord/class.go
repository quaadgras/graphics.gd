...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectRecord")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectRecord{gdclass.NewAudioEffectRecord(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
