...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebXRInterface")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebXRInterface{gdclass.NewWebXRInterface(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
