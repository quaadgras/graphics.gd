...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureProgressBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureProgressBar{gdclass.NewTextureProgressBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
