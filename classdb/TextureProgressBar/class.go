...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("TextureProgressBar"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureProgressBar{gdclass.NewTextureProgressBar(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
