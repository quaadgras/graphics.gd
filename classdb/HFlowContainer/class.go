...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HFlowContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HFlowContainer{gdclass.NewHFlowContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
