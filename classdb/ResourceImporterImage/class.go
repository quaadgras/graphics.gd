...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterImage{gdclass.NewResourceImporterImage(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
