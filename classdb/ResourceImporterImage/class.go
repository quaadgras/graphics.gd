...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterImage")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterImage{gdclass.NewResourceImporterImage(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
