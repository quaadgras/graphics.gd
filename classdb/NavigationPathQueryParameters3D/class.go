...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("NavigationPathQueryParameters3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryParameters3D{gdclass.NewNavigationPathQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
