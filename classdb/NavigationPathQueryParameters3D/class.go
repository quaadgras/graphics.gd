...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryParameters3D{gdclass.NewNavigationPathQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
