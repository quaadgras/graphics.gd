...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationPathQueryParameters3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryParameters3D{gdclass.NewNavigationPathQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
