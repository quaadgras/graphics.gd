...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AudioStreamMP3"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamMP3{gdclass.NewAudioStreamMP3(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
