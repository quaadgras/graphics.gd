...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OfflineMultiplayerPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OfflineMultiplayerPeer{gdclass.NewOfflineMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
