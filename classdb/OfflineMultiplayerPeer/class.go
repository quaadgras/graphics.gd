...
func New() Instance {
	...
	casted := Instance([1]gdclass.OfflineMultiplayerPeer{gdclass.NewOfflineMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
