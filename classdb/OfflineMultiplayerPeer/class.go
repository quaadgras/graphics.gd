...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("OfflineMultiplayerPeer"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OfflineMultiplayerPeer{gdclass.NewOfflineMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
