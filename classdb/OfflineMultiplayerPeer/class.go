...
This means that the [SceneTree] will act as the multiplayer authority by default. Calls to [Instance.Multiplayerapi.IsServer] will return true, and calls to [Instance.Multiplayerapi.GetUniqueId] will return [Multiplayerpeer.TargetPeerServer].
*/
