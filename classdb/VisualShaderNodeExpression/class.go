...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeExpression{gdclass.NewVisualShaderNodeExpression(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
