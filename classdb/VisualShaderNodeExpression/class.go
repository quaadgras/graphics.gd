...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeExpression")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeExpression{gdclass.NewVisualShaderNodeExpression(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
