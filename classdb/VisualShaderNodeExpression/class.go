...
The provided code is directly injected into the graph's matching shader function (vertex, fragment, or light), so it cannot be used to declare functions, varyings, uniforms, or global constants. See [graphics.gd/classdb/VisualShaderNodeGlobalExpression] for such global definitions.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeExpression](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeExpression{pointers.Add[gdclass.VisualShaderNodeExpression]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeExpression{pointers.New[gdclass.VisualShaderNodeExpression]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeExpression() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeExpression](self[0])}
}
func (self Instance) AsVisualShaderNodeExpression() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeExpression](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeExpression", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeExpression](ptr)} })
}
