...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFDocumentExtension{gdclass.NewGLTFDocumentExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
