...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFDocumentExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFDocumentExtension{gdclass.NewGLTFDocumentExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
