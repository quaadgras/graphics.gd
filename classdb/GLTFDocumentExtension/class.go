...
To use, make a new class extending GLTFDocumentExtension, override any methods you need, make an instance of your class, and register it using [Instance.Gltfdocument.RegisterGltfDocumentExtension].
...
/*
Part of the import process. This method is run after [Instance.ImportPreflight] and before [Instance.ParseNodeExtensions].
Returns an array of the glTF extensions supported by this GLTFDocumentExtension class. This is used to validate if a glTF file with required extensions can be loaded.
*/
...
/*
Part of the import process. This method is run after [Instance.GetSupportedExtensions] and before [Instance.ImportPostParse].
Runs when parsing the node extensions of a GLTFNode. This method can be used to process the extension JSON data into a format that can be used by [Instance.GenerateSceneNode]. The return value should be a member of the [Error] enum.
*/
func (Instance) _parse_node_extensions(impl func(ptr gdclass.Receiver, state GLTFState.Instance, gltf_node GLTFNode.Instance, extensions map[any]any) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var state = [1]gdclass.GLTFState{pointers.New[gdclass.GLTFState]([3]uint64{uint64(gd.UnsafeGet[gdextension.Object](p_args, 0))})}
...
/*
Part of the import process. This method is run after [Instance.ParseNodeExtensions] and before [Instance.ParseTextureJson].
Runs when parsing image data from a glTF file. The data could be sourced from a separate file, a URI, or a buffer, and then is passed as a byte array.
*/
...
/*
Part of the import process. This method is run after [Instance.ParseImageData] and before [Instance.GenerateSceneNode].
Runs when parsing the texture JSON from the glTF textures array. This can be used to set the source image index to use as the texture.
*/
func (Instance) _parse_texture_json(impl func(ptr gdclass.Receiver, state GLTFState.Instance, texture_json map[any]any, ret_gltf_texture GLTFTexture.Instance) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var state = [1]gdclass.GLTFState{pointers.New[gdclass.GLTFState]([3]uint64{uint64(gd.UnsafeGet[gdextension.Object](p_args, 0))})}
...
/*
Part of the import process. Allows GLTFDocumentExtension classes to provide mappings for JSON pointers to glTF properties, as defined by the glTF object model, to properties of nodes in the Godot scene tree.
Returns a [GLTFObjectModelProperty] instance that defines how the property should be mapped. If your extension can't handle the property, return null or an instance without any NodePaths (see [Instance.Gltfobjectmodelproperty.HasNodePaths]). You should use [Instance.Gltfobjectmodelproperty.SetTypes] to set the types, and [Instance.Gltfobjectmodelproperty.AppendPathToProperty] function is useful for most simple cases.
...
/*
Part of the import process. This method is run after [Instance.ParseNodeExtensions] and before [Instance.ImportPreGenerate].
This method can be used to modify any of the data imported so far after parsing each node, but before generating the scene or any of its nodes.
*/
...
/*
Part of the import process. This method is run after [Instance.ImportPostParse] and before [Instance.GenerateSceneNode].
This method can be used to modify or read from any of the processed data structures, before generating the nodes and then running the final per-node import step.
*/
...
/*
Part of the import process. This method is run after [Instance.ImportPreGenerate] and before [Instance.ImportNode].
Runs when generating a Godot scene node from a GLTFNode. The returned node will be added to the scene tree. Multiple nodes can be generated in this step if they are added as a child of the returned node.
...
/*
Part of the import process. This method is run after [Instance.GenerateSceneNode] and before [Instance.ImportPost].
This method can be used to make modifications to each of the generated Godot scene nodes.
*/
func (Instance) _import_node(impl func(ptr gdclass.Receiver, state GLTFState.Instance, gltf_node GLTFNode.Instance, json map[any]any, node Node.Instance) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var state = [1]gdclass.GLTFState{pointers.New[gdclass.GLTFState]([3]uint64{uint64(gd.UnsafeGet[gdextension.Object](p_args, 0))})}
...
/*
Part of the export process. This method is run after [Instance.ExportPreflight] and before [Instance.ExportPostConvert].
Runs when converting the data from a Godot scene node. This method can be used to process the Godot scene node data into a format that can be used by [Instance.ExportNode].
*/
...
/*
Part of the export process. This method is run after [Instance.ConvertSceneNode] and before [Instance.ExportPreserialize].
This method can be used to modify the converted node data structures before serialization with any additional data from the scene tree.
*/
...
/*
Part of the export process. This method is run after [Instance.ExportPostConvert] and before [Instance.GetSaveableImageFormats].
This method can be used to alter the state before performing serialization. It runs every time when generating a buffer with [Instance.Gltfdocument.GenerateBuffer] or writing to the file system with [Instance.Gltfdocument.WriteToFilesystem].
*/
...
/*
Part of the export process. Allows GLTFDocumentExtension classes to provide mappings for properties of nodes in the Godot scene tree, to JSON pointers to glTF properties, as defined by the glTF object model.
Returns a [GLTFObjectModelProperty] instance that defines how the property should be mapped. If your extension can't handle the property, return null or an instance without any JSON pointers (see [Instance.Gltfobjectmodelproperty.HasJsonPointers]). You should use [Instance.Gltfobjectmodelproperty.SetTypes] to set the types, and set the JSON pointer(s) using the [member GLTFObjectModelProperty.json_pointers] property.
...
/*
Part of the export process. This method is run after [Instance.ConvertSceneNode] and before [Instance.ExportNode].
Returns an array of the image formats that can be saved/exported by this extension. This extension will only be selected as the image exporter if the [GLTFDocument]'s [member GLTFDocument.image_format] is in this array. If this [GLTFDocumentExtension] is selected as the image exporter, one of the [Instance.SaveImageAtPath] or [Instance.SerializeImageToBytes] methods will run next, otherwise [Instance.ExportNode] will run next. If the format name contains "Lossy", the lossy quality slider will be displayed.
*/
...
/*
Part of the export process. This method is run after [Instance.GetSaveableImageFormats] and before [Instance.SerializeTextureJson].
This method is run when embedding images in the glTF file. When images are saved separately, [Instance.SaveImageAtPath] runs instead. Note that these methods only run when this [GLTFDocumentExtension] is selected as the image exporter.
This method must set the image MIME type in the 'image_dict' with the "mimeType" key. For example, for a PNG image, it would be set to "image/png". The return value must be a byte slice containing the image data.
*/
func (Instance) _serialize_image_to_bytes(impl func(ptr gdclass.Receiver, state GLTFState.Instance, image Image.Instance, image_dict map[any]any, image_format string, lossy_quality Float.X) []byte) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var state = [1]gdclass.GLTFState{pointers.New[gdclass.GLTFState]([3]uint64{uint64(gd.UnsafeGet[gdextension.Object](p_args, 0))})}
...
/*
Part of the export process. This method is run after [Instance.GetSaveableImageFormats] and before [Instance.SerializeTextureJson].
This method is run when saving images separately from the glTF file. When images are embedded, [Instance.SerializeImageToBytes] runs instead. Note that these methods only run when this [GLTFDocumentExtension] is selected as the image exporter.
*/
...
/*
Part of the export process. This method is run after [Instance.SaveImageAtPath] or [Instance.SerializeImageToBytes], and before [Instance.ExportNode]. Note that this method only runs when this [GLTFDocumentExtension] is selected as the image exporter.
This method can be used to set up the extensions for the texture JSON by editing 'texture_json'. The extension must also be added as used extension with [Instance.Gltfstate.AddUsedExtension], be sure to set required to true if you are not providing a fallback.
*/
func (Instance) _serialize_texture_json(impl func(ptr gdclass.Receiver, state GLTFState.Instance, texture_json map[any]any, gltf_texture GLTFTexture.Instance, image_format string) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var state = [1]gdclass.GLTFState{pointers.New[gdclass.GLTFState]([3]uint64{uint64(gd.UnsafeGet[gdextension.Object](p_args, 0))})}
...
/*
Part of the export process. This method is run after [Instance.GetSaveableImageFormats] and before [Instance.ExportPost]. If this [GLTFDocumentExtension] is used for exporting images, this runs after [Instance.SerializeTextureJson].
...
*/
func (Instance) _export_node(impl func(ptr gdclass.Receiver, state GLTFState.Instance, gltf_node GLTFNode.Instance, json map[any]any, node Node.Instance) error) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		var state = [1]gdclass.GLTFState{pointers.New[gdclass.GLTFState]([3]uint64{uint64(gd.UnsafeGet[gdextension.Object](p_args, 0))})}
