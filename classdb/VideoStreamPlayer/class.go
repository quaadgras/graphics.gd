...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVideoStreamPlayer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVideoStreamPlayer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VideoStreamPlayer{gdclass.NewVideoStreamPlayer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVideoStreamPlayer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VideoStreamPlayer{gdclass.NewVideoStreamPlayer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) SetStream(stream [1]gdclass.VideoStream) { //gd:VideoStreamPlayer.set_stream
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_stream, 0|(gdextension.SizeObject<<4), &struct{ stream gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetVideoStream(stream[0])))})
}
func (self class) GetStream() [1]gdclass.VideoStream { //gd:VideoStreamPlayer.get_stream
	...
	var ret = [1]gdclass.VideoStream{gdclass.NewVideoStream(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsVideoStreamPlayer() Advanced {
	return Advanced{gdclass.NewVideoStreamPlayer(self.AsObject()[0])}
}
func (self Instance) AsVideoStreamPlayer() Instance {
	return Instance{gdclass.NewVideoStreamPlayer(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VideoStreamPlayer", func(ptr gd.Object) any { return Instance{gdclass.NewVideoStreamPlayer(ptr)} })
}
