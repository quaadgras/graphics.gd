...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimatedTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimatedTexture{gdclass.NewAnimatedTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
