...
/*
A physics joint that attaches two 2D physics bodies at a single point, allowing them to freely rotate. For example, a [graphics.gd/classdb/RigidBody2D] can be attached to a [graphics.gd/classdb/StaticBody2D] to create a pendulum or a seesaw.
*/
package PinJoint2D
