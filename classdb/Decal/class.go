...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Decal")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Decal{gdclass.NewDecal(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
