...
/*
Sets the [graphics.gd/classdb/Texture2D] associated with the specified [DecalTexture]. This is a convenience method, in most cases you should access the texture directly.
...
/*
Returns the [graphics.gd/classdb/Texture2D] associated with the specified [DecalTexture]. This is a convenience method, in most cases you should access the texture directly.
...
const (
	// [graphics.gd/classdb/Texture2D] corresponding to [Instance.TextureAlbedo].
	TextureAlbedo DecalTexture = 0
	// [graphics.gd/classdb/Texture2D] corresponding to [Instance.TextureNormal].
	TextureNormal DecalTexture = 1
	// [graphics.gd/classdb/Texture2D] corresponding to [Instance.TextureOrm].
	TextureOrm DecalTexture = 2
	// [graphics.gd/classdb/Texture2D] corresponding to [Instance.TextureEmission].
