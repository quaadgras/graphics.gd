...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatParameter{gdclass.NewVisualShaderNodeFloatParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
