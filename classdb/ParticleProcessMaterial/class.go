...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ParticleProcessMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ParticleProcessMaterial{gdclass.NewParticleProcessMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
