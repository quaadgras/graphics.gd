...
func New() Instance {
	...
	casted := Instance([1]gdclass.ParticleProcessMaterial{gdclass.NewParticleProcessMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
