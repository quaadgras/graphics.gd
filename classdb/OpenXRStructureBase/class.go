...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRStructureBase")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRStructureBase{gdclass.NewOpenXRStructureBase(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
