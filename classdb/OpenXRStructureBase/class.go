...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRStructureBase(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRStructureBase(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRStructureBase{gdclass.NewOpenXRStructureBase(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRStructureBase(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRStructureBase{gdclass.NewOpenXRStructureBase(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetNext() [1]gdclass.OpenXRStructureBase { //gd:OpenXRStructureBase.get_next
	...
	var ret = [1]gdclass.OpenXRStructureBase{gdclass.NewOpenXRStructureBase(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
func (self class) AsOpenXRStructureBase() Advanced {
	return Advanced{gdclass.NewOpenXRStructureBase(self.AsObject()[0])}
}
func (self Instance) AsOpenXRStructureBase() Instance {
	return Instance{gdclass.NewOpenXRStructureBase(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRStructureBase() Instance {
...
func init() {
	gdclass.Register("OpenXRStructureBase", func(ptr gd.Object) any { return Instance{gdclass.NewOpenXRStructureBase(ptr)} })
}
