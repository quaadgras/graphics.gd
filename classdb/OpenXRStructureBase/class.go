...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRStructureBase{gdclass.NewOpenXRStructureBase(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
