...
func (self class) AsObject() [1]gd.Object { return gdclass.GetParallaxBackground(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetParallaxBackground(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ParallaxBackground{gdclass.NewParallaxBackground(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetParallaxBackground(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ParallaxBackground{gdclass.NewParallaxBackground(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsParallaxBackground() Advanced {
	return Advanced{gdclass.NewParallaxBackground(self.AsObject()[0])}
}
func (self Instance) AsParallaxBackground() Instance {
	return Instance{gdclass.NewParallaxBackground(self.AsObject()[0])}
}
...
func (self class) AsCanvasLayer() CanvasLayer.Advanced {
	return CanvasLayer.Advanced{gdclass.NewCanvasLayer(self.AsObject()[0])}
}
...
func (self Instance) AsCanvasLayer() CanvasLayer.Instance {
	return CanvasLayer.Instance{gdclass.NewCanvasLayer(self.AsObject()[0])}
}
