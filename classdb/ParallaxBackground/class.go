...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ParallaxBackground")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ParallaxBackground{gdclass.NewParallaxBackground(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
