...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Node")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Node{gdclass.NewNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
