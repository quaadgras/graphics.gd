...
Positioning of the body is performed by creating an [graphics.gd/classdb/XRNode3D] ancestor of the body mesh driven by the same [graphics.gd/classdb/XRBodyTracker].

The body tracking position-data is scaled by [graphics.gd/classdb/Skeleton3D.Instance.MotionScale] when applied to the skeleton, which can be used to adjust the tracked body to match the scale of the body model.
*/
