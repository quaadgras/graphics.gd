...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollision3D{gdclass.NewSpringBoneCollision3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
