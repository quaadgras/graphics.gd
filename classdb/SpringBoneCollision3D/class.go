...
The colliding and sliding are done in the [SpringBoneSimulator3D]'s modification process in order of its collision list which is set by [Instance.Springbonesimulator3d.SetCollisionPath]. If [Instance.Springbonesimulator3d.AreAllChildCollisionsEnabled] is true, the order matches [SceneTree].
