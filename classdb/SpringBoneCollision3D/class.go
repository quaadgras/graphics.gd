...
/*
A collision can be a child of [graphics.gd/classdb/SpringBoneSimulator3D]. If it is not a child of [graphics.gd/classdb/SpringBoneSimulator3D], it has no effect.

The colliding and sliding are done in the [graphics.gd/classdb/SpringBoneSimulator3D]'s modification process in order of its collision list which is set by [graphics.gd/classdb/SpringBoneSimulator3D.Instance.SetCollisionPath]. If [graphics.gd/classdb/SpringBoneSimulator3D.Instance.AreAllChildCollisionsEnabled] is true, the order matches [graphics.gd/classdb/SceneTree].

If [Instance.Bone] is set, it synchronizes with the bone pose of the ancestor [graphics.gd/classdb/Skeleton3D], which is done in before the [graphics.gd/classdb/SpringBoneSimulator3D]'s modification process as the pre-process.

Warning: A scaled [graphics.gd/classdb/SpringBoneCollision3D] will likely not behave as expected. Make sure that the parent [graphics.gd/classdb/Skeleton3D] and its bones are not scaled.
*/
...
/*
Get parent [graphics.gd/classdb/Skeleton3D] node of the parent [graphics.gd/classdb/SpringBoneSimulator3D] if found.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.SpringBoneCollision3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SpringBoneCollision3D{pointers.Add[gdclass.SpringBoneCollision3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.SpringBoneCollision3D{pointers.New[gdclass.SpringBoneCollision3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetPositionOffset(offset Vector3.XYZ) { //gd:SpringBoneCollision3D.set_position_offset
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_position_offset, 0|(gdextension.SizeVector3<<4), &struct{ offset Vector3.XYZ }{offset})
}

//go:nosplit
func (self class) GetPositionOffset() Vector3.XYZ { //gd:SpringBoneCollision3D.get_position_offset
	var r_ret = gdextension.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_position_offset, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetRotationOffset(offset Quaternion.IJKX) { //gd:SpringBoneCollision3D.set_rotation_offset
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_rotation_offset, 0|(gdextension.SizeQuaternion<<4), &struct{ offset Quaternion.IJKX }{offset})
}

//go:nosplit
func (self class) GetRotationOffset() Quaternion.IJKX { //gd:SpringBoneCollision3D.get_rotation_offset
	var r_ret = gdextension.Call[Quaternion.IJKX](gd.ObjectChecked(self.AsObject()), methods.get_rotation_offset, gdextension.SizeQuaternion, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsSpringBoneCollision3D() Advanced {
	return Advanced{pointers.AsA[gdclass.SpringBoneCollision3D](self[0])}
}
func (self Instance) AsSpringBoneCollision3D() Instance {
	return Instance{pointers.AsA[gdclass.SpringBoneCollision3D](self[0])}
}
...
func init() {
	gdclass.Register("SpringBoneCollision3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.SpringBoneCollision3D](ptr)} })
}
