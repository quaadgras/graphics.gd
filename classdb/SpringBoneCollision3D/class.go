...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpringBoneCollision3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollision3D{gdclass.NewSpringBoneCollision3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
