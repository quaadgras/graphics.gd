...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioSamplePlayback{gdclass.NewAudioSamplePlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
