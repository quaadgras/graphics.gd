...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioSamplePlayback")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioSamplePlayback{gdclass.NewAudioSamplePlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
