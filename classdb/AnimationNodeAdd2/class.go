...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeAdd2")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeAdd2{gdclass.NewAnimationNodeAdd2(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
