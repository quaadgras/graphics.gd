...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAnimationNodeAdd2(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAnimationNodeAdd2(self[0]) }
...
func (self class) AsAnimationNodeAdd2() Advanced {
	return Advanced{gdclass.NewAnimationNodeAdd2(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeAdd2() Instance {
	return Instance{gdclass.NewAnimationNodeAdd2(self.AsObject()[0])}
}
func (self *Extension[T]) AsAnimationNodeAdd2() Instance { return self.Super().AsAnimationNodeAdd2() }
