...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileMapLayer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileMapLayer{gdclass.NewTileMapLayer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
