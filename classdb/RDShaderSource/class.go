...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDShaderSource")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDShaderSource{gdclass.NewRDShaderSource(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
