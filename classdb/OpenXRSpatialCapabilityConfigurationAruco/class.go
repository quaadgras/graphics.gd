...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialCapabilityConfigurationAruco")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialCapabilityConfigurationAruco{gdclass.NewOpenXRSpatialCapabilityConfigurationAruco(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
