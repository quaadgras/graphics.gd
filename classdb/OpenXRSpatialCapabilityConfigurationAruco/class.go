...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialCapabilityConfigurationAruco{gdclass.NewOpenXRSpatialCapabilityConfigurationAruco(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
