...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RenderData")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderData{gdclass.NewRenderData(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
