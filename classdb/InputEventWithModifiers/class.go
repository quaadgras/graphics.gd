...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventWithModifiers")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventWithModifiers{gdclass.NewInputEventWithModifiers(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
