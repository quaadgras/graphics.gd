...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventWithModifiers{gdclass.NewInputEventWithModifiers(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
