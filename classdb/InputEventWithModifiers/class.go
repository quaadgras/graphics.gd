...
func (self class) AsObject() [1]gd.Object { return gdclass.GetInputEventWithModifiers(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetInputEventWithModifiers(self[0]) }
...
func (self class) AsInputEventWithModifiers() Advanced {
	return Advanced{gdclass.NewInputEventWithModifiers(self.AsObject()[0])}
}
func (self Instance) AsInputEventWithModifiers() Instance {
	return Instance{gdclass.NewInputEventWithModifiers(self.AsObject()[0])}
}
