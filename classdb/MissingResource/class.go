...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MissingResource")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MissingResource{gdclass.NewMissingResource(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
