...
/*
This CSG node allows you to use any mesh resource as a CSG shape, provided it is manifold. A manifold shape is closed, does not self-intersect, does not contain internal faces and has no edges that connect to more than two faces. See also [graphics.gd/classdb/CSGPolygon3D] for drawing 2D extruded polygons to be used as CSG nodes.
