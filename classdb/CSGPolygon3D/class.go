...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("CSGPolygon3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CSGPolygon3D{gdclass.NewCSGPolygon3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
