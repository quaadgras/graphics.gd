...
/*
A box-shaped attractor that influences particles from [graphics.gd/classdb/GPUParticles3D] nodes. Can be used to attract particles towards its origin, or to push them away from its origin.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.GPUParticlesAttractorBox3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GPUParticlesAttractorBox3D{pointers.Add[gdclass.GPUParticlesAttractorBox3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorBox3D{pointers.New[gdclass.GPUParticlesAttractorBox3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsGPUParticlesAttractorBox3D() Advanced {
	return Advanced{pointers.AsA[gdclass.GPUParticlesAttractorBox3D](self[0])}
}
func (self Instance) AsGPUParticlesAttractorBox3D() Instance {
	return Instance{pointers.AsA[gdclass.GPUParticlesAttractorBox3D](self[0])}
}
...
func init() {
	gdclass.Register("GPUParticlesAttractorBox3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.GPUParticlesAttractorBox3D](ptr)} })
}
