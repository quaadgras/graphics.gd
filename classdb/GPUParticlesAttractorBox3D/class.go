...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticlesAttractorBox3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorBox3D{gdclass.NewGPUParticlesAttractorBox3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
