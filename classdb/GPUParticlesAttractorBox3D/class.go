...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorBox3D{gdclass.NewGPUParticlesAttractorBox3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
