...
/*
A 3D heightmap shape, intended for use in physics. Usually used to provide a shape for a [graphics.gd/classdb/CollisionShape3D]. This is useful for terrain, but it is limited as overhangs (such as caves) cannot be stored. Holes in a [graphics.gd/classdb/HeightMapShape3D] are created by assigning very low values to points in the desired area.
...
A heightmap collision shape can also be build by using an [graphics.gd/classdb/Image] reference:
