...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HeightMapShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HeightMapShape3D{gdclass.NewHeightMapShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
