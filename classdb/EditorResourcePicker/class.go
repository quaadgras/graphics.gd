...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourcePicker{gdclass.NewEditorResourcePicker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
