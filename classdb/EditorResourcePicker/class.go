...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorResourcePicker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourcePicker{gdclass.NewEditorResourcePicker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
