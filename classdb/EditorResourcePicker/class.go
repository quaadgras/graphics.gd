...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("EditorResourcePicker"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourcePicker{gdclass.NewEditorResourcePicker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetBaseType() String.Readable { //gd:EditorResourcePicker.get_base_type
	var r_ret = jumponly.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_base_type, gdextension.SizeString, &struct{}{})
