...
Note: Implement [Instance.HandleMenuSelected] to handle these custom items.
*/
...
/*
This virtual method can be implemented to handle context menu items not handled by default. See [Instance.SetCreateOptions].
*/
