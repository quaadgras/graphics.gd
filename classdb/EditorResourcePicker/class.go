...
/*
This [graphics.gd/classdb/Control] node is used in the editor's Inspector dock to allow editing of [graphics.gd/classdb/Resource] type properties. It provides options for creating, loading, saving and converting resources. Can be used with [graphics.gd/classdb/EditorInspectorPlugin] to recreate the same behavior.

Note: This [graphics.gd/classdb/Control] does not include any editor for the resource, as editing is controlled by the Inspector dock itself or sub-Inspectors.
*/
...
type Interface interface {
	// This virtual method is called when updating the context menu of [graphics.gd/classdb/EditorResourcePicker]. Implement this method to override the "New ..." items with your own options. 'menu_node' is a reference to the [graphics.gd/classdb/PopupMenu] node.
	//
	// Note: Implement [Interface.HandleMenuSelected] to handle these custom items.
	SetCreateOptions(menu_node Object.Instance)
	// This virtual method can be implemented to handle context menu items not handled by default. See [Interface.SetCreateOptions].
...
/*
Returns a list of all allowed types and subtypes corresponding to the [Instance.BaseType]. If the [Instance.BaseType] is empty, an empty list is returned.
*/
...
/*
Sets the toggle mode state for the main button. Works only if [Instance.ToggleMode] is set to true.
*/
