...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorPaths")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorPaths{gdclass.NewEditorPaths(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
