...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeIntOp")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntOp{gdclass.NewVisualShaderNodeIntOp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
