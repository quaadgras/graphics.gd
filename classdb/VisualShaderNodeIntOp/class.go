...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntOp{gdclass.NewVisualShaderNodeIntOp(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
