...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AStarGrid2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AStarGrid2D{gdclass.NewAStarGrid2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
