...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AStarGrid2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AStarGrid2D{gdclass.NewAStarGrid2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
