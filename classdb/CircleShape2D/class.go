...
/*
A 2D circle shape, intended for use in physics. Usually used to provide a shape for a [graphics.gd/classdb/CollisionShape2D].

Performance: [graphics.gd/classdb/CircleShape2D] is fast to check collisions against. It is faster than [graphics.gd/classdb/RectangleShape2D] and [graphics.gd/classdb/CapsuleShape2D].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CircleShape2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CircleShape2D{pointers.Add[gdclass.CircleShape2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CircleShape2D{pointers.New[gdclass.CircleShape2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsCircleShape2D() Advanced {
	return Advanced{pointers.AsA[gdclass.CircleShape2D](self[0])}
}
func (self Instance) AsCircleShape2D() Instance {
	return Instance{pointers.AsA[gdclass.CircleShape2D](self[0])}
}
func (self *Extension[T]) AsCircleShape2D() Instance { return self.Super().AsCircleShape2D() }
...
func init() {
	gdclass.Register("CircleShape2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CircleShape2D](ptr)} })
}
