...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCircleShape2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCircleShape2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CircleShape2D{gdclass.NewCircleShape2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCircleShape2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CircleShape2D{gdclass.NewCircleShape2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCircleShape2D() Advanced {
	return Advanced{gdclass.NewCircleShape2D(self.AsObject()[0])}
}
func (self Instance) AsCircleShape2D() Instance {
	return Instance{gdclass.NewCircleShape2D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("CircleShape2D", func(ptr gd.Object) any { return Instance{gdclass.NewCircleShape2D(ptr)} })
}
