...
Note: Any [Shape2D]s that the shape is already colliding with e.g. inside of, will be ignored. Use [Instance.CollideShape] to determine the [Shape2D]s that the shape is already colliding with.
*/
...
/*
Checks the intersections of a shape, given through a [PhysicsShapeQueryParameters2D] object, against the space. The resulting array contains a list of points where the shape intersects another. Like with [Instance.IntersectShape], the number of returned results can be limited to save processing time.
