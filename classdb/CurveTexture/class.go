...
func (self class) SetTextureMode(texture_mode TextureMode) { //gd:CurveTexture.set_texture_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture_mode, 0|(gdextension.SizeInt<<4), &struct{ texture_mode TextureMode }{texture_mode})
}

//go:nosplit
func (self class) GetTextureMode() TextureMode { //gd:CurveTexture.get_texture_mode
	var r_ret = mainthread.Call[TextureMode](gd.ObjectChecked(self.AsObject()), methods.get_texture_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
