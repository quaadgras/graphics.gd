...
/*
A 1D texture where pixel brightness corresponds to points on a unit [graphics.gd/classdb/Curve] resource, either in grayscale or in red. This visual representation simplifies the task of saving curves as image files.

If you need to store up to 3 curves within a single texture, use [graphics.gd/classdb/CurveXYZTexture] instead. See also [graphics.gd/classdb/GradientTexture1D] and [graphics.gd/classdb/GradientTexture2D].
*/
