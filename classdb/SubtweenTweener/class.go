...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SubtweenTweener")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SubtweenTweener{gdclass.NewSubtweenTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
