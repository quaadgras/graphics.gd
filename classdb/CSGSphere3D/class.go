...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CSGSphere3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CSGSphere3D{gdclass.NewCSGSphere3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
