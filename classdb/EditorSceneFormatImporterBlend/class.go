...
This importer is only used if [member ProjectSettings.filesystem/import/blender/enabled] is enabled, otherwise .blend files present in the project folder are not imported.
