...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterBlend{gdclass.NewEditorSceneFormatImporterBlend(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
