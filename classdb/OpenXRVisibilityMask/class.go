...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRVisibilityMask")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRVisibilityMask{gdclass.NewOpenXRVisibilityMask(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
