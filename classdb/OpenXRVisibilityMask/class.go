...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRVisibilityMask{gdclass.NewOpenXRVisibilityMask(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
