...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("OpenXRVisibilityMask"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRVisibilityMask{gdclass.NewOpenXRVisibilityMask(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
