...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConfigFile")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConfigFile{gdclass.NewConfigFile(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
