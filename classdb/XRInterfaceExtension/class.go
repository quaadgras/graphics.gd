...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRInterfaceExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRInterfaceExtension{gdclass.NewXRInterfaceExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
