...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GridMap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GridMap{gdclass.NewGridMap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
