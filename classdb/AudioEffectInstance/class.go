...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectInstance")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectInstance{gdclass.NewAudioEffectInstance(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
