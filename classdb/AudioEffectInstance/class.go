...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectInstance{gdclass.NewAudioEffectInstance(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
