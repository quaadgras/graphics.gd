...
/*
An audio effect instance manipulates the audio it receives for a given effect. This instance is automatically created by an [AudioEffect] when it is added to a bus, and should usually not be created directly. If necessary, it can be fetched at run-time with [Instance.Audioserver.GetBusEffectInstance].
*/
...
/*
Called by the [AudioServer] to process this effect. When [Instance.ProcessSilence] is not overridden or it returns false, this method is called only when the bus is active.
...
/*
Override this method to customize the processing behavior of this effect instance.
Should return true to force the [AudioServer] to always call [Instance.Process], even if the bus has been muted or cannot otherwise be heard.
*/
