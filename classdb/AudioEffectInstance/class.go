...
/*
An audio effect instance manipulates the audio it receives for a given effect. This instance is automatically created by an [graphics.gd/classdb/AudioEffect] when it is added to a bus, and should usually not be created directly. If necessary, it can be fetched at run-time with [graphics.gd/classdb/AudioServer.GetBusEffectInstance].
*/
...
type Interface interface {
	// Called by the [graphics.gd/classdb/AudioServer] to process this effect. When [Interface.ProcessSilence] is not overridden or it returns false, this method is called only when the bus is active.
	//
	// Note: It is not useful to override this method in GDScript or C#. Only GDExtension can take advantage of it.
	Process(src_buffer gdextension.Pointer, dst_buffer *AudioFrame, frame_count int)
	// Override this method to customize the processing behavior of this effect instance.
	//
	// Should return true to force the [graphics.gd/classdb/AudioServer] to always call [Interface.Process], even if the bus has been muted or cannot otherwise be heard.
	ProcessSilence() bool
}
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioEffectInstance](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectInstance{pointers.Add[gdclass.AudioEffectInstance]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioEffectInstance{pointers.New[gdclass.AudioEffectInstance]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsAudioEffectInstance() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioEffectInstance](self[0])}
}
func (self Instance) AsAudioEffectInstance() Instance {
	return Instance{pointers.AsA[gdclass.AudioEffectInstance](self[0])}
}
...
func init() {
	gdclass.Register("AudioEffectInstance", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioEffectInstance](ptr)} })
}
