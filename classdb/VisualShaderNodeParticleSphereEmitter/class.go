...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleSphereEmitter(self[0])
}
...
func (self class) AsVisualShaderNodeParticleSphereEmitter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleSphereEmitter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleSphereEmitter() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleSphereEmitter(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleSphereEmitter() Instance {
	return self.Super().AsVisualShaderNodeParticleSphereEmitter()
}
