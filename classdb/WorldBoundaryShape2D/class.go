...
func New() Instance {
	...
	casted := Instance([1]gdclass.WorldBoundaryShape2D{gdclass.NewWorldBoundaryShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
