...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WorldBoundaryShape2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WorldBoundaryShape2D{gdclass.NewWorldBoundaryShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
