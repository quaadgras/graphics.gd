...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ItemList")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ItemList{gdclass.NewItemList(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
