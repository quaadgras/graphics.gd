...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectHighPassFilter{gdclass.NewAudioEffectHighPassFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
