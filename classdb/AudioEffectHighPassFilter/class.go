...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectHighPassFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectHighPassFilter{gdclass.NewAudioEffectHighPassFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
