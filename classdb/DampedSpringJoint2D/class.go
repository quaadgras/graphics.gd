...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("DampedSpringJoint2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.DampedSpringJoint2D{gdclass.NewDampedSpringJoint2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
