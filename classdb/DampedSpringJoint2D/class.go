...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.DampedSpringJoint2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.DampedSpringJoint2D{pointers.Add[gdclass.DampedSpringJoint2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.DampedSpringJoint2D{pointers.New[gdclass.DampedSpringJoint2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetRestLength(rest_length float64) { //gd:DampedSpringJoint2D.set_rest_length
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_rest_length, 0|(gdextension.SizeFloat<<4), &struct{ rest_length float64 }{rest_length})
}

//go:nosplit
func (self class) GetRestLength() float64 { //gd:DampedSpringJoint2D.get_rest_length
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_rest_length, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsDampedSpringJoint2D() Advanced {
	return Advanced{pointers.AsA[gdclass.DampedSpringJoint2D](self[0])}
}
func (self Instance) AsDampedSpringJoint2D() Instance {
	return Instance{pointers.AsA[gdclass.DampedSpringJoint2D](self[0])}
}
...
func init() {
	gdclass.Register("DampedSpringJoint2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.DampedSpringJoint2D](ptr)} })
}
