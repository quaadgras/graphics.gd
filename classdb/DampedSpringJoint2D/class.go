...
func (self class) AsObject() [1]gd.Object { return gdclass.GetDampedSpringJoint2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetDampedSpringJoint2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.DampedSpringJoint2D{gdclass.NewDampedSpringJoint2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetDampedSpringJoint2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.DampedSpringJoint2D{gdclass.NewDampedSpringJoint2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsDampedSpringJoint2D() Advanced {
	return Advanced{gdclass.NewDampedSpringJoint2D(self.AsObject()[0])}
}
func (self Instance) AsDampedSpringJoint2D() Instance {
	return Instance{gdclass.NewDampedSpringJoint2D(self.AsObject()[0])}
}
...
func (self class) AsJoint2D() Joint2D.Advanced {
	return Joint2D.Advanced{gdclass.NewJoint2D(self.AsObject()[0])}
}
...
func (self Instance) AsJoint2D() Joint2D.Instance {
	return Joint2D.Instance{gdclass.NewJoint2D(self.AsObject()[0])}
}
