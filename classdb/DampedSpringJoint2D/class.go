...
func New() Instance {
	...
	casted := Instance([1]gdclass.DampedSpringJoint2D{gdclass.NewDampedSpringJoint2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
