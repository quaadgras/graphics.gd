...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeReroute(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeReroute(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeReroute{gdclass.NewVisualShaderNodeReroute(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeReroute(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeReroute{gdclass.NewVisualShaderNodeReroute(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeReroute() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeReroute(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeReroute() Instance {
	return Instance{gdclass.NewVisualShaderNodeReroute(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeReroute() Instance {
	return self.Super().AsVisualShaderNodeReroute()
}
...
func init() {
	gdclass.Register("VisualShaderNodeReroute", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeReroute(ptr)} })
}
