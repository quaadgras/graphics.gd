...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeReroute{gdclass.NewVisualShaderNodeReroute(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
