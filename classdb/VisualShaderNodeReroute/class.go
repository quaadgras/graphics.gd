...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeReroute](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeReroute{pointers.Add[gdclass.VisualShaderNodeReroute]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeReroute{pointers.New[gdclass.VisualShaderNodeReroute]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) GetPortType() VisualShaderNode.PortType { //gd:VisualShaderNodeReroute.get_port_type
	var r_ret = mainthread.Call[VisualShaderNode.PortType](gd.ObjectChecked(self.AsObject()), methods.get_port_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeReroute() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeReroute](self[0])}
}
func (self Instance) AsVisualShaderNodeReroute() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeReroute](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeReroute", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeReroute](ptr)} })
}
