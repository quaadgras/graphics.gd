...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeReroute")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeReroute{gdclass.NewVisualShaderNodeReroute(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
