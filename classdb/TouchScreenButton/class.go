...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TouchScreenButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TouchScreenButton{gdclass.NewTouchScreenButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
