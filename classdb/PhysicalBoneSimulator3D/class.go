...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalBoneSimulator3D{gdclass.NewPhysicalBoneSimulator3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
