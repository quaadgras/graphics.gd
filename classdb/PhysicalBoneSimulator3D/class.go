...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicalBoneSimulator3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalBoneSimulator3D{gdclass.NewPhysicalBoneSimulator3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
