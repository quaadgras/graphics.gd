...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PopupPanel")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PopupPanel{gdclass.NewPopupPanel(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
