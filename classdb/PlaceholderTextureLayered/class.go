...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderTextureLayered{gdclass.NewPlaceholderTextureLayered(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
