...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventScreenTouch{gdclass.NewInputEventScreenTouch(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
