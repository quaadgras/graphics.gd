...
func New() Instance {
	...
	casted := Instance([1]gdclass.VideoStreamPlayback{gdclass.NewVideoStreamPlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
