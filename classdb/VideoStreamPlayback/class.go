...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VideoStreamPlayback")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VideoStreamPlayback{gdclass.NewVideoStreamPlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
