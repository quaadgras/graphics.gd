...
/*
Stops playback. May be called multiple times before [Instance.Play], or in response to [Instance.Videostreamplayer.Stop]. [Instance.IsPlaying] should return false once stopped.
*/
...
/*
Called in response to [member VideoStreamPlayer.autoplay] or [Instance.Videostreamplayer.Play]. Note that manual playback may also invoke [Instance.Stop] multiple times before this method is called. [Instance.IsPlaying] should return true once playing.
*/
...
/*
Returns the playback state, as determined by calls to [Instance.Play] and [Instance.Stop].
*/
...
/*
Set the paused status of video playback. [Instance.IsPaused] must return 'paused'. Called in response to the [member VideoStreamPlayer.paused] setter.
*/
...
/*
Returns the paused status, as set by [Instance.SetPaused].
*/
...
/*
Seeks to 'time' seconds. Called in response to the [member VideoStreamPlayer.stream_position] setter.
*/
...
/*
Select the audio track 'idx'. Called when playback starts, and in response to the [member VideoStreamPlayer.audio_track] setter.
*/
...
/*
Ticks video playback for 'delta' seconds. Called every frame as long as both [Instance.IsPaused] and [Instance.IsPlaying] return true.
*/
...
/*
Render 'num_frames' audio frames (of [Instance.GetChannels] floats each) from 'buffer', starting from index 'offset' in the array. Returns the number of audio frames rendered, or -1 on error.
*/
