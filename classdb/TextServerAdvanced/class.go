...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextServerAdvanced")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextServerAdvanced{gdclass.NewTextServerAdvanced(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
