...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorFunc{gdclass.NewVisualShaderNodeColorFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
