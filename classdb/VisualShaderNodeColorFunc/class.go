...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeColorFunc](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeColorFunc{pointers.Add[gdclass.VisualShaderNodeColorFunc]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorFunc{pointers.New[gdclass.VisualShaderNodeColorFunc]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeColorFunc() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeColorFunc](self[0])}
}
func (self Instance) AsVisualShaderNodeColorFunc() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeColorFunc](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeColorFunc", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeColorFunc](ptr)} })
}
