...
/*
Most basic 3D game object, with a [Transform3D.BasisOrigin] and visibility settings. All other 3D game objects inherit from [graphics.gd/classdb/Node3D]. Use [graphics.gd/classdb/Node3D] as a parent node to move, scale, rotate and show/hide children in a 3D project.

Affine operations (rotate, scale, translate) happen in parent's local coordinate system, unless the [graphics.gd/classdb/Node3D] object is set as top-level. Affine operations in this coordinate system correspond to direct affine operations on the [graphics.gd/classdb/Node3D]'s transform. The word local below refers to this coordinate system. The coordinate system that is attached to the [graphics.gd/classdb/Node3D] object itself is referred to as object-local coordinate system.

Note: Unless otherwise specified, all methods that have angle parameters must have angles specified as radians. To convert degrees to radians, use [graphics.gd/classdb/@GlobalScope.Instance.DegToRad].
...
/*
Returns the parent [graphics.gd/classdb/Node3D], or null if no parent exists, the parent is not of type [graphics.gd/classdb/Node3D], or [Instance.TopLevel] is true.

Note: Calling this method is not equivalent to get_parent() as Node3D, which does not take [Instance.TopLevel] into account.
*/
...
/*
Returns the current [graphics.gd/classdb/World3D] resource this [graphics.gd/classdb/Node3D] node is registered to.
*/
...
/*
Updates all the [graphics.gd/classdb/Node3D] gizmos attached to this node.
*/
...
/*
Attach an editor gizmo to this [graphics.gd/classdb/Node3D].
...
/*
Returns all the gizmos attached to this [graphics.gd/classdb/Node3D].
*/
...
/*
Clear all gizmos attached to this [graphics.gd/classdb/Node3D].
*/
...
/*
Returns true if the node is present in the [graphics.gd/classdb/SceneTree], its [Instance.Visible] property is true and all its ancestors are also visible. If any ancestor is hidden, this node will not be visible in the scene tree.

Visibility is checked only in parent nodes that inherit from [graphics.gd/classdb/Node3D]. If the parent is of any other type (such as [graphics.gd/classdb/Node], [graphics.gd/classdb/AnimationPlayer], or [graphics.gd/classdb/Node2D]), it is assumed to be visible.

Note: This method does not take [graphics.gd/classdb/VisualInstance3D.Instance.Layers] into account, so even if this method returns true, the node might end up not being rendered.
*/
...
/*
Enables rendering of this node. Changes [Instance.Visible] to true.
*/
...
/*
Disables rendering of this node. Changes [Instance.Visible] to false.
*/
...
/*
Sets whether the node notifies about its local transformation changes. [graphics.gd/classdb/Node3D] will not propagate this by default.
*/
...
/*
Returns whether node notifies about its local transformation changes. [graphics.gd/classdb/Node3D] will not propagate this by default.
*/
...
/*
Sets whether the node notifies about its global and local transformation changes. [graphics.gd/classdb/Node3D] will not propagate this by default, unless it is in the editor context and it has a valid gizmo.
*/
...
/*
Returns whether the node notifies about its global and local transformation changes. [graphics.gd/classdb/Node3D] will not propagate this by default.
*/
...
/*
Rotates the local transformation around axis, a unit [Vector3.XYZ], by specified angle in radians.
*/
...
/*
Rotates the global (world) transformation around axis, a unit [Vector3.XYZ], by specified angle in radians. The rotation axis is in global coordinate system.
*/
...
/*
Scales the global (world) transformation by the given [Vector3.XYZ] scale factors.
*/
...
/*
Moves the global (world) transformation by [Vector3.XYZ] offset. The offset is in global coordinate system.
*/
...
/*
Rotates the local transformation around axis, a unit [Vector3.XYZ], by specified angle in radians. The rotation axis is in object-local coordinate system.
*/
...
/*
Changes the node's position by the given offset [Vector3.XYZ] in local space.
*/
...
/*
Changes the node's position by the given offset [Vector3.XYZ].
...
/*
Resets this node's transformations (like scale, skew and taper) preserving its rotation and translation by performing Gram-Schmidt orthonormalization on this node's [Transform3D.BasisOrigin].
*/
...
/*
Reset all transformations for this node (sets its [Transform3D.BasisOrigin] to the identity matrix).
*/
...
/*
Moves the node to the specified 'position', and then rotates the node to point toward the 'target' as per [Instance.LookAt]. Operations take place in global space.
*/
...
const (
	// The rotation is edited using [Vector3.XYZ] Euler angles.
	...
	// The rotation is edited using a [Basis.XYZ]. In this mode, [Instance.Scale] can't be edited separately.
