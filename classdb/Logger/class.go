...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Logger")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Logger{gdclass.NewLogger(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
