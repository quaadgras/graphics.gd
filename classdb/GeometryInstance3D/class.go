...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GeometryInstance3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GeometryInstance3D{gdclass.NewGeometryInstance3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
