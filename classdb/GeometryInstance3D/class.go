...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGeometryInstance3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGeometryInstance3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GeometryInstance3D{gdclass.NewGeometryInstance3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGeometryInstance3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GeometryInstance3D{gdclass.NewGeometryInstance3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) SetMaterialOverride(material [1]gdclass.Material) { //gd:GeometryInstance3D.set_material_override
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_material_override, 0|(gdextension.SizeObject<<4), &struct{ material gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetMaterial(material[0])))})
}
...
func (self class) SetMaterialOverlay(material [1]gdclass.Material) { //gd:GeometryInstance3D.set_material_overlay
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_material_overlay, 0|(gdextension.SizeObject<<4), &struct{ material gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetMaterial(material[0])))})
}
...
func (self class) AsGeometryInstance3D() Advanced {
	return Advanced{gdclass.NewGeometryInstance3D(self.AsObject()[0])}
}
func (self Instance) AsGeometryInstance3D() Instance {
	return Instance{gdclass.NewGeometryInstance3D(self.AsObject()[0])}
}
