...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileSetSource")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileSetSource{gdclass.NewTileSetSource(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
