...
Warning: [TileSetSource] can only be added to one TileSet at the same time. Calling [Instance.Tileset.AddSource] on a second [TileSet] will remove the source from the first one.
*/
