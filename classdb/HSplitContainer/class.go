...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HSplitContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HSplitContainer{gdclass.NewHSplitContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
