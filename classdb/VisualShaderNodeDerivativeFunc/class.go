...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeDerivativeFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDerivativeFunc{gdclass.NewVisualShaderNodeDerivativeFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
