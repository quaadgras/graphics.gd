...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDerivativeFunc{gdclass.NewVisualShaderNodeDerivativeFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
