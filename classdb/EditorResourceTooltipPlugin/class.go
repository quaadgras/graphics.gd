...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourceTooltipPlugin{gdclass.NewEditorResourceTooltipPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
