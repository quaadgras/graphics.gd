...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorResourceTooltipPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourceTooltipPlugin{gdclass.NewEditorResourceTooltipPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
