...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceImporterTextureAtlas(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceImporterTextureAtlas(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterTextureAtlas{gdclass.NewResourceImporterTextureAtlas(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceImporterTextureAtlas(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterTextureAtlas{gdclass.NewResourceImporterTextureAtlas(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsResourceImporterTextureAtlas() Advanced {
	return Advanced{gdclass.NewResourceImporterTextureAtlas(self.AsObject()[0])}
}
func (self Instance) AsResourceImporterTextureAtlas() Instance {
	return Instance{gdclass.NewResourceImporterTextureAtlas(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("ResourceImporterTextureAtlas", func(ptr gd.Object) any { return Instance{gdclass.NewResourceImporterTextureAtlas(ptr)} })
}
