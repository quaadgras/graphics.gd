...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterTextureAtlas{gdclass.NewResourceImporterTextureAtlas(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
