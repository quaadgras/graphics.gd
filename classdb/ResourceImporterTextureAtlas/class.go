...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterTextureAtlas")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterTextureAtlas{gdclass.NewResourceImporterTextureAtlas(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
