...
func (self class) GetFontNames() Packed.Strings { //gd:SystemFont.get_font_names
	var r_ret = jumponly.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_font_names, gdextension.SizePackedArray, &struct{}{})
...
func (self class) GetFontItalic() bool { //gd:SystemFont.get_font_italic
	var r_ret = jumponly.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_font_italic, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
