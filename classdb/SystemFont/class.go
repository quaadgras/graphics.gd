...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSystemFont(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSystemFont(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SystemFont{gdclass.NewSystemFont(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetSystemFont(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SystemFont{gdclass.NewSystemFont(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsSystemFont() Advanced { return Advanced{gdclass.NewSystemFont(self.AsObject()[0])} }
func (self Instance) AsSystemFont() Instance {
	return Instance{gdclass.NewSystemFont(self.AsObject()[0])}
}
func (self *Extension[T]) AsSystemFont() Instance { return self.Super().AsSystemFont() }
func (self class) AsFont() Font.Advanced          { return Font.Advanced{gdclass.NewFont(self.AsObject()[0])} }
func (self *Extension[T]) AsFont() Font.Instance  { return self.Super().AsFont() }
func (self Instance) AsFont() Font.Instance {
	return Font.Instance{gdclass.NewFont(self.AsObject()[0])}
}
