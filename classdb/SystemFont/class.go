...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SystemFont")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SystemFont{gdclass.NewSystemFont(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
