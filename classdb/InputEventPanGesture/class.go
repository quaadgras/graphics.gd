...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventPanGesture{gdclass.NewInputEventPanGesture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
