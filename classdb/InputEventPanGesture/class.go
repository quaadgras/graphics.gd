...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventPanGesture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventPanGesture{gdclass.NewInputEventPanGesture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
