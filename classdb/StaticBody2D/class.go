...
/*
A static 2D physics body. It can't be moved by external forces or contacts, but can be moved manually by other means such as code, [graphics.gd/classdb/AnimationMixer]s (with [graphics.gd/classdb/AnimationMixer.Instance.CallbackModeProcess] set to [Animationmixer.AnimationCallbackModeProcessPhysics]), and [graphics.gd/classdb/RemoteTransform2D].

When [graphics.gd/classdb/StaticBody2D] is moved, it is teleported to its new position without affecting other physics bodies in its path. If this is not desired, use [graphics.gd/classdb/AnimatableBody2D] instead.

[graphics.gd/classdb/StaticBody2D] is useful for completely static objects like floors and walls, as well as moving surfaces like conveyor belts and circular revolving platforms (by using [Instance.ConstantLinearVelocity] and [Instance.ConstantAngularVelocity]).
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.StaticBody2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StaticBody2D{pointers.Add[gdclass.StaticBody2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.StaticBody2D{pointers.New[gdclass.StaticBody2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetConstantLinearVelocity(vel Vector2.XY) { //gd:StaticBody2D.set_constant_linear_velocity
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant_linear_velocity, 0|(gdextension.SizeVector2<<4), &struct{ vel Vector2.XY }{vel})
}

//go:nosplit
func (self class) SetConstantAngularVelocity(vel float64) { //gd:StaticBody2D.set_constant_angular_velocity
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant_angular_velocity, 0|(gdextension.SizeFloat<<4), &struct{ vel float64 }{vel})
}

//go:nosplit
func (self class) GetConstantLinearVelocity() Vector2.XY { //gd:StaticBody2D.get_constant_linear_velocity
	var r_ret = gdextension.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_constant_linear_velocity, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetConstantAngularVelocity() float64 { //gd:StaticBody2D.get_constant_angular_velocity
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_constant_angular_velocity, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsStaticBody2D() Advanced {
	return Advanced{pointers.AsA[gdclass.StaticBody2D](self[0])}
}
func (self Instance) AsStaticBody2D() Instance {
	return Instance{pointers.AsA[gdclass.StaticBody2D](self[0])}
}
...
func init() {
	gdclass.Register("StaticBody2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.StaticBody2D](ptr)} })
}
