...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeScreenUVToSDF")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeScreenUVToSDF{gdclass.NewVisualShaderNodeScreenUVToSDF(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
