...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeScreenUVToSDF{gdclass.NewVisualShaderNodeScreenUVToSDF(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
