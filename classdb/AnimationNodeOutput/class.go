...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeOutput")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeOutput{gdclass.NewAnimationNodeOutput(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
