...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAnimationNodeOutput(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAnimationNodeOutput(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeOutput{gdclass.NewAnimationNodeOutput(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAnimationNodeOutput(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeOutput{gdclass.NewAnimationNodeOutput(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsAnimationNodeOutput() Advanced {
	return Advanced{gdclass.NewAnimationNodeOutput(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeOutput() Instance {
	return Instance{gdclass.NewAnimationNodeOutput(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeOutput", func(ptr gd.Object) any { return Instance{gdclass.NewAnimationNodeOutput(ptr)} })
}
