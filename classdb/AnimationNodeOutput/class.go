...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeOutput{gdclass.NewAnimationNodeOutput(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
