...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("PhysicalBone2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalBone2D{gdclass.NewPhysicalBone2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
