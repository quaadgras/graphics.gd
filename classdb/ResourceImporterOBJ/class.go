...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterOBJ{gdclass.NewResourceImporterOBJ(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
