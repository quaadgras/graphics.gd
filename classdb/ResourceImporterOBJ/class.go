...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterOBJ")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterOBJ{gdclass.NewResourceImporterOBJ(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
