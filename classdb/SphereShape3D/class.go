...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SphereShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SphereShape3D{gdclass.NewSphereShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
