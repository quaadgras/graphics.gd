...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCompressedCubemapArray(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCompressedCubemapArray(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedCubemapArray{gdclass.NewCompressedCubemapArray(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCompressedCubemapArray(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CompressedCubemapArray{gdclass.NewCompressedCubemapArray(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCompressedCubemapArray() Advanced {
	return Advanced{gdclass.NewCompressedCubemapArray(self.AsObject()[0])}
}
func (self Instance) AsCompressedCubemapArray() Instance {
	return Instance{gdclass.NewCompressedCubemapArray(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("CompressedCubemapArray", func(ptr gd.Object) any { return Instance{gdclass.NewCompressedCubemapArray(ptr)} })
}
