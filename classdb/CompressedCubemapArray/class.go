...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CompressedCubemapArray")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedCubemapArray{gdclass.NewCompressedCubemapArray(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
