...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedCubemapArray{gdclass.NewCompressedCubemapArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
