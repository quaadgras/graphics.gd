...
/*
A cubemap array that is loaded from a .ccubearray file. This file format is internal to Godot; it is created by importing other image formats with the import system. [graphics.gd/classdb/CompressedCubemapArray] can use one of 4 compression methods:
...
See [graphics.gd/classdb/CubemapArray] for a general description of cubemap arrays.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CompressedCubemapArray](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedCubemapArray{pointers.Add[gdclass.CompressedCubemapArray]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CompressedCubemapArray{pointers.New[gdclass.CompressedCubemapArray]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsCompressedCubemapArray() Advanced {
	return Advanced{pointers.AsA[gdclass.CompressedCubemapArray](self[0])}
}
func (self Instance) AsCompressedCubemapArray() Instance {
	return Instance{pointers.AsA[gdclass.CompressedCubemapArray](self[0])}
}
...
func init() {
	gdclass.Register("CompressedCubemapArray", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CompressedCubemapArray](ptr)} })
}
