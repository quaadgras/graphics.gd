...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioStreamOggVorbis(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioStreamOggVorbis(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamOggVorbis{gdclass.NewAudioStreamOggVorbis(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioStreamOggVorbis(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamOggVorbis{gdclass.NewAudioStreamOggVorbis(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetPacketSequence() [1]gdclass.OggPacketSequence { //gd:AudioStreamOggVorbis.get_packet_sequence
	...
	var ret = [1]gdclass.OggPacketSequence{gdclass.NewOggPacketSequence(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsAudioStreamOggVorbis() Advanced {
	return Advanced{gdclass.NewAudioStreamOggVorbis(self.AsObject()[0])}
}
func (self Instance) AsAudioStreamOggVorbis() Instance {
	return Instance{gdclass.NewAudioStreamOggVorbis(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AudioStreamOggVorbis", func(ptr gd.Object) any { return Instance{gdclass.NewAudioStreamOggVorbis(ptr)} })
}
