...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamOggVorbis{gdclass.NewAudioStreamOggVorbis(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
