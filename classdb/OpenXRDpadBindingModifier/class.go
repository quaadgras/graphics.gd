...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRDpadBindingModifier{gdclass.NewOpenXRDpadBindingModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
