...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("UDPServer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.UDPServer{gdclass.NewUDPServer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
