...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("UDPServer"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.UDPServer{gdclass.NewUDPServer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
