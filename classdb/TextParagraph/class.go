...
func (self class) SetDirection(direction TextServer.Direction) { //gd:TextParagraph.set_direction
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_direction, 0|(gdextension.SizeInt<<4), &struct{ direction TextServer.Direction }{direction})
}

//go:nosplit
func (self class) GetDirection() TextServer.Direction { //gd:TextParagraph.get_direction
	var r_ret = mainthread.Call[TextServer.Direction](gd.ObjectChecked(self.AsObject()), methods.get_direction, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetInferredDirection() TextServer.Direction { //gd:TextParagraph.get_inferred_direction
	var r_ret = mainthread.Call[TextServer.Direction](gd.ObjectChecked(self.AsObject()), methods.get_inferred_direction, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCustomPunctuation(custom_punctuation String.Readable) { //gd:TextParagraph.set_custom_punctuation
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_custom_punctuation, 0|(gdextension.SizeString<<4), &struct{ custom_punctuation gdextension.String }{pointers.Get(gd.InternalString(custom_punctuation))})
}

//go:nosplit
func (self class) GetCustomPunctuation() String.Readable { //gd:TextParagraph.get_custom_punctuation
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_custom_punctuation, gdextension.SizeString, &struct{}{})
...
func (self class) SetOrientation(orientation TextServer.Orientation) { //gd:TextParagraph.set_orientation
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_orientation, 0|(gdextension.SizeInt<<4), &struct{ orientation TextServer.Orientation }{orientation})
}

//go:nosplit
func (self class) GetOrientation() TextServer.Orientation { //gd:TextParagraph.get_orientation
	var r_ret = mainthread.Call[TextServer.Orientation](gd.ObjectChecked(self.AsObject()), methods.get_orientation, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetPreserveInvalid(enabled bool) { //gd:TextParagraph.set_preserve_invalid
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_preserve_invalid, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) GetPreserveInvalid() bool { //gd:TextParagraph.get_preserve_invalid
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_preserve_invalid, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetPreserveControl(enabled bool) { //gd:TextParagraph.set_preserve_control
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_preserve_control, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) GetPreserveControl() bool { //gd:TextParagraph.get_preserve_control
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_preserve_control, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetBidiOverride(override Array.Any) { //gd:TextParagraph.set_bidi_override
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_bidi_override, 0|(gdextension.SizeArray<<4), &struct{ override gdextension.Array }{pointers.Get(gd.InternalArray(override))})
}
...
func (self class) SetDropcap(text String.Readable, font [1]gdclass.Font, font_size int64, dropcap_margins Rect2.PositionSize, language String.Readable) bool { //gd:TextParagraph.set_dropcap
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.set_dropcap, gdextension.SizeBool|(gdextension.SizeString<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeRect2<<16)|(gdextension.SizeString<<20), &struct {
...
func (self class) ClearDropcap() { //gd:TextParagraph.clear_dropcap
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.clear_dropcap, 0, &struct{}{})
}
...
func (self class) AddString(text String.Readable, font [1]gdclass.Font, font_size int64, language String.Readable, meta variant.Any) bool { //gd:TextParagraph.add_string
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.add_string, gdextension.SizeBool|(gdextension.SizeString<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeString<<16)|(gdextension.SizeVariant<<20), &struct {
		text      gdextension.String
		font      gdextension.Object
		font_size int64
		language  gdextension.String
...
func (self class) AddObject(key variant.Any, size Vector2.XY, inline_align GUI.InlineAlignment, length int64, baseline float64) bool { //gd:TextParagraph.add_object
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.add_object, gdextension.SizeBool|(gdextension.SizeVariant<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeFloat<<20), &struct {
...
func (self class) ResizeObject(key variant.Any, size Vector2.XY, inline_align GUI.InlineAlignment, baseline float64) bool { //gd:TextParagraph.resize_object
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.resize_object, gdextension.SizeBool|(gdextension.SizeVariant<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeFloat<<16), &struct {
		key          gdextension.Variant
		size         Vector2.XY
		inline_align GUI.InlineAlignment
		baseline     float64
...
func (self class) SetAlignment(alignment GUI.HorizontalAlignment) { //gd:TextParagraph.set_alignment
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_alignment, 0|(gdextension.SizeInt<<4), &struct{ alignment GUI.HorizontalAlignment }{alignment})
}

//go:nosplit
func (self class) GetAlignment() GUI.HorizontalAlignment { //gd:TextParagraph.get_alignment
	var r_ret = mainthread.Call[GUI.HorizontalAlignment](gd.ObjectChecked(self.AsObject()), methods.get_alignment, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) TabAlign(tab_stops Packed.Array[float32]) { //gd:TextParagraph.tab_align
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.tab_align, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) SetBreakFlags(flags TextServer.LineBreakFlag) { //gd:TextParagraph.set_break_flags
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_break_flags, 0|(gdextension.SizeInt<<4), &struct{ flags TextServer.LineBreakFlag }{flags})
}

//go:nosplit
func (self class) GetBreakFlags() TextServer.LineBreakFlag { //gd:TextParagraph.get_break_flags
	var r_ret = mainthread.Call[TextServer.LineBreakFlag](gd.ObjectChecked(self.AsObject()), methods.get_break_flags, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetJustificationFlags(flags TextServer.JustificationFlag) { //gd:TextParagraph.set_justification_flags
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_justification_flags, 0|(gdextension.SizeInt<<4), &struct{ flags TextServer.JustificationFlag }{flags})
}
...
func (self class) SetEllipsisChar(char String.Readable) { //gd:TextParagraph.set_ellipsis_char
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_ellipsis_char, 0|(gdextension.SizeString<<4), &struct{ char gdextension.String }{pointers.Get(gd.InternalString(char))})
}

//go:nosplit
func (self class) GetEllipsisChar() String.Readable { //gd:TextParagraph.get_ellipsis_char
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_ellipsis_char, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) GetNonWrappedSize() Vector2.XY { //gd:TextParagraph.get_non_wrapped_size
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_non_wrapped_size, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineRid(line int64) RID.Any { //gd:TextParagraph.get_line_rid
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_line_rid, gdextension.SizeRID|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetDropcapRid() RID.Any { //gd:TextParagraph.get_dropcap_rid
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_dropcap_rid, gdextension.SizeRID, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxLinesVisible(max_lines_visible int64) { //gd:TextParagraph.set_max_lines_visible
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max_lines_visible, 0|(gdextension.SizeInt<<4), &struct{ max_lines_visible int64 }{max_lines_visible})
}

//go:nosplit
func (self class) GetMaxLinesVisible() int64 { //gd:TextParagraph.get_max_lines_visible
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_max_lines_visible, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineObjects(line int64) Array.Any { //gd:TextParagraph.get_line_objects
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_line_objects, gdextension.SizeArray|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
...
func (self class) GetLineObjectRect(line int64, key variant.Any) Rect2.PositionSize { //gd:TextParagraph.get_line_object_rect
	var r_ret = mainthread.Call[Rect2.PositionSize](gd.ObjectChecked(self.AsObject()), methods.get_line_object_rect, gdextension.SizeRect2|(gdextension.SizeInt<<4)|(gdextension.SizeVariant<<8), &struct {
		line int64
		key  gdextension.Variant
...
func (self class) GetLineSize(line int64) Vector2.XY { //gd:TextParagraph.get_line_size
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_line_size, gdextension.SizeVector2|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineAscent(line int64) float64 { //gd:TextParagraph.get_line_ascent
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_ascent, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineDescent(line int64) float64 { //gd:TextParagraph.get_line_descent
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_descent, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineWidth(line int64) float64 { //gd:TextParagraph.get_line_width
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_width, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineUnderlinePosition(line int64) float64 { //gd:TextParagraph.get_line_underline_position
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_underline_position, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineUnderlineThickness(line int64) float64 { //gd:TextParagraph.get_line_underline_thickness
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_underline_thickness, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ line int64 }{line})
	var ret = r_ret
	return ret
}
...
func (self class) GetDropcapSize() Vector2.XY { //gd:TextParagraph.get_dropcap_size
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_dropcap_size, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetDropcapLines() int64 { //gd:TextParagraph.get_dropcap_lines
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_dropcap_lines, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) Draw(canvas RID.Any, pos Vector2.XY, color Color.RGBA, dc_color Color.RGBA, oversampling float64) { //gd:TextParagraph.draw
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeFloat<<20), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		color        Color.RGBA
		dc_color     Color.RGBA
...
func (self class) DrawOutline(canvas RID.Any, pos Vector2.XY, outline_size int64, color Color.RGBA, dc_color Color.RGBA, oversampling float64) { //gd:TextParagraph.draw_outline
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw_outline, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeColor<<20)|(gdextension.SizeFloat<<24), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		outline_size int64
		color        Color.RGBA
...
func (self class) DrawLine(canvas RID.Any, pos Vector2.XY, line int64, color Color.RGBA, oversampling float64) { //gd:TextParagraph.draw_line
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw_line, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeFloat<<20), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		line         int64
		color        Color.RGBA
...
func (self class) DrawLineOutline(canvas RID.Any, pos Vector2.XY, line int64, outline_size int64, color Color.RGBA, oversampling float64) { //gd:TextParagraph.draw_line_outline
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw_line_outline, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeColor<<20)|(gdextension.SizeFloat<<24), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		line         int64
		outline_size int64
...
func (self class) DrawDropcap(canvas RID.Any, pos Vector2.XY, color Color.RGBA, oversampling float64) { //gd:TextParagraph.draw_dropcap
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw_dropcap, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeFloat<<16), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		color        Color.RGBA
		oversampling float64
...
func (self class) DrawDropcapOutline(canvas RID.Any, pos Vector2.XY, outline_size int64, color Color.RGBA, oversampling float64) { //gd:TextParagraph.draw_dropcap_outline
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw_dropcap_outline, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeFloat<<20), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		outline_size int64
		color        Color.RGBA
...
func (self class) HitTest(coords Vector2.XY) int64 { //gd:TextParagraph.hit_test
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.hit_test, gdextension.SizeInt|(gdextension.SizeVector2<<4), &struct{ coords Vector2.XY }{coords})
	var ret = r_ret
	return ret
}
