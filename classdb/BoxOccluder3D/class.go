...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoxOccluder3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoxOccluder3D{gdclass.NewBoxOccluder3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
