...
If [member root_motion_track] is not a path to a track of type [Animation.TypePosition3d], returns Vector3(0, 0, 0).
...
If [member root_motion_track] is not a path to a track of type [Animation.TypeRotation3d], returns Quaternion(0, 0, 0, 1).
See also [member root_motion_track] and [RootMotionView].
...
If [member root_motion_track] is not a path to a track of type [Animation.TypeScale3d], returns Vector3(0, 0, 0).
See also [member root_motion_track] and [RootMotionView].
...
/*
[AnimationMixer] caches animated nodes. It may not notice if a node disappears; [Instance.ClearCaches] forces it to update the cache again.
*/
