...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationMixer{gdclass.NewAnimationMixer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
