...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimatedSprite3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimatedSprite3D{gdclass.NewAnimatedSprite3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
