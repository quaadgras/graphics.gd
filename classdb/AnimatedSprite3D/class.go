...
/*
Pauses the currently playing animation. The [member frame] and [member frame_progress] will be kept and calling [Instance.Play] or [Instance.PlayBackwards] without arguments will resume the animation from the current playback position.
