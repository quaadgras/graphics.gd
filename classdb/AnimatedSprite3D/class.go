...
/*
[graphics.gd/classdb/AnimatedSprite3D] is similar to the [graphics.gd/classdb/Sprite3D] node, except it carries multiple textures as animation [Instance.SpriteFrames]. Animations are created using a [graphics.gd/classdb/SpriteFrames] resource, which allows you to import image files (or a folder containing said files) to provide the animation frames for the sprite. The [graphics.gd/classdb/SpriteFrames] resource can be configured in the editor via the SpriteFrames bottom panel.
*/
