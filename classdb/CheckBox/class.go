...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CheckBox")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CheckBox{gdclass.NewCheckBox(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
