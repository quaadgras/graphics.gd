...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VideoStream"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VideoStream{gdclass.NewVideoStream(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetFile() String.Readable { //gd:VideoStream.get_file
	var r_ret = jumponly.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_file, gdextension.SizeString, &struct{}{})
