...
/*
Base resource type for all video streams. Classes that derive from [graphics.gd/classdb/VideoStream] can all be used as resource types to play back videos in [graphics.gd/classdb/VideoStreamPlayer].
*/
package VideoStream
...
type Interface interface {
	// Called when the video starts playing, to initialize and return a subclass of [graphics.gd/classdb/VideoStreamPlayback].
