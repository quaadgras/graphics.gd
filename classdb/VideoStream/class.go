...
func (self class) SetFile(file String.Readable) { //gd:VideoStream.set_file
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_file, 0|(gdextension.SizeString<<4), &struct{ file gdextension.String }{pointers.Get(gd.InternalString(file))})
}

//go:nosplit
func (self class) GetFile() String.Readable { //gd:VideoStream.get_file
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_file, gdextension.SizeString, &struct{}{})
