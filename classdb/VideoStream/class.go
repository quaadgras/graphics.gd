...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VideoStream")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VideoStream{gdclass.NewVideoStream(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
