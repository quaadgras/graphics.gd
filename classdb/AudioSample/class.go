...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioSample")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioSample{gdclass.NewAudioSample(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
