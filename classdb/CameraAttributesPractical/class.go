...
func New() Instance {
	...
	casted := Instance([1]gdclass.CameraAttributesPractical{gdclass.NewCameraAttributesPractical(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
