...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CameraAttributesPractical")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CameraAttributesPractical{gdclass.NewCameraAttributesPractical(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
