...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Slider")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Slider{gdclass.NewSlider(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
