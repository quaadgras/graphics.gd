...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeOuterProduct{gdclass.NewVisualShaderNodeOuterProduct(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
