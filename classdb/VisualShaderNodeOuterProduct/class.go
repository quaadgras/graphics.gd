...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeOuterProduct")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeOuterProduct{gdclass.NewVisualShaderNodeOuterProduct(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
