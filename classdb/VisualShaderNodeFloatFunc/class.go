...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeFloatFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatFunc{gdclass.NewVisualShaderNodeFloatFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
