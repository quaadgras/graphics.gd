...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatFunc{gdclass.NewVisualShaderNodeFloatFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
