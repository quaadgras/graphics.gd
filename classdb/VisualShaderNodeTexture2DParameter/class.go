...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DParameter{gdclass.NewVisualShaderNodeTexture2DParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
