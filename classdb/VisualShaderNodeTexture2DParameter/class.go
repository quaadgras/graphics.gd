...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTexture2DParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DParameter{gdclass.NewVisualShaderNodeTexture2DParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
