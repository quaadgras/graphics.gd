...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeTexture2DParameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture2DParameter{pointers.Add[gdclass.VisualShaderNodeTexture2DParameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DParameter{pointers.New[gdclass.VisualShaderNodeTexture2DParameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeTexture2DParameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeTexture2DParameter](self[0])}
}
func (self Instance) AsVisualShaderNodeTexture2DParameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture2DParameter](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DParameter", func(ptr gd.Object) any {
		return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture2DParameter](ptr)}
	})
}
