...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTexture2DParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture2DParameter{gdclass.NewVisualShaderNodeTexture2DParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTexture2DParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DParameter{gdclass.NewVisualShaderNodeTexture2DParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTexture2DParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTexture2DParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTexture2DParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeTexture2DParameter(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeTexture2DParameter() Instance {
	return self.Super().AsVisualShaderNodeTexture2DParameter()
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DParameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture2DParameter(ptr)} })
}
