...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPath2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPath2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Path2D{gdclass.NewPath2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetPath2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Path2D{gdclass.NewPath2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsPath2D() Advanced         { return Advanced{gdclass.NewPath2D(self.AsObject()[0])} }
func (self Instance) AsPath2D() Instance      { return Instance{gdclass.NewPath2D(self.AsObject()[0])} }
...
func init() {
	gdclass.Register("Path2D", func(ptr gd.Object) any { return Instance{gdclass.NewPath2D(ptr)} })
}
