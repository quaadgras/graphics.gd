...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BackBufferCopy")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BackBufferCopy{gdclass.NewBackBufferCopy(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
