...
func (self class) HasTexture(context String.Name, name String.Name) bool { //gd:RenderSceneBuffersRD.has_texture
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_texture, gdextension.SizeBool|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), &struct {
...
func (self class) CreateTexture(context String.Name, name String.Name, data_format Rendering.DataFormat, usage_bits int64, texture_samples Rendering.TextureSamples, size Vector2i.XY, layers int64, mipmaps int64, unique bool, discardable bool) RID.Any { //gd:RenderSceneBuffersRD.create_texture
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.create_texture, gdextension.SizeRID|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeVector2i<<24)|(gdextension.SizeInt<<28)|(gdextension.SizeInt<<32)|(gdextension.SizeBool<<36)|(gdextension.SizeBool<<40), &struct {
		context         gdextension.StringName
		name            gdextension.StringName
...
func (self class) CreateTextureFromFormat(context String.Name, name String.Name, format [1]gdclass.RDTextureFormat, view [1]gdclass.RDTextureView, unique bool) RID.Any { //gd:RenderSceneBuffersRD.create_texture_from_format
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.create_texture_from_format, gdextension.SizeRID|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeObject<<12)|(gdextension.SizeObject<<16)|(gdextension.SizeBool<<20), &struct {
		context gdextension.StringName
		name    gdextension.StringName
...
func (self class) CreateTextureView(context String.Name, name String.Name, view_name String.Name, view [1]gdclass.RDTextureView) RID.Any { //gd:RenderSceneBuffersRD.create_texture_view
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.create_texture_view, gdextension.SizeRID|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeStringName<<12)|(gdextension.SizeObject<<16), &struct {
		context   gdextension.StringName
		name      gdextension.StringName
...
func (self class) GetTexture(context String.Name, name String.Name) RID.Any { //gd:RenderSceneBuffersRD.get_texture
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_texture, gdextension.SizeRID|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), &struct {
		context gdextension.StringName
		name    gdextension.StringName
	}{pointers.Get(gd.InternalStringName(context)), pointers.Get(gd.InternalStringName(name))})
	var ret = r_ret
...
func (self class) GetTextureFormat(context String.Name, name String.Name) [1]gdclass.RDTextureFormat { //gd:RenderSceneBuffersRD.get_texture_format
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_texture_format, gdextension.SizeObject|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), &struct {
		context gdextension.StringName
		name    gdextension.StringName
	}{pointers.Get(gd.InternalStringName(context)), pointers.Get(gd.InternalStringName(name))})
...
func (self class) GetTextureSlice(context String.Name, name String.Name, layer int64, mipmap int64, layers int64, mipmaps int64) RID.Any { //gd:RenderSceneBuffersRD.get_texture_slice
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_texture_slice, gdextension.SizeRID|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeInt<<24), &struct {
		context gdextension.StringName
		name    gdextension.StringName
		layer   int64
		mipmap  int64
...
func (self class) GetTextureSliceView(context String.Name, name String.Name, layer int64, mipmap int64, layers int64, mipmaps int64, view [1]gdclass.RDTextureView) RID.Any { //gd:RenderSceneBuffersRD.get_texture_slice_view
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_texture_slice_view, gdextension.SizeRID|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeInt<<24)|(gdextension.SizeObject<<28), &struct {
		context gdextension.StringName
		name    gdextension.StringName
		layer   int64
		mipmap  int64
...
func (self class) GetTextureSliceSize(context String.Name, name String.Name, mipmap int64) Vector2i.XY { //gd:RenderSceneBuffersRD.get_texture_slice_size
	var r_ret = mainthread.Call[Vector2i.XY](gd.ObjectChecked(self.AsObject()), methods.get_texture_slice_size, gdextension.SizeVector2i|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12), &struct {
		context gdextension.StringName
		name    gdextension.StringName
		mipmap  int64
...
func (self class) ClearContext(context String.Name) { //gd:RenderSceneBuffersRD.clear_context
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.clear_context, 0|(gdextension.SizeStringName<<4), &struct{ context gdextension.StringName }{pointers.Get(gd.InternalStringName(context))})
}
...
func (self class) GetColorTexture(msaa bool) RID.Any { //gd:RenderSceneBuffersRD.get_color_texture
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_color_texture, gdextension.SizeRID|(gdextension.SizeBool<<4), &struct{ msaa bool }{msaa})
	var ret = r_ret
	return ret
}
...
func (self class) GetColorLayer(layer int64, msaa bool) RID.Any { //gd:RenderSceneBuffersRD.get_color_layer
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_color_layer, gdextension.SizeRID|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		layer int64
		msaa  bool
	}{layer, msaa})
	var ret = r_ret
...
func (self class) GetDepthTexture(msaa bool) RID.Any { //gd:RenderSceneBuffersRD.get_depth_texture
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_depth_texture, gdextension.SizeRID|(gdextension.SizeBool<<4), &struct{ msaa bool }{msaa})
	var ret = r_ret
	return ret
}
...
func (self class) GetDepthLayer(layer int64, msaa bool) RID.Any { //gd:RenderSceneBuffersRD.get_depth_layer
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_depth_layer, gdextension.SizeRID|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		layer int64
		msaa  bool
	}{layer, msaa})
	var ret = r_ret
...
func (self class) GetVelocityTexture(msaa bool) RID.Any { //gd:RenderSceneBuffersRD.get_velocity_texture
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_velocity_texture, gdextension.SizeRID|(gdextension.SizeBool<<4), &struct{ msaa bool }{msaa})
	var ret = r_ret
	return ret
}
...
func (self class) GetVelocityLayer(layer int64, msaa bool) RID.Any { //gd:RenderSceneBuffersRD.get_velocity_layer
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_velocity_layer, gdextension.SizeRID|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		layer int64
		msaa  bool
	}{layer, msaa})
	var ret = r_ret
...
func (self class) GetTextureSamples() Rendering.TextureSamples { //gd:RenderSceneBuffersRD.get_texture_samples
	var r_ret = mainthread.Call[Rendering.TextureSamples](gd.ObjectChecked(self.AsObject()), methods.get_texture_samples, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetUseTaa() bool { //gd:RenderSceneBuffersRD.get_use_taa
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_use_taa, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
