...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneBuffersRD{gdclass.NewRenderSceneBuffersRD(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
