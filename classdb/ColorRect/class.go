...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ColorRect")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ColorRect{gdclass.NewColorRect(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
