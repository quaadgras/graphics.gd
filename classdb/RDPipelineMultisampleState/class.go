...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineMultisampleState{gdclass.NewRDPipelineMultisampleState(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
