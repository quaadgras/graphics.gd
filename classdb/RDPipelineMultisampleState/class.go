...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDPipelineMultisampleState")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineMultisampleState{gdclass.NewRDPipelineMultisampleState(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
