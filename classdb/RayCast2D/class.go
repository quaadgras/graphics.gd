...
Note: This object is not guaranteed to be a [graphics.gd/classdb/CollisionObject2D]. For example, if the ray intersects a [graphics.gd/classdb/TileMapLayer], the method will return a [graphics.gd/classdb/TileMapLayer] instance.
*/
