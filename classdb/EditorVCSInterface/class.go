...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorVCSInterface")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorVCSInterface{gdclass.NewEditorVCSInterface(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
