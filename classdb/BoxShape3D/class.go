...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoxShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoxShape3D{gdclass.NewBoxShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
