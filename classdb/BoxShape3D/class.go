...
func (self class) AsObject() [1]gd.Object { return gdclass.GetBoxShape3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetBoxShape3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.BoxShape3D{gdclass.NewBoxShape3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetBoxShape3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.BoxShape3D{gdclass.NewBoxShape3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsBoxShape3D() Advanced { return Advanced{gdclass.NewBoxShape3D(self.AsObject()[0])} }
func (self Instance) AsBoxShape3D() Instance {
	return Instance{gdclass.NewBoxShape3D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("BoxShape3D", func(ptr gd.Object) any { return Instance{gdclass.NewBoxShape3D(ptr)} })
}
