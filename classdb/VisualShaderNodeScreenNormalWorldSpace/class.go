...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeScreenNormalWorldSpace{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
