...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeScreenNormalWorldSpace")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeScreenNormalWorldSpace{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
