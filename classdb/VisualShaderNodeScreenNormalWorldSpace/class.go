...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeScreenNormalWorldSpace(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeScreenNormalWorldSpace{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeScreenNormalWorldSpace(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeScreenNormalWorldSpace{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeScreenNormalWorldSpace() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeScreenNormalWorldSpace() Instance {
	return Instance{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeScreenNormalWorldSpace() Instance {
	return self.Super().AsVisualShaderNodeScreenNormalWorldSpace()
}
...
func init() {
	gdclass.Register("VisualShaderNodeScreenNormalWorldSpace", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(ptr)} })
}
