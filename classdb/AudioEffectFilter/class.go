...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectFilter{gdclass.NewAudioEffectFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
