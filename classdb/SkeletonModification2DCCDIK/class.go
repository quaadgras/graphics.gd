...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SkeletonModification2DCCDIK")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DCCDIK{gdclass.NewSkeletonModification2DCCDIK(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
