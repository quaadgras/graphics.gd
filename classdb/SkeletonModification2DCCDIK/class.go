...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DCCDIK{gdclass.NewSkeletonModification2DCCDIK(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
