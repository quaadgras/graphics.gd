...
/*
Sets the [graphics.gd/classdb/Bone2D] node assigned to the CCDIK joint at 'joint_idx'.
*/
...
/*
Returns the [graphics.gd/classdb/Bone2D] node assigned to the CCDIK joint at 'joint_idx'.
*/
...
/*
Returns the index of the [graphics.gd/classdb/Bone2D] node assigned to the CCDIK joint at 'joint_idx'.
*/
...
/*
Returns whether the CCDIK joint at 'joint_idx' uses an inverted joint constraint. See [Instance.SetCcdikJointConstraintAngleInvert] for details.
*/
