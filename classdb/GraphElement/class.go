...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGraphElement(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGraphElement(self[0]) }
...
func (self class) AsGraphElement() Advanced {
	return Advanced{gdclass.NewGraphElement(self.AsObject()[0])}
}
func (self Instance) AsGraphElement() Instance {
	return Instance{gdclass.NewGraphElement(self.AsObject()[0])}
}
