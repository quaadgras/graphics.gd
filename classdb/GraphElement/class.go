...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GraphElement")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GraphElement{gdclass.NewGraphElement(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
