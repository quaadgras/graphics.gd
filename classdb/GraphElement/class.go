...
/*
[graphics.gd/classdb/GraphElement] allows to create custom elements for a [graphics.gd/classdb/GraphEdit] graph. By default such elements can be selected, resized, and repositioned, but they cannot be connected. For a graph element that allows for connections see [graphics.gd/classdb/GraphNode].
*/
