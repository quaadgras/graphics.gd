...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CharacterBody2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CharacterBody2D{gdclass.NewCharacterBody2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
