...
func (self class) AsObject() [1]gd.Object { return gdclass.GetXRBodyTracker(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetXRBodyTracker(self[0]) }
...
func (self class) AsXRBodyTracker() Advanced {
	return Advanced{gdclass.NewXRBodyTracker(self.AsObject()[0])}
}
func (self Instance) AsXRBodyTracker() Instance {
	return Instance{gdclass.NewXRBodyTracker(self.AsObject()[0])}
}
