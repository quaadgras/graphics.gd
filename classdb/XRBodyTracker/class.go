...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRBodyTracker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRBodyTracker{gdclass.NewXRBodyTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
