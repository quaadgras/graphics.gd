...
/*
A body tracking system will create an instance of this object and add it to the [graphics.gd/classdb/XRServer]. This tracking system will then obtain skeleton data, convert it to the Godot Humanoid skeleton and store this data on the [graphics.gd/classdb/XRBodyTracker] object.

Use [graphics.gd/classdb/XRBodyModifier3D] to animate a body mesh using body tracking data.
*/
