...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStream")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStream{gdclass.NewAudioStream(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
