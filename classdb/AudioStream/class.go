...
type Interface interface {
	// Override this method to customize the returned value of [Instance.InstantiatePlayback]. Should return a new [graphics.gd/classdb/AudioStreamPlayback] created when the stream is played (such as by an [graphics.gd/classdb/AudioStreamPlayer]).
