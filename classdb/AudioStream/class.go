...
/*
Override this method to customize the returned value of [Instance.InstantiatePlayback]. Should return a new [AudioStreamPlayback] created when the stream is played (such as by an [AudioStreamPlayer]).
*/
...
/*
Override this method to customize the returned value of [Instance.GetLength]. Should return the length of this audio stream, in seconds.
*/
...
/*
Override this method to customize the returned value of [Instance.IsMonophonic]. Should return true if this audio stream only supports one channel.
*/
...
/*
Return the controllable parameters of this stream. This array contains dictionaries with a property info description format (see [Instance.Object.GetPropertyList]). Additionally, the default value for this parameter must be added tho each dictionary in "default_value" field.
*/
...
/*
Returns a newly created [AudioStreamPlayback] intended to play this audio stream. Useful for when you want to extend [Instance.InstantiatePlayback] but call [Instance.InstantiatePlayback] from an internally held AudioStream subresource. An example of this can be found in the source code for AudioStreamRandomPitch::instantiate_playback.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioStream](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStream{pointers.Add[gdclass.AudioStream]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioStream{pointers.New[gdclass.AudioStream]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) ParameterListChanged() Signal.Any {
	return Signal.Via(gd.SignalProxy{}, pointers.Pack(gd.NewSignalOf(self.AsObject(), gd.NewStringName(`ParameterListChanged`))))
}

func (self class) AsAudioStream() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioStream](self[0])}
}
func (self Instance) AsAudioStream() Instance {
	return Instance{pointers.AsA[gdclass.AudioStream](self[0])}
}
...
func init() {
	gdclass.Register("AudioStream", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioStream](ptr)} })
}
