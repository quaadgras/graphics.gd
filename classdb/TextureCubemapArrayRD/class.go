...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureCubemapArrayRD{gdclass.NewTextureCubemapArrayRD(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
