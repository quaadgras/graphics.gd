...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureCubemapArrayRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureCubemapArrayRD{gdclass.NewTextureCubemapArrayRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
