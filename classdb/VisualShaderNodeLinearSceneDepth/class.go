...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeLinearSceneDepth{gdclass.NewVisualShaderNodeLinearSceneDepth(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
