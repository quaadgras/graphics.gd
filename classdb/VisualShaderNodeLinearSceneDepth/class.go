...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeLinearSceneDepth")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeLinearSceneDepth{gdclass.NewVisualShaderNodeLinearSceneDepth(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
