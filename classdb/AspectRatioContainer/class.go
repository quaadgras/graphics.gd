...
func New() Instance {
	...
	casted := Instance([1]gdclass.AspectRatioContainer{gdclass.NewAspectRatioContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
