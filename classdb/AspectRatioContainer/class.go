...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AspectRatioContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AspectRatioContainer{gdclass.NewAspectRatioContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
