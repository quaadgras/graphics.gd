...
By default, audio is heard from the screen center. This can be changed by adding an [AudioListener2D] node to the scene and enabling it by calling [Instance.Audiolistener2d.MakeCurrent] on it.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioStreamPlayer2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlayer2D{pointers.Add[gdclass.AudioStreamPlayer2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioStreamPlayer2D{pointers.New[gdclass.AudioStreamPlayer2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetAttenuation(curve float64) { //gd:AudioStreamPlayer2D.set_attenuation
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_attenuation, 0|(gdextension.SizeFloat<<4), &struct{ curve float64 }{curve})
}

//go:nosplit
func (self class) GetAttenuation() float64 { //gd:AudioStreamPlayer2D.get_attenuation
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_attenuation, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsAudioStreamPlayer2D() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioStreamPlayer2D](self[0])}
}
func (self Instance) AsAudioStreamPlayer2D() Instance {
	return Instance{pointers.AsA[gdclass.AudioStreamPlayer2D](self[0])}
}
...
func init() {
	gdclass.Register("AudioStreamPlayer2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioStreamPlayer2D](ptr)} })
}
