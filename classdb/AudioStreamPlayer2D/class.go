...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AudioStreamPlayer2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlayer2D{gdclass.NewAudioStreamPlayer2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
