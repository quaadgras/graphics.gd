...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShader")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShader{gdclass.NewVisualShader(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
