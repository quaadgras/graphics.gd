...
Because of how FABRIK works, it often gives more natural results than those seen in [graphics.gd/classdb/SkeletonModification2DCCDIK]. FABRIK also supports angle constraints, which are fully taken into account when solving.
