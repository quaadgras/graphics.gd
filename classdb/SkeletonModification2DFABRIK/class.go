...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DFABRIK{gdclass.NewSkeletonModification2DFABRIK(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
