...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SkeletonModification2DFABRIK")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModification2DFABRIK{gdclass.NewSkeletonModification2DFABRIK(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
