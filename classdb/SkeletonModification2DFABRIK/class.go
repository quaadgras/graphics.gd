...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSkeletonModification2DFABRIK(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSkeletonModification2DFABRIK(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SkeletonModification2DFABRIK{gdclass.NewSkeletonModification2DFABRIK(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetSkeletonModification2DFABRIK(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SkeletonModification2DFABRIK{gdclass.NewSkeletonModification2DFABRIK(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsSkeletonModification2DFABRIK() Advanced {
	return Advanced{gdclass.NewSkeletonModification2DFABRIK(self.AsObject()[0])}
}
func (self Instance) AsSkeletonModification2DFABRIK() Instance {
	return Instance{gdclass.NewSkeletonModification2DFABRIK(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("SkeletonModification2DFABRIK", func(ptr gd.Object) any { return Instance{gdclass.NewSkeletonModification2DFABRIK(ptr)} })
}
