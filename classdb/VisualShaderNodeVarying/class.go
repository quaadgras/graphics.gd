...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVarying{gdclass.NewVisualShaderNodeVarying(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
