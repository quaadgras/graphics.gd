...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVarying")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVarying{gdclass.NewVisualShaderNodeVarying(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
