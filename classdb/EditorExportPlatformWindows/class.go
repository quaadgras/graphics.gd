...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformWindows")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformWindows{gdclass.NewEditorExportPlatformWindows(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
