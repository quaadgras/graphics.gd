...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformWindows{gdclass.NewEditorExportPlatformWindows(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
