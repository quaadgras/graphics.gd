...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFPhysicsShape")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFPhysicsShape{gdclass.NewGLTFPhysicsShape(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
