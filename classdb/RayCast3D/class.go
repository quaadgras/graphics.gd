...
func New() Instance {
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				pointers.Set(gdclass.GetRayCast3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RayCast3D{gdclass.NewRayCast3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("RayCast3D", func(ptr gd.Object) any { return Instance{gdclass.NewRayCast3D(ptr)} })
}
