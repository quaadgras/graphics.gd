...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeInput{gdclass.NewVisualShaderNodeInput(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
