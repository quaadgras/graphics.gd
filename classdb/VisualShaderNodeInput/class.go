...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeInput](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeInput{pointers.Add[gdclass.VisualShaderNodeInput]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeInput{pointers.New[gdclass.VisualShaderNodeInput]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetInputName(name String.Readable) { //gd:VisualShaderNodeInput.set_input_name
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_input_name, 0|(gdextension.SizeString<<4), &struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))})
}

//go:nosplit
func (self class) GetInputName() String.Readable { //gd:VisualShaderNodeInput.get_input_name
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_input_name, gdextension.SizeString, &struct{}{})
...
func (self class) GetInputRealName() String.Readable { //gd:VisualShaderNodeInput.get_input_real_name
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_input_real_name, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) AsVisualShaderNodeInput() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeInput](self[0])}
}
func (self Instance) AsVisualShaderNodeInput() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeInput](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeInput", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeInput](ptr)} })
}
