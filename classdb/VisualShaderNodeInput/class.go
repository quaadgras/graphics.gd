...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeInput")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeInput{gdclass.NewVisualShaderNodeInput(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
