...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeInput(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeInput(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeInput{gdclass.NewVisualShaderNodeInput(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeInput(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeInput{gdclass.NewVisualShaderNodeInput(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnInputTypeChanged(cb func(), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("input_type_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsVisualShaderNodeInput() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeInput(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeInput() Instance {
	return Instance{gdclass.NewVisualShaderNodeInput(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeInput", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeInput(ptr)} })
}
