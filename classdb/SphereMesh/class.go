...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SphereMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SphereMesh{gdclass.NewSphereMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
