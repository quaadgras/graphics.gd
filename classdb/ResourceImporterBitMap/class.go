...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterBitMap{gdclass.NewResourceImporterBitMap(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
