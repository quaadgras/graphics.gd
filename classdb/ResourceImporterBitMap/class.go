...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterBitMap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterBitMap{gdclass.NewResourceImporterBitMap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
