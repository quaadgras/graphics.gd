...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceImporterBitMap(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceImporterBitMap(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterBitMap{gdclass.NewResourceImporterBitMap(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceImporterBitMap(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterBitMap{gdclass.NewResourceImporterBitMap(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsResourceImporterBitMap() Advanced {
	return Advanced{gdclass.NewResourceImporterBitMap(self.AsObject()[0])}
}
func (self Instance) AsResourceImporterBitMap() Instance {
	return Instance{gdclass.NewResourceImporterBitMap(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("ResourceImporterBitMap", func(ptr gd.Object) any { return Instance{gdclass.NewResourceImporterBitMap(ptr)} })
}
