...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("Texture2DArray"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture2DArray{gdclass.NewTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
