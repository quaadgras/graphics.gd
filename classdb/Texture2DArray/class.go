...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture2DArray{gdclass.NewTexture2DArray(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetTexture2DArray(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Texture2DArray{gdclass.NewTexture2DArray(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("Texture2DArray", func(ptr gd.Object) any { return Instance{gdclass.NewTexture2DArray(ptr)} })
}
