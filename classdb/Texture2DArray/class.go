...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTexture2DArray(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTexture2DArray(self[0]) }
...
func (self class) AsTexture2DArray() Advanced {
	return Advanced{gdclass.NewTexture2DArray(self.AsObject()[0])}
}
func (self Instance) AsTexture2DArray() Instance {
	return Instance{gdclass.NewTexture2DArray(self.AsObject()[0])}
}
