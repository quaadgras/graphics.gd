...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectDelay{gdclass.NewAudioEffectDelay(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
