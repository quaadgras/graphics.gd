...
[/codeblock]
Note: Since [CanvasGroup] and [member CanvasItem.clip_children] both utilize the backbuffer, children of a [CanvasGroup] who have their [member CanvasItem.clip_children] set to anything other than [Canvasitem.ClipChildrenDisabled] will not function correctly.
*/
package CanvasGroup
