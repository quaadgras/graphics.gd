...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCanvasGroup(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCanvasGroup(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CanvasGroup{gdclass.NewCanvasGroup(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCanvasGroup(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CanvasGroup{gdclass.NewCanvasGroup(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCanvasGroup() Advanced {
	return Advanced{gdclass.NewCanvasGroup(self.AsObject()[0])}
}
func (self Instance) AsCanvasGroup() Instance {
	return Instance{gdclass.NewCanvasGroup(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("CanvasGroup", func(ptr gd.Object) any { return Instance{gdclass.NewCanvasGroup(ptr)} })
}
