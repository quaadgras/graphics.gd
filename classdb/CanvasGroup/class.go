...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CanvasGroup")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CanvasGroup{gdclass.NewCanvasGroup(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
