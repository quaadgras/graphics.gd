...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("SphereOccluder3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SphereOccluder3D{gdclass.NewSphereOccluder3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
