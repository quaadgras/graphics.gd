...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SphereOccluder3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SphereOccluder3D{gdclass.NewSphereOccluder3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
