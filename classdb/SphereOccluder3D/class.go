...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSphereOccluder3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSphereOccluder3D(self[0]) }
...
func (self class) AsSphereOccluder3D() Advanced {
	return Advanced{gdclass.NewSphereOccluder3D(self.AsObject()[0])}
}
func (self Instance) AsSphereOccluder3D() Instance {
	return Instance{gdclass.NewSphereOccluder3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsSphereOccluder3D() Instance { return self.Super().AsSphereOccluder3D() }
