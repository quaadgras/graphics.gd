...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialEntityExtension{gdclass.NewOpenXRSpatialEntityExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
