...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSettings")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSettings{gdclass.NewEditorSettings(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
