...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("EditorSettings"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSettings{gdclass.NewEditorSettings(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
