...
/*
A physics joint that restricts the movement of two 2D physics bodies to a fixed axis. For example, a [graphics.gd/classdb/StaticBody2D] representing a piston base can be attached to a [graphics.gd/classdb/RigidBody2D] representing the piston head, moving up and down.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.GrooveJoint2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GrooveJoint2D{pointers.Add[gdclass.GrooveJoint2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.GrooveJoint2D{pointers.New[gdclass.GrooveJoint2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsGrooveJoint2D() Advanced {
	return Advanced{pointers.AsA[gdclass.GrooveJoint2D](self[0])}
}
func (self Instance) AsGrooveJoint2D() Instance {
	return Instance{pointers.AsA[gdclass.GrooveJoint2D](self[0])}
}
...
func init() {
	gdclass.Register("GrooveJoint2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.GrooveJoint2D](ptr)} })
}
