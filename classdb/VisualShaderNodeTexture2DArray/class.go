...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeTexture2DArray(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTexture2DArray(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture2DArray{gdclass.NewVisualShaderNodeTexture2DArray(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTexture2DArray(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DArray{gdclass.NewVisualShaderNodeTexture2DArray(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTexture2DArray() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTexture2DArray(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTexture2DArray() Instance {
	return Instance{gdclass.NewVisualShaderNodeTexture2DArray(self.AsObject()[0])}
}
...
func (self class) AsVisualShaderNodeSample3D() VisualShaderNodeSample3D.Advanced {
	return VisualShaderNodeSample3D.Advanced{gdclass.NewVisualShaderNodeSample3D(self.AsObject()[0])}
}
...
func (self Instance) AsVisualShaderNodeSample3D() VisualShaderNodeSample3D.Instance {
	return VisualShaderNodeSample3D.Instance{gdclass.NewVisualShaderNodeSample3D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture2DArray", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture2DArray(ptr)} })
}
