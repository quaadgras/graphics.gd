...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTexture2DArray")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture2DArray{gdclass.NewVisualShaderNodeTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
