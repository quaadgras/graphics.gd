...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorScriptPicker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorScriptPicker{gdclass.NewEditorScriptPicker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
