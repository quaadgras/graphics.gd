...
/*
Similar to [graphics.gd/classdb/EditorResourcePicker] this [graphics.gd/classdb/Control] node is used in the editor's Inspector dock, but only to edit the script property of a [graphics.gd/classdb/Node]. Default options for creating new resources of all possible subtypes are replaced with dedicated buttons that open the "Attach Node Script" dialog. Can be used with [graphics.gd/classdb/EditorInspectorPlugin] to recreate the same behavior.

Note: You must set the [Instance.ScriptOwner] for the custom context menu items to work.
*/
