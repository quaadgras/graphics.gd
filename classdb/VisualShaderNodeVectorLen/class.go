...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorLen{gdclass.NewVisualShaderNodeVectorLen(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
