...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVectorLen(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeVectorLen(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVectorLen{gdclass.NewVisualShaderNodeVectorLen(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeVectorLen(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorLen{gdclass.NewVisualShaderNodeVectorLen(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeVectorLen() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVectorLen(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVectorLen() Instance {
	return Instance{gdclass.NewVisualShaderNodeVectorLen(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeVectorLen() Instance {
	return self.Super().AsVisualShaderNodeVectorLen()
}
...
func init() {
	gdclass.Register("VisualShaderNodeVectorLen", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorLen(ptr)} })
}
