...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectBandPassFilter{gdclass.NewAudioEffectBandPassFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
