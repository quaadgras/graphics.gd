...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectBandPassFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectBandPassFilter{gdclass.NewAudioEffectBandPassFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
