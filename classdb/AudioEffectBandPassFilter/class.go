...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioEffectBandPassFilter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioEffectBandPassFilter(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectBandPassFilter{gdclass.NewAudioEffectBandPassFilter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioEffectBandPassFilter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectBandPassFilter{gdclass.NewAudioEffectBandPassFilter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsAudioEffectBandPassFilter() Advanced {
	return Advanced{gdclass.NewAudioEffectBandPassFilter(self.AsObject()[0])}
}
func (self Instance) AsAudioEffectBandPassFilter() Instance {
	return Instance{gdclass.NewAudioEffectBandPassFilter(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AudioEffectBandPassFilter", func(ptr gd.Object) any { return Instance{gdclass.NewAudioEffectBandPassFilter(ptr)} })
}
