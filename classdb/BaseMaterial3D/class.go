...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BaseMaterial3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BaseMaterial3D{gdclass.NewBaseMaterial3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
