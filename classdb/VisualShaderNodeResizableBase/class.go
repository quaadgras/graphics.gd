...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeResizableBase](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeResizableBase{pointers.Add[gdclass.VisualShaderNodeResizableBase]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeResizableBase{pointers.New[gdclass.VisualShaderNodeResizableBase]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeResizableBase() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeResizableBase](self[0])}
}
func (self Instance) AsVisualShaderNodeResizableBase() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeResizableBase](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeResizableBase", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeResizableBase](ptr)} })
}
