...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeResizableBase{gdclass.NewVisualShaderNodeResizableBase(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
