...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeResizableBase")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeResizableBase{gdclass.NewVisualShaderNodeResizableBase(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
