...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeResizableBase(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeResizableBase(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeResizableBase{gdclass.NewVisualShaderNodeResizableBase(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeResizableBase(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeResizableBase{gdclass.NewVisualShaderNodeResizableBase(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeResizableBase() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeResizableBase(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeResizableBase() Instance {
	return Instance{gdclass.NewVisualShaderNodeResizableBase(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeResizableBase", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeResizableBase(ptr)} })
}
