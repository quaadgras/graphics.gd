...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ENetConnection")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ENetConnection{gdclass.NewENetConnection(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
