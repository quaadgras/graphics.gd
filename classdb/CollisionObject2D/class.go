...
/*
Abstract base class for 2D physics objects. [CollisionObject2D] can hold any number of [Shape2D]s for collision. Each shape must be assigned to a [i]shape owner[/i]. Shape owners are not nodes and do not appear in the editor, but are accessible through code using the shape_owner_* methods.
...
Note: [Instance.InputEvent] requires [member input_pickable] to be true and at least one [member collision_layer] bit to be set.
*/
...
/*
Called when the mouse pointer enters any of this object's shapes or moves from one shape to another. 'shape_idx' is the child index of the newly entered [Shape2D]. Requires [member input_pickable] to be true and at least one [member collision_layer] bit to be called.
*/
...
/*
Called when the mouse pointer exits any of this object's shapes. 'shape_idx' is the child index of the exited [Shape2D]. Requires [member input_pickable] to be true and at least one [member collision_layer] bit to be called.
*/
