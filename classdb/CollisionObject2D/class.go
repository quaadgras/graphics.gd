...
type Interface interface {
	// Accepts unhandled [graphics.gd/classdb/InputEvent]s. 'shape_idx' is the child index of the clicked [graphics.gd/classdb/Shape2D]. Connect to [Instance.OnInputEvent] to easily pick up these events.
	//
	// Note: [Interface.InputEvent] requires [Instance.InputPickable] to be true and at least one [Instance.CollisionLayer] bit to be set.
	InputEvent(viewport Viewport.Instance, event InputEvent.Instance, shape_idx int)
	// Called when the mouse pointer enters any of this object's shapes. Requires [Instance.InputPickable] to be true and at least one [Instance.CollisionLayer] bit to be set. Note that moving between different shapes within a single [graphics.gd/classdb/CollisionObject2D] won't cause this function to be called.
	MouseEnter()
	// Called when the mouse pointer exits all this object's shapes. Requires [Instance.InputPickable] to be true and at least one [Instance.CollisionLayer] bit to be set. Note that moving between different shapes within a single [graphics.gd/classdb/CollisionObject2D] won't cause this function to be called.
	MouseExit()
	// Called when the mouse pointer enters any of this object's shapes or moves from one shape to another. 'shape_idx' is the child index of the newly entered [graphics.gd/classdb/Shape2D]. Requires [Instance.InputPickable] to be true and at least one [Instance.CollisionLayer] bit to be called.
	MouseShapeEnter(shape_idx int)
	// Called when the mouse pointer exits any of this object's shapes. 'shape_idx' is the child index of the exited [graphics.gd/classdb/Shape2D]. Requires [Instance.InputPickable] to be true and at least one [Instance.CollisionLayer] bit to be called.
...
func (self class) SetPickable(enabled bool) { //gd:CollisionObject2D.set_pickable
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_pickable, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsPickable() bool { //gd:CollisionObject2D.is_pickable
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_pickable, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) ShapeOwnerSetTransform(owner_id int64, transform Transform2D.OriginXY) { //gd:CollisionObject2D.shape_owner_set_transform
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.shape_owner_set_transform, 0|(gdextension.SizeInt<<4)|(gdextension.SizeTransform2D<<8), &struct {
		owner_id  int64
...
func (self class) ShapeOwnerGetTransform(owner_id int64) Transform2D.OriginXY { //gd:CollisionObject2D.shape_owner_get_transform
	var r_ret = gdextension.Call[Transform2D.OriginXY](gd.ObjectChecked(self.AsObject()), methods.shape_owner_get_transform, gdextension.SizeTransform2D|(gdextension.SizeInt<<4), &struct{ owner_id int64 }{owner_id})
	var ret = r_ret
	return ret
}
...
func (self class) ShapeOwnerSetOneWayCollision(owner_id int64, enable bool) { //gd:CollisionObject2D.shape_owner_set_one_way_collision
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.shape_owner_set_one_way_collision, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		owner_id int64
		enable   bool
	}{owner_id, enable})
}
...
func (self class) IsShapeOwnerOneWayCollisionEnabled(owner_id int64) bool { //gd:CollisionObject2D.is_shape_owner_one_way_collision_enabled
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_shape_owner_one_way_collision_enabled, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ owner_id int64 }{owner_id})
	var ret = r_ret
	return ret
}
...
func (self class) ShapeOwnerSetOneWayCollisionMargin(owner_id int64, margin float64) { //gd:CollisionObject2D.shape_owner_set_one_way_collision_margin
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.shape_owner_set_one_way_collision_margin, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
		owner_id int64
		margin   float64
	}{owner_id, margin})
}
...
func (self class) GetShapeOwnerOneWayCollisionMargin(owner_id int64) float64 { //gd:CollisionObject2D.get_shape_owner_one_way_collision_margin
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_shape_owner_one_way_collision_margin, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ owner_id int64 }{owner_id})
	var ret = r_ret
	return ret
}
...
const (
	// When [graphics.gd/classdb/Node.Instance.ProcessMode] is set to [Node.ProcessModeDisabled], remove from the physics simulation to stop all physics interactions with this [graphics.gd/classdb/CollisionObject2D].
	//
	...
	// When [graphics.gd/classdb/Node.Instance.ProcessMode] is set to [Node.ProcessModeDisabled], make the body static. Doesn't affect [graphics.gd/classdb/Area2D]. [graphics.gd/classdb/PhysicsBody2D] can't be affected by forces or other bodies while static.
	//
	// Automatically set [graphics.gd/classdb/PhysicsBody2D] back to its original mode when the [graphics.gd/classdb/Node] is processed again.
