...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDFramebufferPass")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDFramebufferPass{gdclass.NewRDFramebufferPass(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
