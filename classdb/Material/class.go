...
/*
[graphics.gd/classdb/Material] is a base resource used for coloring and shading geometry. All materials inherit from it and almost all [graphics.gd/classdb/VisualInstance3D] derived nodes carry a [graphics.gd/classdb/Material]. A few flags and parameters are shared between all material types and are configured here.

Importantly, you can inherit from [graphics.gd/classdb/Material] to create your own custom material type in script or in GDExtension.
*/
package Material
...
type Interface interface {
	...
	CanDoNextPass() bool
	// Only exposed for the purpose of overriding. You cannot call this function directly. Used internally to determine if [Instance.RenderPriority] should be shown in the editor or not.
...
/*
Only available when running in the editor. Opens a popup that visualizes the generated shader code, including all variants and internal shader code. See also [graphics.gd/classdb/Shader.Instance.InspectNativeShaderCode].
*/
...
/*
Creates a placeholder version of this resource ([graphics.gd/classdb/PlaceholderMaterial]).
*/
