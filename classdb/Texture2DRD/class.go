...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Texture2DRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture2DRD{gdclass.NewTexture2DRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
