...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.Texture2DRD](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture2DRD{pointers.Add[gdclass.Texture2DRD]([3]uint64{})})
	...
	casted := Instance([1]gdclass.Texture2DRD{pointers.New[gdclass.Texture2DRD]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsTexture2DRD() Advanced {
	return Advanced{pointers.AsA[gdclass.Texture2DRD](self[0])}
}
func (self Instance) AsTexture2DRD() Instance {
	return Instance{pointers.AsA[gdclass.Texture2DRD](self[0])}
}
...
func init() {
	gdclass.Register("Texture2DRD", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.Texture2DRD](ptr)} })
}
