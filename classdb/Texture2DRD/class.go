...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTexture2DRD(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTexture2DRD(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture2DRD{gdclass.NewTexture2DRD(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetTexture2DRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Texture2DRD{gdclass.NewTexture2DRD(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsTexture2DRD() Advanced {
	return Advanced{gdclass.NewTexture2DRD(self.AsObject()[0])}
}
func (self Instance) AsTexture2DRD() Instance {
	return Instance{gdclass.NewTexture2DRD(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("Texture2DRD", func(ptr gd.Object) any { return Instance{gdclass.NewTexture2DRD(ptr)} })
}
