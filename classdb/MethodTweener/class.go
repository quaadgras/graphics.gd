...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MethodTweener")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MethodTweener{gdclass.NewMethodTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
