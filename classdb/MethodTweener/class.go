...
func (self class) AsObject() [1]gd.Object { return gdclass.GetMethodTweener(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetMethodTweener(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MethodTweener{gdclass.NewMethodTweener(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetMethodTweener(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.MethodTweener{gdclass.NewMethodTweener(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsMethodTweener() Advanced {
	return Advanced{gdclass.NewMethodTweener(self.AsObject()[0])}
}
func (self Instance) AsMethodTweener() Instance {
	return Instance{gdclass.NewMethodTweener(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("MethodTweener", func(ptr gd.Object) any { return Instance{gdclass.NewMethodTweener(ptr)} })
}
