...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("MethodTweener"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MethodTweener{gdclass.NewMethodTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
