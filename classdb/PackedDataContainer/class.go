...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PackedDataContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PackedDataContainer{gdclass.NewPackedDataContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
