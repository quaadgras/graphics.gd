...
func New() Instance {
	...
	casted := Instance([1]gdclass.PackedDataContainer{gdclass.NewPackedDataContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
