...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebRTCDataChannelExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCDataChannelExtension{gdclass.NewWebRTCDataChannelExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
