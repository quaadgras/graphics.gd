...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCDataChannelExtension{gdclass.NewWebRTCDataChannelExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
