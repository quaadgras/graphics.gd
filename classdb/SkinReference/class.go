...
See also [Instance.Meshinstance3d.GetSkinReference] and [Instance.Renderingserver.InstanceAttachSkeleton].
...
/*
Returns the [RID] owned by this SkinReference, as returned by [Instance.Renderingserver.SkeletonCreate].
*/
