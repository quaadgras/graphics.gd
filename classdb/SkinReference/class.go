...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SkinReference")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkinReference{gdclass.NewSkinReference(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
