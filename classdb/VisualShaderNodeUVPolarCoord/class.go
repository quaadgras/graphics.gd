...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUVPolarCoord{gdclass.NewVisualShaderNodeUVPolarCoord(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
