...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeUVPolarCoord")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUVPolarCoord{gdclass.NewVisualShaderNodeUVPolarCoord(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
