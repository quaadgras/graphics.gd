...
/*
Provides direct access to a physics body in the [graphics.gd/classdb/PhysicsServer2D], allowing safe changes to physics properties. This object is passed via the direct state callback of [graphics.gd/classdb/RigidBody2D], and is intended for changing the direct state of that body. See [graphics.gd/classdb/RigidBody2D.Instance.IntegrateForces].
*/
...
Note: [Instance.InverseInertia] is required for this to work. To have [Instance.InverseInertia], an active [graphics.gd/classdb/CollisionShape2D] must be a child of the node, or you can manually set [Instance.InverseInertia].
*/
...
Note: By default, this returns 0 unless bodies are configured to monitor contacts. See [graphics.gd/classdb/RigidBody2D.Instance.ContactMonitor].
*/
