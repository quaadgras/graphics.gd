...
func (self class) AsObject() [1]gd.Object { return gdclass.GetMeshTexture(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetMeshTexture(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MeshTexture{gdclass.NewMeshTexture(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetMeshTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.MeshTexture{gdclass.NewMeshTexture(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) SetBaseTexture(texture [1]gdclass.Texture2D) { //gd:MeshTexture.set_base_texture
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_base_texture, 0|(gdextension.SizeObject<<4), &struct{ texture gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetTexture2D(texture[0])))})
}
...
func (self class) AsMeshTexture() Advanced {
	return Advanced{gdclass.NewMeshTexture(self.AsObject()[0])}
}
func (self Instance) AsMeshTexture() Instance {
	return Instance{gdclass.NewMeshTexture(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("MeshTexture", func(ptr gd.Object) any { return Instance{gdclass.NewMeshTexture(ptr)} })
}
