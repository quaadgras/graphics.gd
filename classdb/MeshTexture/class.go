...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MeshTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MeshTexture{gdclass.NewMeshTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
