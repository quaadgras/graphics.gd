...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeFrame")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFrame{gdclass.NewVisualShaderNodeFrame(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
