...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFrame{gdclass.NewVisualShaderNodeFrame(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
