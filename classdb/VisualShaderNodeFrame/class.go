...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeFrame(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeFrame(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeFrame{gdclass.NewVisualShaderNodeFrame(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeFrame(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFrame{gdclass.NewVisualShaderNodeFrame(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeFrame() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeFrame(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeFrame() Instance {
	return Instance{gdclass.NewVisualShaderNodeFrame(self.AsObject()[0])}
}
