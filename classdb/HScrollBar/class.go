...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HScrollBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HScrollBar{gdclass.NewHScrollBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
