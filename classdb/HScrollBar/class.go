...
/*
A horizontal scrollbar, typically used to navigate through content that extends beyond the visible width of a control. It is a [graphics.gd/classdb/Range]-based control and goes from left (min) to right (max).
*/
package HScrollBar
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.HScrollBar](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HScrollBar{pointers.Add[gdclass.HScrollBar]([3]uint64{})})
	...
	casted := Instance([1]gdclass.HScrollBar{pointers.New[gdclass.HScrollBar]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsHScrollBar() Advanced { return Advanced{pointers.AsA[gdclass.HScrollBar](self[0])} }
func (self Instance) AsHScrollBar() Instance {
	return Instance{pointers.AsA[gdclass.HScrollBar](self[0])}
}
...
func init() {
	gdclass.Register("HScrollBar", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.HScrollBar](ptr)} })
}
