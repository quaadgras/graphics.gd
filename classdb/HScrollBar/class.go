...
func (self class) AsObject() [1]gd.Object { return gdclass.GetHScrollBar(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetHScrollBar(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HScrollBar{gdclass.NewHScrollBar(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetHScrollBar(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HScrollBar{gdclass.NewHScrollBar(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsHScrollBar() Advanced { return Advanced{gdclass.NewHScrollBar(self.AsObject()[0])} }
func (self Instance) AsHScrollBar() Instance {
	return Instance{gdclass.NewHScrollBar(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("HScrollBar", func(ptr gd.Object) any { return Instance{gdclass.NewHScrollBar(ptr)} })
}
