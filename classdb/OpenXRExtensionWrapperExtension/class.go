...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRExtensionWrapperExtension{gdclass.NewOpenXRExtensionWrapperExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
