...
/*
[graphics.gd/classdb/OpenXRExtensionWrapperExtension] allows clients to implement OpenXR extensions with GDExtension. The extension should be registered with [Instance.RegisterExtensionWrapper].
*/
...
type Interface interface {
	...
	SetViewportCompositionLayerAndGetNextPointer(layer gdextension.Pointer, property_values map[string]Object.PropertyInfo, next_pointer gdextension.Pointer) int
	...
	//
	// 'property_values' contains the values of the properties returned by [Interface.GetViewportCompositionLayerExtensionProperties].
	SetAndroidSurfaceSwapchainCreateInfoAndGetNextPointer(property_values map[string]Object.PropertyInfo, next_pointer gdextension.Pointer) int
}
...
func (self implementation) SetViewportCompositionLayerAndGetNextPointer(layer gdextension.Pointer, property_values map[string]Object.PropertyInfo, next_pointer gdextension.Pointer) (_ int) {
	return
}
...
func (self implementation) SetAndroidSurfaceSwapchainCreateInfoAndGetNextPointer(property_values map[string]Object.PropertyInfo, next_pointer gdextension.Pointer) (_ int) {
	return
}
...
'layer' is a pointer to an XrCompositionLayerBaseHeader struct.
*/
func (Instance) _set_viewport_composition_layer_and_get_next_pointer(impl func(ptr gdclass.Receiver, layer gdextension.Pointer, property_values map[string]Object.PropertyInfo, next_pointer gdextension.Pointer) int) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		self := gdclass.Receiver(reflect.ValueOf(class).UnsafePointer())
		ret := impl(self, layer, gd.DictionaryAs[map[string]Object.PropertyInfo](property_values), next_pointer)
		gd.UnsafeSet(p_back, int64(ret))
	}
}
...
'property_values' contains the values of the properties returned by [Interface.GetViewportCompositionLayerExtensionProperties].
*/
func (Instance) _set_android_surface_swapchain_create_info_and_get_next_pointer(impl func(ptr gdclass.Receiver, property_values map[string]Object.PropertyInfo, next_pointer gdextension.Pointer) int) (cb gd.ExtensionClassCallVirtualFunc) {
	return func(class any, p_args, p_back gdextension.Pointer) {
		...
		var next_pointer = gd.UnsafeGet[gdextension.Pointer](p_args, 1)
		self := gdclass.Receiver(reflect.ValueOf(class).UnsafePointer())
		ret := impl(self, gd.DictionaryAs[map[string]Object.PropertyInfo](property_values), next_pointer)
		gd.UnsafeSet(p_back, int64(ret))
	}
}
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.OpenXRExtensionWrapperExtension](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRExtensionWrapperExtension{pointers.Add[gdclass.OpenXRExtensionWrapperExtension]([3]uint64{})})
	...
	casted := Instance([1]gdclass.OpenXRExtensionWrapperExtension{pointers.New[gdclass.OpenXRExtensionWrapperExtension]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsOpenXRExtensionWrapperExtension() Advanced {
	return Advanced{pointers.AsA[gdclass.OpenXRExtensionWrapperExtension](self[0])}
}
func (self Instance) AsOpenXRExtensionWrapperExtension() Instance {
	return Instance{pointers.AsA[gdclass.OpenXRExtensionWrapperExtension](self[0])}
}
...
func init() {
	gdclass.Register("OpenXRExtensionWrapperExtension", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.OpenXRExtensionWrapperExtension](ptr)} })
}
