...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRExtensionWrapperExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRExtensionWrapperExtension{gdclass.NewOpenXRExtensionWrapperExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
