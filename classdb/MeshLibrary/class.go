...
func (self class) CreateItem(id int64) { //gd:MeshLibrary.create_item
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.create_item, 0|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
}
...
func (self class) SetItemName(id int64, name String.Readable) { //gd:MeshLibrary.set_item_name
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct {
		id   int64
...
func (self class) SetItemMesh(id int64, mesh [1]gdclass.Mesh) { //gd:MeshLibrary.set_item_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_mesh, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct {
		id   int64
...
func (self class) SetItemMeshTransform(id int64, mesh_transform Transform3D.BasisOrigin) { //gd:MeshLibrary.set_item_mesh_transform
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_mesh_transform, 0|(gdextension.SizeInt<<4)|(gdextension.SizeTransform3D<<8), &struct {
		id             int64
...
func (self class) SetItemMeshCastShadow(id int64, shadow_casting_setting RenderingServer.ShadowCastingSetting) { //gd:MeshLibrary.set_item_mesh_cast_shadow
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_mesh_cast_shadow, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		id                     int64
...
func (self class) SetItemNavigationMesh(id int64, navigation_mesh [1]gdclass.NavigationMesh) { //gd:MeshLibrary.set_item_navigation_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_navigation_mesh, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct {
		id              int64
...
func (self class) SetItemNavigationMeshTransform(id int64, navigation_mesh Transform3D.BasisOrigin) { //gd:MeshLibrary.set_item_navigation_mesh_transform
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_navigation_mesh_transform, 0|(gdextension.SizeInt<<4)|(gdextension.SizeTransform3D<<8), &struct {
		id              int64
...
func (self class) SetItemNavigationLayers(id int64, navigation_layers int64) { //gd:MeshLibrary.set_item_navigation_layers
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_navigation_layers, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		id                int64
...
func (self class) SetItemShapes(id int64, shapes Array.Any) { //gd:MeshLibrary.set_item_shapes
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_shapes, 0|(gdextension.SizeInt<<4)|(gdextension.SizeArray<<8), &struct {
		id     int64
...
func (self class) SetItemPreview(id int64, texture [1]gdclass.Texture2D) { //gd:MeshLibrary.set_item_preview
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_item_preview, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct {
		id      int64
...
func (self class) GetItemName(id int64) String.Readable { //gd:MeshLibrary.get_item_name
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_item_name, gdextension.SizeString|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
...
func (self class) GetItemMesh(id int64) [1]gdclass.Mesh { //gd:MeshLibrary.get_item_mesh
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_item_mesh, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
...
func (self class) GetItemMeshTransform(id int64) Transform3D.BasisOrigin { //gd:MeshLibrary.get_item_mesh_transform
	var r_ret = mainthread.Call[Transform3D.BasisOrigin](gd.ObjectChecked(self.AsObject()), methods.get_item_mesh_transform, gdextension.SizeTransform3D|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
...
func (self class) GetItemMeshCastShadow(id int64) RenderingServer.ShadowCastingSetting { //gd:MeshLibrary.get_item_mesh_cast_shadow
	var r_ret = mainthread.Call[RenderingServer.ShadowCastingSetting](gd.ObjectChecked(self.AsObject()), methods.get_item_mesh_cast_shadow, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
	var ret = r_ret
	return ret
}
...
func (self class) GetItemNavigationMesh(id int64) [1]gdclass.NavigationMesh { //gd:MeshLibrary.get_item_navigation_mesh
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_item_navigation_mesh, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
...
func (self class) GetItemNavigationMeshTransform(id int64) Transform3D.BasisOrigin { //gd:MeshLibrary.get_item_navigation_mesh_transform
	var r_ret = mainthread.Call[Transform3D.BasisOrigin](gd.ObjectChecked(self.AsObject()), methods.get_item_navigation_mesh_transform, gdextension.SizeTransform3D|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
	var ret = gd.Transposed(r_ret)
	return ret
}
...
func (self class) GetItemNavigationLayers(id int64) int64 { //gd:MeshLibrary.get_item_navigation_layers
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_item_navigation_layers, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
	var ret = r_ret
	return ret
}
...
func (self class) GetItemShapes(id int64) Array.Any { //gd:MeshLibrary.get_item_shapes
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_item_shapes, gdextension.SizeArray|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
...
func (self class) GetItemPreview(id int64) [1]gdclass.Texture2D { //gd:MeshLibrary.get_item_preview
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_item_preview, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
...
func (self class) RemoveItem(id int64) { //gd:MeshLibrary.remove_item
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.remove_item, 0|(gdextension.SizeInt<<4), &struct{ id int64 }{id})
}
...
func (self class) FindItemByName(name String.Readable) int64 { //gd:MeshLibrary.find_item_by_name
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.find_item_by_name, gdextension.SizeInt|(gdextension.SizeString<<4), &struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))})
	var ret = r_ret
	return ret
}
...
func (self class) GetItemList() Packed.Array[int32] { //gd:MeshLibrary.get_item_list
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_item_list, gdextension.SizePackedArray, &struct{}{})
...
func (self class) GetLastUnusedItemId() int64 { //gd:MeshLibrary.get_last_unused_item_id
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_last_unused_item_id, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
