...
/*
When running in the editor, returns a generated item preview (a 3D rendering in isometric perspective). When used in a running project, returns the manually-defined item preview which can be set using [Instance.SetItemPreview]. Returns an empty [Texture2D] if no preview was manually set in a running project.
*/
