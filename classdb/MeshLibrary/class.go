...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MeshLibrary")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MeshLibrary{gdclass.NewMeshLibrary(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
