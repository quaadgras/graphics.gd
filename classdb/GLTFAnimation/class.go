...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFAnimation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFAnimation{gdclass.NewGLTFAnimation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
