...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.GLTFAnimation](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GLTFAnimation{pointers.Add[gdclass.GLTFAnimation]([3]uint64{})})
	...
	casted := Instance([1]gdclass.GLTFAnimation{pointers.New[gdclass.GLTFAnimation]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) GetLoop() bool { //gd:GLTFAnimation.get_loop
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_loop, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self Instance) AsGLTFAnimation() Instance {
	return Instance{pointers.AsA[gdclass.GLTFAnimation](self[0])}
}
...
func init() {
	gdclass.Register("GLTFAnimation", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.GLTFAnimation](ptr)} })
}
