...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGLTFAnimation(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGLTFAnimation(self[0]) }
...
func (self class) AsGLTFAnimation() Advanced {
	return Advanced{gdclass.NewGLTFAnimation(self.AsObject()[0])}
}
func (self Instance) AsGLTFAnimation() Instance {
	return Instance{gdclass.NewGLTFAnimation(self.AsObject()[0])}
}
