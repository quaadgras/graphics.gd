...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShaderGlobalsOverride{gdclass.NewShaderGlobalsOverride(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
