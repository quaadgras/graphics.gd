...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRMarkerTracker{gdclass.NewOpenXRMarkerTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
