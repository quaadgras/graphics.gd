...
func (self class) SetBandGainDb(band_idx int64, volume_db float64) { //gd:AudioEffectEQ.set_band_gain_db
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_band_gain_db, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
		band_idx  int64
		volume_db float64
	}{band_idx, volume_db})
}
...
func (self class) GetBandGainDb(band_idx int64) float64 { //gd:AudioEffectEQ.get_band_gain_db
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_band_gain_db, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ band_idx int64 }{band_idx})
	var ret = r_ret
	return ret
}
...
func (self class) GetBandCount() int64 { //gd:AudioEffectEQ.get_band_count
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_band_count, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
