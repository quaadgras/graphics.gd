...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectEQ")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectEQ{gdclass.NewAudioEffectEQ(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
