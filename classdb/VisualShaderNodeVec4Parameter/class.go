...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec4Parameter{gdclass.NewVisualShaderNodeVec4Parameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
