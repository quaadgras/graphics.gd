...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFSpecGloss")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFSpecGloss{gdclass.NewGLTFSpecGloss(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
