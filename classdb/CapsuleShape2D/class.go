...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CapsuleShape2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CapsuleShape2D{pointers.Add[gdclass.CapsuleShape2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CapsuleShape2D{pointers.New[gdclass.CapsuleShape2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsCapsuleShape2D() Advanced {
	return Advanced{pointers.AsA[gdclass.CapsuleShape2D](self[0])}
}
func (self Instance) AsCapsuleShape2D() Instance {
	return Instance{pointers.AsA[gdclass.CapsuleShape2D](self[0])}
}
func (self *Extension[T]) AsCapsuleShape2D() Instance { return self.Super().AsCapsuleShape2D() }
...
func init() {
	gdclass.Register("CapsuleShape2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CapsuleShape2D](ptr)} })
}
