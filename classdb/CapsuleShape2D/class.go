...
/*
A 2D capsule shape, intended for use in physics. Usually used to provide a shape for a [graphics.gd/classdb/CollisionShape2D].

Performance: [graphics.gd/classdb/CapsuleShape2D] is fast to check collisions against, but it is slower than [graphics.gd/classdb/RectangleShape2D] and [graphics.gd/classdb/CircleShape2D].
*/
