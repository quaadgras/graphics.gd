...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicalBone3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalBone3D{gdclass.NewPhysicalBone3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
