...
Note: In order to detect physical bones with raycasts, the [graphics.gd/classdb/SkeletonModifier3D.Instance.Active] property of the parent [graphics.gd/classdb/PhysicalBoneSimulator3D] must be true and the [graphics.gd/classdb/Skeleton3D]'s bone must be assigned to [graphics.gd/classdb/PhysicalBone3D] correctly; it means that [Instance.GetBoneId] should return a valid id (>= 0).
*/
