...
Note: In order to detect physical bones with raycasts, the [member SkeletonModifier3D.active] property of the parent [PhysicalBoneSimulator3D] must be true and the [Skeleton3D]'s bone must be assigned to [PhysicalBone3D] correctly; it means that [Instance.GetBoneId] should return a valid id (>= 0).
*/
