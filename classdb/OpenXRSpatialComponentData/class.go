...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentData{gdclass.NewOpenXRSpatialComponentData(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
