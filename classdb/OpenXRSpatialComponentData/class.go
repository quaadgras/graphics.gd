...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialComponentData")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentData{gdclass.NewOpenXRSpatialComponentData(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
