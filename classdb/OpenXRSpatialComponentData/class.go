...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRSpatialComponentData(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRSpatialComponentData(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRSpatialComponentData{gdclass.NewOpenXRSpatialComponentData(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRSpatialComponentData(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentData{gdclass.NewOpenXRSpatialComponentData(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsOpenXRSpatialComponentData() Advanced {
	return Advanced{gdclass.NewOpenXRSpatialComponentData(self.AsObject()[0])}
}
func (self Instance) AsOpenXRSpatialComponentData() Instance {
	return Instance{gdclass.NewOpenXRSpatialComponentData(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRSpatialComponentData() Instance {
...
func init() {
	gdclass.Register("OpenXRSpatialComponentData", func(ptr gd.Object) any { return Instance{gdclass.NewOpenXRSpatialComponentData(ptr)} })
}
