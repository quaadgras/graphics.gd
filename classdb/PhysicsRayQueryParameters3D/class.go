...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsRayQueryParameters3D{gdclass.NewPhysicsRayQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
