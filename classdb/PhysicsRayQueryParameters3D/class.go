...
/*
By changing various properties of this object, such as the ray position, you can configure the parameters for [Instance.Physicsdirectspacestate3d.IntersectRay].
*/
