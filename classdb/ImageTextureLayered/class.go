...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ImageTextureLayered")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageTextureLayered{gdclass.NewImageTextureLayered(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
