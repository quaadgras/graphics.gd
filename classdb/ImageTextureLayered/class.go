...
func (self class) AsObject() [1]gd.Object { return gdclass.GetImageTextureLayered(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetImageTextureLayered(self[0]) }
...
func (self class) AsImageTextureLayered() Advanced {
	return Advanced{gdclass.NewImageTextureLayered(self.AsObject()[0])}
}
func (self Instance) AsImageTextureLayered() Instance {
	return Instance{gdclass.NewImageTextureLayered(self.AsObject()[0])}
}
