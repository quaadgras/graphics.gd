...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageTextureLayered{gdclass.NewImageTextureLayered(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
