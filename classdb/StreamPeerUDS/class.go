...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("StreamPeerUDS"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeerUDS{gdclass.NewStreamPeerUDS(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
