...
/*
Register a [graphics.gd/classdb/PhysicsServer2D] implementation by passing a 'name' and a func that returns a [graphics.gd/classdb/PhysicsServer2D] object.
*/
...
/*
Set the default [graphics.gd/classdb/PhysicsServer2D] implementation to the one identified by 'name', if 'priority' is greater than the priority of the current default implementation.
*/
