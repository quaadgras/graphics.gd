...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsServer2DManager")
...
func singleton() {
	self[0] = gdclass.NewPhysicsServer2DManager(gdreference.RawObject(gdextension.Object(gdunsafe.ObjectGlobal(sname))))
}
