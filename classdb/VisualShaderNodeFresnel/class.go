...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFresnel{gdclass.NewVisualShaderNodeFresnel(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
