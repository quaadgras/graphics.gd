...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeFresnel")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFresnel{gdclass.NewVisualShaderNodeFresnel(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
