...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRHapticVibration{gdclass.NewOpenXRHapticVibration(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
