...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StatusIndicator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StatusIndicator{gdclass.NewStatusIndicator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
