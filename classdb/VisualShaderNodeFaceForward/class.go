...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFaceForward{gdclass.NewVisualShaderNodeFaceForward(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
