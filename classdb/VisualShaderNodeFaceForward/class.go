...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeFaceForward(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeFaceForward(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeFaceForward{gdclass.NewVisualShaderNodeFaceForward(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeFaceForward(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFaceForward{gdclass.NewVisualShaderNodeFaceForward(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeFaceForward() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeFaceForward(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeFaceForward() Instance {
	return Instance{gdclass.NewVisualShaderNodeFaceForward(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeFaceForward() Instance {
	return self.Super().AsVisualShaderNodeFaceForward()
}
...
func init() {
	gdclass.Register("VisualShaderNodeFaceForward", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeFaceForward(ptr)} })
}
