...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeFaceForward")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFaceForward{gdclass.NewVisualShaderNodeFaceForward(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
