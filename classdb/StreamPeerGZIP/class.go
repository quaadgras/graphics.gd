...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StreamPeerGZIP")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeerGZIP{gdclass.NewStreamPeerGZIP(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
