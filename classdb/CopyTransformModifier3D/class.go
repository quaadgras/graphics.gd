...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CopyTransformModifier3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CopyTransformModifier3D{gdclass.NewCopyTransformModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
