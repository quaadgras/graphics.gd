...
func New() Instance {
	...
	casted := Instance([1]gdclass.CopyTransformModifier3D{gdclass.NewCopyTransformModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
