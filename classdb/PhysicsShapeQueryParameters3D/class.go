...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsShapeQueryParameters3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsShapeQueryParameters3D{gdclass.NewPhysicsShapeQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
