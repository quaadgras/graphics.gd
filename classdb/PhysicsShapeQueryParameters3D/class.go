...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsShapeQueryParameters3D{gdclass.NewPhysicsShapeQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
