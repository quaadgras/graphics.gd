...
/*
Can have [graphics.gd/classdb/PathFollow3D] child nodes moving along the [graphics.gd/classdb/Curve3D]. See [graphics.gd/classdb/PathFollow3D] for more information on the usage.

Note that the path is considered as relative to the moved nodes (children of [graphics.gd/classdb/PathFollow3D]). As such, the curve should usually start with a zero vector (0, 0, 0).
*/
package Path3D
