...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPath3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPath3D(self[0]) }
...
func (self class) AsPath3D() Advanced         { return Advanced{gdclass.NewPath3D(self.AsObject()[0])} }
func (self Instance) AsPath3D() Instance      { return Instance{gdclass.NewPath3D(self.AsObject()[0])} }
