...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureLayered")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureLayered{gdclass.NewTextureLayered(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
