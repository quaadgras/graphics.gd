...
func (self class) SetAction(action [1]gdclass.OpenXRAction) { //gd:OpenXRIPBinding.set_action
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_action, 0|(gdextension.SizeObject<<4), &struct{ action gdextension.Object }{gdextension.Object(gd.ObjectChecked(action[0].AsObject()))})
}

//go:nosplit
func (self class) GetAction() [1]gdclass.OpenXRAction { //gd:OpenXRIPBinding.get_action
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_action, gdextension.SizeObject, &struct{}{})
...
func (self class) SetBindingPath(binding_path String.Readable) { //gd:OpenXRIPBinding.set_binding_path
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_binding_path, 0|(gdextension.SizeString<<4), &struct{ binding_path gdextension.String }{pointers.Get(gd.InternalString(binding_path))})
}

//go:nosplit
func (self class) GetBindingPath() String.Readable { //gd:OpenXRIPBinding.get_binding_path
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_binding_path, gdextension.SizeString, &struct{}{})
...
func (self class) SetPaths(paths Packed.Strings) { //gd:OpenXRIPBinding.set_paths
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_paths, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) GetPaths() Packed.Strings { //gd:OpenXRIPBinding.get_paths
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_paths, gdextension.SizePackedArray, &struct{}{})
...
func (self class) GetPathCount() int64 { //gd:OpenXRIPBinding.get_path_count
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_path_count, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) HasPath(path String.Readable) bool { //gd:OpenXRIPBinding.has_path
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_path, gdextension.SizeBool|(gdextension.SizeString<<4), &struct{ path gdextension.String }{pointers.Get(gd.InternalString(path))})
	var ret = r_ret
	return ret
}
...
func (self class) AddPath(path String.Readable) { //gd:OpenXRIPBinding.add_path
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_path, 0|(gdextension.SizeString<<4), &struct{ path gdextension.String }{pointers.Get(gd.InternalString(path))})
}
...
func (self class) RemovePath(path String.Readable) { //gd:OpenXRIPBinding.remove_path
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.remove_path, 0|(gdextension.SizeString<<4), &struct{ path gdextension.String }{pointers.Get(gd.InternalString(path))})
}
