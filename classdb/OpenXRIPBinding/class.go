...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRIPBinding")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRIPBinding{gdclass.NewOpenXRIPBinding(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
