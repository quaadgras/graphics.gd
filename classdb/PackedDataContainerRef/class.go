...
func New() Instance {
	...
	casted := Instance([1]gdclass.PackedDataContainerRef{gdclass.NewPackedDataContainerRef(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
