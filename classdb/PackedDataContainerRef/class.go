...
/*
When packing nested containers using [graphics.gd/classdb/PackedDataContainer], they are recursively packed into [graphics.gd/classdb/PackedDataContainerRef] (only applies to slice and data structure). Their data can be retrieved the same way as from [graphics.gd/classdb/PackedDataContainer].
