...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PackedDataContainerRef")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PackedDataContainerRef{gdclass.NewPackedDataContainerRef(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
