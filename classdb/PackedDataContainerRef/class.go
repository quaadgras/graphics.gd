...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("PackedDataContainerRef"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PackedDataContainerRef{gdclass.NewPackedDataContainerRef(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
