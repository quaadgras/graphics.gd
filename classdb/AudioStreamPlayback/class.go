...
/*
Override this method to customize what happens when the playback starts at the given position, such as by calling [Instance.Audiostreamplayer.Play].
*/
...
/*
Override this method to customize what happens when the playback is stopped, such as by calling [Instance.Audiostreamplayer.Stop].
*/
...
/*
Override this method to customize what happens when seeking this audio stream at the given 'position', such as by calling [Instance.Audiostreamplayer.Seek].
*/
...
/*
Overridable method. Called whenever the audio stream is mixed if the playback is active and [Instance.Audioserver.SetEnableTaggingUsedAudioStreams] has been set to true. Editor plugins may use this method to "tag" the current position along the audio stream and display it in a preview.
*/
...
/*
Set the current value of a playback parameter by name (see [Instance.Audiostream.GetParameterList]).
*/
...
/*
Return the current value of a playback parameter by name (see [Instance.Audiostream.GetParameterList]).
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioStreamPlayback](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlayback{pointers.Add[gdclass.AudioStreamPlayback]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioStreamPlayback{pointers.New[gdclass.AudioStreamPlayback]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetSamplePlayback(playback_sample [1]gdclass.AudioSamplePlayback) { //gd:AudioStreamPlayback.set_sample_playback
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sample_playback, 0|(gdextension.SizeObject<<4), &struct{ playback_sample gdextension.Object }{gdextension.Object(gd.ObjectChecked(playback_sample[0].AsObject()))})
}
...
func (self class) GetSamplePlayback() [1]gdclass.AudioSamplePlayback { //gd:AudioStreamPlayback.get_sample_playback
	var r_ret = gdextension.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_sample_playback, gdextension.SizeObject, &struct{}{})
...
func (self class) MixAudio(rate_scale float64, frames int64) Packed.Array[Vector2.XY] { //gd:AudioStreamPlayback.mix_audio
	var r_ret = gdextension.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.mix_audio, gdextension.SizePackedArray|(gdextension.SizeFloat<<4)|(gdextension.SizeInt<<8), &struct {
		rate_scale float64
		frames     int64
	}{rate_scale, frames})
...
func (self class) Start(from_pos float64) { //gd:AudioStreamPlayback.start
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.start, 0|(gdextension.SizeFloat<<4), &struct{ from_pos float64 }{from_pos})
}
...
func (self class) SeekTo(time float64) { //gd:AudioStreamPlayback.seek
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.seek, 0|(gdextension.SizeFloat<<4), &struct{ time float64 }{time})
}
...
func (self class) GetLoopCount() int64 { //gd:AudioStreamPlayback.get_loop_count
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_loop_count, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsAudioStreamPlayback() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioStreamPlayback](self[0])}
}
func (self Instance) AsAudioStreamPlayback() Instance {
	return Instance{pointers.AsA[gdclass.AudioStreamPlayback](self[0])}
}
...
func init() {
	gdclass.Register("AudioStreamPlayback", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioStreamPlayback](ptr)} })
}
