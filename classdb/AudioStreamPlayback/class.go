...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioStreamPlayback(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioStreamPlayback(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlayback{gdclass.NewAudioStreamPlayback(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioStreamPlayback(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamPlayback{gdclass.NewAudioStreamPlayback(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetSamplePlayback() [1]gdclass.AudioSamplePlayback { //gd:AudioStreamPlayback.get_sample_playback
	...
	var ret = [1]gdclass.AudioSamplePlayback{gdclass.NewAudioSamplePlayback(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsAudioStreamPlayback() Advanced {
	return Advanced{gdclass.NewAudioStreamPlayback(self.AsObject()[0])}
}
func (self Instance) AsAudioStreamPlayback() Instance {
	return Instance{gdclass.NewAudioStreamPlayback(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AudioStreamPlayback", func(ptr gd.Object) any { return Instance{gdclass.NewAudioStreamPlayback(ptr)} })
}
