...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlayback{gdclass.NewAudioStreamPlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
