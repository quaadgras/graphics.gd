...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlayback")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlayback{gdclass.NewAudioStreamPlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
