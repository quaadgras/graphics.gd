...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorProperty")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorProperty{gdclass.NewEditorProperty(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
