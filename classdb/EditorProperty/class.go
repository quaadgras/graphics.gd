...
func (self class) SetLabel(text String.Readable) { //gd:EditorProperty.set_label
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_label, 0|(gdextension.SizeString<<4), &struct{ text gdextension.String }{pointers.Get(gd.InternalString(text))})
}
...
func (self class) SetDrawLabel(draw_label bool) { //gd:EditorProperty.set_draw_label
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_draw_label, 0|(gdextension.SizeBool<<4), &struct{ draw_label bool }{draw_label})
}

//go:nosplit
func (self class) IsDrawLabel() bool { //gd:EditorProperty.is_draw_label
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_draw_label, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDrawBackground(draw_background bool) { //gd:EditorProperty.set_draw_background
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_draw_background, 0|(gdextension.SizeBool<<4), &struct{ draw_background bool }{draw_background})
}

//go:nosplit
func (self class) IsDrawBackground() bool { //gd:EditorProperty.is_draw_background
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_draw_background, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCheckable(checkable bool) { //gd:EditorProperty.set_checkable
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_checkable, 0|(gdextension.SizeBool<<4), &struct{ checkable bool }{checkable})
}

//go:nosplit
func (self class) IsCheckable() bool { //gd:EditorProperty.is_checkable
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_checkable, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetChecked(checked bool) { //gd:EditorProperty.set_checked
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_checked, 0|(gdextension.SizeBool<<4), &struct{ checked bool }{checked})
}

//go:nosplit
func (self class) IsChecked() bool { //gd:EditorProperty.is_checked
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_checked, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDrawWarning(draw_warning bool) { //gd:EditorProperty.set_draw_warning
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_draw_warning, 0|(gdextension.SizeBool<<4), &struct{ draw_warning bool }{draw_warning})
}

//go:nosplit
func (self class) IsDrawWarning() bool { //gd:EditorProperty.is_draw_warning
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_draw_warning, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetKeying(keying bool) { //gd:EditorProperty.set_keying
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_keying, 0|(gdextension.SizeBool<<4), &struct{ keying bool }{keying})
}

//go:nosplit
func (self class) IsKeying() bool { //gd:EditorProperty.is_keying
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_keying, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDeletable(deletable bool) { //gd:EditorProperty.set_deletable
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_deletable, 0|(gdextension.SizeBool<<4), &struct{ deletable bool }{deletable})
}

//go:nosplit
func (self class) IsDeletable() bool { //gd:EditorProperty.is_deletable
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_deletable, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetEditedProperty() String.Name { //gd:EditorProperty.get_edited_property
	var r_ret = mainthread.Call[gdextension.StringName](gd.ObjectChecked(self.AsObject()), methods.get_edited_property, gdextension.SizeStringName, &struct{}{})
...
func (self class) GetEditedObject() [1]gd.Object { //gd:EditorProperty.get_edited_object
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_edited_object, gdextension.SizeObject, &struct{}{})
...
func (self class) UpdateProperty() { //gd:EditorProperty.update_property
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.update_property, 0, &struct{}{})
}
...
func (self class) AddFocusable(control [1]gdclass.Control) { //gd:EditorProperty.add_focusable
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_focusable, 0|(gdextension.SizeObject<<4), &struct{ control gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(control[0].AsObject()[0]))})
}
...
func (self class) SetBottomEditor(editor [1]gdclass.Control) { //gd:EditorProperty.set_bottom_editor
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_bottom_editor, 0|(gdextension.SizeObject<<4), &struct{ editor gdextension.Object }{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(editor[0].AsObject()[0]))})
}
...
func (self class) SetUseFolding(use_folding bool) { //gd:EditorProperty.set_use_folding
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_folding, 0|(gdextension.SizeBool<<4), &struct{ use_folding bool }{use_folding})
}

//go:nosplit
func (self class) IsUsingFolding() bool { //gd:EditorProperty.is_using_folding
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_using_folding, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetNameSplitRatio(ratio float64) { //gd:EditorProperty.set_name_split_ratio
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_name_split_ratio, 0|(gdextension.SizeFloat<<4), &struct{ ratio float64 }{ratio})
}

//go:nosplit
func (self class) GetNameSplitRatio() float64 { //gd:EditorProperty.get_name_split_ratio
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_name_split_ratio, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) Select(focusable int64) { //gd:EditorProperty.select_
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.select_, 0|(gdextension.SizeInt<<4), &struct{ focusable int64 }{focusable})
}
...
func (self class) SetObjectAndProperty(obj [1]gd.Object, property String.Name) { //gd:EditorProperty.set_object_and_property
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_object_and_property, 0|(gdextension.SizeObject<<4)|(gdextension.SizeStringName<<8), &struct {
...
func (self class) SetLabelReference(control [1]gdclass.Control) { //gd:EditorProperty.set_label_reference
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_label_reference, 0|(gdextension.SizeObject<<4), &struct{ control gdextension.Object }{gdextension.Object(gd.ObjectChecked(control[0].AsObject()))})
}
...
func (self class) EmitChanged(property String.Name, value variant.Any, field String.Name, changing bool) { //gd:EditorProperty.emit_changed
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.emit_changed, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeVariant<<8)|(gdextension.SizeStringName<<12)|(gdextension.SizeBool<<16), &struct {
		property gdextension.StringName
