...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("EditorProperty"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorProperty{gdclass.NewEditorProperty(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetEditedProperty() String.Name { //gd:EditorProperty.get_edited_property
	var r_ret = jumponly.Call[gdextension.StringName](gd.ObjectChecked(self.AsObject()), methods.get_edited_property, gdextension.SizeStringName, &struct{}{})
