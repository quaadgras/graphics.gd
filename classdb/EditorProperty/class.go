...
/*
Gets the edited property. If your editor is for a single property (added via [Instance.Editorinspectorplugin.ParseProperty]), then this will return the property.
*/
...
/*
Puts the 'editor' control below the property label. The control must be previously added using [Instance.Node.AddChild].
*/
