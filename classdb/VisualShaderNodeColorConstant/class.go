...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeColorConstant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorConstant{gdclass.NewVisualShaderNodeColorConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
