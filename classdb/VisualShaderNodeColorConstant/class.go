...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeColorConstant](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeColorConstant{pointers.Add[gdclass.VisualShaderNodeColorConstant]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorConstant{pointers.New[gdclass.VisualShaderNodeColorConstant]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetConstant(constant Color.RGBA) { //gd:VisualShaderNodeColorConstant.set_constant
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant, 0|(gdextension.SizeColor<<4), &struct{ constant Color.RGBA }{constant})
}

//go:nosplit
func (self class) GetConstant() Color.RGBA { //gd:VisualShaderNodeColorConstant.get_constant
	var r_ret = mainthread.Call[Color.RGBA](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeColor, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeColorConstant() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeColorConstant](self[0])}
}
func (self Instance) AsVisualShaderNodeColorConstant() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeColorConstant](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeColorConstant", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeColorConstant](ptr)} })
}
