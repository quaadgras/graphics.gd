...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeColorConstant{gdclass.NewVisualShaderNodeColorConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
