...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectLowShelfFilter{gdclass.NewAudioEffectLowShelfFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
