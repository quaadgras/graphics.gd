...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioEffectLowShelfFilter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioEffectLowShelfFilter(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectLowShelfFilter{gdclass.NewAudioEffectLowShelfFilter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioEffectLowShelfFilter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectLowShelfFilter{gdclass.NewAudioEffectLowShelfFilter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsAudioEffectLowShelfFilter() Advanced {
	return Advanced{gdclass.NewAudioEffectLowShelfFilter(self.AsObject()[0])}
}
func (self Instance) AsAudioEffectLowShelfFilter() Instance {
	return Instance{gdclass.NewAudioEffectLowShelfFilter(self.AsObject()[0])}
}
func (self *Extension[T]) AsAudioEffectLowShelfFilter() Instance {
	return self.Super().AsAudioEffectLowShelfFilter()
}
...
func init() {
	gdclass.Register("AudioEffectLowShelfFilter", func(ptr gd.Object) any { return Instance{gdclass.NewAudioEffectLowShelfFilter(ptr)} })
}
