...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsDirectBodyState2DExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsDirectBodyState2DExtension{gdclass.NewPhysicsDirectBodyState2DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
