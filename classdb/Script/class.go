...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Script")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Script{gdclass.NewScript(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
