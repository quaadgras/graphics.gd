...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MenuButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MenuButton{gdclass.NewMenuButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
