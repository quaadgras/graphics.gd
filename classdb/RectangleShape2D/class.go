...
/*
A 2D rectangle shape, intended for use in physics. Usually used to provide a shape for a [graphics.gd/classdb/CollisionShape2D].

Performance: [graphics.gd/classdb/RectangleShape2D] is fast to check collisions against. It is faster than [graphics.gd/classdb/CapsuleShape2D], but slower than [graphics.gd/classdb/CircleShape2D].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.RectangleShape2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RectangleShape2D{pointers.Add[gdclass.RectangleShape2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.RectangleShape2D{pointers.New[gdclass.RectangleShape2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsRectangleShape2D() Advanced {
	return Advanced{pointers.AsA[gdclass.RectangleShape2D](self[0])}
}
func (self Instance) AsRectangleShape2D() Instance {
	return Instance{pointers.AsA[gdclass.RectangleShape2D](self[0])}
}
...
func init() {
	gdclass.Register("RectangleShape2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.RectangleShape2D](ptr)} })
}
