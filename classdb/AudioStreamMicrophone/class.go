...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamMicrophone{gdclass.NewAudioStreamMicrophone(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
