...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamMicrophone")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamMicrophone{gdclass.NewAudioStreamMicrophone(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
