...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeIntParameter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeIntParameter(self[0]) }
...
func (self class) AsVisualShaderNodeIntParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeIntParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeIntParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeIntParameter(self.AsObject()[0])}
}
