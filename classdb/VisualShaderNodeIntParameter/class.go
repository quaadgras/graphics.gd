...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeIntParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntParameter{gdclass.NewVisualShaderNodeIntParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
