...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntParameter{gdclass.NewVisualShaderNodeIntParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
