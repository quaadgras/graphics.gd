...
func (self class) SetMin(value int64) { //gd:VisualShaderNodeIntParameter.set_min
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_min, 0|(gdextension.SizeInt<<4), &struct{ value int64 }{value})
}

//go:nosplit
func (self class) GetMin() int64 { //gd:VisualShaderNodeIntParameter.get_min
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_min, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMax(value int64) { //gd:VisualShaderNodeIntParameter.set_max
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max, 0|(gdextension.SizeInt<<4), &struct{ value int64 }{value})
}

//go:nosplit
func (self class) GetMax() int64 { //gd:VisualShaderNodeIntParameter.get_max
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_max, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetStep(value int64) { //gd:VisualShaderNodeIntParameter.set_step
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_step, 0|(gdextension.SizeInt<<4), &struct{ value int64 }{value})
}

//go:nosplit
func (self class) GetStep() int64 { //gd:VisualShaderNodeIntParameter.get_step
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_step, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetEnumNames(names Packed.Strings) { //gd:VisualShaderNodeIntParameter.set_enum_names
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_enum_names, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) GetEnumNames() Packed.Strings { //gd:VisualShaderNodeIntParameter.get_enum_names
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_enum_names, gdextension.SizePackedArray, &struct{}{})
...
func (self class) SetDefaultValue(value int64) { //gd:VisualShaderNodeIntParameter.set_default_value
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeInt<<4), &struct{ value int64 }{value})
}

//go:nosplit
func (self class) GetDefaultValue() int64 { //gd:VisualShaderNodeIntParameter.get_default_value
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
