...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebSocketPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebSocketPeer{gdclass.NewWebSocketPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
