...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamInteractive")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamInteractive{gdclass.NewAudioStreamInteractive(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
