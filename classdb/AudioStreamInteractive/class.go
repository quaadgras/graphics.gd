...
func (self class) SetClipCount(clip_count int64) { //gd:AudioStreamInteractive.set_clip_count
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_clip_count, 0|(gdextension.SizeInt<<4), &struct{ clip_count int64 }{clip_count})
}

//go:nosplit
func (self class) GetClipCount() int64 { //gd:AudioStreamInteractive.get_clip_count
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_clip_count, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetInitialClip(clip_index int64) { //gd:AudioStreamInteractive.set_initial_clip
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_initial_clip, 0|(gdextension.SizeInt<<4), &struct{ clip_index int64 }{clip_index})
}

//go:nosplit
func (self class) GetInitialClip() int64 { //gd:AudioStreamInteractive.get_initial_clip
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_initial_clip, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetClipName(clip_index int64, name String.Name) { //gd:AudioStreamInteractive.set_clip_name
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_clip_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeStringName<<8), &struct {
		clip_index int64
...
func (self class) GetClipName(clip_index int64) String.Name { //gd:AudioStreamInteractive.get_clip_name
	var r_ret = mainthread.Call[gdextension.StringName](gd.ObjectChecked(self.AsObject()), methods.get_clip_name, gdextension.SizeStringName|(gdextension.SizeInt<<4), &struct{ clip_index int64 }{clip_index})
...
func (self class) SetClipStream(clip_index int64, stream [1]gdclass.AudioStream) { //gd:AudioStreamInteractive.set_clip_stream
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_clip_stream, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct {
		clip_index int64
...
func (self class) GetClipStream(clip_index int64) [1]gdclass.AudioStream { //gd:AudioStreamInteractive.get_clip_stream
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_clip_stream, gdextension.SizeObject|(gdextension.SizeInt<<4), &struct{ clip_index int64 }{clip_index})
...
func (self class) SetClipAutoAdvance(clip_index int64, mode AutoAdvanceMode) { //gd:AudioStreamInteractive.set_clip_auto_advance
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_clip_auto_advance, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		clip_index int64
...
func (self class) GetClipAutoAdvance(clip_index int64) AutoAdvanceMode { //gd:AudioStreamInteractive.get_clip_auto_advance
	var r_ret = mainthread.Call[AutoAdvanceMode](gd.ObjectChecked(self.AsObject()), methods.get_clip_auto_advance, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ clip_index int64 }{clip_index})
	var ret = r_ret
	return ret
}
...
func (self class) SetClipAutoAdvanceNextClip(clip_index int64, auto_advance_next_clip int64) { //gd:AudioStreamInteractive.set_clip_auto_advance_next_clip
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_clip_auto_advance_next_clip, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		clip_index             int64
...
func (self class) GetClipAutoAdvanceNextClip(clip_index int64) int64 { //gd:AudioStreamInteractive.get_clip_auto_advance_next_clip
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_clip_auto_advance_next_clip, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ clip_index int64 }{clip_index})
	var ret = r_ret
	return ret
}
...
func (self class) AddTransition(from_clip int64, to_clip int64, from_time TransitionFromTime, to_time TransitionToTime, fade_mode FadeMode, fade_beats float64, use_filler_clip bool, filler_clip int64, hold_previous bool) { //gd:AudioStreamInteractive.add_transition
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_transition, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeFloat<<24)|(gdextension.SizeBool<<28)|(gdextension.SizeInt<<32)|(gdextension.SizeBool<<36), &struct {
		from_clip       int64
		to_clip         int64
...
func (self class) HasTransition(from_clip int64, to_clip int64) bool { //gd:AudioStreamInteractive.has_transition
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.has_transition, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) EraseTransition(from_clip int64, to_clip int64) { //gd:AudioStreamInteractive.erase_transition
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.erase_transition, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
}
...
func (self class) GetTransitionList() Packed.Array[int32] { //gd:AudioStreamInteractive.get_transition_list
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_transition_list, gdextension.SizePackedArray, &struct{}{})
...
func (self class) GetTransitionFromTime(from_clip int64, to_clip int64) TransitionFromTime { //gd:AudioStreamInteractive.get_transition_from_time
	var r_ret = mainthread.Call[TransitionFromTime](gd.ObjectChecked(self.AsObject()), methods.get_transition_from_time, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) GetTransitionToTime(from_clip int64, to_clip int64) TransitionToTime { //gd:AudioStreamInteractive.get_transition_to_time
	var r_ret = mainthread.Call[TransitionToTime](gd.ObjectChecked(self.AsObject()), methods.get_transition_to_time, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) GetTransitionFadeMode(from_clip int64, to_clip int64) FadeMode { //gd:AudioStreamInteractive.get_transition_fade_mode
	var r_ret = mainthread.Call[FadeMode](gd.ObjectChecked(self.AsObject()), methods.get_transition_fade_mode, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) GetTransitionFadeBeats(from_clip int64, to_clip int64) float64 { //gd:AudioStreamInteractive.get_transition_fade_beats
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_transition_fade_beats, gdextension.SizeFloat|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) IsTransitionUsingFillerClip(from_clip int64, to_clip int64) bool { //gd:AudioStreamInteractive.is_transition_using_filler_clip
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_transition_using_filler_clip, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) GetTransitionFillerClip(from_clip int64, to_clip int64) int64 { //gd:AudioStreamInteractive.get_transition_filler_clip
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_transition_filler_clip, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
...
func (self class) IsTransitionHoldingPrevious(from_clip int64, to_clip int64) bool { //gd:AudioStreamInteractive.is_transition_holding_previous
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_transition_holding_previous, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct {
		from_clip int64
		to_clip   int64
	}{from_clip, to_clip})
	var ret = r_ret
