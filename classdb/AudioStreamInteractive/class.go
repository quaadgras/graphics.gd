...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamInteractive{gdclass.NewAudioStreamInteractive(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
