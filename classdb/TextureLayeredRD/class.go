...
/*
Base class for [graphics.gd/classdb/Texture2DArrayRD], [graphics.gd/classdb/TextureCubemapRD] and [graphics.gd/classdb/TextureCubemapArrayRD]. Cannot be used directly, but contains all the functions necessary for accessing the derived resource types.
*/
