...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureLayeredRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureLayeredRD{gdclass.NewTextureLayeredRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
