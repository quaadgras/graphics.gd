...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.TextureLayeredRD](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.TextureLayeredRD{pointers.Add[gdclass.TextureLayeredRD]([3]uint64{})})
	...
	casted := Instance([1]gdclass.TextureLayeredRD{pointers.New[gdclass.TextureLayeredRD]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetTextureRdRid(texture_rd_rid RID.Any) { //gd:TextureLayeredRD.set_texture_rd_rid
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture_rd_rid, 0|(gdextension.SizeRID<<4), &struct{ texture_rd_rid RID.Any }{texture_rd_rid})
}

//go:nosplit
func (self class) GetTextureRdRid() RID.Any { //gd:TextureLayeredRD.get_texture_rd_rid
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_texture_rd_rid, gdextension.SizeRID, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsTextureLayeredRD() Advanced {
	return Advanced{pointers.AsA[gdclass.TextureLayeredRD](self[0])}
}
func (self Instance) AsTextureLayeredRD() Instance {
	return Instance{pointers.AsA[gdclass.TextureLayeredRD](self[0])}
}
...
func init() {
	gdclass.Register("TextureLayeredRD", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.TextureLayeredRD](ptr)} })
}
