...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTextureLayeredRD(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTextureLayeredRD(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.TextureLayeredRD{gdclass.NewTextureLayeredRD(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetTextureLayeredRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.TextureLayeredRD{gdclass.NewTextureLayeredRD(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsTextureLayeredRD() Advanced {
	return Advanced{gdclass.NewTextureLayeredRD(self.AsObject()[0])}
}
func (self Instance) AsTextureLayeredRD() Instance {
	return Instance{gdclass.NewTextureLayeredRD(self.AsObject()[0])}
}
func (self *Extension[T]) AsTextureLayeredRD() Instance { return self.Super().AsTextureLayeredRD() }
...
func init() {
	gdclass.Register("TextureLayeredRD", func(ptr gd.Object) any { return Instance{gdclass.NewTextureLayeredRD(ptr)} })
}
