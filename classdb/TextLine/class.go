...
func (self class) SetFlags(flags TextServer.JustificationFlag) { //gd:TextLine.set_flags
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_flags, 0|(gdextension.SizeInt<<4), &struct{ flags TextServer.JustificationFlag }{flags})
}

//go:nosplit
func (self class) GetFlags() TextServer.JustificationFlag { //gd:TextLine.get_flags
	var r_ret = mainthread.Call[TextServer.JustificationFlag](gd.ObjectChecked(self.AsObject()), methods.get_flags, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetObjects() Array.Any { //gd:TextLine.get_objects
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_objects, gdextension.SizeArray, &struct{}{})
...
func (self class) GetObjectRect(key variant.Any) Rect2.PositionSize { //gd:TextLine.get_object_rect
	var r_ret = mainthread.Call[Rect2.PositionSize](gd.ObjectChecked(self.AsObject()), methods.get_object_rect, gdextension.SizeRect2|(gdextension.SizeVariant<<4), &struct{ key gdextension.Variant }{gdextension.Variant(pointers.Get(gd.InternalVariant(key)))})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineAscent() float64 { //gd:TextLine.get_line_ascent
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_ascent, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineDescent() float64 { //gd:TextLine.get_line_descent
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_descent, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineWidth() float64 { //gd:TextLine.get_line_width
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_width, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineUnderlinePosition() float64 { //gd:TextLine.get_line_underline_position
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_underline_position, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineUnderlineThickness() float64 { //gd:TextLine.get_line_underline_thickness
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_line_underline_thickness, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) Draw(canvas RID.Any, pos Vector2.XY, color Color.RGBA, oversampling float64) { //gd:TextLine.draw
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeFloat<<16), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		color        Color.RGBA
...
func (self class) DrawOutline(canvas RID.Any, pos Vector2.XY, outline_size int64, color Color.RGBA, oversampling float64) { //gd:TextLine.draw_outline
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.draw_outline, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeFloat<<20), &struct {
		canvas       RID.Any
		pos          Vector2.XY
		outline_size int64
		color        Color.RGBA
...
func (self class) HitTest(coords float64) int64 { //gd:TextLine.hit_test
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.hit_test, gdextension.SizeInt|(gdextension.SizeFloat<<4), &struct{ coords float64 }{coords})
	var ret = r_ret
	return ret
}
