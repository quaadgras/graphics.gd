...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextLine")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextLine{gdclass.NewTextLine(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
