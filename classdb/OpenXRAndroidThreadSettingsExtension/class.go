...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAndroidThreadSettingsExtension{gdclass.NewOpenXRAndroidThreadSettingsExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
