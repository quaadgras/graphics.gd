...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterTexture{gdclass.NewResourceImporterTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
