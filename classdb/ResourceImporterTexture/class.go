...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterTexture{gdclass.NewResourceImporterTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
