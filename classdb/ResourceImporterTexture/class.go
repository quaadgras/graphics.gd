...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("ResourceImporterTexture"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterTexture{gdclass.NewResourceImporterTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
