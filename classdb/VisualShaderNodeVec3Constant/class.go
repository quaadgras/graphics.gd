...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVec3Constant(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeVec3Constant(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeVec3Constant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeVec3Constant() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVec3Constant(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVec3Constant() Instance {
	return Instance{gdclass.NewVisualShaderNodeVec3Constant(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeVec3Constant", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeVec3Constant(ptr)} })
}
