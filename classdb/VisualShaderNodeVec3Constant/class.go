...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVec3Constant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
