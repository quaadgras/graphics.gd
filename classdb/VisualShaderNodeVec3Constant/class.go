...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
