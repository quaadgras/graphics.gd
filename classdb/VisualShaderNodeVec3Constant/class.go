...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeVec3Constant](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVec3Constant{pointers.Add[gdclass.VisualShaderNodeVec3Constant]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Constant{pointers.New[gdclass.VisualShaderNodeVec3Constant]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetConstant(constant Vector3.XYZ) { //gd:VisualShaderNodeVec3Constant.set_constant
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant, 0|(gdextension.SizeVector3<<4), &struct{ constant Vector3.XYZ }{constant})
}

//go:nosplit
func (self class) GetConstant() Vector3.XYZ { //gd:VisualShaderNodeVec3Constant.get_constant
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeVec3Constant() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeVec3Constant](self[0])}
}
func (self Instance) AsVisualShaderNodeVec3Constant() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeVec3Constant](self[0])}
}
func (self *Extension[T]) AsVisualShaderNodeVec3Constant() Instance {
	return self.Super().AsVisualShaderNodeVec3Constant()
}
...
func init() {
	gdclass.Register("VisualShaderNodeVec3Constant", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeVec3Constant](ptr)} })
}
