...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeVec3Constant"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec3Constant{gdclass.NewVisualShaderNodeVec3Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
