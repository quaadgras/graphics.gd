...
func (self class) SetAction(action String.Name) { //gd:InputEventAction.set_action
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_action, 0|(gdextension.SizeStringName<<4), &struct{ action gdextension.StringName }{pointers.Get(gd.InternalStringName(action))})
}

//go:nosplit
func (self class) GetAction() String.Name { //gd:InputEventAction.get_action
	var r_ret = mainthread.Call[gdextension.StringName](gd.ObjectChecked(self.AsObject()), methods.get_action, gdextension.SizeStringName, &struct{}{})
...
func (self class) SetEventIndex(index int64) { //gd:InputEventAction.set_event_index
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_event_index, 0|(gdextension.SizeInt<<4), &struct{ index int64 }{index})
}

//go:nosplit
func (self class) GetEventIndex() int64 { //gd:InputEventAction.get_event_index
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_event_index, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
