...
func (self class) AsObject() [1]gd.Object { return gdclass.GetInputEventAction(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetInputEventAction(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventAction{gdclass.NewInputEventAction(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetInputEventAction(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.InputEventAction{gdclass.NewInputEventAction(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsInputEventAction() Advanced {
	return Advanced{gdclass.NewInputEventAction(self.AsObject()[0])}
}
func (self Instance) AsInputEventAction() Instance {
	return Instance{gdclass.NewInputEventAction(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("InputEventAction", func(ptr gd.Object) any { return Instance{gdclass.NewInputEventAction(ptr)} })
}
