...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventAction")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventAction{gdclass.NewInputEventAction(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
