...
Note: Unlike the other [InputEvent] subclasses which map to unique physical events, this virtual one is not emitted by the engine. This class is useful to emit actions manually with [Instance.Input.ParseInputEvent], which are then received in [Instance.Node.Input]. To check if a physical event matches an action from the Input Map, use [Instance.Inputevent.IsAction] and [Instance.Inputevent.IsActionPressed].
*/
