...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("UPNPDevice")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.UPNPDevice{gdclass.NewUPNPDevice(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
