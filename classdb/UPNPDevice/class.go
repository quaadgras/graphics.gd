...
func (self class) IsValidGateway() bool { //gd:UPNPDevice.is_valid_gateway
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_valid_gateway, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDescriptionUrl(url String.Readable) { //gd:UPNPDevice.set_description_url
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_description_url, 0|(gdextension.SizeString<<4), &struct{ url gdextension.String }{pointers.Get(gd.InternalString(url))})
}

//go:nosplit
func (self class) GetDescriptionUrl() String.Readable { //gd:UPNPDevice.get_description_url
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_description_url, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetServiceType(atype String.Readable) { //gd:UPNPDevice.set_service_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_service_type, 0|(gdextension.SizeString<<4), &struct{ atype gdextension.String }{pointers.Get(gd.InternalString(atype))})
}

//go:nosplit
func (self class) GetServiceType() String.Readable { //gd:UPNPDevice.get_service_type
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_service_type, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetIgdControlUrl(url String.Readable) { //gd:UPNPDevice.set_igd_control_url
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_igd_control_url, 0|(gdextension.SizeString<<4), &struct{ url gdextension.String }{pointers.Get(gd.InternalString(url))})
}

//go:nosplit
func (self class) GetIgdControlUrl() String.Readable { //gd:UPNPDevice.get_igd_control_url
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_igd_control_url, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetIgdServiceType(atype String.Readable) { //gd:UPNPDevice.set_igd_service_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_igd_service_type, 0|(gdextension.SizeString<<4), &struct{ atype gdextension.String }{pointers.Get(gd.InternalString(atype))})
}

//go:nosplit
func (self class) GetIgdServiceType() String.Readable { //gd:UPNPDevice.get_igd_service_type
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_igd_service_type, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetIgdOurAddr(addr String.Readable) { //gd:UPNPDevice.set_igd_our_addr
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_igd_our_addr, 0|(gdextension.SizeString<<4), &struct{ addr gdextension.String }{pointers.Get(gd.InternalString(addr))})
}

//go:nosplit
func (self class) GetIgdOurAddr() String.Readable { //gd:UPNPDevice.get_igd_our_addr
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_igd_our_addr, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetIgdStatus(status IGDStatus) { //gd:UPNPDevice.set_igd_status
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_igd_status, 0|(gdextension.SizeInt<<4), &struct{ status IGDStatus }{status})
}

//go:nosplit
func (self class) GetIgdStatus() IGDStatus { //gd:UPNPDevice.get_igd_status
	var r_ret = mainthread.Call[IGDStatus](gd.ObjectChecked(self.AsObject()), methods.get_igd_status, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
