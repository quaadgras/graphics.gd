...
/*
This class is available only in [graphics.gd/classdb/EditorPlugin]s and can't be instantiated. You can access it using [graphics.gd/classdb/EditorInterface.GetFileSystemDock].

While [graphics.gd/classdb/FileSystemDock] doesn't expose any methods for file manipulation, it can listen for various file-related signals.
*/
...
/*
Registers a new [graphics.gd/classdb/EditorResourceTooltipPlugin].
*/
...
/*
Removes an [graphics.gd/classdb/EditorResourceTooltipPlugin]. Fails if the plugin wasn't previously added.
*/
