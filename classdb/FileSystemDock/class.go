...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FileSystemDock")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FileSystemDock{gdclass.NewFileSystemDock(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
