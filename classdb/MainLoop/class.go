...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MainLoop")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MainLoop{gdclass.NewMainLoop(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
