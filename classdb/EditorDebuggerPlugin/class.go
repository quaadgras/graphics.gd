...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorDebuggerPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorDebuggerPlugin{gdclass.NewEditorDebuggerPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
