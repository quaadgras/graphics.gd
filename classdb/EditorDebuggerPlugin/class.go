...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorDebuggerPlugin{gdclass.NewEditorDebuggerPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
