...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FileAccess")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FileAccess{gdclass.NewFileAccess(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
