...
/*
Calling this method connects this UDP peer to the given 'host'/'port' pair. UDP is in reality connectionless, so this option only means that incoming packets from different addresses are automatically discarded, and that outgoing packets are always sent to the connected address (future calls to [Instance.SetDestAddress] are not allowed). This method does not send any data to the remote peer, to do that, use [Instance.Packetpeer.PutVar] or [Instance.Packetpeer.PutPacket] as usual. See also [UDPServer].
...
/*
Returns the IP of the remote peer that sent the last packet(that was received with [Instance.Packetpeer.GetPacket] or [Instance.Packetpeer.GetVar]).
*/
...
/*
Returns the port of the remote peer that sent the last packet(that was received with [Instance.Packetpeer.GetPacket] or [Instance.Packetpeer.GetVar]).
*/
...
You can join the same multicast group with multiple interfaces. Use [Instance.Ip.GetLocalInterfaces] to know which are available.
