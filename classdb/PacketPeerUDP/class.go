...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PacketPeerUDP")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PacketPeerUDP{gdclass.NewPacketPeerUDP(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
