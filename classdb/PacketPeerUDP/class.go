...
func New() Instance {
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				pointers.Set(gdclass.GetPacketPeerUDP(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.PacketPeerUDP{gdclass.NewPacketPeerUDP(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("PacketPeerUDP", func(ptr gd.Object) any { return Instance{gdclass.NewPacketPeerUDP(ptr)} })
}
