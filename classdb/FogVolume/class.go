...
/*
[graphics.gd/classdb/FogVolume]s are used to add localized fog into the global volumetric fog effect. [graphics.gd/classdb/FogVolume]s can also remove volumetric fog from specific areas if using a [graphics.gd/classdb/FogMaterial] with a negative [graphics.gd/classdb/FogMaterial.Instance.Density].

Performance of [graphics.gd/classdb/FogVolume]s is directly related to their relative size on the screen and the complexity of their attached [graphics.gd/classdb/FogMaterial]. It is best to keep [graphics.gd/classdb/FogVolume]s relatively small and simple where possible.

Note: [graphics.gd/classdb/FogVolume]s only have a visible effect if [graphics.gd/classdb/Environment.Instance.VolumetricFogEnabled] is true. If you don't want fog to be globally visible (but only within [graphics.gd/classdb/FogVolume] nodes), set [graphics.gd/classdb/Environment.Instance.VolumetricFogDensity] to 0.0.
*/
package FogVolume
