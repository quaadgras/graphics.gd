...
func New() Instance {
	...
	casted := Instance([1]gdclass.RandomNumberGenerator{gdclass.NewRandomNumberGenerator(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
