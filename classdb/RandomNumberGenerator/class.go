...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RandomNumberGenerator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RandomNumberGenerator{gdclass.NewRandomNumberGenerator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
