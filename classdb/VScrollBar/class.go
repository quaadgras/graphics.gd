...
/*
A vertical scrollbar, typically used to navigate through content that extends beyond the visible height of a control. It is a [graphics.gd/classdb/Range]-based control and goes from top (min) to bottom (max). Note that this direction is the opposite of [graphics.gd/classdb/VSlider]'s.
*/
package VScrollBar
