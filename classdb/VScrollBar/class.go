...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VScrollBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VScrollBar{gdclass.NewVScrollBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
