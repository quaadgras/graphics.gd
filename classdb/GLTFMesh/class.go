...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFMesh{gdclass.NewGLTFMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
