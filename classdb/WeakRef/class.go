...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WeakRef")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WeakRef{gdclass.NewWeakRef(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
