...
func (self class) AsObject() [1]gd.Object { return gdclass.GetWeakRef(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetWeakRef(self[0]) }
...
func (self class) AsWeakRef() Advanced         { return Advanced{gdclass.NewWeakRef(self.AsObject()[0])} }
func (self Instance) AsWeakRef() Instance      { return Instance{gdclass.NewWeakRef(self.AsObject()[0])} }
