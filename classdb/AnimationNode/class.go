...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNode")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNode{gdclass.NewAnimationNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
