...
/*
When inheriting from [AnimationRootNode], implement this virtual method to return a list of the properties on this animation node. Parameters are custom local memory used for your animation nodes, given a resource can be reused in multiple trees. Format is similar to [Instance.Object.GetPropertyList].
*/
...
Note: This method should only be called from within the [Instance.Animationnodeextension.ProcessAnimationNode] method, and will return an invalid id otherwise.
*/
