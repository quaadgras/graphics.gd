...
Note: Using this method is equivalent to calling [Instance.SetBusVolumeDb] with the result of [Instance.@Globalscope.LinearToDb] on a value.
*/
...
Note: The returned value is equivalent to the result of [Instance.@Globalscope.DbToLinear] on the result of [Instance.GetBusVolumeDb].
*/
...
Note: This can be expensive; it is not recommended to call [Instance.GetOutputLatency] every frame.
*/
...
/*
If set to true, all instances of [AudioStreamPlayback] will call [Instance.Audiostreamplayback.TagUsedStreams] every mix step.
...
If false, the stream will have to be registered before playing it. To prevent lag spikes, register the stream as sample with [Instance.RegisterStreamAsSample].
*/
