...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorContextMenuPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorContextMenuPlugin{gdclass.NewEditorContextMenuPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
