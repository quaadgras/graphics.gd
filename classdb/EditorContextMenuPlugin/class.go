...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorContextMenuPlugin{gdclass.NewEditorContextMenuPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
