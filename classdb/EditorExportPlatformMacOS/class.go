...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformMacOS{gdclass.NewEditorExportPlatformMacOS(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
