...
func (self class) AsObject() [1]gd.Object { return gdclass.GetEditorExportPlatformMacOS(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetEditorExportPlatformMacOS(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorExportPlatformMacOS{gdclass.NewEditorExportPlatformMacOS(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetEditorExportPlatformMacOS(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorExportPlatformMacOS{gdclass.NewEditorExportPlatformMacOS(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsEditorExportPlatformMacOS() Advanced {
	return Advanced{gdclass.NewEditorExportPlatformMacOS(self.AsObject()[0])}
}
func (self Instance) AsEditorExportPlatformMacOS() Instance {
	return Instance{gdclass.NewEditorExportPlatformMacOS(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("EditorExportPlatformMacOS", func(ptr gd.Object) any { return Instance{gdclass.NewEditorExportPlatformMacOS(ptr)} })
}
