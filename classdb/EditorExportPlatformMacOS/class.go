...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformMacOS")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformMacOS{gdclass.NewEditorExportPlatformMacOS(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
