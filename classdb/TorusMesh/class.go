...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TorusMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TorusMesh{gdclass.NewTorusMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
