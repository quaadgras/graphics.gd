...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFileSystemDirectory{gdclass.NewEditorFileSystemDirectory(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
