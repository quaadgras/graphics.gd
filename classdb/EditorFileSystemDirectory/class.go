...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorFileSystemDirectory")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFileSystemDirectory{gdclass.NewEditorFileSystemDirectory(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
