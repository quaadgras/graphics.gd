...
Multiple origin points can be added to the scene tree, but only one can used at a time. All the [graphics.gd/classdb/XRCamera3D], [graphics.gd/classdb/XRController3D], and [graphics.gd/classdb/XRAnchor3D] nodes should be direct children of this node for spatial tracking to work correctly.

It is the position of this node that you update when your character needs to move through your game world while we're not moving in the real world. Movement in the real world is always in relation to this origin point.

For example, if your character is driving a car, the [graphics.gd/classdb/XROrigin3D] node should be a child node of this car. Or, if you're implementing a teleport system to move your character, you should change the position of this node.
*/
package XROrigin3D
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.XROrigin3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.XROrigin3D{pointers.Add[gdclass.XROrigin3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.XROrigin3D{pointers.New[gdclass.XROrigin3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsXROrigin3D() Advanced { return Advanced{pointers.AsA[gdclass.XROrigin3D](self[0])} }
func (self Instance) AsXROrigin3D() Instance {
	return Instance{pointers.AsA[gdclass.XROrigin3D](self[0])}
}
...
func init() {
	gdclass.Register("XROrigin3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.XROrigin3D](ptr)} })
}
