...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XROrigin3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XROrigin3D{gdclass.NewXROrigin3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
