...
func (self class) SetWorldScale(world_scale float64) { //gd:XROrigin3D.set_world_scale
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_world_scale, 0|(gdextension.SizeFloat<<4), &struct{ world_scale float64 }{world_scale})
}

//go:nosplit
func (self class) GetWorldScale() float64 { //gd:XROrigin3D.get_world_scale
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_world_scale, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
