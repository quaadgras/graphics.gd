...
func (self class) SetLayer(layer int64) { //gd:CanvasLayer.set_layer
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_layer, 0|(gdextension.SizeInt<<4), &struct{ layer int64 }{layer})
}

//go:nosplit
func (self class) GetLayer() int64 { //gd:CanvasLayer.get_layer
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_layer, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFollowViewport(enable bool) { //gd:CanvasLayer.set_follow_viewport
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_follow_viewport, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsFollowingViewport() bool { //gd:CanvasLayer.is_following_viewport
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_following_viewport, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFollowViewportScale(scale float64) { //gd:CanvasLayer.set_follow_viewport_scale
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_follow_viewport_scale, 0|(gdextension.SizeFloat<<4), &struct{ scale float64 }{scale})
}

//go:nosplit
func (self class) GetFollowViewportScale() float64 { //gd:CanvasLayer.get_follow_viewport_scale
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_follow_viewport_scale, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
