...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CanvasLayer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CanvasLayer{gdclass.NewCanvasLayer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
