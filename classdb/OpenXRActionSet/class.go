...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRActionSet")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRActionSet{gdclass.NewOpenXRActionSet(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
