...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AnimatableBody3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimatableBody3D{pointers.Add[gdclass.AnimatableBody3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AnimatableBody3D{pointers.New[gdclass.AnimatableBody3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetSyncToPhysics(enable bool) { //gd:AnimatableBody3D.set_sync_to_physics
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sync_to_physics, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsSyncToPhysicsEnabled() bool { //gd:AnimatableBody3D.is_sync_to_physics_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_sync_to_physics_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsAnimatableBody3D() Advanced {
	return Advanced{pointers.AsA[gdclass.AnimatableBody3D](self[0])}
}
func (self Instance) AsAnimatableBody3D() Instance {
	return Instance{pointers.AsA[gdclass.AnimatableBody3D](self[0])}
}
...
func (self class) AsStaticBody3D() StaticBody3D.Advanced {
	return StaticBody3D.Advanced{pointers.AsA[gdclass.StaticBody3D](self[0])}
}
...
func (self Instance) AsStaticBody3D() StaticBody3D.Instance {
	return StaticBody3D.Instance{pointers.AsA[gdclass.StaticBody3D](self[0])}
}
...
func init() {
	gdclass.Register("AnimatableBody3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AnimatableBody3D](ptr)} })
}
