...
/*
An animatable 3D physics body. It can't be moved by external forces or contacts, but can be moved manually by other means such as code, [graphics.gd/classdb/AnimationMixer]s (with [graphics.gd/classdb/AnimationMixer.Instance.CallbackModeProcess] set to [Animationmixer.AnimationCallbackModeProcessPhysics]), and [graphics.gd/classdb/RemoteTransform3D].

When [graphics.gd/classdb/AnimatableBody3D] is moved, its linear and angular velocity are estimated and used to affect other physics bodies in its path. This makes it useful for moving platforms, doors, and other moving objects.
*/
