...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorSphere3D{gdclass.NewGPUParticlesAttractorSphere3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
