...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("GPUParticlesAttractorSphere3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorSphere3D{gdclass.NewGPUParticlesAttractorSphere3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
