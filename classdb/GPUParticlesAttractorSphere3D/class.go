...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticlesAttractorSphere3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorSphere3D{gdclass.NewGPUParticlesAttractorSphere3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
