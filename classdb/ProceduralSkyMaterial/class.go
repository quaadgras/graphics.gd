...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ProceduralSkyMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ProceduralSkyMaterial{gdclass.NewProceduralSkyMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
