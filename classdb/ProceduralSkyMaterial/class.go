...
func New() Instance {
	...
	casted := Instance([1]gdclass.ProceduralSkyMaterial{gdclass.NewProceduralSkyMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
