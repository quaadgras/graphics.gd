...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterImageFont{gdclass.NewResourceImporterImageFont(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
