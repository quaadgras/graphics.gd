...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterImageFont")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterImageFont{gdclass.NewResourceImporterImageFont(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
