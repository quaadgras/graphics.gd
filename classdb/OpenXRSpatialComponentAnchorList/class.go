...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialComponentAnchorList")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentAnchorList{gdclass.NewOpenXRSpatialComponentAnchorList(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
