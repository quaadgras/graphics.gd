...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentAnchorList{gdclass.NewOpenXRSpatialComponentAnchorList(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
