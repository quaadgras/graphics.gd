...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RenderingDevice")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderingDevice{gdclass.NewRenderingDevice(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
