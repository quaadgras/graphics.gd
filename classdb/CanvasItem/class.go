...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CanvasItem")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CanvasItem{gdclass.NewCanvasItem(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
