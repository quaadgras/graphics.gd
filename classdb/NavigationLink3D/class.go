...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationLink3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationLink3D{gdclass.NewNavigationLink3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
