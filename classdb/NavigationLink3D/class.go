...
/*
Sets the [member start_position] that is relative to the link from a global 'position'.
*/
...
/*
Sets the [member end_position] that is relative to the link from a global 'position'.
*/
