...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FABRIK3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FABRIK3D{gdclass.NewFABRIK3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
