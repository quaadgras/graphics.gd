...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CylinderMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CylinderMesh{gdclass.NewCylinderMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
