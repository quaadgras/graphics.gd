...
func (self class) AsObject() [1]gd.Object { return gdclass.GetWebSocketMultiplayerPeer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetWebSocketMultiplayerPeer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.WebSocketMultiplayerPeer{gdclass.NewWebSocketMultiplayerPeer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetWebSocketMultiplayerPeer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.WebSocketMultiplayerPeer{gdclass.NewWebSocketMultiplayerPeer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetPeer(peer_id int64) [1]gdclass.WebSocketPeer { //gd:WebSocketMultiplayerPeer.get_peer
	...
	var ret = [1]gdclass.WebSocketPeer{gdclass.NewWebSocketPeer(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsWebSocketMultiplayerPeer() Advanced {
	return Advanced{gdclass.NewWebSocketMultiplayerPeer(self.AsObject()[0])}
}
func (self Instance) AsWebSocketMultiplayerPeer() Instance {
	return Instance{gdclass.NewWebSocketMultiplayerPeer(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("WebSocketMultiplayerPeer", func(ptr gd.Object) any { return Instance{gdclass.NewWebSocketMultiplayerPeer(ptr)} })
}
