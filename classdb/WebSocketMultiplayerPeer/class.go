...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebSocketMultiplayerPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebSocketMultiplayerPeer{gdclass.NewWebSocketMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
