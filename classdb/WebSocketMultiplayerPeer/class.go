...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebSocketMultiplayerPeer{gdclass.NewWebSocketMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
