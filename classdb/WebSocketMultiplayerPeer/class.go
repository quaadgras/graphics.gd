...
/*
Starts a new multiplayer client connecting to the given 'url'. TLS certificates will be verified against the hostname when connecting using the wss:// protocol. You can pass the optional 'tls_client_options' parameter to customize the trusted certification authorities, or disable the common name verification. See [Instance.Tlsoptions.Client] and [Instance.Tlsoptions.ClientUnsafe].
...
/*
Starts a new multiplayer server listening on the given 'port'. You can optionally specify a 'bind_address', and provide valid 'tls_server_options' to use TLS. See [Instance.Tlsoptions.Server].
*/
