...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("WebSocketMultiplayerPeer"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebSocketMultiplayerPeer{gdclass.NewWebSocketMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
