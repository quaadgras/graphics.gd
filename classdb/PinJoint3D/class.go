...
/*
A physics joint that attaches two 3D physics bodies at a single point, allowing them to freely rotate. For example, a [graphics.gd/classdb/RigidBody3D] can be attached to a [graphics.gd/classdb/StaticBody3D] to create a pendulum or a seesaw.
*/
package PinJoint3D
