...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicalSkyMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalSkyMaterial{gdclass.NewPhysicalSkyMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
