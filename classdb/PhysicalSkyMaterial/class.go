...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicalSkyMaterial{gdclass.NewPhysicalSkyMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
