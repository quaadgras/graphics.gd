...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectPhaser")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectPhaser{gdclass.NewAudioEffectPhaser(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
