...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("RDPipelineSpecializationConstant"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineSpecializationConstant{gdclass.NewRDPipelineSpecializationConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetValue() variant.Any { //gd:RDPipelineSpecializationConstant.get_value
	var r_ret = jumponly.Call[gdextension.Variant](gd.ObjectChecked(self.AsObject()), methods.get_value, gdextension.SizeVariant, &struct{}{})
