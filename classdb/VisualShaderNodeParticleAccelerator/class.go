...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleAccelerator{gdclass.NewVisualShaderNodeParticleAccelerator(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
