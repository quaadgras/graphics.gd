...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleAccelerator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleAccelerator{gdclass.NewVisualShaderNodeParticleAccelerator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
