...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleAccelerator(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleAccelerator{gdclass.NewVisualShaderNodeParticleAccelerator(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeParticleAccelerator(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleAccelerator{gdclass.NewVisualShaderNodeParticleAccelerator(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeParticleAccelerator() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleAccelerator(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleAccelerator() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleAccelerator(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleAccelerator() Instance {
	return self.Super().AsVisualShaderNodeParticleAccelerator()
}
