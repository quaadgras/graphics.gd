...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeUVFunc")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUVFunc{gdclass.NewVisualShaderNodeUVFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
