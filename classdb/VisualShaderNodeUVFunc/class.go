...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUVFunc{gdclass.NewVisualShaderNodeUVFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
