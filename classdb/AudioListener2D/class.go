...
/*
Once added to the scene tree and enabled using [Instance.MakeCurrent], this node will override the location sounds are heard from. Only one [AudioListener2D] can be current. Using [Instance.MakeCurrent] will disable the previous [AudioListener2D].
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioListener2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioListener2D{pointers.Add[gdclass.AudioListener2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioListener2D{pointers.New[gdclass.AudioListener2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsAudioListener2D() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioListener2D](self[0])}
}
func (self Instance) AsAudioListener2D() Instance {
	return Instance{pointers.AsA[gdclass.AudioListener2D](self[0])}
}
...
func init() {
	gdclass.Register("AudioListener2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioListener2D](ptr)} })
}
