...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioListener2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioListener2D{gdclass.NewAudioListener2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
