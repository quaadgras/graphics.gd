...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("JSON")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.JSON{gdclass.NewJSON(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
