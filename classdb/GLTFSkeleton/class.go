...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGLTFSkeleton(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGLTFSkeleton(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GLTFSkeleton{gdclass.NewGLTFSkeleton(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGLTFSkeleton(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GLTFSkeleton{gdclass.NewGLTFSkeleton(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetGodotSkeleton() [1]gdclass.Skeleton3D { //gd:GLTFSkeleton.get_godot_skeleton
	...
	var ret = [1]gdclass.Skeleton3D{gdclass.NewSkeleton3D(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) GetBoneAttachment(idx int64) [1]gdclass.BoneAttachment3D { //gd:GLTFSkeleton.get_bone_attachment
	...
	var ret = [1]gdclass.BoneAttachment3D{gdclass.NewBoneAttachment3D(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
func (self class) AsGLTFSkeleton() Advanced {
	return Advanced{gdclass.NewGLTFSkeleton(self.AsObject()[0])}
}
func (self Instance) AsGLTFSkeleton() Instance {
	return Instance{gdclass.NewGLTFSkeleton(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("GLTFSkeleton", func(ptr gd.Object) any { return Instance{gdclass.NewGLTFSkeleton(ptr)} })
}
