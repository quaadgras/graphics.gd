...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFSkeleton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFSkeleton{gdclass.NewGLTFSkeleton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
