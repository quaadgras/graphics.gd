...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CSGCombiner3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CSGCombiner3D{pointers.Add[gdclass.CSGCombiner3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CSGCombiner3D{pointers.New[gdclass.CSGCombiner3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsCSGCombiner3D() Advanced {
	return Advanced{pointers.AsA[gdclass.CSGCombiner3D](self[0])}
}
func (self Instance) AsCSGCombiner3D() Instance {
	return Instance{pointers.AsA[gdclass.CSGCombiner3D](self[0])}
}
...
func init() {
	gdclass.Register("CSGCombiner3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CSGCombiner3D](ptr)} })
}
