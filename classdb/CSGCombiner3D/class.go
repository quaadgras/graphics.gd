...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCSGCombiner3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCSGCombiner3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CSGCombiner3D{gdclass.NewCSGCombiner3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCSGCombiner3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.CSGCombiner3D{gdclass.NewCSGCombiner3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsCSGCombiner3D() Advanced {
	return Advanced{gdclass.NewCSGCombiner3D(self.AsObject()[0])}
}
func (self Instance) AsCSGCombiner3D() Instance {
	return Instance{gdclass.NewCSGCombiner3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsCSGCombiner3D() Instance { return self.Super().AsCSGCombiner3D() }
...
func init() {
	gdclass.Register("CSGCombiner3D", func(ptr gd.Object) any { return Instance{gdclass.NewCSGCombiner3D(ptr)} })
}
