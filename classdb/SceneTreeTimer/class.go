...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SceneTreeTimer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneTreeTimer{gdclass.NewSceneTreeTimer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
