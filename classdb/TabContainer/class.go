...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TabContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TabContainer{gdclass.NewTabContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
