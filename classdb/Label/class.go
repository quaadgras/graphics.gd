...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Label")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Label{gdclass.NewLabel(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
