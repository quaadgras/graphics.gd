...
func (self class) SetLabelSettings(settings [1]gdclass.LabelSettings) { //gd:Label.set_label_settings
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_label_settings, 0|(gdextension.SizeObject<<4), &struct{ settings gdextension.Object }{gdextension.Object(gd.ObjectChecked(settings[0].AsObject()))})
}

//go:nosplit
func (self class) GetLabelSettings() [1]gdclass.LabelSettings { //gd:Label.get_label_settings
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_label_settings, gdextension.SizeObject, &struct{}{})
...
func (self class) SetParagraphSeparator(paragraph_separator String.Readable) { //gd:Label.set_paragraph_separator
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_paragraph_separator, 0|(gdextension.SizeString<<4), &struct{ paragraph_separator gdextension.String }{pointers.Get(gd.InternalString(paragraph_separator))})
}

//go:nosplit
func (self class) GetParagraphSeparator() String.Readable { //gd:Label.get_paragraph_separator
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_paragraph_separator, gdextension.SizeString, &struct{}{})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func (self class) SetClipText(enable bool) { //gd:Label.set_clip_text
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_clip_text, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) IsClippingText() bool { //gd:Label.is_clipping_text
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_clipping_text, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetLinesSkipped(lines_skipped int64) { //gd:Label.set_lines_skipped
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_lines_skipped, 0|(gdextension.SizeInt<<4), &struct{ lines_skipped int64 }{lines_skipped})
}

//go:nosplit
func (self class) GetLinesSkipped() int64 { //gd:Label.get_lines_skipped
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_lines_skipped, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxLinesVisible(lines_visible int64) { //gd:Label.set_max_lines_visible
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max_lines_visible, 0|(gdextension.SizeInt<<4), &struct{ lines_visible int64 }{lines_visible})
}
...
func (self class) GetCharacterBounds(pos int64) Rect2.PositionSize { //gd:Label.get_character_bounds
	var r_ret = mainthread.Call[Rect2.PositionSize](gd.ObjectChecked(self.AsObject()), methods.get_character_bounds, gdextension.SizeRect2|(gdextension.SizeInt<<4), &struct{ pos int64 }{pos})
	var ret = r_ret
	return ret
}
