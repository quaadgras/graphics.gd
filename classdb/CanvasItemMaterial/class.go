...
/*
[graphics.gd/classdb/CanvasItemMaterial]s provide a means of modifying the textures associated with a CanvasItem. They specialize in describing blend and lighting behaviors for textures. Use a [graphics.gd/classdb/ShaderMaterial] to more fully customize a material's interactions with a [graphics.gd/classdb/CanvasItem].
*/
