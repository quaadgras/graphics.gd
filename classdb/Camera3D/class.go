...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Camera3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Camera3D{gdclass.NewCamera3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
