...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorNode3DGizmo")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorNode3DGizmo{gdclass.NewEditorNode3DGizmo(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
