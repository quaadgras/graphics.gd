...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.NavigationPathQueryResult2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.NavigationPathQueryResult2D{pointers.Add[gdclass.NavigationPathQueryResult2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.NavigationPathQueryResult2D{pointers.New[gdclass.NavigationPathQueryResult2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetPath(path Packed.Array[Vector2.XY]) { //gd:NavigationPathQueryResult2D.set_path
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_path, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) GetPath() Packed.Array[Vector2.XY] { //gd:NavigationPathQueryResult2D.get_path
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_path, gdextension.SizePackedArray, &struct{}{})
...
func (self class) SetPathTypes(path_types Packed.Array[int32]) { //gd:NavigationPathQueryResult2D.set_path_types
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_path_types, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) GetPathTypes() Packed.Array[int32] { //gd:NavigationPathQueryResult2D.get_path_types
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_path_types, gdextension.SizePackedArray, &struct{}{})
...
func (self class) SetPathRids(path_rids Array.Contains[RID.Any]) { //gd:NavigationPathQueryResult2D.set_path_rids
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_path_rids, 0|(gdextension.SizeArray<<4), &struct{ path_rids gdextension.Array }{pointers.Get(gd.InternalArray(path_rids))})
}

//go:nosplit
func (self class) GetPathRids() Array.Contains[RID.Any] { //gd:NavigationPathQueryResult2D.get_path_rids
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_path_rids, gdextension.SizeArray, &struct{}{})
...
func (self class) SetPathOwnerIds(path_owner_ids Packed.Array[int64]) { //gd:NavigationPathQueryResult2D.set_path_owner_ids
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_path_owner_ids, 0|(gdextension.SizePackedArray<<4), &struct {
...
func (self class) GetPathOwnerIds() Packed.Array[int64] { //gd:NavigationPathQueryResult2D.get_path_owner_ids
	var r_ret = mainthread.Call[gd.PackedPointers](gd.ObjectChecked(self.AsObject()), methods.get_path_owner_ids, gdextension.SizePackedArray, &struct{}{})
...
func (self class) SetPathLength(length float64) { //gd:NavigationPathQueryResult2D.set_path_length
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_path_length, 0|(gdextension.SizeFloat<<4), &struct{ length float64 }{length})
}
...
func (self class) AsNavigationPathQueryResult2D() Advanced {
	return Advanced{pointers.AsA[gdclass.NavigationPathQueryResult2D](self[0])}
}
func (self Instance) AsNavigationPathQueryResult2D() Instance {
	return Instance{pointers.AsA[gdclass.NavigationPathQueryResult2D](self[0])}
}
...
func init() {
	gdclass.Register("NavigationPathQueryResult2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.NavigationPathQueryResult2D](ptr)} })
}
