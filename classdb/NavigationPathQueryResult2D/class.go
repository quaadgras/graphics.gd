...
func (self Instance) SetPath(value []Vector2.XY) Instance {
...
func (self Instance) SetPathRids(value []RID.Either[RID.NavigationLink2D, RID.NavigationRegion2D]) Instance {
