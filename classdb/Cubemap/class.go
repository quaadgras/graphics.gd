...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Cubemap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Cubemap{gdclass.NewCubemap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
