...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCubemap(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCubemap(self[0]) }
...
func (self class) AsCubemap() Advanced         { return Advanced{gdclass.NewCubemap(self.AsObject()[0])} }
func (self Instance) AsCubemap() Instance      { return Instance{gdclass.NewCubemap(self.AsObject()[0])} }
...
func (self class) AsImageTextureLayered() ImageTextureLayered.Advanced {
	return ImageTextureLayered.Advanced{gdclass.NewImageTextureLayered(self.AsObject()[0])}
}
...
func (self Instance) AsImageTextureLayered() ImageTextureLayered.Instance {
	return ImageTextureLayered.Instance{gdclass.NewImageTextureLayered(self.AsObject()[0])}
}
