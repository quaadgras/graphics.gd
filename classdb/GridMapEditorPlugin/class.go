...
/*
Returns the [graphics.gd/classdb/GridMap] node currently edited by the grid map editor.
*/
...
/*
Selects the [graphics.gd/classdb/MeshLibrary] item with the given index in the grid map editor's palette. If a negative index is given, no item will be selected. If a value greater than the last index is given, the last item will be selected.
...
/*
Returns the index of the selected [graphics.gd/classdb/MeshLibrary] item in the grid map editor's palette or -1 if no item is selected.
