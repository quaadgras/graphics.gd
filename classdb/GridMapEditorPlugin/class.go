...
func New() Instance {
	...
	casted := Instance([1]gdclass.GridMapEditorPlugin{gdclass.NewGridMapEditorPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
