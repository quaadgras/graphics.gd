...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RenderSceneDataExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneDataExtension{gdclass.NewRenderSceneDataExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
