...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneDataExtension{gdclass.NewRenderSceneDataExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
