...
/*
[graphics.gd/classdb/GridContainer] arranges its child controls in a grid layout. The number of columns is specified by the [Instance.Columns] property, whereas the number of rows depends on how many are needed for the child controls. The number of rows and columns is preserved for every size of the container.

Note: [graphics.gd/classdb/GridContainer] only works with child nodes inheriting from [graphics.gd/classdb/Control]. It won't rearrange child nodes inheriting from [graphics.gd/classdb/Node2D].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.GridContainer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GridContainer{pointers.Add[gdclass.GridContainer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.GridContainer{pointers.New[gdclass.GridContainer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsGridContainer() Advanced {
	return Advanced{pointers.AsA[gdclass.GridContainer](self[0])}
}
func (self Instance) AsGridContainer() Instance {
	return Instance{pointers.AsA[gdclass.GridContainer](self[0])}
}
func (self *Extension[T]) AsGridContainer() Instance { return self.Super().AsGridContainer() }
...
func init() {
	gdclass.Register("GridContainer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.GridContainer](ptr)} })
}
