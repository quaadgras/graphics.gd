...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GridContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GridContainer{gdclass.NewGridContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
