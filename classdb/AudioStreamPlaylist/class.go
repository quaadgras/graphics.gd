...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaylist{gdclass.NewAudioStreamPlaylist(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
