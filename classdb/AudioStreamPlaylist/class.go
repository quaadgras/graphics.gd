...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlaylist")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaylist{gdclass.NewAudioStreamPlaylist(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
