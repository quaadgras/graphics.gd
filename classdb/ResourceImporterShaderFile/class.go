...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterShaderFile")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterShaderFile{gdclass.NewResourceImporterShaderFile(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
