...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterShaderFile{gdclass.NewResourceImporterShaderFile(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
