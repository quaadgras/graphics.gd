...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("ResourceImporterShaderFile"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterShaderFile{gdclass.NewResourceImporterShaderFile(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
