...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceImporterShaderFile(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceImporterShaderFile(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterShaderFile{gdclass.NewResourceImporterShaderFile(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceImporterShaderFile(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterShaderFile{gdclass.NewResourceImporterShaderFile(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsResourceImporterShaderFile() Advanced {
	return Advanced{gdclass.NewResourceImporterShaderFile(self.AsObject()[0])}
}
func (self Instance) AsResourceImporterShaderFile() Instance {
	return Instance{gdclass.NewResourceImporterShaderFile(self.AsObject()[0])}
}
func (self *Extension[T]) AsResourceImporterShaderFile() Instance {
	return self.Super().AsResourceImporterShaderFile()
}
...
func init() {
	gdclass.Register("ResourceImporterShaderFile", func(ptr gd.Object) any { return Instance{gdclass.NewResourceImporterShaderFile(ptr)} })
}
