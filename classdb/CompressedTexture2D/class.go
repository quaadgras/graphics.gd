...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTexture2D{gdclass.NewCompressedTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
