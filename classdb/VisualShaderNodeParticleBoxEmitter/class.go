...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleBoxEmitter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleBoxEmitter{gdclass.NewVisualShaderNodeParticleBoxEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
