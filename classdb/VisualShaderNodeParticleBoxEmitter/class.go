...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleBoxEmitter{gdclass.NewVisualShaderNodeParticleBoxEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
