...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleBoxEmitter(self[0])
}
...
func (self class) AsVisualShaderNodeParticleBoxEmitter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleBoxEmitter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleBoxEmitter() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleBoxEmitter(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleBoxEmitter() Instance {
	return self.Super().AsVisualShaderNodeParticleBoxEmitter()
}
