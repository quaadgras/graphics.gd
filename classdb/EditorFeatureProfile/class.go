...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorFeatureProfile")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFeatureProfile{gdclass.NewEditorFeatureProfile(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
