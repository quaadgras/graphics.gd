...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFeatureProfile{gdclass.NewEditorFeatureProfile(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
