...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3DParameter{gdclass.NewVisualShaderNodeTexture3DParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
