...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTexture3DParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture3DParameter{gdclass.NewVisualShaderNodeTexture3DParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTexture3DParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3DParameter{gdclass.NewVisualShaderNodeTexture3DParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTexture3DParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTexture3DParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTexture3DParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeTexture3DParameter(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeTexture3DParameter() Instance {
	return self.Super().AsVisualShaderNodeTexture3DParameter()
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture3DParameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture3DParameter(ptr)} })
}
