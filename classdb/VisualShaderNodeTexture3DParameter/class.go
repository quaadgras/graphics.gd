...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeTexture3DParameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture3DParameter{pointers.Add[gdclass.VisualShaderNodeTexture3DParameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3DParameter{pointers.New[gdclass.VisualShaderNodeTexture3DParameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeTexture3DParameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeTexture3DParameter](self[0])}
}
func (self Instance) AsVisualShaderNodeTexture3DParameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture3DParameter](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture3DParameter", func(ptr gd.Object) any {
		return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture3DParameter](ptr)}
	})
}
