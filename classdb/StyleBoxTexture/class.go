...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.StyleBoxTexture](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StyleBoxTexture{pointers.Add[gdclass.StyleBoxTexture]([3]uint64{})})
	...
	casted := Instance([1]gdclass.StyleBoxTexture{pointers.New[gdclass.StyleBoxTexture]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetTextureMargin(margin Rect2.Side, size float64) { //gd:StyleBoxTexture.set_texture_margin
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture_margin, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
		margin Rect2.Side
		size   float64
	}{margin, size})
}
...
func (self class) SetTextureMarginAll(size float64) { //gd:StyleBoxTexture.set_texture_margin_all
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture_margin_all, 0|(gdextension.SizeFloat<<4), &struct{ size float64 }{size})
}
...
func (self class) GetTextureMargin(margin Rect2.Side) float64 { //gd:StyleBoxTexture.get_texture_margin
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_texture_margin, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ margin Rect2.Side }{margin})
	var ret = r_ret
	return ret
}
...
func (self class) SetRegionRect(region Rect2.PositionSize) { //gd:StyleBoxTexture.set_region_rect
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_region_rect, 0|(gdextension.SizeRect2<<4), &struct{ region Rect2.PositionSize }{region})
}
...
func (self class) SetDrawCenter(enable bool) { //gd:StyleBoxTexture.set_draw_center
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_draw_center, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}
...
func (self class) SetHAxisStretchMode(mode AxisStretchMode) { //gd:StyleBoxTexture.set_h_axis_stretch_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_h_axis_stretch_mode, 0|(gdextension.SizeInt<<4), &struct{ mode AxisStretchMode }{mode})
}

//go:nosplit
func (self class) GetHAxisStretchMode() AxisStretchMode { //gd:StyleBoxTexture.get_h_axis_stretch_mode
	var r_ret = mainthread.Call[AxisStretchMode](gd.ObjectChecked(self.AsObject()), methods.get_h_axis_stretch_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetVAxisStretchMode(mode AxisStretchMode) { //gd:StyleBoxTexture.set_v_axis_stretch_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_v_axis_stretch_mode, 0|(gdextension.SizeInt<<4), &struct{ mode AxisStretchMode }{mode})
}

//go:nosplit
func (self class) GetVAxisStretchMode() AxisStretchMode { //gd:StyleBoxTexture.get_v_axis_stretch_mode
	var r_ret = mainthread.Call[AxisStretchMode](gd.ObjectChecked(self.AsObject()), methods.get_v_axis_stretch_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsStyleBoxTexture() Advanced {
	return Advanced{pointers.AsA[gdclass.StyleBoxTexture](self[0])}
}
func (self Instance) AsStyleBoxTexture() Instance {
	return Instance{pointers.AsA[gdclass.StyleBoxTexture](self[0])}
}
...
func init() {
	gdclass.Register("StyleBoxTexture", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.StyleBoxTexture](ptr)} })
}
