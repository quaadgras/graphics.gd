...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StyleBoxTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StyleBoxTexture{gdclass.NewStyleBoxTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
