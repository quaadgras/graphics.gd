...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorCompose")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorCompose{gdclass.NewVisualShaderNodeVectorCompose(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
