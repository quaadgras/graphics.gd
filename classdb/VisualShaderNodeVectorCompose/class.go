...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorCompose{gdclass.NewVisualShaderNodeVectorCompose(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
