...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVectorCompose(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeVectorCompose(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVectorCompose{gdclass.NewVisualShaderNodeVectorCompose(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeVectorCompose(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorCompose{gdclass.NewVisualShaderNodeVectorCompose(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeVectorCompose() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVectorCompose(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVectorCompose() Instance {
	return Instance{gdclass.NewVisualShaderNodeVectorCompose(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeVectorCompose() Instance {
	return self.Super().AsVisualShaderNodeVectorCompose()
}
...
func init() {
	gdclass.Register("VisualShaderNodeVectorCompose", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorCompose(ptr)} })
}
