...
func (self class) AsObject() [1]gd.Object { return gdclass.GetWorldEnvironment(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetWorldEnvironment(self[0]) }
...
func (self class) AsWorldEnvironment() Advanced {
	return Advanced{gdclass.NewWorldEnvironment(self.AsObject()[0])}
}
func (self Instance) AsWorldEnvironment() Instance {
	return Instance{gdclass.NewWorldEnvironment(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("WorldEnvironment", func(ptr gd.Object) any { return Instance{gdclass.NewWorldEnvironment(ptr)} })
}
