...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WorldEnvironment")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WorldEnvironment{gdclass.NewWorldEnvironment(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
