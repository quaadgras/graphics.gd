...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CameraAttributes")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CameraAttributes{gdclass.NewCameraAttributes(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
