...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PolygonOccluder3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PolygonOccluder3D{gdclass.NewPolygonOccluder3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
