...
/*
Stores information about screen drag events. See [graphics.gd/classdb/Node.Instance.Input].
*/
...
func (self class) SetIndex(index int64) { //gd:InputEventScreenDrag.set_index
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_index, 0|(gdextension.SizeInt<<4), &struct{ index int64 }{index})
}
