...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventScreenDrag{gdclass.NewInputEventScreenDrag(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
