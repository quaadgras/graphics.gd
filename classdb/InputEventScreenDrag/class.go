...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventScreenDrag")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventScreenDrag{gdclass.NewInputEventScreenDrag(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
