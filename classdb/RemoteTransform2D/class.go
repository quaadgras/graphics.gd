...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RemoteTransform2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RemoteTransform2D{gdclass.NewRemoteTransform2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
