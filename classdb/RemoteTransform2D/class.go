...
/*
[graphics.gd/classdb/RemoteTransform2D] caches the remote node. It may not notice if the remote node disappears; [Instance.ForceUpdateCache] forces it to update the cache again.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.RemoteTransform2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RemoteTransform2D{pointers.Add[gdclass.RemoteTransform2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.RemoteTransform2D{pointers.New[gdclass.RemoteTransform2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsRemoteTransform2D() Advanced {
	return Advanced{pointers.AsA[gdclass.RemoteTransform2D](self[0])}
}
func (self Instance) AsRemoteTransform2D() Instance {
	return Instance{pointers.AsA[gdclass.RemoteTransform2D](self[0])}
}
...
func init() {
	gdclass.Register("RemoteTransform2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.RemoteTransform2D](ptr)} })
}
