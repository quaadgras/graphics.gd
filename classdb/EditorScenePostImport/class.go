...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorScenePostImport")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorScenePostImport{gdclass.NewEditorScenePostImport(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
