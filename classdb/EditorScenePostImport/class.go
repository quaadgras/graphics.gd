...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorScenePostImport{gdclass.NewEditorScenePostImport(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
