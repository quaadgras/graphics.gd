...
func (self class) AsObject() [1]gd.Object { return gdclass.GetEditorScenePostImport(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetEditorScenePostImport(self[0]) }
...
func (self class) AsEditorScenePostImport() Advanced {
	return Advanced{gdclass.NewEditorScenePostImport(self.AsObject()[0])}
}
func (self Instance) AsEditorScenePostImport() Instance {
	return Instance{gdclass.NewEditorScenePostImport(self.AsObject()[0])}
}
