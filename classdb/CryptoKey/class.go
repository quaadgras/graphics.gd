...
/*
The CryptoKey class represents a cryptographic key. Keys can be loaded and saved like any other [graphics.gd/classdb/Resource].

They can be used to generate a self-signed [graphics.gd/classdb/X509Certificate] via [graphics.gd/classdb/Crypto.Instance.GenerateSelfSignedCertificate] and as private key in [graphics.gd/classdb/StreamPeerTLS.Instance.AcceptStream] along with the appropriate certificate.
*/
package CryptoKey
