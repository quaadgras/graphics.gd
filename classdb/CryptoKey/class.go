...
They can be used to generate a self-signed [X509Certificate] via [Instance.Crypto.GenerateSelfSignedCertificate] and as private key in [Instance.Streampeertls.AcceptStream] along with the appropriate certificate.
*/
package CryptoKey
