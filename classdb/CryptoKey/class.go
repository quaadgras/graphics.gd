...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CryptoKey")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CryptoKey{gdclass.NewCryptoKey(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
