...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamRandomizer{gdclass.NewAudioStreamRandomizer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
