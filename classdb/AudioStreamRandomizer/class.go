...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamRandomizer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamRandomizer{gdclass.NewAudioStreamRandomizer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
