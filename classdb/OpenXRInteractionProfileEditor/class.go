...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.OpenXRInteractionProfileEditor](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRInteractionProfileEditor{pointers.Add[gdclass.OpenXRInteractionProfileEditor]([3]uint64{})})
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditor{pointers.New[gdclass.OpenXRInteractionProfileEditor]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsOpenXRInteractionProfileEditor() Advanced {
	return Advanced{pointers.AsA[gdclass.OpenXRInteractionProfileEditor](self[0])}
}
func (self Instance) AsOpenXRInteractionProfileEditor() Instance {
	return Instance{pointers.AsA[gdclass.OpenXRInteractionProfileEditor](self[0])}
}
...
func (self class) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Advanced {
	return OpenXRInteractionProfileEditorBase.Advanced{pointers.AsA[gdclass.OpenXRInteractionProfileEditorBase](self[0])}
}
...
func (self Instance) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Instance {
	return OpenXRInteractionProfileEditorBase.Instance{pointers.AsA[gdclass.OpenXRInteractionProfileEditorBase](self[0])}
}
...
func init() {
	gdclass.Register("OpenXRInteractionProfileEditor", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.OpenXRInteractionProfileEditor](ptr)} })
}
