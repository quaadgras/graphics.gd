...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditor{gdclass.NewOpenXRInteractionProfileEditor(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
