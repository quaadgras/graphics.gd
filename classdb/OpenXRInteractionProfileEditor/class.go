...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRInteractionProfileEditor")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditor{gdclass.NewOpenXRInteractionProfileEditor(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
