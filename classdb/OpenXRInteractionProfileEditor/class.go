...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRInteractionProfileEditor(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetOpenXRInteractionProfileEditor(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRInteractionProfileEditor{gdclass.NewOpenXRInteractionProfileEditor(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRInteractionProfileEditor(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditor{gdclass.NewOpenXRInteractionProfileEditor(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsOpenXRInteractionProfileEditor() Advanced {
	return Advanced{gdclass.NewOpenXRInteractionProfileEditor(self.AsObject()[0])}
}
func (self Instance) AsOpenXRInteractionProfileEditor() Instance {
	return Instance{gdclass.NewOpenXRInteractionProfileEditor(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRInteractionProfileEditor() Instance {
	return self.Super().AsOpenXRInteractionProfileEditor()
}
func (self class) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Advanced {
	return OpenXRInteractionProfileEditorBase.Advanced{gdclass.NewOpenXRInteractionProfileEditorBase(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Instance {
...
func (self Instance) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Instance {
	return OpenXRInteractionProfileEditorBase.Instance{gdclass.NewOpenXRInteractionProfileEditorBase(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("OpenXRInteractionProfileEditor", func(ptr gd.Object) any { return Instance{gdclass.NewOpenXRInteractionProfileEditor(ptr)} })
}
