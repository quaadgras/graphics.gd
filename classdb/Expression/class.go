...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Expression")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Expression{gdclass.NewExpression(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
