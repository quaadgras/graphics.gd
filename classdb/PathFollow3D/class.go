...
func (self class) SetRotationMode(rotation_mode RotationMode) { //gd:PathFollow3D.set_rotation_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_rotation_mode, 0|(gdextension.SizeInt<<4), &struct{ rotation_mode RotationMode }{rotation_mode})
}

//go:nosplit
func (self class) GetRotationMode() RotationMode { //gd:PathFollow3D.get_rotation_mode
	var r_ret = mainthread.Call[RotationMode](gd.ObjectChecked(self.AsObject()), methods.get_rotation_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetUseModelFront(enabled bool) { //gd:PathFollow3D.set_use_model_front
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_model_front, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsUsingModelFront() bool { //gd:PathFollow3D.is_using_model_front
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_using_model_front, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetTiltEnabled(enabled bool) { //gd:PathFollow3D.set_tilt_enabled
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_tilt_enabled, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsTiltEnabled() bool { //gd:PathFollow3D.is_tilt_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_tilt_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) CorrectPosture(transform Transform3D.BasisOrigin, rotation_mode RotationMode) Transform3D.BasisOrigin { //gd:PathFollow3D.correct_posture
	var r_ret = mainthread.CallStatic[Transform3D.BasisOrigin](methods.correct_posture, gdextension.SizeTransform3D|(gdextension.SizeTransform3D<<4)|(gdextension.SizeInt<<8), &struct {
