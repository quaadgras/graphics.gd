...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPathFollow3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPathFollow3D(self[0]) }
...
func (self class) AsPathFollow3D() Advanced {
	return Advanced{gdclass.NewPathFollow3D(self.AsObject()[0])}
}
func (self Instance) AsPathFollow3D() Instance {
	return Instance{gdclass.NewPathFollow3D(self.AsObject()[0])}
}
