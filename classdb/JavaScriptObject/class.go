...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("JavaScriptObject")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.JavaScriptObject{gdclass.NewJavaScriptObject(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
