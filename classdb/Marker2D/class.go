...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.Marker2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Marker2D{pointers.Add[gdclass.Marker2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.Marker2D{pointers.New[gdclass.Marker2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetGizmoExtents(extents float64) { //gd:Marker2D.set_gizmo_extents
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_gizmo_extents, 0|(gdextension.SizeFloat<<4), &struct{ extents float64 }{extents})
}

//go:nosplit
func (self class) GetGizmoExtents() float64 { //gd:Marker2D.get_gizmo_extents
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_gizmo_extents, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsMarker2D() Advanced         { return Advanced{pointers.AsA[gdclass.Marker2D](self[0])} }
func (self Instance) AsMarker2D() Instance      { return Instance{pointers.AsA[gdclass.Marker2D](self[0])} }
func (self *Extension[T]) AsMarker2D() Instance { return self.Super().AsMarker2D() }
...
func init() {
	gdclass.Register("Marker2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.Marker2D](ptr)} })
}
