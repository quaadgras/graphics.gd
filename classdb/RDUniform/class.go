...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDUniform")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDUniform{gdclass.NewRDUniform(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
