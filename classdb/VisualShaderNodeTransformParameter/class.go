...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTransformParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformParameter{gdclass.NewVisualShaderNodeTransformParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
