...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTransformParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTransformParameter{gdclass.NewVisualShaderNodeTransformParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTransformParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformParameter{gdclass.NewVisualShaderNodeTransformParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTransformParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTransformParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTransformParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeTransformParameter(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTransformParameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformParameter(ptr)} })
}
