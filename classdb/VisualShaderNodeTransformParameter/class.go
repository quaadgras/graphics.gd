...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformParameter{gdclass.NewVisualShaderNodeTransformParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
