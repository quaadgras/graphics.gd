...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRandomRange{gdclass.NewVisualShaderNodeRandomRange(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
