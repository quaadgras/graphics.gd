...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeRandomRange(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeRandomRange(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeRandomRange{gdclass.NewVisualShaderNodeRandomRange(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeRandomRange(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRandomRange{gdclass.NewVisualShaderNodeRandomRange(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeRandomRange() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeRandomRange(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeRandomRange() Instance {
	return Instance{gdclass.NewVisualShaderNodeRandomRange(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeRandomRange() Instance {
	return self.Super().AsVisualShaderNodeRandomRange()
}
...
func init() {
	gdclass.Register("VisualShaderNodeRandomRange", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeRandomRange(ptr)} })
}
