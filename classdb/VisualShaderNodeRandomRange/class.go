...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeRandomRange")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRandomRange{gdclass.NewVisualShaderNodeRandomRange(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
