...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TCPServer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TCPServer{gdclass.NewTCPServer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
