...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationObstacle3D{gdclass.NewNavigationObstacle3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
