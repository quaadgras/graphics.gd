...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.NavigationObstacle3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.NavigationObstacle3D{pointers.Add[gdclass.NavigationObstacle3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.NavigationObstacle3D{pointers.New[gdclass.NavigationObstacle3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetAffectNavigationMesh(enabled bool) { //gd:NavigationObstacle3D.set_affect_navigation_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_affect_navigation_mesh, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) GetAffectNavigationMesh() bool { //gd:NavigationObstacle3D.get_affect_navigation_mesh
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_affect_navigation_mesh, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCarveNavigationMesh(enabled bool) { //gd:NavigationObstacle3D.set_carve_navigation_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_carve_navigation_mesh, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) GetCarveNavigationMesh() bool { //gd:NavigationObstacle3D.get_carve_navigation_mesh
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_carve_navigation_mesh, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsNavigationObstacle3D() Advanced {
	return Advanced{pointers.AsA[gdclass.NavigationObstacle3D](self[0])}
}
func (self Instance) AsNavigationObstacle3D() Instance {
	return Instance{pointers.AsA[gdclass.NavigationObstacle3D](self[0])}
}
...
func init() {
	gdclass.Register("NavigationObstacle3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.NavigationObstacle3D](ptr)} })
}
