...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorDecompose")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorDecompose{gdclass.NewVisualShaderNodeVectorDecompose(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
