...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorDecompose{gdclass.NewVisualShaderNodeVectorDecompose(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
