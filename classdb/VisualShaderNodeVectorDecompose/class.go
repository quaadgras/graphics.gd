...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVectorDecompose(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeVectorDecompose(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeVectorDecompose{gdclass.NewVisualShaderNodeVectorDecompose(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeVectorDecompose(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorDecompose{gdclass.NewVisualShaderNodeVectorDecompose(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeVectorDecompose() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVectorDecompose(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVectorDecompose() Instance {
	return Instance{gdclass.NewVisualShaderNodeVectorDecompose(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeVectorDecompose() Instance {
	return self.Super().AsVisualShaderNodeVectorDecompose()
}
...
func init() {
	gdclass.Register("VisualShaderNodeVectorDecompose", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorDecompose(ptr)} })
}
