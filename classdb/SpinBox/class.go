...
/*
[graphics.gd/classdb/SpinBox] is a numerical input text field. It allows entering integers and floating-point numbers.
...
/*
Applies the current value of this [graphics.gd/classdb/SpinBox].
*/
