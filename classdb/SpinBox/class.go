...
Note: If you want to implement drag and drop for the underlying [LineEdit], you can use [Instance.Control.SetDragForwarding] on the node returned by [Instance.GetLineEdit].
*/
package SpinBox
