...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpinBox")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpinBox{gdclass.NewSpinBox(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
