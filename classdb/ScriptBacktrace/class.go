...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("ScriptBacktrace"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptBacktrace{gdclass.NewScriptBacktrace(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetLanguageName() String.Readable { //gd:ScriptBacktrace.get_language_name
	var r_ret = jumponly.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_language_name, gdextension.SizeString, &struct{}{})
