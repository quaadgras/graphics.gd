...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScriptBacktrace")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptBacktrace{gdclass.NewScriptBacktrace(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
