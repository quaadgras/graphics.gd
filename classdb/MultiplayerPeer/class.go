...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("MultiplayerPeer"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiplayerPeer{gdclass.NewMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
