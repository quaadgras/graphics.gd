...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MultiplayerPeer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiplayerPeer{gdclass.NewMultiplayerPeer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
