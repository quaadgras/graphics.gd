...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderMesh{gdclass.NewPlaceholderMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
