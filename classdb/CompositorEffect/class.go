...
type Interface interface {
	// Implement this function with your custom rendering code. 'effect_callback_type' should always match the effect callback type you've specified in [Instance.EffectCallbackType]. 'render_data' provides access to the rendering state, it is only valid during rendering and should not be stored.
