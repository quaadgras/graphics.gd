...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CompositorEffect")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompositorEffect{gdclass.NewCompositorEffect(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
