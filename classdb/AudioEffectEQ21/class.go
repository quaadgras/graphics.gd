...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectEQ21")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectEQ21{gdclass.NewAudioEffectEQ21(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
