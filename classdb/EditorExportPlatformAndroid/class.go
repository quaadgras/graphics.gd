...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformAndroid")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformAndroid{gdclass.NewEditorExportPlatformAndroid(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
