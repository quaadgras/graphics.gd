...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformAndroid{gdclass.NewEditorExportPlatformAndroid(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
