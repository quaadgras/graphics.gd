...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.EditorExportPlatformAndroid](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorExportPlatformAndroid{pointers.Add[gdclass.EditorExportPlatformAndroid]([3]uint64{})})
	...
	casted := Instance([1]gdclass.EditorExportPlatformAndroid{pointers.New[gdclass.EditorExportPlatformAndroid]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsEditorExportPlatformAndroid() Advanced {
	return Advanced{pointers.AsA[gdclass.EditorExportPlatformAndroid](self[0])}
}
func (self Instance) AsEditorExportPlatformAndroid() Instance {
	return Instance{pointers.AsA[gdclass.EditorExportPlatformAndroid](self[0])}
}
...
func init() {
	gdclass.Register("EditorExportPlatformAndroid", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.EditorExportPlatformAndroid](ptr)} })
}
