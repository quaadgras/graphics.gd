...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsPointQueryParameters2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsPointQueryParameters2D{gdclass.NewPhysicsPointQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
