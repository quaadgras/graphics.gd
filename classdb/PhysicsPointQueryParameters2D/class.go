...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PhysicsPointQueryParameters2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PhysicsPointQueryParameters2D{pointers.Add[gdclass.PhysicsPointQueryParameters2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PhysicsPointQueryParameters2D{pointers.New[gdclass.PhysicsPointQueryParameters2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetCanvasInstanceId(canvas_instance_id int64) { //gd:PhysicsPointQueryParameters2D.set_canvas_instance_id
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_canvas_instance_id, 0|(gdextension.SizeInt<<4), &struct{ canvas_instance_id int64 }{canvas_instance_id})
}

//go:nosplit
func (self class) GetCanvasInstanceId() int64 { //gd:PhysicsPointQueryParameters2D.get_canvas_instance_id
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_canvas_instance_id, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsPhysicsPointQueryParameters2D() Advanced {
	return Advanced{pointers.AsA[gdclass.PhysicsPointQueryParameters2D](self[0])}
}
func (self Instance) AsPhysicsPointQueryParameters2D() Instance {
	return Instance{pointers.AsA[gdclass.PhysicsPointQueryParameters2D](self[0])}
}
...
func init() {
	gdclass.Register("PhysicsPointQueryParameters2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PhysicsPointQueryParameters2D](ptr)} })
}
