...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsPointQueryParameters2D{gdclass.NewPhysicsPointQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
