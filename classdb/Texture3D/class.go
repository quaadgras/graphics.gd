...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Texture3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture3D{gdclass.NewTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
