...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PacketPeerDTLS")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PacketPeerDTLS{gdclass.NewPacketPeerDTLS(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
