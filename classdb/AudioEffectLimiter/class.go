...
func (self class) SetThresholdDb(threshold float64) { //gd:AudioEffectLimiter.set_threshold_db
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_threshold_db, 0|(gdextension.SizeFloat<<4), &struct{ threshold float64 }{threshold})
}

//go:nosplit
func (self class) GetThresholdDb() float64 { //gd:AudioEffectLimiter.get_threshold_db
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_threshold_db, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSoftClipDb(soft_clip float64) { //gd:AudioEffectLimiter.set_soft_clip_db
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_soft_clip_db, 0|(gdextension.SizeFloat<<4), &struct{ soft_clip float64 }{soft_clip})
}

//go:nosplit
func (self class) GetSoftClipDb() float64 { //gd:AudioEffectLimiter.get_soft_clip_db
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_soft_clip_db, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSoftClipRatio(soft_clip float64) { //gd:AudioEffectLimiter.set_soft_clip_ratio
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_soft_clip_ratio, 0|(gdextension.SizeFloat<<4), &struct{ soft_clip float64 }{soft_clip})
}

//go:nosplit
func (self class) GetSoftClipRatio() float64 { //gd:AudioEffectLimiter.get_soft_clip_ratio
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_soft_clip_ratio, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
