...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectLimiter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectLimiter{gdclass.NewAudioEffectLimiter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
