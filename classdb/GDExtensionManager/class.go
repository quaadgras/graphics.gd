...
/*
Loads an extension by absolute file path. The 'path' needs to point to a valid [graphics.gd/classdb/GDExtension]. Returns [LoadStatusOk] if successful.
*/
...
/*
Reloads the extension at the given file path. The 'path' needs to point to a valid [graphics.gd/classdb/GDExtension], otherwise this method may return either [LoadStatusNotLoaded] or [LoadStatusFailed].
...
/*
Unloads an extension by file path. The 'path' needs to point to an already loaded [graphics.gd/classdb/GDExtension], otherwise this method returns [LoadStatusNotLoaded].
*/
...
/*
Returns the [graphics.gd/classdb/GDExtension] at the given file 'path', or null if it has not been loaded or does not exist.
*/
