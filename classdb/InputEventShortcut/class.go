...
/*
InputEventShortcut is a special event that can be received in [Instance.Node.Input], [Instance.Node.ShortcutInput], and [Instance.Node.UnhandledInput]. It is typically sent by the editor's Command Palette to trigger actions, but can also be sent manually using [Instance.Viewport.PushInput].
*/
