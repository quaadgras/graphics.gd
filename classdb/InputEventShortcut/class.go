...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventShortcut")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventShortcut{gdclass.NewInputEventShortcut(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
