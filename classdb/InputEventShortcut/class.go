...
/*
InputEventShortcut is a special event that can be received in [graphics.gd/classdb/Node.Instance.Input], [graphics.gd/classdb/Node.Instance.ShortcutInput], and [graphics.gd/classdb/Node.Instance.UnhandledInput]. It is typically sent by the editor's Command Palette to trigger actions, but can also be sent manually using [graphics.gd/classdb/Viewport.Instance.PushInput].
*/
