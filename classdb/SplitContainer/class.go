...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSplitContainer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSplitContainer(self[0]) }
...
func (self class) AsSplitContainer() Advanced {
	return Advanced{gdclass.NewSplitContainer(self.AsObject()[0])}
}
func (self Instance) AsSplitContainer() Instance {
	return Instance{gdclass.NewSplitContainer(self.AsObject()[0])}
}
