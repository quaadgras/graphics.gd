...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SplitContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SplitContainer{gdclass.NewSplitContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
