...
/*
A node that provides a thickened polygon shape (a prism) to a [graphics.gd/classdb/CollisionObject3D] parent and allows to edit it. The polygon can be concave or convex. This can give a detection shape to an [graphics.gd/classdb/Area3D] or turn [graphics.gd/classdb/PhysicsBody3D] into a solid object.

Warning: A non-uniformly scaled [graphics.gd/classdb/CollisionShape3D] will likely not behave as expected. Make sure to keep its scale the same on all axes and adjust its shape resource instead.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CollisionPolygon3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CollisionPolygon3D{pointers.Add[gdclass.CollisionPolygon3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CollisionPolygon3D{pointers.New[gdclass.CollisionPolygon3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetEnableDebugFill(enable bool) { //gd:CollisionPolygon3D.set_enable_debug_fill
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_enable_debug_fill, 0|(gdextension.SizeBool<<4), &struct{ enable bool }{enable})
}

//go:nosplit
func (self class) GetEnableDebugFill() bool { //gd:CollisionPolygon3D.get_enable_debug_fill
	var r_ret = gdextension.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_enable_debug_fill, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsCollisionPolygon3D() Advanced {
	return Advanced{pointers.AsA[gdclass.CollisionPolygon3D](self[0])}
}
func (self Instance) AsCollisionPolygon3D() Instance {
	return Instance{pointers.AsA[gdclass.CollisionPolygon3D](self[0])}
}
func (self *Extension[T]) AsCollisionPolygon3D() Instance { return self.Super().AsCollisionPolygon3D() }
...
func init() {
	gdclass.Register("CollisionPolygon3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CollisionPolygon3D](ptr)} })
}
