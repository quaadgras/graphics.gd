...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPolyphonic{gdclass.NewAudioStreamPolyphonic(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
