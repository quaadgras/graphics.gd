...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPolyphonic")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPolyphonic{gdclass.NewAudioStreamPolyphonic(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
