...
/*
Playback component of [graphics.gd/classdb/AudioStreamInteractive]. Contains functions to change the currently played clip.
*/
...
/*
Return the index of the currently playing clip. You can use this to get the name of the currently playing clip with [graphics.gd/classdb/AudioStreamInteractive.Instance.GetClipName].

Example: Get the currently playing clip name from inside an [graphics.gd/classdb/AudioStreamPlayer] node.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioStreamPlaybackInteractive](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlaybackInteractive{pointers.Add[gdclass.AudioStreamPlaybackInteractive]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackInteractive{pointers.New[gdclass.AudioStreamPlaybackInteractive]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsAudioStreamPlaybackInteractive() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioStreamPlaybackInteractive](self[0])}
}
func (self Instance) AsAudioStreamPlaybackInteractive() Instance {
	return Instance{pointers.AsA[gdclass.AudioStreamPlaybackInteractive](self[0])}
}
...
func init() {
	gdclass.Register("AudioStreamPlaybackInteractive", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioStreamPlaybackInteractive](ptr)} })
}
