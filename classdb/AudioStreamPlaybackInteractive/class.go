...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackInteractive{gdclass.NewAudioStreamPlaybackInteractive(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
