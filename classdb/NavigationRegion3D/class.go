...
func (self class) SetNavigationMesh(navigation_mesh [1]gdclass.NavigationMesh) { //gd:NavigationRegion3D.set_navigation_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_navigation_mesh, 0|(gdextension.SizeObject<<4), &struct{ navigation_mesh gdextension.Object }{gdextension.Object(gd.ObjectChecked(navigation_mesh[0].AsObject()))})
}
...
func (self class) BakeNavigationMesh(on_thread bool) { //gd:NavigationRegion3D.bake_navigation_mesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.bake_navigation_mesh, 0|(gdextension.SizeBool<<4), &struct{ on_thread bool }{on_thread})
}
