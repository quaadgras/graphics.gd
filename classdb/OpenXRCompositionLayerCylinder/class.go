...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRCompositionLayerCylinder")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerCylinder{gdclass.NewOpenXRCompositionLayerCylinder(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
