...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerCylinder{gdclass.NewOpenXRCompositionLayerCylinder(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
