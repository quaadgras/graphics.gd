...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XMLParser")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XMLParser{gdclass.NewXMLParser(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
