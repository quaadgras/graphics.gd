...
/*
The base [Resource] for every audio effect. In the editor, an audio effect can be added to the current bus layout through the Audio panel. At run-time, it is also possible to manipulate audio effects through [Instance.Audioserver.AddBusEffect], [Instance.Audioserver.RemoveBusEffect], and [Instance.Audioserver.GetBusEffect].
...
/*
Override this method to customize the [AudioEffectInstance] created when this effect is applied on a bus in the editor's Audio panel, or through [Instance.Audioserver.AddBusEffect].
[codeblock]
extends AudioEffect
