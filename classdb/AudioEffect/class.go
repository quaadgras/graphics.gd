...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffect")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffect{gdclass.NewAudioEffect(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
