...
PointMeshes, must be used with a material that has a point size. Point size can be accessed in a shader with POINT_SIZE, or in a [graphics.gd/classdb/BaseMaterial3D] by setting [graphics.gd/classdb/BaseMaterial3D.Instance.UsePointSize] and the variable [graphics.gd/classdb/BaseMaterial3D.Instance.PointSize].
