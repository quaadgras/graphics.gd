...
func (self class) AsObject() [1]gd.Object { return gdclass.GetMultiMeshInstance2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetMultiMeshInstance2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MultiMeshInstance2D{gdclass.NewMultiMeshInstance2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetMultiMeshInstance2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.MultiMeshInstance2D{gdclass.NewMultiMeshInstance2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetMultimesh() [1]gdclass.MultiMesh { //gd:MultiMeshInstance2D.get_multimesh
	...
	var ret = [1]gdclass.MultiMesh{gdclass.NewMultiMesh(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsMultiMeshInstance2D() Advanced {
	return Advanced{gdclass.NewMultiMeshInstance2D(self.AsObject()[0])}
}
func (self Instance) AsMultiMeshInstance2D() Instance {
	return Instance{gdclass.NewMultiMeshInstance2D(self.AsObject()[0])}
}
