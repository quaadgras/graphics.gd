...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.MultiMeshInstance2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.MultiMeshInstance2D{pointers.Add[gdclass.MultiMeshInstance2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.MultiMeshInstance2D{pointers.New[gdclass.MultiMeshInstance2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetMultimesh(multimesh [1]gdclass.MultiMesh) { //gd:MultiMeshInstance2D.set_multimesh
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_multimesh, 0|(gdextension.SizeObject<<4), &struct{ multimesh gdextension.Object }{gdextension.Object(gd.ObjectChecked(multimesh[0].AsObject()))})
}

//go:nosplit
func (self class) GetMultimesh() [1]gdclass.MultiMesh { //gd:MultiMeshInstance2D.get_multimesh
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_multimesh, gdextension.SizeObject, &struct{}{})
...
func (self class) AsMultiMeshInstance2D() Advanced {
	return Advanced{pointers.AsA[gdclass.MultiMeshInstance2D](self[0])}
}
func (self Instance) AsMultiMeshInstance2D() Instance {
	return Instance{pointers.AsA[gdclass.MultiMeshInstance2D](self[0])}
}
...
func init() {
	gdclass.Register("MultiMeshInstance2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.MultiMeshInstance2D](ptr)} })
}
