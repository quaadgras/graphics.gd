...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiMeshInstance2D{gdclass.NewMultiMeshInstance2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
