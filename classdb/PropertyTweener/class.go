...
/*
[PropertyTweener] is used to interpolate a property in an object. See [Instance.Tween.TweenProperty] for more usage information.
The tweener will finish automatically if the target object is freed.
Note: [Instance.Tween.TweenProperty] is the only correct way to create [PropertyTweener]. Any [PropertyTweener] created manually will not function correctly.
*/
...
/*
Makes the [PropertyTweener] use the current property value (i.e. at the time of creating this [PropertyTweener]) as a starting point. This is equivalent of using [Instance.From] with the current value. These two calls will do the same:
