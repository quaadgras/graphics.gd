...
func New() Instance {
	...
	casted := Instance([1]gdclass.PropertyTweener{gdclass.NewPropertyTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
