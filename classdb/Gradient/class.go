...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Gradient")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Gradient{gdclass.NewGradient(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
