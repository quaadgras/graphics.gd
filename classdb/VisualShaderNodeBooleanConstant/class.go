...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeBooleanConstant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanConstant{gdclass.NewVisualShaderNodeBooleanConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
