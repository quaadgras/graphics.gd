...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanConstant{gdclass.NewVisualShaderNodeBooleanConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
