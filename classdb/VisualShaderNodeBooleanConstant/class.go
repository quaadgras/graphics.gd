...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeBooleanConstant](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeBooleanConstant{pointers.Add[gdclass.VisualShaderNodeBooleanConstant]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanConstant{pointers.New[gdclass.VisualShaderNodeBooleanConstant]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetConstant(constant bool) { //gd:VisualShaderNodeBooleanConstant.set_constant
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant, 0|(gdextension.SizeBool<<4), &struct{ constant bool }{constant})
}

//go:nosplit
func (self class) GetConstant() bool { //gd:VisualShaderNodeBooleanConstant.get_constant
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeBooleanConstant() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeBooleanConstant](self[0])}
}
func (self Instance) AsVisualShaderNodeBooleanConstant() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeBooleanConstant](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeBooleanConstant", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeBooleanConstant](ptr)} })
}
