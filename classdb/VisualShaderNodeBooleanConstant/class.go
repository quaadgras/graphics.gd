...
func New() Instance {
	if !gd.Linked {
		...
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				...
				pointers.Set(gdclass.GetVisualShaderNodeBooleanConstant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanConstant{gdclass.NewVisualShaderNodeBooleanConstant(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("VisualShaderNodeBooleanConstant", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeBooleanConstant(ptr)} })
}
