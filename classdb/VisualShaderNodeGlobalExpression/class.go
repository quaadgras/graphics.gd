...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeGlobalExpression")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeGlobalExpression{gdclass.NewVisualShaderNodeGlobalExpression(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
