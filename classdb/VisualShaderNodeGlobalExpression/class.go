...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeGlobalExpression{gdclass.NewVisualShaderNodeGlobalExpression(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
