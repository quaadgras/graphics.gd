...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MultiMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiMesh{gdclass.NewMultiMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
