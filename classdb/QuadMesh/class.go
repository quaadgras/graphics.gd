...
func (self class) AsObject() [1]gd.Object { return gdclass.GetQuadMesh(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetQuadMesh(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.QuadMesh{gdclass.NewQuadMesh(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetQuadMesh(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.QuadMesh{gdclass.NewQuadMesh(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsQuadMesh() Advanced         { return Advanced{gdclass.NewQuadMesh(self.AsObject()[0])} }
func (self Instance) AsQuadMesh() Instance      { return Instance{gdclass.NewQuadMesh(self.AsObject()[0])} }
func (self *Extension[T]) AsQuadMesh() Instance { return self.Super().AsQuadMesh() }
func (self class) AsPlaneMesh() PlaneMesh.Advanced {
	return PlaneMesh.Advanced{gdclass.NewPlaneMesh(self.AsObject()[0])}
}
...
func (self Instance) AsPlaneMesh() PlaneMesh.Instance {
	return PlaneMesh.Instance{gdclass.NewPlaneMesh(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("QuadMesh", func(ptr gd.Object) any { return Instance{gdclass.NewQuadMesh(ptr)} })
}
