...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("QuadMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.QuadMesh{gdclass.NewQuadMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
