...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsPointQueryParameters3D{gdclass.NewPhysicsPointQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
