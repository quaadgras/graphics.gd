...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsPointQueryParameters3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsPointQueryParameters3D{gdclass.NewPhysicsPointQueryParameters3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
