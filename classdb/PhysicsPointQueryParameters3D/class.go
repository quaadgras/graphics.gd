...
/*
By changing various properties of this object, such as the point position, you can configure the parameters for [Instance.Physicsdirectspacestate3d.IntersectPoint].
*/
