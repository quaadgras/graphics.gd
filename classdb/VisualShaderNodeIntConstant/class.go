...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeIntConstant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntConstant{gdclass.NewVisualShaderNodeIntConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
