...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIntConstant{gdclass.NewVisualShaderNodeIntConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
