...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioEffectPitchShift(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioEffectPitchShift(self[0]) }
...
func (self class) AsAudioEffectPitchShift() Advanced {
	return Advanced{gdclass.NewAudioEffectPitchShift(self.AsObject()[0])}
}
func (self Instance) AsAudioEffectPitchShift() Instance {
	return Instance{gdclass.NewAudioEffectPitchShift(self.AsObject()[0])}
}
