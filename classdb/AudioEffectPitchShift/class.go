...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectPitchShift")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectPitchShift{gdclass.NewAudioEffectPitchShift(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
