...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectPitchShift{gdclass.NewAudioEffectPitchShift(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
