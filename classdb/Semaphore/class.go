...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Semaphore")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Semaphore{gdclass.NewSemaphore(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
