...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRemap{gdclass.NewVisualShaderNodeRemap(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
