...
/*
Remap will transform the input range into output range, e.g. you can change a 0..1 value to -2..2 etc. See [graphics.gd/classdb/@GlobalScope.Instance.Remap] for more details.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeRemap](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeRemap{pointers.Add[gdclass.VisualShaderNodeRemap]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeRemap{pointers.New[gdclass.VisualShaderNodeRemap]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeRemap() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeRemap](self[0])}
}
func (self Instance) AsVisualShaderNodeRemap() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeRemap](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeRemap", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeRemap](ptr)} })
}
