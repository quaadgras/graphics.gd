...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeRemap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeRemap{gdclass.NewVisualShaderNodeRemap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
