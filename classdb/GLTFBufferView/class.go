...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFBufferView")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFBufferView{gdclass.NewGLTFBufferView(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
