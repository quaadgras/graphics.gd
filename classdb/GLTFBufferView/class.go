...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGLTFBufferView(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGLTFBufferView(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GLTFBufferView{gdclass.NewGLTFBufferView(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGLTFBufferView(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GLTFBufferView{gdclass.NewGLTFBufferView(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) FromDictionary(dictionary Dictionary.Any) [1]gdclass.GLTFBufferView { //gd:GLTFBufferView.from_dictionary
	...
	var ret = [1]gdclass.GLTFBufferView{gdclass.NewGLTFBufferView(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsGLTFBufferView() Advanced {
	return Advanced{gdclass.NewGLTFBufferView(self.AsObject()[0])}
}
func (self Instance) AsGLTFBufferView() Instance {
	return Instance{gdclass.NewGLTFBufferView(self.AsObject()[0])}
}
