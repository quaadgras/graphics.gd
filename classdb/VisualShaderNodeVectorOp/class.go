...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorOp{gdclass.NewVisualShaderNodeVectorOp(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
