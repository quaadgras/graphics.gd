...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVectorOp")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVectorOp{gdclass.NewVisualShaderNodeVectorOp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
