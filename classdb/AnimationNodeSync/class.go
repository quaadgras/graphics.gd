...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeSync")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeSync{gdclass.NewAnimationNodeSync(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
