...
/*
A node that displays a 2D texture in a 3D environment. The texture displayed can be a region from a larger atlas texture, or a frame from a sprite sheet animation. See also [graphics.gd/classdb/SpriteBase3D] where properties such as the billboard mode are defined.
*/
package Sprite3D
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.Sprite3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Sprite3D{pointers.Add[gdclass.Sprite3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.Sprite3D{pointers.New[gdclass.Sprite3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self Instance) AsSprite3D() Instance      { return Instance{pointers.AsA[gdclass.Sprite3D](self[0])} }
...
func init() {
	gdclass.Register("Sprite3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.Sprite3D](ptr)} })
}
