...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Sprite3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Sprite3D{gdclass.NewSprite3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
