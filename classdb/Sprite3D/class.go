...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSprite3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSprite3D(self[0]) }
...
func (self class) AsSprite3D() Advanced         { return Advanced{gdclass.NewSprite3D(self.AsObject()[0])} }
func (self Instance) AsSprite3D() Instance      { return Instance{gdclass.NewSprite3D(self.AsObject()[0])} }
