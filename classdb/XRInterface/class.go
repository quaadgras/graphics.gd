...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRInterface")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRInterface{gdclass.NewXRInterface(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
