...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Node3DGizmo")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Node3DGizmo{gdclass.NewNode3DGizmo(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
