...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGPUParticlesCollisionSphere3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetGPUParticlesCollisionSphere3D(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GPUParticlesCollisionSphere3D{gdclass.NewGPUParticlesCollisionSphere3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGPUParticlesCollisionSphere3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionSphere3D{gdclass.NewGPUParticlesCollisionSphere3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsGPUParticlesCollisionSphere3D() Advanced {
	return Advanced{gdclass.NewGPUParticlesCollisionSphere3D(self.AsObject()[0])}
}
func (self Instance) AsGPUParticlesCollisionSphere3D() Instance {
	return Instance{gdclass.NewGPUParticlesCollisionSphere3D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("GPUParticlesCollisionSphere3D", func(ptr gd.Object) any { return Instance{gdclass.NewGPUParticlesCollisionSphere3D(ptr)} })
}
