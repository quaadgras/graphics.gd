...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileMap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileMap{gdclass.NewTileMap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
