...
/*
By changing various properties of this object, such as the shape, you can configure the parameters for [graphics.gd/classdb/PhysicsDirectSpaceState2D.Instance.IntersectShape].
*/
