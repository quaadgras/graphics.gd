...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PhysicsShapeQueryParameters2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PhysicsShapeQueryParameters2D{pointers.Add[gdclass.PhysicsShapeQueryParameters2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PhysicsShapeQueryParameters2D{pointers.New[gdclass.PhysicsShapeQueryParameters2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetShapeRid(shape RID.Any) { //gd:PhysicsShapeQueryParameters2D.set_shape_rid
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_shape_rid, 0|(gdextension.SizeRID<<4), &struct{ shape RID.Any }{shape})
}

//go:nosplit
func (self class) GetShapeRid() RID.Any { //gd:PhysicsShapeQueryParameters2D.get_shape_rid
	var r_ret = mainthread.Call[RID.Any](gd.ObjectChecked(self.AsObject()), methods.get_shape_rid, gdextension.SizeRID, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsPhysicsShapeQueryParameters2D() Advanced {
	return Advanced{pointers.AsA[gdclass.PhysicsShapeQueryParameters2D](self[0])}
}
func (self Instance) AsPhysicsShapeQueryParameters2D() Instance {
	return Instance{pointers.AsA[gdclass.PhysicsShapeQueryParameters2D](self[0])}
}
...
func init() {
	gdclass.Register("PhysicsShapeQueryParameters2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PhysicsShapeQueryParameters2D](ptr)} })
}
