...
/*
By changing various properties of this object, such as the shape, you can configure the parameters for [Instance.Physicsdirectspacestate2d.IntersectShape].
*/
