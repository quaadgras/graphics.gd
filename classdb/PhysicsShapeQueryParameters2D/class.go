...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("PhysicsShapeQueryParameters2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsShapeQueryParameters2D{gdclass.NewPhysicsShapeQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
