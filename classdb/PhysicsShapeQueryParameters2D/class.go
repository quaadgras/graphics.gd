...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsShapeQueryParameters2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsShapeQueryParameters2D{gdclass.NewPhysicsShapeQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
