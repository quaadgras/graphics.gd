...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TabBar")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TabBar{gdclass.NewTabBar(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
