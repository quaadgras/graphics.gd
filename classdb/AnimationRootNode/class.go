...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationRootNode")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationRootNode{gdclass.NewAnimationRootNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
