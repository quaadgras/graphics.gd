...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoneTwistDisperser3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoneTwistDisperser3D{gdclass.NewBoneTwistDisperser3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
