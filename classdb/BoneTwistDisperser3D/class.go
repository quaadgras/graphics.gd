...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoneTwistDisperser3D{gdclass.NewBoneTwistDisperser3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
