...
func (self class) AsObject() [1]gd.Object { return gdclass.GetBoneTwistDisperser3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetBoneTwistDisperser3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.BoneTwistDisperser3D{gdclass.NewBoneTwistDisperser3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetBoneTwistDisperser3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.BoneTwistDisperser3D{gdclass.NewBoneTwistDisperser3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsBoneTwistDisperser3D() Advanced {
	return Advanced{gdclass.NewBoneTwistDisperser3D(self.AsObject()[0])}
}
func (self Instance) AsBoneTwistDisperser3D() Instance {
	return Instance{gdclass.NewBoneTwistDisperser3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsBoneTwistDisperser3D() Instance {
	return self.Super().AsBoneTwistDisperser3D()
}
