...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackPlaylist{gdclass.NewAudioStreamPlaybackPlaylist(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
