...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlaybackPlaylist")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackPlaylist{gdclass.NewAudioStreamPlaybackPlaylist(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
