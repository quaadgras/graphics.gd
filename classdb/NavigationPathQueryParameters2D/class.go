...
func (self class) SetStartPosition(start_position Vector2.XY) { //gd:NavigationPathQueryParameters2D.set_start_position
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_start_position, 0|(gdextension.SizeVector2<<4), &struct{ start_position Vector2.XY }{start_position})
}
...
func (self class) SetTargetPosition(target_position Vector2.XY) { //gd:NavigationPathQueryParameters2D.set_target_position
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_target_position, 0|(gdextension.SizeVector2<<4), &struct{ target_position Vector2.XY }{target_position})
}
