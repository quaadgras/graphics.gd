...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryParameters2D{gdclass.NewNavigationPathQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
