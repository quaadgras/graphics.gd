...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationPathQueryParameters2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryParameters2D{gdclass.NewNavigationPathQueryParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
