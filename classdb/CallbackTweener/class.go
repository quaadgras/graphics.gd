...
/*
[graphics.gd/classdb/CallbackTweener] is used to call a method in a tweening sequence. See [graphics.gd/classdb/Tween.Instance.TweenCallback] for more usage information.

The tweener will finish automatically if the callback's target object is freed.

Note: [graphics.gd/classdb/Tween.Instance.TweenCallback] is the only correct way to create [graphics.gd/classdb/CallbackTweener]. Any [graphics.gd/classdb/CallbackTweener] created manually will not function correctly.
*/
...
Example: Call [graphics.gd/classdb/Node.Instance.QueueFree] after 2 seconds:
