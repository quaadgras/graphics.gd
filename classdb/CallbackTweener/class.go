...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CallbackTweener")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CallbackTweener{gdclass.NewCallbackTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
