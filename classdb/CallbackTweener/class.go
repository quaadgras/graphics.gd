...
/*
[CallbackTweener] is used to call a method in a tweening sequence. See [Instance.Tween.TweenCallback] for more usage information.
The tweener will finish automatically if the callback's target object is freed.
Note: [Instance.Tween.TweenCallback] is the only correct way to create [CallbackTweener]. Any [CallbackTweener] created manually will not function correctly.
*/
...
Example: Call [Instance.Node.QueueFree] after 2 seconds:
[codeblock]
