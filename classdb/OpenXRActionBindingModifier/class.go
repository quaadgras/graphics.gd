...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRActionBindingModifier")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRActionBindingModifier{gdclass.NewOpenXRActionBindingModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
