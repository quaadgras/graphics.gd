...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRActionBindingModifier{gdclass.NewOpenXRActionBindingModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
