...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OggPacketSequence")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OggPacketSequence{gdclass.NewOggPacketSequence(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
