...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRExtensionWrapper{gdclass.NewOpenXRExtensionWrapper(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
