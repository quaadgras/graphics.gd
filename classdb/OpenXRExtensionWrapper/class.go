...
func (self class) GetOpenxrApi() [1]gdclass.OpenXRAPIExtension { //gd:OpenXRExtensionWrapper.get_openxr_api
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_openxr_api, gdextension.SizeObject, &struct{}{})
...
func (self class) RegisterExtensionWrapper() { //gd:OpenXRExtensionWrapper.register_extension_wrapper
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.register_extension_wrapper, 0, &struct{}{})
}
