...
/*
[graphics.gd/classdb/OpenXRExtensionWrapper] allows implementing OpenXR extensions with GDExtension. The extension should be registered with [Instance.RegisterExtensionWrapper].
*/
...
type Interface interface {
	...
	//
	// This will only be called if the extension previously registered itself with [graphics.gd/classdb/OpenXRAPIExtension.Instance.RegisterFrameInfoExtension].
	...
	// Returns the number of composition layers this extension wrapper provides via [Interface.GetCompositionLayer].
	//
	// This will only be called if the extension previously registered itself with [graphics.gd/classdb/OpenXRAPIExtension.Instance.RegisterCompositionLayerProvider].
	...
	// Returns an integer that will be used to sort the given composition layer provided via [Interface.GetCompositionLayer]. Lower numbers will move the layer to the front of the list, and higher numbers to the end. The default projection layer has an order of 0, so layers provided by this method should probably be above or below (but not exactly) 0.
	//
	// This will only be called if the extension previously registered itself with [graphics.gd/classdb/OpenXRAPIExtension.Instance.RegisterCompositionLayerProvider].
	...
	// Adds additional data structures to composition layers created by [graphics.gd/classdb/OpenXRCompositionLayer].
	//
	// 'property_values' contains the values of the properties returned by [Interface.GetViewportCompositionLayerExtensionProperties].
	//
	...
	// Gets an array of data structures that represent properties, just like [graphics.gd/classdb/Object.Instance.GetPropertyList], that will be added to [graphics.gd/classdb/OpenXRCompositionLayer] nodes.
	GetViewportCompositionLayerExtensionProperties() [][]Object.PropertyInfo
	// Gets a data structure containing the default values for the properties returned by [Interface.GetViewportCompositionLayerExtensionProperties].
	GetViewportCompositionLayerExtensionPropertyDefaults() map[string]interface{}
	// Called when a composition layer created via [graphics.gd/classdb/OpenXRCompositionLayer] is destroyed.
	//
	// 'layer' is a pointer to an XrCompositionLayerBaseHeader struct.
	OnViewportCompositionLayerDestroyed(layer gdextension.Pointer)
	// Adds additional data structures to Android surface swapchains created by [graphics.gd/classdb/OpenXRCompositionLayer].
	//
	// 'property_values' contains the values of the properties returned by [Interface.GetViewportCompositionLayerExtensionProperties].
...
/*
Returns the created [graphics.gd/classdb/OpenXRAPIExtension], which can be used to access the OpenXR API.
*/
//go:nosplit
