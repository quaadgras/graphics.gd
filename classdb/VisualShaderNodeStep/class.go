...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeStep")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeStep{gdclass.NewVisualShaderNodeStep(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
