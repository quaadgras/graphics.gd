...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeStep{gdclass.NewVisualShaderNodeStep(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
