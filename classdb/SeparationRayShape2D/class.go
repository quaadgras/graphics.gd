...
func New() Instance {
	...
	casted := Instance([1]gdclass.SeparationRayShape2D{gdclass.NewSeparationRayShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
