...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Tweener")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Tweener{gdclass.NewTweener(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
