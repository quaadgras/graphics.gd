...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryResult3D{gdclass.NewNavigationPathQueryResult3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
