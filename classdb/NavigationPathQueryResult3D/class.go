...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationPathQueryResult3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationPathQueryResult3D{gdclass.NewNavigationPathQueryResult3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
