...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TriangleMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TriangleMesh{gdclass.NewTriangleMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
