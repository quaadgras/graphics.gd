...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ShapeCast2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShapeCast2D{gdclass.NewShapeCast2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
