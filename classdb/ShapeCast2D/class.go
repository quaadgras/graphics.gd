...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("ShapeCast2D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShapeCast2D{gdclass.NewShapeCast2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
