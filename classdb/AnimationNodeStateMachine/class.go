...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeStateMachine{gdclass.NewAnimationNodeStateMachine(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
