...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CameraTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CameraTexture{gdclass.NewCameraTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
