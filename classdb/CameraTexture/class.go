...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCameraTexture(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCameraTexture(self[0]) }
...
func (self class) AsCameraTexture() Advanced {
	return Advanced{gdclass.NewCameraTexture(self.AsObject()[0])}
}
func (self Instance) AsCameraTexture() Instance {
	return Instance{gdclass.NewCameraTexture(self.AsObject()[0])}
}
