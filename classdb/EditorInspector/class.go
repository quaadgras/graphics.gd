...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorInspector")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorInspector{gdclass.NewEditorInspector(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
