...
/*
This is the control that implements property editing in the editor's Settings dialogs, the Inspector dock, etc. To get the [EditorInspector] used in the editor's Inspector dock, use [Instance.Editorinterface.GetInspector].
[EditorInspector] will show properties in the same order as the array returned by [Instance.Object.GetPropertyList].
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.EditorInspector](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorInspector{pointers.Add[gdclass.EditorInspector]([3]uint64{})})
	...
	casted := Instance([1]gdclass.EditorInspector{pointers.New[gdclass.EditorInspector]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) Edit(obj [1]gd.Object) { //gd:EditorInspector.edit
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.edit, 0|(gdextension.SizeObject<<4), &struct{ obj gdextension.Object }{gdextension.Object(gd.ObjectChecked(obj[0].AsObject()))})
}
...
func (self class) GetSelectedPath() String.Readable { //gd:EditorInspector.get_selected_path
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_selected_path, gdextension.SizeString, &struct{}{})
...
func (self class) InstantiatePropertyEditor(obj [1]gd.Object, atype variant.Type, path String.Readable, hint ClassDB.PropertyHint, hint_text String.Readable, usage int64, wide bool) [1]gdclass.EditorProperty { //gd:EditorInspector.instantiate_property_editor
	var r_ret = gdextension.CallStatic[gdextension.Object](methods.instantiate_property_editor, gdextension.SizeObject|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeString<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeString<<20)|(gdextension.SizeInt<<24)|(gdextension.SizeBool<<28), &struct {
		...
		usage     int64
		wide      bool
	}{gdextension.Object(gd.ObjectChecked(obj[0].AsObject())), atype, pointers.Get(gd.InternalString(path)), hint, pointers.Get(gd.InternalString(hint_text)), usage, wide})
...
func (self class) AsEditorInspector() Advanced {
	return Advanced{pointers.AsA[gdclass.EditorInspector](self[0])}
}
func (self Instance) AsEditorInspector() Instance {
	return Instance{pointers.AsA[gdclass.EditorInspector](self[0])}
}
...
func (self class) AsScrollContainer() ScrollContainer.Advanced {
	return ScrollContainer.Advanced{pointers.AsA[gdclass.ScrollContainer](self[0])}
}
...
func (self Instance) AsScrollContainer() ScrollContainer.Instance {
	return ScrollContainer.Instance{pointers.AsA[gdclass.ScrollContainer](self[0])}
}
...
func init() {
	gdclass.Register("EditorInspector", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.EditorInspector](ptr)} })
}
