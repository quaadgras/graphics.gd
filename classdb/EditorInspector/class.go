...
func (self class) AsObject() [1]gd.Object { return gdclass.GetEditorInspector(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetEditorInspector(self[0]) }
...
func (self class) AsEditorInspector() Advanced {
	return Advanced{gdclass.NewEditorInspector(self.AsObject()[0])}
}
func (self Instance) AsEditorInspector() Instance {
	return Instance{gdclass.NewEditorInspector(self.AsObject()[0])}
}
...
func (self class) AsScrollContainer() ScrollContainer.Advanced {
	return ScrollContainer.Advanced{gdclass.NewScrollContainer(self.AsObject()[0])}
}
...
func (self Instance) AsScrollContainer() ScrollContainer.Instance {
	return ScrollContainer.Instance{gdclass.NewScrollContainer(self.AsObject()[0])}
}
