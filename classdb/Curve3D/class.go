...
func (self class) AsObject() [1]gd.Object { return gdclass.GetCurve3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetCurve3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Curve3D{gdclass.NewCurve3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetCurve3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Curve3D{gdclass.NewCurve3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsCurve3D() Advanced         { return Advanced{gdclass.NewCurve3D(self.AsObject()[0])} }
func (self Instance) AsCurve3D() Instance      { return Instance{gdclass.NewCurve3D(self.AsObject()[0])} }
...
func init() {
	gdclass.Register("Curve3D", func(ptr gd.Object) any { return Instance{gdclass.NewCurve3D(ptr)} })
}
