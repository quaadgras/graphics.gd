...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("SceneReplicationConfig"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneReplicationConfig{gdclass.NewSceneReplicationConfig(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
