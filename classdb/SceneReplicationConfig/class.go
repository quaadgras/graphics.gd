...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SceneReplicationConfig")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneReplicationConfig{gdclass.NewSceneReplicationConfig(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
