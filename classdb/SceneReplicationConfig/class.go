...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSceneReplicationConfig(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSceneReplicationConfig(self[0]) }
...
func (self class) AsSceneReplicationConfig() Advanced {
	return Advanced{gdclass.NewSceneReplicationConfig(self.AsObject()[0])}
}
func (self Instance) AsSceneReplicationConfig() Instance {
	return Instance{gdclass.NewSceneReplicationConfig(self.AsObject()[0])}
}
