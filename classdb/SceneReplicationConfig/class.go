...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneReplicationConfig{gdclass.NewSceneReplicationConfig(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
