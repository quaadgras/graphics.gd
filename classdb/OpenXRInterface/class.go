...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRInterface(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRInterface(self[0]) }
...
func (self class) AsOpenXRInterface() Advanced {
	return Advanced{gdclass.NewOpenXRInterface(self.AsObject()[0])}
}
func (self Instance) AsOpenXRInterface() Instance {
	return Instance{gdclass.NewOpenXRInterface(self.AsObject()[0])}
}
