...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTexture2DArray{gdclass.NewCompressedTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
