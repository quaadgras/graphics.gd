...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("CompressedTexture2DArray"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTexture2DArray{gdclass.NewCompressedTexture2DArray(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
