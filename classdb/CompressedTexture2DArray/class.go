...
/*
A texture array that is loaded from a .ctexarray file. This file format is internal to Godot; it is created by importing other image formats with the import system. [graphics.gd/classdb/CompressedTexture2DArray] can use one of 4 compression methods:
...
See [graphics.gd/classdb/Texture2DArray] for a general description of texture arrays.
*/
