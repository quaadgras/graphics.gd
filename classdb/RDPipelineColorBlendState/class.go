...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDPipelineColorBlendState")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineColorBlendState{gdclass.NewRDPipelineColorBlendState(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
