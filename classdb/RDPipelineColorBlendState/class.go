...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineColorBlendState{gdclass.NewRDPipelineColorBlendState(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
