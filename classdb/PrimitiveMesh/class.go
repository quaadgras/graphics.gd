...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PrimitiveMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PrimitiveMesh{gdclass.NewPrimitiveMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
