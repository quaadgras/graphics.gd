...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PortableCompressedTexture2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PortableCompressedTexture2D{gdclass.NewPortableCompressedTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
