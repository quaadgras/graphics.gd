...
func New() Instance {
	...
	casted := Instance([1]gdclass.PortableCompressedTexture2D{gdclass.NewPortableCompressedTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
