...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Mutex")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Mutex{gdclass.NewMutex(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
