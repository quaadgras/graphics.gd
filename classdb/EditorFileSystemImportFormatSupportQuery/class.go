...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorFileSystemImportFormatSupportQuery{gdclass.NewEditorFileSystemImportFormatSupportQuery(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetEditorFileSystemImportFormatSupportQuery(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorFileSystemImportFormatSupportQuery{gdclass.NewEditorFileSystemImportFormatSupportQuery(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func init() {
	gdclass.Register("EditorFileSystemImportFormatSupportQuery", func(ptr gd.Object) any { return Instance{gdclass.NewEditorFileSystemImportFormatSupportQuery(ptr)} })
}
