...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetEditorFileSystemImportFormatSupportQuery(self[0])
}
...
func (self class) AsEditorFileSystemImportFormatSupportQuery() Advanced {
	return Advanced{gdclass.NewEditorFileSystemImportFormatSupportQuery(self.AsObject()[0])}
}
func (self Instance) AsEditorFileSystemImportFormatSupportQuery() Instance {
	return Instance{gdclass.NewEditorFileSystemImportFormatSupportQuery(self.AsObject()[0])}
}
