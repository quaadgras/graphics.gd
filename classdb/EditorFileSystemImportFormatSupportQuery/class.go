...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFileSystemImportFormatSupportQuery{gdclass.NewEditorFileSystemImportFormatSupportQuery(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
