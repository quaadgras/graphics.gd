...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorFileSystemImportFormatSupportQuery")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorFileSystemImportFormatSupportQuery{gdclass.NewEditorFileSystemImportFormatSupportQuery(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
