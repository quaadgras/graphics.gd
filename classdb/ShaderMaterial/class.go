...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ShaderMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ShaderMaterial{gdclass.NewShaderMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
