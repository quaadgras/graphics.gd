...
func (self class) SetCone(cone bool) { //gd:CSGCylinder3D.set_cone
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cone, 0|(gdextension.SizeBool<<4), &struct{ cone bool }{cone})
}

//go:nosplit
func (self class) IsCone() bool { //gd:CSGCylinder3D.is_cone
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_cone, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
