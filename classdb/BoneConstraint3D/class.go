...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("BoneConstraint3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoneConstraint3D{gdclass.NewBoneConstraint3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
