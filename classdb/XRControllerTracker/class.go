...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRControllerTracker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRControllerTracker{gdclass.NewXRControllerTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
