...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRControllerTracker{gdclass.NewXRControllerTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
