...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileSetAtlasSource")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileSetAtlasSource{gdclass.NewTileSetAtlasSource(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
