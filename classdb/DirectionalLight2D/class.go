...
func (self class) AsObject() [1]gd.Object { return gdclass.GetDirectionalLight2D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetDirectionalLight2D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.DirectionalLight2D{gdclass.NewDirectionalLight2D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetDirectionalLight2D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.DirectionalLight2D{gdclass.NewDirectionalLight2D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsDirectionalLight2D() Advanced {
	return Advanced{gdclass.NewDirectionalLight2D(self.AsObject()[0])}
}
func (self Instance) AsDirectionalLight2D() Instance {
	return Instance{gdclass.NewDirectionalLight2D(self.AsObject()[0])}
}
...
func (self class) AsLight2D() Light2D.Advanced {
	return Light2D.Advanced{gdclass.NewLight2D(self.AsObject()[0])}
}
...
func (self Instance) AsLight2D() Light2D.Instance {
	return Light2D.Instance{gdclass.NewLight2D(self.AsObject()[0])}
}
