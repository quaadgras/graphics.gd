...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("DirectionalLight2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.DirectionalLight2D{gdclass.NewDirectionalLight2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
