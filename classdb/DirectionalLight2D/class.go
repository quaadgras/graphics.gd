...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.DirectionalLight2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.DirectionalLight2D{pointers.Add[gdclass.DirectionalLight2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.DirectionalLight2D{pointers.New[gdclass.DirectionalLight2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsDirectionalLight2D() Advanced {
	return Advanced{pointers.AsA[gdclass.DirectionalLight2D](self[0])}
}
func (self Instance) AsDirectionalLight2D() Instance {
	return Instance{pointers.AsA[gdclass.DirectionalLight2D](self[0])}
}
...
func init() {
	gdclass.Register("DirectionalLight2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.DirectionalLight2D](ptr)} })
}
