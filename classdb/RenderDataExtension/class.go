...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderDataExtension{gdclass.NewRenderDataExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
