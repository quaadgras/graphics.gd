...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("RenderDataExtension"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderDataExtension{gdclass.NewRenderDataExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
