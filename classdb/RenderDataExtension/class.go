...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RenderDataExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderDataExtension{gdclass.NewRenderDataExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
