...
/*
This singleton provides access to static information about [graphics.gd/classdb/Theme] resources used by the engine and by your projects. You can fetch the default engine theme, as well as your project configured theme.

[graphics.gd/classdb/ThemeDB] also contains fallback values for theme properties.
*/
package ThemeDB
...
/*
Returns a reference to the default engine [graphics.gd/classdb/Theme]. This theme resource is responsible for the out-of-the-box look of [graphics.gd/classdb/Control] nodes and cannot be overridden.
*/
...
/*
Returns a reference to the custom project [graphics.gd/classdb/Theme]. This theme resources allows to override the default engine theme for every control node in the project.

To set the project theme, see [graphics.gd/classdb/ProjectSettings] "gui/theme/custom".
*/
