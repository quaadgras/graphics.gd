...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BoxContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BoxContainer{gdclass.NewBoxContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
