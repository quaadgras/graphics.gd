...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditorBase{gdclass.NewOpenXRInteractionProfileEditorBase(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
