...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRInteractionProfileEditorBase")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileEditorBase{gdclass.NewOpenXRInteractionProfileEditorBase(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
