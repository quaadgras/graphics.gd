...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorScenePostImportPlugin{gdclass.NewEditorScenePostImportPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
