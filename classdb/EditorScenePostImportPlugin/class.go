...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorScenePostImportPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorScenePostImportPlugin{gdclass.NewEditorScenePostImportPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
