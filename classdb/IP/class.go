...
/*
IP contains support functions for the Internet Protocol (IP). TCP/IP support is in different classes (see [graphics.gd/classdb/StreamPeerTCP] and [graphics.gd/classdb/TCPServer]). IP provides DNS hostname resolution support, both blocking and threaded.
*/
package IP
