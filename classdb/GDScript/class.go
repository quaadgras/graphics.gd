...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GDScript")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GDScript{gdclass.NewGDScript(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
