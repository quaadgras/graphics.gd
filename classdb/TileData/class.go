...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TileData")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TileData{gdclass.NewTileData(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
