...
/*
[graphics.gd/classdb/TileData] object represents a single tile in a [graphics.gd/classdb/TileSet]. It is usually edited using the tileset editor, but it can be modified at runtime using [graphics.gd/classdb/TileMap.Instance.TileDataRuntimeUpdate].
*/
package TileData
