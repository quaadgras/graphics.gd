...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GDExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GDExtension{gdclass.NewGDExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
