...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCompare{gdclass.NewVisualShaderNodeCompare(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
