...
const (
	...
	// Comparison for greater than (a > b). Cannot be used if [Instance.Type] set to [CtypeBoolean] or [CtypeTransform].
	FuncGreaterThan Function = 2
	// Comparison for greater than or equal (a >= b). Cannot be used if [Instance.Type] set to [CtypeBoolean] or [CtypeTransform].
	FuncGreaterThanEqual Function = 3
	// Comparison for less than (a < b). Cannot be used if [Instance.Type] set to [CtypeBoolean] or [CtypeTransform].
	FuncLessThan Function = 4
	// Comparison for less than or equal (a <= b). Cannot be used if [Instance.Type] set to [CtypeBoolean] or [CtypeTransform].
