...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeCompare")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCompare{gdclass.NewVisualShaderNodeCompare(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
