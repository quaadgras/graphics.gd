...
/*
[graphics.gd/classdb/ImageTexture3D] is a 3-dimensional [graphics.gd/classdb/ImageTexture] that has a width, height, and depth. See also [graphics.gd/classdb/ImageTextureLayered].

3D textures are typically used to store density maps for [graphics.gd/classdb/FogMaterial], color correction LUTs for [graphics.gd/classdb/Environment], vector fields for [graphics.gd/classdb/GPUParticlesAttractorVectorField3D] and collision maps for [graphics.gd/classdb/GPUParticlesCollisionSDF3D]. 3D textures can also be used in custom shaders.
*/
...
/*
Creates the [graphics.gd/classdb/ImageTexture3D] with specified 'width', 'height', and 'depth'. See [Image.Format] for 'format' options. If 'use_mipmaps' is true, then generate mipmaps for the [graphics.gd/classdb/ImageTexture3D].
*/
...
/*
Replaces the texture's existing data with the layers specified in 'data'. The size of 'data' must match the parameters that were used for [Instance.Create]. In other words, the texture cannot be resized or have its format changed by calling [Instance.Update].
*/
