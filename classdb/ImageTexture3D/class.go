...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ImageTexture3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImageTexture3D{gdclass.NewImageTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
