...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterScene{gdclass.NewResourceImporterScene(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
