...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterScene")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterScene{gdclass.NewResourceImporterScene(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
