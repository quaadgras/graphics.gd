...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRFutureExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRFutureExtension{gdclass.NewOpenXRFutureExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
