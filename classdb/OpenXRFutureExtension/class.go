...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRFutureExtension{gdclass.NewOpenXRFutureExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
