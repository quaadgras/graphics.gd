...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectBandLimitFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectBandLimitFilter{gdclass.NewAudioEffectBandLimitFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
