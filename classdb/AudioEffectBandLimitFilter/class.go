...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioEffectBandLimitFilter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioEffectBandLimitFilter(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectBandLimitFilter{gdclass.NewAudioEffectBandLimitFilter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioEffectBandLimitFilter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectBandLimitFilter{gdclass.NewAudioEffectBandLimitFilter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsAudioEffectBandLimitFilter() Advanced {
	return Advanced{gdclass.NewAudioEffectBandLimitFilter(self.AsObject()[0])}
}
func (self Instance) AsAudioEffectBandLimitFilter() Instance {
	return Instance{gdclass.NewAudioEffectBandLimitFilter(self.AsObject()[0])}
}
func (self *Extension[T]) AsAudioEffectBandLimitFilter() Instance {
	return self.Super().AsAudioEffectBandLimitFilter()
}
...
func init() {
	gdclass.Register("AudioEffectBandLimitFilter", func(ptr gd.Object) any { return Instance{gdclass.NewAudioEffectBandLimitFilter(ptr)} })
}
