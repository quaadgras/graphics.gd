...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectBandLimitFilter{gdclass.NewAudioEffectBandLimitFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
