...
/*
A variant of [graphics.gd/classdb/FlowContainer] that can only arrange its child controls vertically, wrapping them around at the borders. This is similar to how text in a book wraps around when no more words can fit on a line, except vertically.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VFlowContainer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VFlowContainer{pointers.Add[gdclass.VFlowContainer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VFlowContainer{pointers.New[gdclass.VFlowContainer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVFlowContainer() Advanced {
	return Advanced{pointers.AsA[gdclass.VFlowContainer](self[0])}
}
func (self Instance) AsVFlowContainer() Instance {
	return Instance{pointers.AsA[gdclass.VFlowContainer](self[0])}
}
...
func init() {
	gdclass.Register("VFlowContainer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VFlowContainer](ptr)} })
}
