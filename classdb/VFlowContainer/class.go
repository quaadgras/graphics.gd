...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVFlowContainer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVFlowContainer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VFlowContainer{gdclass.NewVFlowContainer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVFlowContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VFlowContainer{gdclass.NewVFlowContainer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsVFlowContainer() Advanced {
	return Advanced{gdclass.NewVFlowContainer(self.AsObject()[0])}
}
func (self Instance) AsVFlowContainer() Instance {
	return Instance{gdclass.NewVFlowContainer(self.AsObject()[0])}
}
func (self *Extension[T]) AsVFlowContainer() Instance { return self.Super().AsVFlowContainer() }
func (self class) AsFlowContainer() FlowContainer.Advanced {
	return FlowContainer.Advanced{gdclass.NewFlowContainer(self.AsObject()[0])}
}
...
func (self Instance) AsFlowContainer() FlowContainer.Instance {
	return FlowContainer.Instance{gdclass.NewFlowContainer(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VFlowContainer", func(ptr gd.Object) any { return Instance{gdclass.NewVFlowContainer(ptr)} })
}
