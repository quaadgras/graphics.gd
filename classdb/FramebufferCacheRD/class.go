...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("FramebufferCacheRD"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FramebufferCacheRD{gdclass.NewFramebufferCacheRD(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
