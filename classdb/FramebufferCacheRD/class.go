...
func New() Instance {
	...
	casted := Instance([1]gdclass.FramebufferCacheRD{gdclass.NewFramebufferCacheRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
