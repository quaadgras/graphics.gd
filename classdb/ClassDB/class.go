...
func (self class) AsObject() [1]gd.Object { return gdclass.GetClassDB(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetClassDB(self[0]) }
...
func (self class) ClassSetProperty(obj [1]gd.Object, property String.Name, value variant.Any) Error.Code { //gd:ClassDB.class_set_property
	...
	}{gdextension.Object(gd.ObjectChecked(gdclass.GetObject(obj[0]))), pointers.Get(gd.InternalStringName(property)), gdextension.Variant(pointers.Get(gd.InternalVariant(value)))})
...
func (self class) ClassCallStatic(class_ String.Name, method String.Name, args ...gd.Variant) variant.Any { //gd:ClassDB.class_call_static
	...
	ret, err := noescape.MethodForClass(methods.class_call_static).Call(gd.ObjectChecked(self.AsObject()), append(fixed[:], dynamic...)...)
	if err != nil {
		panic(err)
	}
