...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectSpectrumAnalyzerInstance{gdclass.NewAudioEffectSpectrumAnalyzerInstance(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
