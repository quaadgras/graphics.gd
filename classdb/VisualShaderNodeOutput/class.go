...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeOutput{gdclass.NewVisualShaderNodeOutput(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
