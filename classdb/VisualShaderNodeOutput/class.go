...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeOutput")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeOutput{gdclass.NewVisualShaderNodeOutput(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
