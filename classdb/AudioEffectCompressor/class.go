...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectCompressor")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectCompressor{gdclass.NewAudioEffectCompressor(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
