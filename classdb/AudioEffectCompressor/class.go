...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectCompressor{gdclass.NewAudioEffectCompressor(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
