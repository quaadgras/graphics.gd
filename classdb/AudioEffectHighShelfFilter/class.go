...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectHighShelfFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectHighShelfFilter{gdclass.NewAudioEffectHighShelfFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
