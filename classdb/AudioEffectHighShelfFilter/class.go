...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectHighShelfFilter{gdclass.NewAudioEffectHighShelfFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
