...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioEffectHighShelfFilter(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAudioEffectHighShelfFilter(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectHighShelfFilter{gdclass.NewAudioEffectHighShelfFilter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioEffectHighShelfFilter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioEffectHighShelfFilter{gdclass.NewAudioEffectHighShelfFilter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsAudioEffectHighShelfFilter() Advanced {
	return Advanced{gdclass.NewAudioEffectHighShelfFilter(self.AsObject()[0])}
}
func (self Instance) AsAudioEffectHighShelfFilter() Instance {
	return Instance{gdclass.NewAudioEffectHighShelfFilter(self.AsObject()[0])}
}
func (self *Extension[T]) AsAudioEffectHighShelfFilter() Instance {
	return self.Super().AsAudioEffectHighShelfFilter()
}
...
func init() {
	gdclass.Register("AudioEffectHighShelfFilter", func(ptr gd.Object) any { return Instance{gdclass.NewAudioEffectHighShelfFilter(ptr)} })
}
