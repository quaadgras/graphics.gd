...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterCSVTranslation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterCSVTranslation{gdclass.NewResourceImporterCSVTranslation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
