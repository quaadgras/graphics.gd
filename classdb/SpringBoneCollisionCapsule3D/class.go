...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpringBoneCollisionCapsule3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionCapsule3D{gdclass.NewSpringBoneCollisionCapsule3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
