...
func (self class) SetMidHeight(mid_height float64) { //gd:SpringBoneCollisionCapsule3D.set_mid_height
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_mid_height, 0|(gdextension.SizeFloat<<4), &struct{ mid_height float64 }{mid_height})
}

//go:nosplit
func (self class) GetMidHeight() float64 { //gd:SpringBoneCollisionCapsule3D.get_mid_height
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_mid_height, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetInside(enabled bool) { //gd:SpringBoneCollisionCapsule3D.set_inside
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_inside, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsInside() bool { //gd:SpringBoneCollisionCapsule3D.is_inside
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_inside, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
