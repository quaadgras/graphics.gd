...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionCapsule3D{gdclass.NewSpringBoneCollisionCapsule3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
