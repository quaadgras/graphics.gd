...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("SpringBoneCollisionCapsule3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionCapsule3D{gdclass.NewSpringBoneCollisionCapsule3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
