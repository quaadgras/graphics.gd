...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureSDF{gdclass.NewVisualShaderNodeTextureSDF(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
