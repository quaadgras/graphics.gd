...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeTextureSDF(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeTextureSDF(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTextureSDF{gdclass.NewVisualShaderNodeTextureSDF(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTextureSDF(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureSDF{gdclass.NewVisualShaderNodeTextureSDF(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTextureSDF() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTextureSDF(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTextureSDF() Instance {
	return Instance{gdclass.NewVisualShaderNodeTextureSDF(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeTextureSDF() Instance {
	return self.Super().AsVisualShaderNodeTextureSDF()
}
...
func init() {
	gdclass.Register("VisualShaderNodeTextureSDF", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeTextureSDF(ptr)} })
}
