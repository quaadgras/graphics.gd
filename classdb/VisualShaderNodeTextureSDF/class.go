...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTextureSDF")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTextureSDF{gdclass.NewVisualShaderNodeTextureSDF(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
