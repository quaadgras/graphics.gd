...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PrismMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PrismMesh{gdclass.NewPrismMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
