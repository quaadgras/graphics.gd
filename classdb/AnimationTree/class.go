...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationTree")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationTree{gdclass.NewAnimationTree(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
