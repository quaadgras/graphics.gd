...
func (self class) AsObject() [1]gd.Object { return gdclass.GetColorPicker(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetColorPicker(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ColorPicker{gdclass.NewColorPicker(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetColorPicker(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ColorPicker{gdclass.NewColorPicker(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnPresetAdded(cb func(color Color.RGBA), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("preset_added"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self Instance) OnPresetRemoved(cb func(color Color.RGBA), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("preset_removed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsColorPicker() Advanced {
	return Advanced{gdclass.NewColorPicker(self.AsObject()[0])}
}
func (self Instance) AsColorPicker() Instance {
	return Instance{gdclass.NewColorPicker(self.AsObject()[0])}
}
