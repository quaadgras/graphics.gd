...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ColorPicker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ColorPicker{gdclass.NewColorPicker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
