...
/*
Convenience method to perform standard mix blending with straight (non-premultiplied) alpha. This sets [member enable_blend] to true, [member src_color_blend_factor] to [Renderingdevice.BlendFactorSrcAlpha], [member dst_color_blend_factor] to [Renderingdevice.BlendFactorOneMinusSrcAlpha], [member src_alpha_blend_factor] to [Renderingdevice.BlendFactorSrcAlpha] and [member dst_alpha_blend_factor] to [Renderingdevice.BlendFactorOneMinusSrcAlpha].
*/
