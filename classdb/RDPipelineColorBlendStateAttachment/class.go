...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineColorBlendStateAttachment{gdclass.NewRDPipelineColorBlendStateAttachment(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
