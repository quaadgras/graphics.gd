...
/*
Convenience method to perform standard mix blending with straight (non-premultiplied) alpha. This sets [Instance.EnableBlend] to true, [Instance.SrcColorBlendFactor] to [Renderingdevice.BlendFactorSrcAlpha], [Instance.DstColorBlendFactor] to [Renderingdevice.BlendFactorOneMinusSrcAlpha], [Instance.SrcAlphaBlendFactor] to [Renderingdevice.BlendFactorSrcAlpha] and [Instance.DstAlphaBlendFactor] to [Renderingdevice.BlendFactorOneMinusSrcAlpha].
*/
