...
/*
This imports a 3-dimensional texture, which can then be used in custom shaders, as a [graphics.gd/classdb/FogMaterial] density map or as a [graphics.gd/classdb/GPUParticlesAttractorVectorField3D]. See also [graphics.gd/classdb/ResourceImporterTexture] and [graphics.gd/classdb/ResourceImporterTextureAtlas].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ResourceImporterLayeredTexture](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterLayeredTexture{pointers.Add[gdclass.ResourceImporterLayeredTexture]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ResourceImporterLayeredTexture{pointers.New[gdclass.ResourceImporterLayeredTexture]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsResourceImporterLayeredTexture() Advanced {
	return Advanced{pointers.AsA[gdclass.ResourceImporterLayeredTexture](self[0])}
}
func (self Instance) AsResourceImporterLayeredTexture() Instance {
	return Instance{pointers.AsA[gdclass.ResourceImporterLayeredTexture](self[0])}
}
...
func init() {
	gdclass.Register("ResourceImporterLayeredTexture", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ResourceImporterLayeredTexture](ptr)} })
}
