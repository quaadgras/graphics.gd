...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterLayeredTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterLayeredTexture{gdclass.NewResourceImporterLayeredTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
