...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterLayeredTexture{gdclass.NewResourceImporterLayeredTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
