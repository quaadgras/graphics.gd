...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsBody3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsBody3D{gdclass.NewPhysicsBody3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
