...
func (self class) AsObject() [1]gd.Object { return gdclass.GetStreamPeerSocket(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetStreamPeerSocket(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StreamPeerSocket{gdclass.NewStreamPeerSocket(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetStreamPeerSocket(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StreamPeerSocket{gdclass.NewStreamPeerSocket(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsStreamPeerSocket() Advanced {
	return Advanced{gdclass.NewStreamPeerSocket(self.AsObject()[0])}
}
func (self Instance) AsStreamPeerSocket() Instance {
	return Instance{gdclass.NewStreamPeerSocket(self.AsObject()[0])}
}
func (self *Extension[T]) AsStreamPeerSocket() Instance { return self.Super().AsStreamPeerSocket() }
