...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StreamPeerSocket")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StreamPeerSocket{gdclass.NewStreamPeerSocket(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
