...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVec2Constant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Constant{gdclass.NewVisualShaderNodeVec2Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
