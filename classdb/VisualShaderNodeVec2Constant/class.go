...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeVec2Constant(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeVec2Constant(self[0]) }
...
func (self class) AsVisualShaderNodeVec2Constant() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeVec2Constant(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeVec2Constant() Instance {
	return Instance{gdclass.NewVisualShaderNodeVec2Constant(self.AsObject()[0])}
}
