...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Constant{gdclass.NewVisualShaderNodeVec2Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
