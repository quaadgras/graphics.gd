...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeVec2Constant"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec2Constant{gdclass.NewVisualShaderNodeVec2Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
