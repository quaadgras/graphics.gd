...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FBXDocument")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FBXDocument{gdclass.NewFBXDocument(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
