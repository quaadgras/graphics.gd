...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.FBXDocument](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.FBXDocument{pointers.Add[gdclass.FBXDocument]([3]uint64{})})
	...
	casted := Instance([1]gdclass.FBXDocument{pointers.New[gdclass.FBXDocument]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsFBXDocument() Advanced {
	return Advanced{pointers.AsA[gdclass.FBXDocument](self[0])}
}
func (self Instance) AsFBXDocument() Instance {
	return Instance{pointers.AsA[gdclass.FBXDocument](self[0])}
}
...
func (self class) AsGLTFDocument() GLTFDocument.Advanced {
	return GLTFDocument.Advanced{pointers.AsA[gdclass.GLTFDocument](self[0])}
}
...
func (self Instance) AsGLTFDocument() GLTFDocument.Instance {
	return GLTFDocument.Instance{pointers.AsA[gdclass.GLTFDocument](self[0])}
}
...
func init() {
	gdclass.Register("FBXDocument", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.FBXDocument](ptr)} })
}
