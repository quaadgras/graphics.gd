...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPanel(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPanel(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Panel{gdclass.NewPanel(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetPanel(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.Panel{gdclass.NewPanel(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsPanel() Advanced         { return Advanced{gdclass.NewPanel(self.AsObject()[0])} }
func (self Instance) AsPanel() Instance      { return Instance{gdclass.NewPanel(self.AsObject()[0])} }
func (self *Extension[T]) AsPanel() Instance { return self.Super().AsPanel() }
...
func init() {
	gdclass.Register("Panel", func(ptr gd.Object) any { return Instance{gdclass.NewPanel(ptr)} })
}
