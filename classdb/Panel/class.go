...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Panel")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Panel{gdclass.NewPanel(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
