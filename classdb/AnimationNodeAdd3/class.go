...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAnimationNodeAdd3(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAnimationNodeAdd3(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeAdd3{gdclass.NewAnimationNodeAdd3(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAnimationNodeAdd3(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeAdd3{gdclass.NewAnimationNodeAdd3(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsAnimationNodeAdd3() Advanced {
	return Advanced{gdclass.NewAnimationNodeAdd3(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeAdd3() Instance {
	return Instance{gdclass.NewAnimationNodeAdd3(self.AsObject()[0])}
}
func (self *Extension[T]) AsAnimationNodeAdd3() Instance { return self.Super().AsAnimationNodeAdd3() }
...
func init() {
	gdclass.Register("AnimationNodeAdd3", func(ptr gd.Object) any { return Instance{gdclass.NewAnimationNodeAdd3(ptr)} })
}
