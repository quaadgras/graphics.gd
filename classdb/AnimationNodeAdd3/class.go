...
/*
A resource to add to an [graphics.gd/classdb/AnimationNodeBlendTree]. Blends two animations out of three additively out of three based on the amount value.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AnimationNodeAdd3](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeAdd3{pointers.Add[gdclass.AnimationNodeAdd3]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AnimationNodeAdd3{pointers.New[gdclass.AnimationNodeAdd3]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsAnimationNodeAdd3() Advanced {
	return Advanced{pointers.AsA[gdclass.AnimationNodeAdd3](self[0])}
}
func (self Instance) AsAnimationNodeAdd3() Instance {
	return Instance{pointers.AsA[gdclass.AnimationNodeAdd3](self[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeAdd3", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AnimationNodeAdd3](ptr)} })
}
