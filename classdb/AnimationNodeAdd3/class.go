...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeAdd3")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeAdd3{gdclass.NewAnimationNodeAdd3(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
