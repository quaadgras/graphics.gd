...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Separator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Separator{gdclass.NewSeparator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
