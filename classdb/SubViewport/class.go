...
/*
[graphics.gd/classdb/SubViewport] Isolates a rectangular region of a scene to be displayed independently. This can be used, for example, to display UI in 3D space.

Note: [graphics.gd/classdb/SubViewport] is a [graphics.gd/classdb/Viewport] that isn't a [graphics.gd/classdb/Window], i.e. it doesn't draw anything by itself. To display anything, [graphics.gd/classdb/SubViewport] must have a non-zero size and be either put inside a [graphics.gd/classdb/SubViewportContainer] or assigned to a [graphics.gd/classdb/ViewportTexture].

Note: [graphics.gd/classdb/InputEvent]s are not passed to a standalone [graphics.gd/classdb/SubViewport] by default. To ensure [graphics.gd/classdb/InputEvent] propagation, a [graphics.gd/classdb/SubViewport] can be placed inside of a [graphics.gd/classdb/SubViewportContainer].
*/
package SubViewport
