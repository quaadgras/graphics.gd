...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDTextureFormat")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDTextureFormat{gdclass.NewRDTextureFormat(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
