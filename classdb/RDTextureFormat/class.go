...
func (self class) AsObject() [1]gd.Object { return gdclass.GetRDTextureFormat(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetRDTextureFormat(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RDTextureFormat{gdclass.NewRDTextureFormat(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetRDTextureFormat(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RDTextureFormat{gdclass.NewRDTextureFormat(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsRDTextureFormat() Advanced {
	return Advanced{gdclass.NewRDTextureFormat(self.AsObject()[0])}
}
func (self Instance) AsRDTextureFormat() Instance {
	return Instance{gdclass.NewRDTextureFormat(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("RDTextureFormat", func(ptr gd.Object) any { return Instance{gdclass.NewRDTextureFormat(ptr)} })
}
