...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AnimationNodeSub2"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeSub2{gdclass.NewAnimationNodeSub2(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
