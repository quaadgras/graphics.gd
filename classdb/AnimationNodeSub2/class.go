...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeSub2")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeSub2{gdclass.NewAnimationNodeSub2(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
