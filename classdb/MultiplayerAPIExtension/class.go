...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiplayerAPIExtension{gdclass.NewMultiplayerAPIExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
