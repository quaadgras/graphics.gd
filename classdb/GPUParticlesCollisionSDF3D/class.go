...
Baking: The signed distance field texture can be baked by selecting the [GPUParticlesCollisionSDF3D] node in the editor, then clicking Bake SDF at the top of the 3D viewport. Any [i]visible[/i] [MeshInstance3D]s within the [member size] will be taken into account for baking, regardless of their [member GeometryInstance3D.gi_mode].
...
/*
Based on 'value', enables or disables the specified layer in the [member bake_mask], given a 'layer_number' between 1 and 32.
*/
...
/*
Returns whether or not the specified layer of the [member bake_mask] is enabled, given a 'layer_number' between 1 and 32.
*/
