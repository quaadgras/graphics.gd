...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesCollisionSDF3D{gdclass.NewGPUParticlesCollisionSDF3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
