...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectStereoEnhance")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectStereoEnhance{gdclass.NewAudioEffectStereoEnhance(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
