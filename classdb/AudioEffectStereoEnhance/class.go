...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectStereoEnhance{gdclass.NewAudioEffectStereoEnhance(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
