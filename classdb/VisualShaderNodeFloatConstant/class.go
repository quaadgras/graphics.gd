...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeFloatConstant](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeFloatConstant{pointers.Add[gdclass.VisualShaderNodeFloatConstant]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatConstant{pointers.New[gdclass.VisualShaderNodeFloatConstant]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetConstant(constant float64) { //gd:VisualShaderNodeFloatConstant.set_constant
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_constant, 0|(gdextension.SizeFloat<<4), &struct{ constant float64 }{constant})
}

//go:nosplit
func (self class) GetConstant() float64 { //gd:VisualShaderNodeFloatConstant.get_constant
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeFloatConstant() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeFloatConstant](self[0])}
}
func (self Instance) AsVisualShaderNodeFloatConstant() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeFloatConstant](self[0])}
}
func (self *Extension[T]) AsVisualShaderNodeFloatConstant() Instance {
	return self.Super().AsVisualShaderNodeFloatConstant()
}
...
func init() {
	gdclass.Register("VisualShaderNodeFloatConstant", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeFloatConstant](ptr)} })
}
