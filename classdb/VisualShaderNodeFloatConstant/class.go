...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeFloatConstant(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeFloatConstant(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeFloatConstant{gdclass.NewVisualShaderNodeFloatConstant(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeFloatConstant(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatConstant{gdclass.NewVisualShaderNodeFloatConstant(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeFloatConstant() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeFloatConstant(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeFloatConstant() Instance {
	return Instance{gdclass.NewVisualShaderNodeFloatConstant(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeFloatConstant", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeFloatConstant(ptr)} })
}
