...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeFloatConstant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatConstant{gdclass.NewVisualShaderNodeFloatConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
