...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeFloatConstant{gdclass.NewVisualShaderNodeFloatConstant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
