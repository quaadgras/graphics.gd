...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RenderSceneData")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneData{gdclass.NewRenderSceneData(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
