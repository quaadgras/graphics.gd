...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeCubemapParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeCubemapParameter{gdclass.NewVisualShaderNodeCubemapParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeCubemapParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCubemapParameter{gdclass.NewVisualShaderNodeCubemapParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeCubemapParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeCubemapParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeCubemapParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeCubemapParameter(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeCubemapParameter() Instance {
	return self.Super().AsVisualShaderNodeCubemapParameter()
}
func (self class) AsVisualShaderNodeTextureParameter() VisualShaderNodeTextureParameter.Advanced {
	return VisualShaderNodeTextureParameter.Advanced{gdclass.NewVisualShaderNodeTextureParameter(self.AsObject()[0])}
}
...
func (self Instance) AsVisualShaderNodeTextureParameter() VisualShaderNodeTextureParameter.Instance {
	return VisualShaderNodeTextureParameter.Instance{gdclass.NewVisualShaderNodeTextureParameter(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeCubemapParameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeCubemapParameter(ptr)} })
}
