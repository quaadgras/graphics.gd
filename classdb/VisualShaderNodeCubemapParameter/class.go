...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeCubemapParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCubemapParameter{gdclass.NewVisualShaderNodeCubemapParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
