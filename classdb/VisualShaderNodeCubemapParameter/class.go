...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCubemapParameter{gdclass.NewVisualShaderNodeCubemapParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
