...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterWAV")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterWAV{gdclass.NewResourceImporterWAV(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
