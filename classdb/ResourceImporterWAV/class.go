...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterWAV{gdclass.NewResourceImporterWAV(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
