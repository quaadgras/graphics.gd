...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VSeparator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VSeparator{gdclass.NewVSeparator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
