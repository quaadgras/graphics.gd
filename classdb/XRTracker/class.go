...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRTracker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRTracker{gdclass.NewXRTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
