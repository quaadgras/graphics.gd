...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorScript")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorScript{gdclass.NewEditorScript(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
