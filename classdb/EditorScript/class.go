...
/*
Scripts extending this class and implementing its [Instance.Run] method can be executed from the Script Editor's File > Run menu option (or by pressing [kbd]Ctrl + Shift + X[/kbd]) while the editor is running. This is useful for adding custom in-editor functionality to Godot. For more complex additions, consider using [EditorPlugin]s instead.
...
/*
Returns the edited (current) scene's root [Node]. Equivalent of [Instance.Editorinterface.GetEditedSceneRoot].
*/
