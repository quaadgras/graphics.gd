...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ResourceImporter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporter{pointers.Add[gdclass.ResourceImporter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ResourceImporter{pointers.New[gdclass.ResourceImporter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self Instance) AsResourceImporter() Instance {
	return Instance{pointers.AsA[gdclass.ResourceImporter](self[0])}
}
...
func init() {
	gdclass.Register("ResourceImporter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ResourceImporter](ptr)} })
}
