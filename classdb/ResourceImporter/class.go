...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporter{gdclass.NewResourceImporter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
