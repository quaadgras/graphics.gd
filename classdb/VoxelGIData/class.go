...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VoxelGIData")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VoxelGIData{gdclass.NewVoxelGIData(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
