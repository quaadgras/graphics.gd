...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeTimeSeek{gdclass.NewAnimationNodeTimeSeek(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
