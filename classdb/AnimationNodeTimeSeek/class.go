...
/*
This animation node can be used to cause a seek command to happen to any sub-children of the animation graph. Use to play an [graphics.gd/classdb/Animation] from the start or a certain playback position inside the [graphics.gd/classdb/AnimationNodeBlendTree].
