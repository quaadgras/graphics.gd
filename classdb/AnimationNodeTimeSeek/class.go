...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeTimeSeek")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeTimeSeek{gdclass.NewAnimationNodeTimeSeek(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
