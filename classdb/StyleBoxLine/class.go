...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("StyleBoxLine")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.StyleBoxLine{gdclass.NewStyleBoxLine(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
