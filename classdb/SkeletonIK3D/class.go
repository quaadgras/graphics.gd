...
func (self class) SetRootBone(root_bone String.Name) { //gd:SkeletonIK3D.set_root_bone
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_root_bone, 0|(gdextension.SizeStringName<<4), &struct{ root_bone gdextension.StringName }{pointers.Get(gd.InternalStringName(root_bone))})
}
...
func (self class) SetTipBone(tip_bone String.Name) { //gd:SkeletonIK3D.set_tip_bone
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_tip_bone, 0|(gdextension.SizeStringName<<4), &struct{ tip_bone gdextension.StringName }{pointers.Get(gd.InternalStringName(tip_bone))})
}

//go:nosplit
func (self class) GetTipBone() String.Name { //gd:SkeletonIK3D.get_tip_bone
	var r_ret = mainthread.Call[gdextension.StringName](gd.ObjectChecked(self.AsObject()), methods.get_tip_bone, gdextension.SizeStringName, &struct{}{})
	var ret = String.Name(String.Via(gd.StringNameProxy{}, pointers.Pack(pointers.New[gd.StringName](r_ret))))
	return ret
}
...
func (self class) SetTargetTransform(target Transform3D.BasisOrigin) { //gd:SkeletonIK3D.set_target_transform
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_target_transform, 0|(gdextension.SizeTransform3D<<4), &struct{ target Transform3D.BasisOrigin }{gd.Transposed(target)})
}

//go:nosplit
func (self class) GetTargetTransform() Transform3D.BasisOrigin { //gd:SkeletonIK3D.get_target_transform
	var r_ret = mainthread.Call[Transform3D.BasisOrigin](gd.ObjectChecked(self.AsObject()), methods.get_target_transform, gdextension.SizeTransform3D, &struct{}{})
...
func (self class) SetTargetNode(node Path.ToNode) { //gd:SkeletonIK3D.set_target_node
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_target_node, 0|(gdextension.SizeNodePath<<4), &struct{ node gdextension.NodePath }{pointers.Get(gd.InternalNodePath(node))})
}
...
func (self class) SetOverrideTipBasis(override bool) { //gd:SkeletonIK3D.set_override_tip_basis
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_override_tip_basis, 0|(gdextension.SizeBool<<4), &struct{ override bool }{override})
}

//go:nosplit
func (self class) IsOverrideTipBasis() bool { //gd:SkeletonIK3D.is_override_tip_basis
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_override_tip_basis, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetUseMagnet(use bool) { //gd:SkeletonIK3D.set_use_magnet
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_use_magnet, 0|(gdextension.SizeBool<<4), &struct{ use bool }{use})
}

//go:nosplit
func (self class) IsUsingMagnet() bool { //gd:SkeletonIK3D.is_using_magnet
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_using_magnet, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMagnetPosition(local_position Vector3.XYZ) { //gd:SkeletonIK3D.set_magnet_position
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_magnet_position, 0|(gdextension.SizeVector3<<4), &struct{ local_position Vector3.XYZ }{local_position})
}

//go:nosplit
func (self class) GetMagnetPosition() Vector3.XYZ { //gd:SkeletonIK3D.get_magnet_position
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_magnet_position, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetParentSkeleton() [1]gdclass.Skeleton3D { //gd:SkeletonIK3D.get_parent_skeleton
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_parent_skeleton, gdextension.SizeObject, &struct{}{})
...
func (self class) SetMinDistance(min_distance float64) { //gd:SkeletonIK3D.set_min_distance
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_min_distance, 0|(gdextension.SizeFloat<<4), &struct{ min_distance float64 }{min_distance})
}

//go:nosplit
func (self class) GetMinDistance() float64 { //gd:SkeletonIK3D.get_min_distance
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_min_distance, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxIterations(iterations int64) { //gd:SkeletonIK3D.set_max_iterations
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max_iterations, 0|(gdextension.SizeInt<<4), &struct{ iterations int64 }{iterations})
}

//go:nosplit
func (self class) GetMaxIterations() int64 { //gd:SkeletonIK3D.get_max_iterations
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_max_iterations, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) Start(one_time bool) { //gd:SkeletonIK3D.start
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.start, 0|(gdextension.SizeBool<<4), &struct{ one_time bool }{one_time})
}
...
func (self class) SetInterpolation(interpolation float64) { //gd:SkeletonIK3D.set_interpolation
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_interpolation, 0|(gdextension.SizeFloat<<4), &struct{ interpolation float64 }{interpolation})
}

//go:nosplit
func (self class) GetInterpolation() float64 { //gd:SkeletonIK3D.get_interpolation
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_interpolation, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
