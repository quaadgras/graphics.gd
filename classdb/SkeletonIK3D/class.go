...
/*
Returns true if SkeletonIK is applying IK effects on continues frames to the [Skeleton3D] bones. Returns false if SkeletonIK is stopped or [Instance.Start] was used with the one_time parameter set to true.
*/
...
/*
Stops applying IK effects on each frame to the [Skeleton3D] bones and also calls [Instance.Skeleton3d.ClearBonesGlobalPoseOverride] to remove existing overrides on all bones.
*/
