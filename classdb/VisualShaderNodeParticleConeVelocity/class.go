...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleConeVelocity{gdclass.NewVisualShaderNodeParticleConeVelocity(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
