...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleConeVelocity(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleConeVelocity{gdclass.NewVisualShaderNodeParticleConeVelocity(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeParticleConeVelocity(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleConeVelocity{gdclass.NewVisualShaderNodeParticleConeVelocity(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeParticleConeVelocity() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleConeVelocity(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleConeVelocity() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleConeVelocity(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleConeVelocity() Instance {
	return self.Super().AsVisualShaderNodeParticleConeVelocity()
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleConeVelocity", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleConeVelocity(ptr)} })
}
