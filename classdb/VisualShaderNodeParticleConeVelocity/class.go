...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleConeVelocity")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleConeVelocity{gdclass.NewVisualShaderNodeParticleConeVelocity(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
