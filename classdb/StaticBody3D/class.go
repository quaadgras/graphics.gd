...
When [graphics.gd/classdb/StaticBody3D] is moved, it is teleported to its new position without affecting other physics bodies in its path. If this is not desired, use [graphics.gd/classdb/AnimatableBody3D] instead.

[graphics.gd/classdb/StaticBody3D] is useful for completely static objects like floors and walls, as well as moving surfaces like conveyor belts and circular revolving platforms (by using [Instance.ConstantLinearVelocity] and [Instance.ConstantAngularVelocity]).
*/
