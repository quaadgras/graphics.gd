...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeTexture](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTexture{pointers.Add[gdclass.VisualShaderNodeTexture]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture{pointers.New[gdclass.VisualShaderNodeTexture]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetTexture(value [1]gdclass.Texture2D) { //gd:VisualShaderNodeTexture.set_texture
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_texture, 0|(gdextension.SizeObject<<4), &struct{ value gdextension.Object }{gdextension.Object(gd.ObjectChecked(value[0].AsObject()))})
}
...
func (self class) AsVisualShaderNodeTexture() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeTexture](self[0])}
}
func (self Instance) AsVisualShaderNodeTexture() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeTexture", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeTexture](ptr)} })
}
