...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture{gdclass.NewVisualShaderNodeTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
