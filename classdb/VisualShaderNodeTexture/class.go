...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture{gdclass.NewVisualShaderNodeTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
