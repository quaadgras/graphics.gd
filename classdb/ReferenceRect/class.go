...
func (self class) GetBorderWidth() float64 { //gd:ReferenceRect.get_border_width
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_border_width, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetBorderWidth(width float64) { //gd:ReferenceRect.set_border_width
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_border_width, 0|(gdextension.SizeFloat<<4), &struct{ width float64 }{width})
}

//go:nosplit
func (self class) GetEditorOnly() bool { //gd:ReferenceRect.get_editor_only
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_editor_only, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetEditorOnly(enabled bool) { //gd:ReferenceRect.set_editor_only
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_editor_only, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}
