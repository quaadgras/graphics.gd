...
/*
A rectangular box that displays only a colored border around its rectangle (see [graphics.gd/classdb/Control.Instance.GetRect]). It can be used to visualize the extents of a [graphics.gd/classdb/Control] node, for testing purposes.
*/
