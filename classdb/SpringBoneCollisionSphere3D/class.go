...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.SpringBoneCollisionSphere3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SpringBoneCollisionSphere3D{pointers.Add[gdclass.SpringBoneCollisionSphere3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.SpringBoneCollisionSphere3D{pointers.New[gdclass.SpringBoneCollisionSphere3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsSpringBoneCollisionSphere3D() Advanced {
	return Advanced{pointers.AsA[gdclass.SpringBoneCollisionSphere3D](self[0])}
}
func (self Instance) AsSpringBoneCollisionSphere3D() Instance {
	return Instance{pointers.AsA[gdclass.SpringBoneCollisionSphere3D](self[0])}
}
func (self *Extension[T]) AsSpringBoneCollisionSphere3D() Instance {
	return self.Super().AsSpringBoneCollisionSphere3D()
}
...
func init() {
	gdclass.Register("SpringBoneCollisionSphere3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.SpringBoneCollisionSphere3D](ptr)} })
}
