...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpringBoneCollisionSphere3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionSphere3D{gdclass.NewSpringBoneCollisionSphere3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
