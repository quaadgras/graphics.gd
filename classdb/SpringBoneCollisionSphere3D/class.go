...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneCollisionSphere3D{gdclass.NewSpringBoneCollisionSphere3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
