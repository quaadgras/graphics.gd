...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCubemap{gdclass.NewVisualShaderNodeCubemap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
