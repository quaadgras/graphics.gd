...
/*
[graphics.gd/classdb/CanvasTexture] is an alternative to [graphics.gd/classdb/ImageTexture] for 2D rendering. It allows using normal maps and specular maps in any node that inherits from [graphics.gd/classdb/CanvasItem]. [graphics.gd/classdb/CanvasTexture] also allows overriding the texture's filter and repeat mode independently of the node's properties (or the project settings).

Note: [graphics.gd/classdb/CanvasTexture] cannot be used in 3D. It will not display correctly when applied to any [graphics.gd/classdb/VisualInstance3D], such as [graphics.gd/classdb/Sprite3D] or [graphics.gd/classdb/Decal]. For physically-based materials in 3D, use [graphics.gd/classdb/BaseMaterial3D] instead.
*/
