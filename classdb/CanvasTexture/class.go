...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CanvasTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CanvasTexture{gdclass.NewCanvasTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
