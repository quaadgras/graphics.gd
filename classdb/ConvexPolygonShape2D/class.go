...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConvexPolygonShape2D{gdclass.NewConvexPolygonShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
