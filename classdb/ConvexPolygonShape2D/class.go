...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConvexPolygonShape2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConvexPolygonShape2D{gdclass.NewConvexPolygonShape2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
