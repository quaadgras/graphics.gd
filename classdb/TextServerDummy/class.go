...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTextServerDummy(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTextServerDummy(self[0]) }
...
func (self class) AsTextServerDummy() Advanced {
	return Advanced{gdclass.NewTextServerDummy(self.AsObject()[0])}
}
func (self Instance) AsTextServerDummy() Instance {
	return Instance{gdclass.NewTextServerDummy(self.AsObject()[0])}
}
