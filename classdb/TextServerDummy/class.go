...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextServerDummy")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextServerDummy{gdclass.NewTextServerDummy(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
