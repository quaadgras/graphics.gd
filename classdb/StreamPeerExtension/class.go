...
type Interface interface {
	GetData(r_buffer gdextension.Pointer, r_bytes int, r_received *int32) error
	GetPartialData(r_buffer gdextension.Pointer, r_bytes int, r_received *int32) error
	PutData(p_data gdextension.Pointer, p_bytes int, r_sent *int32) error
	PutPartialData(p_data gdextension.Pointer, p_bytes int, r_sent *int32) error
...
func (self implementation) GetData(r_buffer gdextension.Pointer, r_bytes int, r_received *int32) (_ error) {
	return
}
func (self implementation) GetPartialData(r_buffer gdextension.Pointer, r_bytes int, r_received *int32) (_ error) {
	return
}
func (self implementation) PutData(p_data gdextension.Pointer, p_bytes int, r_sent *int32) (_ error) {
	return
}
...
func (self class) AsObject() [1]gd.Object { return gdclass.GetStreamPeerExtension(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetStreamPeerExtension(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.StreamPeerExtension{gdclass.NewStreamPeerExtension(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetStreamPeerExtension(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.StreamPeerExtension{gdclass.NewStreamPeerExtension(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsStreamPeerExtension() Advanced {
	return Advanced{gdclass.NewStreamPeerExtension(self.AsObject()[0])}
}
func (self Instance) AsStreamPeerExtension() Instance {
	return Instance{gdclass.NewStreamPeerExtension(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("StreamPeerExtension", func(ptr gd.Object) any { return Instance{gdclass.NewStreamPeerExtension(ptr)} })
}
