...
func (self class) SetSky(sky [1]gdclass.Sky) { //gd:Environment.set_sky
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sky, 0|(gdextension.SizeObject<<4), &struct{ sky gdextension.Object }{gdextension.Object(gd.ObjectChecked(sky[0].AsObject()))})
}
...
func (self class) SetGlowMap(mode [1]gdclass.Texture) { //gd:Environment.set_glow_map
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_glow_map, 0|(gdextension.SizeObject<<4), &struct{ mode gdextension.Object }{gdextension.Object(gd.ObjectChecked(mode[0].AsObject()))})
}
...
func (self class) SetAdjustmentColorCorrection(color_correction [1]gdclass.Texture) { //gd:Environment.set_adjustment_color_correction
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_adjustment_color_correction, 0|(gdextension.SizeObject<<4), &struct{ color_correction gdextension.Object }{gdextension.Object(gd.ObjectChecked(color_correction[0].AsObject()))})
}
