...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Environment")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Environment{gdclass.NewEnvironment(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
