...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSyntaxHighlighter{gdclass.NewEditorSyntaxHighlighter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
