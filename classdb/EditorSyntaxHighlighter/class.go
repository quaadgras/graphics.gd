...
Add a syntax highlighter to an individual script by calling [graphics.gd/classdb/ScriptEditorBase.Instance.AddSyntaxHighlighter]. To apply to all scripts on open, call [graphics.gd/classdb/ScriptEditor.Instance.RegisterSyntaxHighlighter].
*/
