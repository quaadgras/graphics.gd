...
Add a syntax highlighter to an individual script by calling [Instance.Scripteditorbase.AddSyntaxHighlighter]. To apply to all scripts on open, call [Instance.Scripteditor.RegisterSyntaxHighlighter].
*/
