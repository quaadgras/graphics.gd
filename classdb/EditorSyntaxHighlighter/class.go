...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSyntaxHighlighter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSyntaxHighlighter{gdclass.NewEditorSyntaxHighlighter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
