...
/*
Returns the unique instance ID of the colliding body's attached [graphics.gd/classdb/Object] given a collision index (the deepest collision by default), if a collision occurred. See [graphics.gd/classdb/Object.Instance.GetInstanceId].
*/
...
/*
Returns the colliding body's attached [graphics.gd/classdb/Object] given a collision index (the deepest collision by default), if a collision occurred.
*/
...
/*
Returns the colliding body's shape index given a collision index (the deepest collision by default), if a collision occurred. See [graphics.gd/classdb/CollisionObject3D].
*/
