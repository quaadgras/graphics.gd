...
/*
Describes the motion and collision result from [Instance.Physicsserver3d.BodyTestMotion].
*/
...
/*
Returns the unique instance ID of the colliding body's attached [Object] given a collision index (the deepest collision by default), if a collision occurred. See [Instance.Object.GetInstanceId].
*/
