...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("PhysicsTestMotionResult3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionResult3D{gdclass.NewPhysicsTestMotionResult3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
