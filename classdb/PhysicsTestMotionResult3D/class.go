...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionResult3D{gdclass.NewPhysicsTestMotionResult3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
