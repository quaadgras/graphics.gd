...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRFrameSynthesisExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRFrameSynthesisExtension{gdclass.NewOpenXRFrameSynthesisExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
