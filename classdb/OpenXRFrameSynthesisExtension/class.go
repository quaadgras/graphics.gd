...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRFrameSynthesisExtension{gdclass.NewOpenXRFrameSynthesisExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
