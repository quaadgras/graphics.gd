...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanParameter{gdclass.NewVisualShaderNodeBooleanParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
