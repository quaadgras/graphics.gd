...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeBooleanParameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeBooleanParameter{pointers.Add[gdclass.VisualShaderNodeBooleanParameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanParameter{pointers.New[gdclass.VisualShaderNodeBooleanParameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetDefaultValue(value bool) { //gd:VisualShaderNodeBooleanParameter.set_default_value
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_default_value, 0|(gdextension.SizeBool<<4), &struct{ value bool }{value})
}

//go:nosplit
func (self class) GetDefaultValue() bool { //gd:VisualShaderNodeBooleanParameter.get_default_value
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeBooleanParameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeBooleanParameter](self[0])}
}
func (self Instance) AsVisualShaderNodeBooleanParameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeBooleanParameter](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeBooleanParameter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeBooleanParameter](ptr)} })
}
