...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeBooleanParameter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanParameter{gdclass.NewVisualShaderNodeBooleanParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
