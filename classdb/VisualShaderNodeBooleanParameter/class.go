...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeBooleanParameter(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeBooleanParameter{gdclass.NewVisualShaderNodeBooleanParameter(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeBooleanParameter(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeBooleanParameter{gdclass.NewVisualShaderNodeBooleanParameter(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeBooleanParameter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeBooleanParameter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeBooleanParameter() Instance {
	return Instance{gdclass.NewVisualShaderNodeBooleanParameter(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeBooleanParameter", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeBooleanParameter(ptr)} })
}
