...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformAppleEmbedded")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformAppleEmbedded{gdclass.NewEditorExportPlatformAppleEmbedded(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
