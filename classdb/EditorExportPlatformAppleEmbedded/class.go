...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformAppleEmbedded{gdclass.NewEditorExportPlatformAppleEmbedded(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
