...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec4Constant{gdclass.NewVisualShaderNodeVec4Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
