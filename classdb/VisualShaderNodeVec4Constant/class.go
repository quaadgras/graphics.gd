...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeVec4Constant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeVec4Constant{gdclass.NewVisualShaderNodeVec4Constant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
