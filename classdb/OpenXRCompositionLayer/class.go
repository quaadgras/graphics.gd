...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayer{gdclass.NewOpenXRCompositionLayer(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
