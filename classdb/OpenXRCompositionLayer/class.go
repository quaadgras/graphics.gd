...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRCompositionLayer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRCompositionLayer(self[0]) }
...
func (self class) AsOpenXRCompositionLayer() Advanced {
	return Advanced{gdclass.NewOpenXRCompositionLayer(self.AsObject()[0])}
}
func (self Instance) AsOpenXRCompositionLayer() Instance {
	return Instance{gdclass.NewOpenXRCompositionLayer(self.AsObject()[0])}
}
