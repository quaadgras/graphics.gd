...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRCompositionLayer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayer{gdclass.NewOpenXRCompositionLayer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
