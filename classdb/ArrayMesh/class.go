...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ArrayMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ArrayMesh{gdclass.NewArrayMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
