...
The [graphics.gd/classdb/MeshInstance3D] is ready to be added to the [graphics.gd/classdb/SceneTree] to be shown.

See also [graphics.gd/classdb/ImmediateMesh], [graphics.gd/classdb/MeshDataTool] and [graphics.gd/classdb/SurfaceTool] for procedural geometry generation.
...
/*
Adds name for a blend shape that will be added with [Instance.AddSurfaceFromArrays]. Must be called before surface is added.
*/
...
/*
Returns the number of blend shapes that the [graphics.gd/classdb/ArrayMesh] holds.
*/
...
/*
Removes all blend shapes from this [graphics.gd/classdb/ArrayMesh].
*/
...
/*
Removes all surfaces from this [graphics.gd/classdb/ArrayMesh].
*/
...
/*
Returns the length in vertices of the vertex array in the requested surface (see [Instance.AddSurfaceFromArrays]).
*/
...
/*
Returns the length in indices of the index array in the requested surface (see [Instance.AddSurfaceFromArrays]).
*/
...
/*
Returns the format mask of the requested surface (see [Instance.AddSurfaceFromArrays]).
*/
...
/*
Returns the primitive type of the requested surface (see [Instance.AddSurfaceFromArrays]).
*/
...
/*
Returns the index of the first surface with this name held within this [graphics.gd/classdb/ArrayMesh]. If none are found, -1 is returned.
*/
...
/*
Regenerates tangents for each of the [graphics.gd/classdb/ArrayMesh]'s surfaces.
*/
...
/*
Performs a UV unwrap on the [graphics.gd/classdb/ArrayMesh] to prepare the mesh for lightmapping.
*/
