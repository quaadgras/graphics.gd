...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameter{gdclass.NewVisualShaderNodeParameter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
