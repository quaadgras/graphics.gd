...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeParameter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParameter{pointers.Add[gdclass.VisualShaderNodeParameter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeParameter{pointers.New[gdclass.VisualShaderNodeParameter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetParameterName(name String.Readable) { //gd:VisualShaderNodeParameter.set_parameter_name
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_parameter_name, 0|(gdextension.SizeString<<4), &struct{ name gdextension.String }{pointers.Get(gd.InternalString(name))})
}

//go:nosplit
func (self class) GetParameterName() String.Readable { //gd:VisualShaderNodeParameter.get_parameter_name
	var r_ret = mainthread.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_parameter_name, gdextension.SizeString, &struct{}{})
...
func (self class) SetQualifier(qualifier Qualifier) { //gd:VisualShaderNodeParameter.set_qualifier
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_qualifier, 0|(gdextension.SizeInt<<4), &struct{ qualifier Qualifier }{qualifier})
}

//go:nosplit
func (self class) GetQualifier() Qualifier { //gd:VisualShaderNodeParameter.get_qualifier
	var r_ret = mainthread.Call[Qualifier](gd.ObjectChecked(self.AsObject()), methods.get_qualifier, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeParameter() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeParameter](self[0])}
}
func (self Instance) AsVisualShaderNodeParameter() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeParameter](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParameter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeParameter](ptr)} })
}
