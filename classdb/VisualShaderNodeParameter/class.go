...
/*
A parameter represents a variable in the shader which is set externally, i.e. from the [graphics.gd/classdb/ShaderMaterial]. Parameters are exposed as properties in the [graphics.gd/classdb/ShaderMaterial] and can be assigned from the Inspector or from a script.
*/
...
const (
	// The parameter will be tied to the [graphics.gd/classdb/ShaderMaterial] using this shader.
	QualNone Qualifier = 0
	// The parameter will use a global value, defined in Project Settings.
	QualGlobal Qualifier = 1
	// The parameter will be tied to the node with attached [graphics.gd/classdb/ShaderMaterial] using this shader.
