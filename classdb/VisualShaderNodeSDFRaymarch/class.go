...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeSDFRaymarch"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFRaymarch{gdclass.NewVisualShaderNodeSDFRaymarch(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
