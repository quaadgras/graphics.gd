...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeSDFRaymarch")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFRaymarch{gdclass.NewVisualShaderNodeSDFRaymarch(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
