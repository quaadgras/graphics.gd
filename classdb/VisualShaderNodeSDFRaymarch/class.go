...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeSDFRaymarch(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeSDFRaymarch(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeSDFRaymarch{gdclass.NewVisualShaderNodeSDFRaymarch(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeSDFRaymarch(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFRaymarch{gdclass.NewVisualShaderNodeSDFRaymarch(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeSDFRaymarch() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeSDFRaymarch(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeSDFRaymarch() Instance {
	return Instance{gdclass.NewVisualShaderNodeSDFRaymarch(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeSDFRaymarch() Instance {
	return self.Super().AsVisualShaderNodeSDFRaymarch()
}
...
func init() {
	gdclass.Register("VisualShaderNodeSDFRaymarch", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeSDFRaymarch(ptr)} })
}
