...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeSDFRaymarch{gdclass.NewVisualShaderNodeSDFRaymarch(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
