...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HSlider")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HSlider{gdclass.NewHSlider(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
