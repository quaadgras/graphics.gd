...
To use [EditorSceneFormatImporter], register it using the [Instance.Editorplugin.AddSceneFormatImporterPlugin] method first.
*/
...
/*
Add a specific import option (name and default value only). This function can only be called from [Instance.GetImportOptions].
*/
...
/*
Add a specific import option. This function can only be called from [Instance.GetImportOptions].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.EditorSceneFormatImporter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorSceneFormatImporter{pointers.Add[gdclass.EditorSceneFormatImporter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporter{pointers.New[gdclass.EditorSceneFormatImporter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self Instance) AsEditorSceneFormatImporter() Instance {
	return Instance{pointers.AsA[gdclass.EditorSceneFormatImporter](self[0])}
}
...
func init() {
	gdclass.Register("EditorSceneFormatImporter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.EditorSceneFormatImporter](ptr)} })
}
