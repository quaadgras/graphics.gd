...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporter{gdclass.NewEditorSceneFormatImporter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
