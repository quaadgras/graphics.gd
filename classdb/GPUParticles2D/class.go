...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticles2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticles2D{gdclass.NewGPUParticles2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
