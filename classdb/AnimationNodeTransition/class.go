...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeTransition{gdclass.NewAnimationNodeTransition(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
