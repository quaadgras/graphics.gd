...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeTransition")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeTransition{gdclass.NewAnimationNodeTransition(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
