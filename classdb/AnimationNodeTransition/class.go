...
func (self class) SetInputCount(input_count int64) { //gd:AnimationNodeTransition.set_input_count
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_input_count, 0|(gdextension.SizeInt<<4), &struct{ input_count int64 }{input_count})
}
...
func (self class) SetInputAsAutoAdvance(input int64, enable bool) { //gd:AnimationNodeTransition.set_input_as_auto_advance
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_input_as_auto_advance, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		input  int64
		enable bool
	}{input, enable})
}
...
func (self class) IsInputSetAsAutoAdvance(input int64) bool { //gd:AnimationNodeTransition.is_input_set_as_auto_advance
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_input_set_as_auto_advance, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ input int64 }{input})
	var ret = r_ret
	return ret
}
...
func (self class) SetInputBreakLoopAtEnd(input int64, enable bool) { //gd:AnimationNodeTransition.set_input_break_loop_at_end
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_input_break_loop_at_end, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		input  int64
		enable bool
	}{input, enable})
}
...
func (self class) IsInputLoopBrokenAtEnd(input int64) bool { //gd:AnimationNodeTransition.is_input_loop_broken_at_end
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_input_loop_broken_at_end, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ input int64 }{input})
	var ret = r_ret
	return ret
}
...
func (self class) SetInputReset(input int64, enable bool) { //gd:AnimationNodeTransition.set_input_reset
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_input_reset, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct {
		input  int64
		enable bool
	}{input, enable})
}
...
func (self class) IsInputReset(input int64) bool { //gd:AnimationNodeTransition.is_input_reset
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_input_reset, gdextension.SizeBool|(gdextension.SizeInt<<4), &struct{ input int64 }{input})
	var ret = r_ret
	return ret
}
...
func (self class) SetXfadeTime(time float64) { //gd:AnimationNodeTransition.set_xfade_time
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_xfade_time, 0|(gdextension.SizeFloat<<4), &struct{ time float64 }{time})
}
