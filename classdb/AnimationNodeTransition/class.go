...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAnimationNodeTransition(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAnimationNodeTransition(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeTransition{gdclass.NewAnimationNodeTransition(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAnimationNodeTransition(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeTransition{gdclass.NewAnimationNodeTransition(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) SetXfadeCurve(curve [1]gdclass.Curve) { //gd:AnimationNodeTransition.set_xfade_curve
	noescape.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_xfade_curve, 0|(gdextension.SizeObject<<4), &struct{ curve gdextension.Object }{gdextension.Object(gd.ObjectChecked(gdclass.GetCurve(curve[0])))})
}
...
func (self class) AsAnimationNodeTransition() Advanced {
	return Advanced{gdclass.NewAnimationNodeTransition(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeTransition() Instance {
	return Instance{gdclass.NewAnimationNodeTransition(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeTransition", func(ptr gd.Object) any { return Instance{gdclass.NewAnimationNodeTransition(ptr)} })
}
