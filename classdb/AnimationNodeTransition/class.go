...
/*
Simple state machine for cases which don't require a more advanced [graphics.gd/classdb/AnimationNodeStateMachine]. Animations can be connected to the inputs and transition times can be specified.
