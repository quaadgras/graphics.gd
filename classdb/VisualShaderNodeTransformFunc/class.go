...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformFunc{gdclass.NewVisualShaderNodeTransformFunc(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
