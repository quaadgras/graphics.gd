...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRAnalogThresholdModifier")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAnalogThresholdModifier{gdclass.NewOpenXRAnalogThresholdModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
