...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAnalogThresholdModifier{gdclass.NewOpenXRAnalogThresholdModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
