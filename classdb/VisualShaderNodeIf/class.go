...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeIf")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeIf{gdclass.NewVisualShaderNodeIf(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
