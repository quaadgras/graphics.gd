...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("LightmapGIData")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.LightmapGIData{gdclass.NewLightmapGIData(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
