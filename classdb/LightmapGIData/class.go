...
Note: Changing this value on already baked lightmaps will not cause them to be baked again. This means the material appearance will look incorrect until lightmaps are baked again, in which case the value set here is discarded as the entire [graphics.gd/classdb/LightmapGIData] resource is replaced by the lightmapper.
*/
//go:nosplit
...
/*
If true, lightmaps were baked with directional information. See also [graphics.gd/classdb/LightmapGI.Instance.Directional].
*/
//go:nosplit
