...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CodeHighlighter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CodeHighlighter{gdclass.NewCodeHighlighter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
