...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformLinuxBSD{gdclass.NewEditorExportPlatformLinuxBSD(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
