...
func (self class) AsObject() [1]gd.Object { return gdclass.GetEditorExportPlatformLinuxBSD(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetEditorExportPlatformLinuxBSD(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorExportPlatformLinuxBSD{gdclass.NewEditorExportPlatformLinuxBSD(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetEditorExportPlatformLinuxBSD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.EditorExportPlatformLinuxBSD{gdclass.NewEditorExportPlatformLinuxBSD(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsEditorExportPlatformLinuxBSD() Advanced {
	return Advanced{gdclass.NewEditorExportPlatformLinuxBSD(self.AsObject()[0])}
}
func (self Instance) AsEditorExportPlatformLinuxBSD() Instance {
	return Instance{gdclass.NewEditorExportPlatformLinuxBSD(self.AsObject()[0])}
}
...
func (self class) AsEditorExportPlatformPC() EditorExportPlatformPC.Advanced {
	return EditorExportPlatformPC.Advanced{gdclass.NewEditorExportPlatformPC(self.AsObject()[0])}
}
...
func (self Instance) AsEditorExportPlatformPC() EditorExportPlatformPC.Instance {
	return EditorExportPlatformPC.Instance{gdclass.NewEditorExportPlatformPC(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("EditorExportPlatformLinuxBSD", func(ptr gd.Object) any { return Instance{gdclass.NewEditorExportPlatformLinuxBSD(ptr)} })
}
