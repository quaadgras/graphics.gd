...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformLinuxBSD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformLinuxBSD{gdclass.NewEditorExportPlatformLinuxBSD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
