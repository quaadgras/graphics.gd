...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("DirAccess")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.DirAccess{gdclass.NewDirAccess(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
