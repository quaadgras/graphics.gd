...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.FastNoiseLite](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.FastNoiseLite{pointers.Add[gdclass.FastNoiseLite]([3]uint64{})})
	...
	casted := Instance([1]gdclass.FastNoiseLite{pointers.New[gdclass.FastNoiseLite]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetNoiseType(atype NoiseType) { //gd:FastNoiseLite.set_noise_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_noise_type, 0|(gdextension.SizeInt<<4), &struct{ atype NoiseType }{atype})
}

//go:nosplit
func (self class) GetNoiseType() NoiseType { //gd:FastNoiseLite.get_noise_type
	var r_ret = mainthread.Call[NoiseType](gd.ObjectChecked(self.AsObject()), methods.get_noise_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFrequency(freq float64) { //gd:FastNoiseLite.set_frequency
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_frequency, 0|(gdextension.SizeFloat<<4), &struct{ freq float64 }{freq})
}

//go:nosplit
func (self class) GetFrequency() float64 { //gd:FastNoiseLite.get_frequency
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_frequency, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetOffset(offset Vector3.XYZ) { //gd:FastNoiseLite.set_offset
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_offset, 0|(gdextension.SizeVector3<<4), &struct{ offset Vector3.XYZ }{offset})
}

//go:nosplit
func (self class) GetOffset() Vector3.XYZ { //gd:FastNoiseLite.get_offset
	var r_ret = mainthread.Call[Vector3.XYZ](gd.ObjectChecked(self.AsObject()), methods.get_offset, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFractalType(atype FractalType) { //gd:FastNoiseLite.set_fractal_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fractal_type, 0|(gdextension.SizeInt<<4), &struct{ atype FractalType }{atype})
}

//go:nosplit
func (self class) GetFractalType() FractalType { //gd:FastNoiseLite.get_fractal_type
	var r_ret = mainthread.Call[FractalType](gd.ObjectChecked(self.AsObject()), methods.get_fractal_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFractalOctaves(octave_count int64) { //gd:FastNoiseLite.set_fractal_octaves
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fractal_octaves, 0|(gdextension.SizeInt<<4), &struct{ octave_count int64 }{octave_count})
}

//go:nosplit
func (self class) GetFractalOctaves() int64 { //gd:FastNoiseLite.get_fractal_octaves
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_fractal_octaves, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFractalLacunarity(lacunarity float64) { //gd:FastNoiseLite.set_fractal_lacunarity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fractal_lacunarity, 0|(gdextension.SizeFloat<<4), &struct{ lacunarity float64 }{lacunarity})
}

//go:nosplit
func (self class) GetFractalLacunarity() float64 { //gd:FastNoiseLite.get_fractal_lacunarity
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_fractal_lacunarity, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFractalGain(gain float64) { //gd:FastNoiseLite.set_fractal_gain
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fractal_gain, 0|(gdextension.SizeFloat<<4), &struct{ gain float64 }{gain})
}

//go:nosplit
func (self class) GetFractalGain() float64 { //gd:FastNoiseLite.get_fractal_gain
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_fractal_gain, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFractalWeightedStrength(weighted_strength float64) { //gd:FastNoiseLite.set_fractal_weighted_strength
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fractal_weighted_strength, 0|(gdextension.SizeFloat<<4), &struct{ weighted_strength float64 }{weighted_strength})
}

//go:nosplit
func (self class) GetFractalWeightedStrength() float64 { //gd:FastNoiseLite.get_fractal_weighted_strength
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_fractal_weighted_strength, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetFractalPingPongStrength(ping_pong_strength float64) { //gd:FastNoiseLite.set_fractal_ping_pong_strength
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_fractal_ping_pong_strength, 0|(gdextension.SizeFloat<<4), &struct{ ping_pong_strength float64 }{ping_pong_strength})
}

//go:nosplit
func (self class) GetFractalPingPongStrength() float64 { //gd:FastNoiseLite.get_fractal_ping_pong_strength
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_fractal_ping_pong_strength, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCellularDistanceFunction(fn CellularDistanceFunction) { //gd:FastNoiseLite.set_cellular_distance_function
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cellular_distance_function, 0|(gdextension.SizeInt<<4), &struct{ fn CellularDistanceFunction }{fn})
}

//go:nosplit
func (self class) GetCellularDistanceFunction() CellularDistanceFunction { //gd:FastNoiseLite.get_cellular_distance_function
	var r_ret = mainthread.Call[CellularDistanceFunction](gd.ObjectChecked(self.AsObject()), methods.get_cellular_distance_function, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCellularJitter(jitter float64) { //gd:FastNoiseLite.set_cellular_jitter
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cellular_jitter, 0|(gdextension.SizeFloat<<4), &struct{ jitter float64 }{jitter})
}

//go:nosplit
func (self class) GetCellularJitter() float64 { //gd:FastNoiseLite.get_cellular_jitter
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_cellular_jitter, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetCellularReturnType(ret CellularReturnType) { //gd:FastNoiseLite.set_cellular_return_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_cellular_return_type, 0|(gdextension.SizeInt<<4), &struct{ ret CellularReturnType }{ret})
}

//go:nosplit
func (self class) GetCellularReturnType() CellularReturnType { //gd:FastNoiseLite.get_cellular_return_type
	var r_ret = mainthread.Call[CellularReturnType](gd.ObjectChecked(self.AsObject()), methods.get_cellular_return_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpEnabled(domain_warp_enabled bool) { //gd:FastNoiseLite.set_domain_warp_enabled
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_enabled, 0|(gdextension.SizeBool<<4), &struct{ domain_warp_enabled bool }{domain_warp_enabled})
}

//go:nosplit
func (self class) IsDomainWarpEnabled() bool { //gd:FastNoiseLite.is_domain_warp_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_domain_warp_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpType(domain_warp_type DomainWarpType) { //gd:FastNoiseLite.set_domain_warp_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_type, 0|(gdextension.SizeInt<<4), &struct{ domain_warp_type DomainWarpType }{domain_warp_type})
}

//go:nosplit
func (self class) GetDomainWarpType() DomainWarpType { //gd:FastNoiseLite.get_domain_warp_type
	var r_ret = mainthread.Call[DomainWarpType](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpAmplitude(domain_warp_amplitude float64) { //gd:FastNoiseLite.set_domain_warp_amplitude
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_amplitude, 0|(gdextension.SizeFloat<<4), &struct{ domain_warp_amplitude float64 }{domain_warp_amplitude})
}

//go:nosplit
func (self class) GetDomainWarpAmplitude() float64 { //gd:FastNoiseLite.get_domain_warp_amplitude
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_amplitude, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpFrequency(domain_warp_frequency float64) { //gd:FastNoiseLite.set_domain_warp_frequency
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_frequency, 0|(gdextension.SizeFloat<<4), &struct{ domain_warp_frequency float64 }{domain_warp_frequency})
}

//go:nosplit
func (self class) GetDomainWarpFrequency() float64 { //gd:FastNoiseLite.get_domain_warp_frequency
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_frequency, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpFractalType(domain_warp_fractal_type DomainWarpFractalType) { //gd:FastNoiseLite.set_domain_warp_fractal_type
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_fractal_type, 0|(gdextension.SizeInt<<4), &struct{ domain_warp_fractal_type DomainWarpFractalType }{domain_warp_fractal_type})
}

//go:nosplit
func (self class) GetDomainWarpFractalType() DomainWarpFractalType { //gd:FastNoiseLite.get_domain_warp_fractal_type
	var r_ret = mainthread.Call[DomainWarpFractalType](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_fractal_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpFractalOctaves(domain_warp_octave_count int64) { //gd:FastNoiseLite.set_domain_warp_fractal_octaves
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_fractal_octaves, 0|(gdextension.SizeInt<<4), &struct{ domain_warp_octave_count int64 }{domain_warp_octave_count})
}

//go:nosplit
func (self class) GetDomainWarpFractalOctaves() int64 { //gd:FastNoiseLite.get_domain_warp_fractal_octaves
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_fractal_octaves, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpFractalLacunarity(domain_warp_lacunarity float64) { //gd:FastNoiseLite.set_domain_warp_fractal_lacunarity
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_fractal_lacunarity, 0|(gdextension.SizeFloat<<4), &struct{ domain_warp_lacunarity float64 }{domain_warp_lacunarity})
}

//go:nosplit
func (self class) GetDomainWarpFractalLacunarity() float64 { //gd:FastNoiseLite.get_domain_warp_fractal_lacunarity
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_fractal_lacunarity, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDomainWarpFractalGain(domain_warp_gain float64) { //gd:FastNoiseLite.set_domain_warp_fractal_gain
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_domain_warp_fractal_gain, 0|(gdextension.SizeFloat<<4), &struct{ domain_warp_gain float64 }{domain_warp_gain})
}

//go:nosplit
func (self class) GetDomainWarpFractalGain() float64 { //gd:FastNoiseLite.get_domain_warp_fractal_gain
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_domain_warp_fractal_gain, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsFastNoiseLite() Advanced {
	return Advanced{pointers.AsA[gdclass.FastNoiseLite](self[0])}
}
func (self Instance) AsFastNoiseLite() Instance {
	return Instance{pointers.AsA[gdclass.FastNoiseLite](self[0])}
}
func (self *Extension[T]) AsFastNoiseLite() Instance { return self.Super().AsFastNoiseLite() }
func (self class) AsNoise() Noise.Advanced {
	return Noise.Advanced{pointers.AsA[gdclass.Noise](self[0])}
}
func (self *Extension[T]) AsNoise() Noise.Instance { return self.Super().AsNoise() }
func (self Instance) AsNoise() Noise.Instance {
	return Noise.Instance{pointers.AsA[gdclass.Noise](self[0])}
}
...
func init() {
	gdclass.Register("FastNoiseLite", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.FastNoiseLite](ptr)} })
}
