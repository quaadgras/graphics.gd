...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FastNoiseLite")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FastNoiseLite{gdclass.NewFastNoiseLite(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
