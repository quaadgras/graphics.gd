...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Control")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Control{gdclass.NewControl(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
