...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PCKPacker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PCKPacker{gdclass.NewPCKPacker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
