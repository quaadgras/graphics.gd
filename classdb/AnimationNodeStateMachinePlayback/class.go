...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeStateMachinePlayback{gdclass.NewAnimationNodeStateMachinePlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
