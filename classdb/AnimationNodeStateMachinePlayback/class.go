...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetAnimationNodeStateMachinePlayback(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeStateMachinePlayback{gdclass.NewAnimationNodeStateMachinePlayback(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAnimationNodeStateMachinePlayback(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeStateMachinePlayback{gdclass.NewAnimationNodeStateMachinePlayback(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnStateStarted(cb func(state string), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("state_started"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self Instance) OnStateFinished(cb func(state string), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("state_finished"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsAnimationNodeStateMachinePlayback() Advanced {
	return Advanced{gdclass.NewAnimationNodeStateMachinePlayback(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeStateMachinePlayback() Instance {
	return Instance{gdclass.NewAnimationNodeStateMachinePlayback(self.AsObject()[0])}
}
