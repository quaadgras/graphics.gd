...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AnimationNodeStateMachinePlayback"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeStateMachinePlayback{gdclass.NewAnimationNodeStateMachinePlayback(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
