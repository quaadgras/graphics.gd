...
/*
A variant of [graphics.gd/classdb/BoxContainer] that can only arrange its child controls horizontally. Child controls are rearranged automatically when their minimum size changes.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.HBoxContainer](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HBoxContainer{pointers.Add[gdclass.HBoxContainer]([3]uint64{})})
	...
	casted := Instance([1]gdclass.HBoxContainer{pointers.New[gdclass.HBoxContainer]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsHBoxContainer() Advanced {
	return Advanced{pointers.AsA[gdclass.HBoxContainer](self[0])}
}
func (self Instance) AsHBoxContainer() Instance {
	return Instance{pointers.AsA[gdclass.HBoxContainer](self[0])}
}
...
func init() {
	gdclass.Register("HBoxContainer", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.HBoxContainer](ptr)} })
}
