...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HBoxContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HBoxContainer{gdclass.NewHBoxContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
