...
func (self class) AsObject() [1]gd.Object { return gdclass.GetHBoxContainer(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetHBoxContainer(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.HBoxContainer{gdclass.NewHBoxContainer(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetHBoxContainer(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.HBoxContainer{gdclass.NewHBoxContainer(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsHBoxContainer() Advanced {
	return Advanced{gdclass.NewHBoxContainer(self.AsObject()[0])}
}
func (self Instance) AsHBoxContainer() Instance {
	return Instance{gdclass.NewHBoxContainer(self.AsObject()[0])}
}
func (self *Extension[T]) AsHBoxContainer() Instance { return self.Super().AsHBoxContainer() }
...
func init() {
	gdclass.Register("HBoxContainer", func(ptr gd.Object) any { return Instance{gdclass.NewHBoxContainer(ptr)} })
}
