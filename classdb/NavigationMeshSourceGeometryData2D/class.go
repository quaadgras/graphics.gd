...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationMeshSourceGeometryData2D{gdclass.NewNavigationMeshSourceGeometryData2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
