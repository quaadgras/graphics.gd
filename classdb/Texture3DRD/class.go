...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.Texture3DRD](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.Texture3DRD{pointers.Add[gdclass.Texture3DRD]([3]uint64{})})
	...
	casted := Instance([1]gdclass.Texture3DRD{pointers.New[gdclass.Texture3DRD]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsTexture3DRD() Advanced {
	return Advanced{pointers.AsA[gdclass.Texture3DRD](self[0])}
}
func (self Instance) AsTexture3DRD() Instance {
	return Instance{pointers.AsA[gdclass.Texture3DRD](self[0])}
}
...
func init() {
	gdclass.Register("Texture3DRD", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.Texture3DRD](ptr)} })
}
