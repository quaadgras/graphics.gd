...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Texture3DRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Texture3DRD{gdclass.NewTexture3DRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
