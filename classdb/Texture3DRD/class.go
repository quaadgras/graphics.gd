...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTexture3DRD(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTexture3DRD(self[0]) }
...
func (self class) AsTexture3DRD() Advanced {
	return Advanced{gdclass.NewTexture3DRD(self.AsObject()[0])}
}
func (self Instance) AsTexture3DRD() Instance {
	return Instance{gdclass.NewTexture3DRD(self.AsObject()[0])}
}
func (self *Extension[T]) AsTexture3DRD() Instance { return self.Super().AsTexture3DRD() }
