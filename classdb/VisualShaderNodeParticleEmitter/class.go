...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmitter{gdclass.NewVisualShaderNodeParticleEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
