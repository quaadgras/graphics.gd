...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleEmitter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleEmitter{gdclass.NewVisualShaderNodeParticleEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
