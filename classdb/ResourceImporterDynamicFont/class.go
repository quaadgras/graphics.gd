...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceImporterDynamicFont")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterDynamicFont{gdclass.NewResourceImporterDynamicFont(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
