...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceImporterDynamicFont{gdclass.NewResourceImporterDynamicFont(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
