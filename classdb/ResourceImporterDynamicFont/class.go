...
func (self class) AsObject() [1]gd.Object { return gdclass.GetResourceImporterDynamicFont(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetResourceImporterDynamicFont(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ResourceImporterDynamicFont{gdclass.NewResourceImporterDynamicFont(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetResourceImporterDynamicFont(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ResourceImporterDynamicFont{gdclass.NewResourceImporterDynamicFont(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsResourceImporterDynamicFont() Advanced {
	return Advanced{gdclass.NewResourceImporterDynamicFont(self.AsObject()[0])}
}
func (self Instance) AsResourceImporterDynamicFont() Instance {
	return Instance{gdclass.NewResourceImporterDynamicFont(self.AsObject()[0])}
}
func (self *Extension[T]) AsResourceImporterDynamicFont() Instance {
	return self.Super().AsResourceImporterDynamicFont()
}
...
func init() {
	gdclass.Register("ResourceImporterDynamicFont", func(ptr gd.Object) any { return Instance{gdclass.NewResourceImporterDynamicFont(ptr)} })
}
