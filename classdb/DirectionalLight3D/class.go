...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("DirectionalLight3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.DirectionalLight3D{gdclass.NewDirectionalLight3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
