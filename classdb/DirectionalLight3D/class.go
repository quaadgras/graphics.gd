...
func (self class) SetShadowMode(mode ShadowMode) { //gd:DirectionalLight3D.set_shadow_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_shadow_mode, 0|(gdextension.SizeInt<<4), &struct{ mode ShadowMode }{mode})
}

//go:nosplit
func (self class) GetShadowMode() ShadowMode { //gd:DirectionalLight3D.get_shadow_mode
	var r_ret = mainthread.Call[ShadowMode](gd.ObjectChecked(self.AsObject()), methods.get_shadow_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetBlendSplits(enabled bool) { //gd:DirectionalLight3D.set_blend_splits
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_blend_splits, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsBlendSplitsEnabled() bool { //gd:DirectionalLight3D.is_blend_splits_enabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_blend_splits_enabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSkyMode(mode SkyMode) { //gd:DirectionalLight3D.set_sky_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_sky_mode, 0|(gdextension.SizeInt<<4), &struct{ mode SkyMode }{mode})
}

//go:nosplit
func (self class) GetSkyMode() SkyMode { //gd:DirectionalLight3D.get_sky_mode
	var r_ret = mainthread.Call[SkyMode](gd.ObjectChecked(self.AsObject()), methods.get_sky_mode, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
