...
/*
This node selects a bone in a [graphics.gd/classdb/Skeleton3D] and attaches to it. This means that the [graphics.gd/classdb/ModifierBoneTarget3D] node will dynamically copy the 3D transform of the selected bone.

The functionality is similar to [graphics.gd/classdb/BoneAttachment3D], but this node adopts the [graphics.gd/classdb/SkeletonModifier3D] cycle and is intended to be used as another [graphics.gd/classdb/SkeletonModifier3D]'s target.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ModifierBoneTarget3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ModifierBoneTarget3D{pointers.Add[gdclass.ModifierBoneTarget3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ModifierBoneTarget3D{pointers.New[gdclass.ModifierBoneTarget3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsModifierBoneTarget3D() Advanced {
	return Advanced{pointers.AsA[gdclass.ModifierBoneTarget3D](self[0])}
}
func (self Instance) AsModifierBoneTarget3D() Instance {
	return Instance{pointers.AsA[gdclass.ModifierBoneTarget3D](self[0])}
}
func (self *Extension[T]) AsModifierBoneTarget3D() Instance {
	return self.Super().AsModifierBoneTarget3D()
}
...
func init() {
	gdclass.Register("ModifierBoneTarget3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ModifierBoneTarget3D](ptr)} })
}
