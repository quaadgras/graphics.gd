...
func New() Instance {
	...
	casted := Instance([1]gdclass.ModifierBoneTarget3D{gdclass.NewModifierBoneTarget3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
