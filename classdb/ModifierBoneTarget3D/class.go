...
func (self class) AsObject() [1]gd.Object { return gdclass.GetModifierBoneTarget3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetModifierBoneTarget3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ModifierBoneTarget3D{gdclass.NewModifierBoneTarget3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetModifierBoneTarget3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.ModifierBoneTarget3D{gdclass.NewModifierBoneTarget3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsModifierBoneTarget3D() Advanced {
	return Advanced{gdclass.NewModifierBoneTarget3D(self.AsObject()[0])}
}
func (self Instance) AsModifierBoneTarget3D() Instance {
	return Instance{gdclass.NewModifierBoneTarget3D(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("ModifierBoneTarget3D", func(ptr gd.Object) any { return Instance{gdclass.NewModifierBoneTarget3D(ptr)} })
}
