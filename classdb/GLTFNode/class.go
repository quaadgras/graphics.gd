...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFNode")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFNode{gdclass.NewGLTFNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
