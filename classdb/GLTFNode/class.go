...
func (self class) AsObject() [1]gd.Object { return gdclass.GetGLTFNode(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetGLTFNode(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GLTFNode{gdclass.NewGLTFNode(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetGLTFNode(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.GLTFNode{gdclass.NewGLTFNode(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsGLTFNode() Advanced         { return Advanced{gdclass.NewGLTFNode(self.AsObject()[0])} }
func (self Instance) AsGLTFNode() Instance      { return Instance{gdclass.NewGLTFNode(self.AsObject()[0])} }
