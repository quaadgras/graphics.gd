...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScriptExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptExtension{gdclass.NewScriptExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
