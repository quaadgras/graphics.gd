...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventJoypadButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventJoypadButton{gdclass.NewInputEventJoypadButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
