...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventJoypadButton{gdclass.NewInputEventJoypadButton(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
