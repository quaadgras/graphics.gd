...
func (self class) SetButtonIndex(button_index Input.JoyButton) { //gd:InputEventJoypadButton.set_button_index
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_button_index, 0|(gdextension.SizeInt<<4), &struct{ button_index Input.JoyButton }{button_index})
}

//go:nosplit
func (self class) GetButtonIndex() Input.JoyButton { //gd:InputEventJoypadButton.get_button_index
	var r_ret = mainthread.Call[Input.JoyButton](gd.ObjectChecked(self.AsObject()), methods.get_button_index, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
