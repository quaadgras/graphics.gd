...
/*
Input event type for gamepad buttons. For gamepad analog sticks and joysticks, see [graphics.gd/classdb/InputEventJoypadMotion].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.InputEventJoypadButton](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventJoypadButton{pointers.Add[gdclass.InputEventJoypadButton]([3]uint64{})})
	...
	casted := Instance([1]gdclass.InputEventJoypadButton{pointers.New[gdclass.InputEventJoypadButton]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetButtonIndex(button_index Input.JoyButton) { //gd:InputEventJoypadButton.set_button_index
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_button_index, 0|(gdextension.SizeInt<<4), &struct{ button_index Input.JoyButton }{button_index})
}

//go:nosplit
func (self class) GetButtonIndex() Input.JoyButton { //gd:InputEventJoypadButton.get_button_index
	var r_ret = gdextension.Call[Input.JoyButton](gd.ObjectChecked(self.AsObject()), methods.get_button_index, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AsInputEventJoypadButton() Advanced {
	return Advanced{pointers.AsA[gdclass.InputEventJoypadButton](self[0])}
}
func (self Instance) AsInputEventJoypadButton() Instance {
	return Instance{pointers.AsA[gdclass.InputEventJoypadButton](self[0])}
}
...
func init() {
	gdclass.Register("InputEventJoypadButton", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.InputEventJoypadButton](ptr)} })
}
