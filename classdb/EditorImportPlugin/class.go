...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorImportPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorImportPlugin{gdclass.NewEditorImportPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
