...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventMouse")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventMouse{gdclass.NewInputEventMouse(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
