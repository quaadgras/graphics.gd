...
func (self class) AsObject() [1]gd.Object { return gdclass.GetIterateIK3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetIterateIK3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.IterateIK3D{gdclass.NewIterateIK3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetIterateIK3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.IterateIK3D{gdclass.NewIterateIK3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetJointLimitation(index int64, joint int64) [1]gdclass.JointLimitation3D { //gd:IterateIK3D.get_joint_limitation
	...
	var ret = [1]gdclass.JointLimitation3D{gdclass.NewJointLimitation3D(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
...
func (self class) AsIterateIK3D() Advanced {
	return Advanced{gdclass.NewIterateIK3D(self.AsObject()[0])}
}
func (self Instance) AsIterateIK3D() Instance {
	return Instance{gdclass.NewIterateIK3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsIterateIK3D() Instance { return self.Super().AsIterateIK3D() }
...
func init() {
	gdclass.Register("IterateIK3D", func(ptr gd.Object) any { return Instance{gdclass.NewIterateIK3D(ptr)} })
}
