...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRPlaneTracker(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRPlaneTracker(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRPlaneTracker{gdclass.NewOpenXRPlaneTracker(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRPlaneTracker(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRPlaneTracker{gdclass.NewOpenXRPlaneTracker(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnMeshChanged(cb func(), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("mesh_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsOpenXRPlaneTracker() Advanced {
	return Advanced{gdclass.NewOpenXRPlaneTracker(self.AsObject()[0])}
}
func (self Instance) AsOpenXRPlaneTracker() Instance {
	return Instance{gdclass.NewOpenXRPlaneTracker(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRPlaneTracker() Instance { return self.Super().AsOpenXRPlaneTracker() }
...
func init() {
	gdclass.Register("OpenXRPlaneTracker", func(ptr gd.Object) any { return Instance{gdclass.NewOpenXRPlaneTracker(ptr)} })
}
