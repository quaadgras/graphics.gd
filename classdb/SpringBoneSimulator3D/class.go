...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneSimulator3D{gdclass.NewSpringBoneSimulator3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
