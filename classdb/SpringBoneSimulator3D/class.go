...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpringBoneSimulator3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringBoneSimulator3D{gdclass.NewSpringBoneSimulator3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
