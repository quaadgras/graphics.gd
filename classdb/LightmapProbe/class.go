...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("LightmapProbe")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.LightmapProbe{gdclass.NewLightmapProbe(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
