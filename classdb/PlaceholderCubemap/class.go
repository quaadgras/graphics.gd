...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PlaceholderCubemap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PlaceholderCubemap{gdclass.NewPlaceholderCubemap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
