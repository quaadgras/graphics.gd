...
- When the [graphics.gd/classdb/Cubemap]-derived class is missing, for example when using a different engine version.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PlaceholderCubemap](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PlaceholderCubemap{pointers.Add[gdclass.PlaceholderCubemap]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PlaceholderCubemap{pointers.New[gdclass.PlaceholderCubemap]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsPlaceholderCubemap() Advanced {
	return Advanced{pointers.AsA[gdclass.PlaceholderCubemap](self[0])}
}
func (self Instance) AsPlaceholderCubemap() Instance {
	return Instance{pointers.AsA[gdclass.PlaceholderCubemap](self[0])}
}
...
func init() {
	gdclass.Register("PlaceholderCubemap", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PlaceholderCubemap](ptr)} })
}
