...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TLSOptions")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TLSOptions{gdclass.NewTLSOptions(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
