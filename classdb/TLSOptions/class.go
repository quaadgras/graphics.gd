...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("TLSOptions"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TLSOptions{gdclass.NewTLSOptions(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
...
func (self class) GetCommonNameOverride() String.Readable { //gd:TLSOptions.get_common_name_override
	var r_ret = jumponly.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_common_name_override, gdextension.SizeString, &struct{}{})
