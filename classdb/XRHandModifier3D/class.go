...
Positioning of hands is performed by creating an [graphics.gd/classdb/XRNode3D] ancestor of the hand mesh driven by the same [graphics.gd/classdb/XRHandTracker].

The hand tracking position-data is scaled by [graphics.gd/classdb/Skeleton3D.Instance.MotionScale] when applied to the skeleton, which can be used to adjust the tracked hand to match the scale of the hand model.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.XRHandModifier3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.XRHandModifier3D{pointers.Add[gdclass.XRHandModifier3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.XRHandModifier3D{pointers.New[gdclass.XRHandModifier3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetHandTracker(tracker_name String.Name) { //gd:XRHandModifier3D.set_hand_tracker
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_hand_tracker, 0|(gdextension.SizeStringName<<4), &struct{ tracker_name gdextension.StringName }{pointers.Get(gd.InternalStringName(tracker_name))})
}

//go:nosplit
func (self class) GetHandTracker() String.Name { //gd:XRHandModifier3D.get_hand_tracker
	var r_ret = gdextension.Call[gdextension.StringName](gd.ObjectChecked(self.AsObject()), methods.get_hand_tracker, gdextension.SizeStringName, &struct{}{})
...
func (self class) AsXRHandModifier3D() Advanced {
	return Advanced{pointers.AsA[gdclass.XRHandModifier3D](self[0])}
}
func (self Instance) AsXRHandModifier3D() Instance {
	return Instance{pointers.AsA[gdclass.XRHandModifier3D](self[0])}
}
...
func init() {
	gdclass.Register("XRHandModifier3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.XRHandModifier3D](ptr)} })
}
