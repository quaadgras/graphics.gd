...
func New() Instance {
	...
	casted := Instance([1]gdclass.RenderSceneBuffersConfiguration{gdclass.NewRenderSceneBuffersConfiguration(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
