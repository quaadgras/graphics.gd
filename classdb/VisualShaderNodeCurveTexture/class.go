...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeCurveTexture(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetVisualShaderNodeCurveTexture(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeCurveTexture(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) GetTexture() [1]gdclass.CurveTexture { //gd:VisualShaderNodeCurveTexture.get_texture
	...
	var ret = [1]gdclass.CurveTexture{gdclass.NewCurveTexture(gd.PointerWithOwnershipTransferredToGo[gd.Object](r_ret))}
	return ret
}
func (self class) AsVisualShaderNodeCurveTexture() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeCurveTexture(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeCurveTexture() Instance {
	return Instance{gdclass.NewVisualShaderNodeCurveTexture(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeCurveTexture", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeCurveTexture(ptr)} })
}
