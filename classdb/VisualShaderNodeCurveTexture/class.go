...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeCurveTexture](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeCurveTexture{pointers.Add[gdclass.VisualShaderNodeCurveTexture]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveTexture{pointers.New[gdclass.VisualShaderNodeCurveTexture]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self Instance) SetTexture(value CurveTexture.Instance) Instance {
...
func (self class) AsVisualShaderNodeCurveTexture() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeCurveTexture](self[0])}
}
func (self Instance) AsVisualShaderNodeCurveTexture() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeCurveTexture](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeCurveTexture", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeCurveTexture](ptr)} })
}
