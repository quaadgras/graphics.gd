...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeCurveTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
