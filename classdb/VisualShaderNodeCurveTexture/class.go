...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeCurveTexture"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
