...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCurveTexture{gdclass.NewVisualShaderNodeCurveTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
