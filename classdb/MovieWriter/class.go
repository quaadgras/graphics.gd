...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MovieWriter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MovieWriter{gdclass.NewMovieWriter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
