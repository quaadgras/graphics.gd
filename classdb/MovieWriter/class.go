...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("MovieWriter"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MovieWriter{gdclass.NewMovieWriter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
