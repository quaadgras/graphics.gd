...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFTextureSampler")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFTextureSampler{gdclass.NewGLTFTextureSampler(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
