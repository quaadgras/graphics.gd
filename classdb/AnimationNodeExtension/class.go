...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeExtension{gdclass.NewAnimationNodeExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
