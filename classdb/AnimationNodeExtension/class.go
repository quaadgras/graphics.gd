...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAnimationNodeExtension(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAnimationNodeExtension(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeExtension{gdclass.NewAnimationNodeExtension(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAnimationNodeExtension(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeExtension{gdclass.NewAnimationNodeExtension(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsAnimationNodeExtension() Advanced {
	return Advanced{gdclass.NewAnimationNodeExtension(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeExtension() Instance {
	return Instance{gdclass.NewAnimationNodeExtension(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeExtension", func(ptr gd.Object) any { return Instance{gdclass.NewAnimationNodeExtension(ptr)} })
}
