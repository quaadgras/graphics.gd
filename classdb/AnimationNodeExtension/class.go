...
/*
A version of the [Instance.Animationnode.Process] method that is meant to be overridden by custom nodes. It returns a [PackedFloat32Array] with the processed animation data.
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AnimationNodeExtension](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeExtension{pointers.Add[gdclass.AnimationNodeExtension]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AnimationNodeExtension{pointers.New[gdclass.AnimationNodeExtension]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsAnimationNodeExtension() Advanced {
	return Advanced{pointers.AsA[gdclass.AnimationNodeExtension](self[0])}
}
func (self Instance) AsAnimationNodeExtension() Instance {
	return Instance{pointers.AsA[gdclass.AnimationNodeExtension](self[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeExtension", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AnimationNodeExtension](ptr)} })
}
