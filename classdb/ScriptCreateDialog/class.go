...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptCreateDialog{gdclass.NewScriptCreateDialog(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
