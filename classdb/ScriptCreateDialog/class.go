...
/*
The [graphics.gd/classdb/ScriptCreateDialog] creates script files according to a given template for a given scripting language. The standard use is to configure its fields prior to calling one of the [graphics.gd/classdb/Window.Instance.Popup] methods.
