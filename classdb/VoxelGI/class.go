...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VoxelGI")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VoxelGI{gdclass.NewVoxelGI(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
