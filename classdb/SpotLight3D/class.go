...
func (self class) AsObject() [1]gd.Object { return gdclass.GetSpotLight3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetSpotLight3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.SpotLight3D{gdclass.NewSpotLight3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetSpotLight3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.SpotLight3D{gdclass.NewSpotLight3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsSpotLight3D() Advanced {
	return Advanced{gdclass.NewSpotLight3D(self.AsObject()[0])}
}
func (self Instance) AsSpotLight3D() Instance {
	return Instance{gdclass.NewSpotLight3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsSpotLight3D() Instance { return self.Super().AsSpotLight3D() }
...
func init() {
	gdclass.Register("SpotLight3D", func(ptr gd.Object) any { return Instance{gdclass.NewSpotLight3D(ptr)} })
}
