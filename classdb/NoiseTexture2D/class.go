...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NoiseTexture2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NoiseTexture2D{gdclass.NewNoiseTexture2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
