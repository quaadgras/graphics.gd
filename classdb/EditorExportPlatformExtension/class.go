...
To use [EditorExportPlatform], register it using the [Instance.Editorplugin.AddExportPlatform] method first.
*/
...
- update_visibility: bool, if set to true, [Instance.GetExportOptionVisibility] is called for each property when this property is changed.
- required: bool, if set to true, this property warnings are critical, and should be resolved to make export possible. This value is a hint for the [Instance.HasValidExportConfiguration] implementation, and not used by the engine directly.
See also [Instance.Object.GetPropertyList].
*/
...
/*
Required.
Returns platform logo displayed in the export dialog, logo should be 32x32 adjusted to the current editor scale, see [Instance.Editorinterface.GetEditorScale].
*/
...
/*
Optional.
Returns one-click deploy menu item icon for the specified 'device', icon should be 16x16 adjusted to the current editor scale, see [Instance.Editorinterface.GetEditorScale].
*/
...
/*
Optional.
Returns icon of the one-click deploy menu button, icon should be 16x16 adjusted to the current editor scale, see [Instance.Editorinterface.GetEditorScale].
*/
...
Usual implementation can call [Instance.HasValidExportConfiguration] and [Instance.HasValidProjectConfiguration] to determine if export is possible.
*/
...
This method is called when "Export" button is pressed in the export dialog.
This method implementation can call [Instance.Editorexportplatform.SavePack] or [Instance.Editorexportplatform.SaveZip] to use default PCK/ZIP export process, or calls [Instance.Editorexportplatform.ExportProjectFiles] and implement custom callback for processing each exported file.
*/
...
/*
Sets current configuration error message text. This method should be called only from the [Instance.CanExport], [Instance.HasValidExportConfiguration], or [Instance.HasValidProjectConfiguration] implementations.
*/
...
/*
Returns current configuration error message text. This method should be called only from the [Instance.CanExport], [Instance.HasValidExportConfiguration], or [Instance.HasValidProjectConfiguration] implementations.
*/
...
/*
Set to true is export templates are missing from the current configuration. This method should be called only from the [Instance.CanExport], [Instance.HasValidExportConfiguration], or [Instance.HasValidProjectConfiguration] implementations.
*/
...
/*
Returns true is export templates are missing from the current configuration. This method should be called only from the [Instance.CanExport], [Instance.HasValidExportConfiguration], or [Instance.HasValidProjectConfiguration] implementations.
*/
