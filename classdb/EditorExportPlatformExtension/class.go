...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformExtension{gdclass.NewEditorExportPlatformExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
