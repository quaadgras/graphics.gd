...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformExtension{gdclass.NewEditorExportPlatformExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
