...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineDepthStencilState{gdclass.NewRDPipelineDepthStencilState(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
