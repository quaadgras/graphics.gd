...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RDPipelineDepthStencilState")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RDPipelineDepthStencilState{gdclass.NewRDPipelineDepthStencilState(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
