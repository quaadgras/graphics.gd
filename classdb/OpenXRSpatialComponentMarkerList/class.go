...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentMarkerList{gdclass.NewOpenXRSpatialComponentMarkerList(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
