...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRSpatialComponentMarkerList")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialComponentMarkerList{gdclass.NewOpenXRSpatialComponentMarkerList(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
