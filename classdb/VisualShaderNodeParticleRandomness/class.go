...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleRandomness{gdclass.NewVisualShaderNodeParticleRandomness(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
