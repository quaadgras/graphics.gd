...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleRandomness")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleRandomness{gdclass.NewVisualShaderNodeParticleRandomness(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
