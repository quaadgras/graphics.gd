...
type Interface interface {
	...
	// Returns the list of extensions available for saving the resource object, provided it is recognized (see [Interface.Recognize]).
	GetRecognizedExtensions(resource Resource.Instance) []string
	// Returns true if this saver handles a given save path and false otherwise.
	//
	// If this method is not implemented, the default behavior returns whether the path's extension is within the ones provided by [Interface.GetRecognizedExtensions].
