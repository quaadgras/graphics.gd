...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceFormatSaver{gdclass.NewResourceFormatSaver(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
