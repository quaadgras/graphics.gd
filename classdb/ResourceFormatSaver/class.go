...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ResourceFormatSaver")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ResourceFormatSaver{gdclass.NewResourceFormatSaver(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
