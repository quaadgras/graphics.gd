...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("MultiplayerSpawner")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiplayerSpawner{gdclass.NewMultiplayerSpawner(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
