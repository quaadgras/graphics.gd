...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Skeleton3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Skeleton3D{gdclass.NewSkeleton3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
