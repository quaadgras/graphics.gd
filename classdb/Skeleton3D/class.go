...
Note: The pose transform needs to be a global pose! To convert a world transform from a [Node3D] to a global bone pose, multiply the [Instance.Transform3d.AffineInverse] of the node's [member Node3D.global_transform] by the desired world transform.
*/
