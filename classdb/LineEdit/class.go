...
- Check [Instance.Edit], [Instance.Unedit], [Instance.IsEditing], and [signal editing_toggled] for more information.
Important:
- Focusing the [LineEdit] with ui_focus_next (by default [kbd]Tab[/kbd]) or ui_focus_prev (by default [kbd]Shift + Tab[/kbd]) or [Instance.Control.GrabFocus] still enters edit mode (for compatibility).
...
/*
Inserts 'text' at the caret. If the resulting value is longer than [member max_length], nothing happens.
*/
...
/*
Deletes a section of the [member text] going from position 'from_column' to 'to_column'. Both parameters should be within the text's length.
*/
