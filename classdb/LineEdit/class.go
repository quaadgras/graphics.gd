...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("LineEdit")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.LineEdit{gdclass.NewLineEdit(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
