...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticlesAttractorVectorField3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorVectorField3D{gdclass.NewGPUParticlesAttractorVectorField3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
