...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractorVectorField3D{gdclass.NewGPUParticlesAttractorVectorField3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
