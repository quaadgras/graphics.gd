...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("SkeletonModifier3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SkeletonModifier3D{gdclass.NewSkeletonModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
