...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeStateMachineTransition{gdclass.NewAnimationNodeStateMachineTransition(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
