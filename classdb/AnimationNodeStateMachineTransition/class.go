...
/*
The path generated when using [Instance.Animationnodestatemachineplayback.Travel] is limited to the nodes connected by [AnimationNodeStateMachineTransition].
