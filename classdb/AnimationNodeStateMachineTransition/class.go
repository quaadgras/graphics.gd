...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeStateMachineTransition")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeStateMachineTransition{gdclass.NewAnimationNodeStateMachineTransition(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
