...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorExportPlatformPC")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformPC{gdclass.NewEditorExportPlatformPC(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
