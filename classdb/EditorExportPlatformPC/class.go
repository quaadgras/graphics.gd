...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorExportPlatformPC{gdclass.NewEditorExportPlatformPC(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
