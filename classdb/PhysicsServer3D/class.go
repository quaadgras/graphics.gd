...
func singleton() {
	self[0] = gdclass.NewPhysicsServer3D(gdreference.RawObject(gdextension.Object(gdunsafe.Singleton(sname))))
}
...
func (self class) ShapeSetData(shape RID.Any, data variant.Any) { //gd:PhysicsServer3D.shape_set_data
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.shape_set_data, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVariant<<8), &struct {
		shape RID.Any
...
func (self class) ShapeSetMargin(shape RID.Any, margin float64) { //gd:PhysicsServer3D.shape_set_margin
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.shape_set_margin, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		shape  RID.Any
		margin float64
	}{shape, margin})
}
...
func (self class) SpaceSetActive(space RID.Any, active bool) { //gd:PhysicsServer3D.space_set_active
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.space_set_active, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		space  RID.Any
		active bool
	}{space, active})
}
...
func (self class) SpaceSetParam(space RID.Any, param SpaceParameter, value float64) { //gd:PhysicsServer3D.space_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.space_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeFloat<<12), &struct {
		space RID.Any
...
func (self class) SpaceGetParam(space RID.Any, param SpaceParameter) float64 { //gd:PhysicsServer3D.space_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.space_get_param, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		space RID.Any
		param SpaceParameter
	}{space, param})
	var ret = r_ret
...
func (self class) AreaSetSpace(area RID.Any, space RID.Any) { //gd:PhysicsServer3D.area_set_space
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_space, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		area  RID.Any
		space RID.Any
	}{area, space})
}
...
func (self class) AreaAddShape(area RID.Any, shape RID.Any, transform Transform3D.BasisOrigin, disabled bool) { //gd:PhysicsServer3D.area_add_shape
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_add_shape, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeTransform3D<<12)|(gdextension.SizeBool<<16), &struct {
		area      RID.Any
		shape     RID.Any
...
func (self class) AreaSetShape(area RID.Any, shape_idx int64, shape RID.Any) { //gd:PhysicsServer3D.area_set_shape
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_shape, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeRID<<12), &struct {
		area      RID.Any
		shape_idx int64
		shape     RID.Any
...
func (self class) AreaSetShapeTransform(area RID.Any, shape_idx int64, transform Transform3D.BasisOrigin) { //gd:PhysicsServer3D.area_set_shape_transform
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_shape_transform, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeTransform3D<<12), &struct {
		area      RID.Any
		shape_idx int64
		transform Transform3D.BasisOrigin
...
func (self class) AreaSetShapeDisabled(area RID.Any, shape_idx int64, disabled bool) { //gd:PhysicsServer3D.area_set_shape_disabled
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_shape_disabled, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), &struct {
		area      RID.Any
		shape_idx int64
		disabled  bool
...
func (self class) AreaGetShape(area RID.Any, shape_idx int64) RID.Any { //gd:PhysicsServer3D.area_get_shape
	once.Do(singleton)
	var r_ret = noescape.Call[RID.Any](gdreference.GetObject(self.AsObject()[0]), methods.area_get_shape, gdextension.SizeRID|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area      RID.Any
		shape_idx int64
	}{area, shape_idx})
	var ret = r_ret
...
func (self class) AreaGetShapeTransform(area RID.Any, shape_idx int64) Transform3D.BasisOrigin { //gd:PhysicsServer3D.area_get_shape_transform
	once.Do(singleton)
	var r_ret = noescape.Call[Transform3D.BasisOrigin](gdreference.GetObject(self.AsObject()[0]), methods.area_get_shape_transform, gdextension.SizeTransform3D|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area      RID.Any
		shape_idx int64
	}{area, shape_idx})
...
func (self class) AreaRemoveShape(area RID.Any, shape_idx int64) { //gd:PhysicsServer3D.area_remove_shape
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_remove_shape, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area      RID.Any
		shape_idx int64
	}{area, shape_idx})
}
...
func (self class) AreaSetCollisionLayer(area RID.Any, layer int64) { //gd:PhysicsServer3D.area_set_collision_layer
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_collision_layer, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area  RID.Any
		layer int64
	}{area, layer})
}
...
func (self class) AreaSetCollisionMask(area RID.Any, mask int64) { //gd:PhysicsServer3D.area_set_collision_mask
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_collision_mask, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area RID.Any
		mask int64
	}{area, mask})
}
...
func (self class) AreaSetParam(area RID.Any, param AreaParameter, value variant.Any) { //gd:PhysicsServer3D.area_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVariant<<12), &struct {
		area  RID.Any
		param AreaParameter
...
func (self class) AreaSetTransform(area RID.Any, transform Transform3D.BasisOrigin) { //gd:PhysicsServer3D.area_set_transform
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_transform, 0|(gdextension.SizeRID<<4)|(gdextension.SizeTransform3D<<8), &struct {
		area      RID.Any
		transform Transform3D.BasisOrigin
...
func (self class) AreaGetParam(area RID.Any, param AreaParameter) variant.Any { //gd:PhysicsServer3D.area_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[gdextension.Variant](gdreference.GetObject(self.AsObject()[0]), methods.area_get_param, gdextension.SizeVariant|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area  RID.Any
		param AreaParameter
	}{area, param})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
...
func (self class) AreaAttachObjectInstanceId(area RID.Any, id int64) { //gd:PhysicsServer3D.area_attach_object_instance_id
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_attach_object_instance_id, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		area RID.Any
		id   int64
	}{area, id})
}
...
func (self class) AreaSetMonitorCallback(area RID.Any, callback Callable.Function) { //gd:PhysicsServer3D.area_set_monitor_callback
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_monitor_callback, 0|(gdextension.SizeRID<<4)|(gdextension.SizeCallable<<8), &struct {
		area     RID.Any
...
func (self class) AreaSetAreaMonitorCallback(area RID.Any, callback Callable.Function) { //gd:PhysicsServer3D.area_set_area_monitor_callback
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_area_monitor_callback, 0|(gdextension.SizeRID<<4)|(gdextension.SizeCallable<<8), &struct {
		area     RID.Any
		callback gdextension.Callable
	}{area, pointers.Get(gd.InternalCallable(callback))})
}
func (self class) AreaSetMonitorable(area RID.Any, monitorable bool) { //gd:PhysicsServer3D.area_set_monitorable
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_monitorable, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		area        RID.Any
		monitorable bool
	}{area, monitorable})
}
func (self class) AreaSetRayPickable(area RID.Any, enable bool) { //gd:PhysicsServer3D.area_set_ray_pickable
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.area_set_ray_pickable, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		area   RID.Any
		enable bool
	}{area, enable})
}
...
func (self class) BodySetSpace(body RID.Any, space RID.Any) { //gd:PhysicsServer3D.body_set_space
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_space, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body  RID.Any
		space RID.Any
	}{body, space})
}
...
func (self class) BodySetMode(body RID.Any, mode BodyMode) { //gd:PhysicsServer3D.body_set_mode
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_mode, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body RID.Any
		mode BodyMode
	}{body, mode})
}
...
func (self class) BodySetCollisionLayer(body RID.Any, layer int64) { //gd:PhysicsServer3D.body_set_collision_layer
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_collision_layer, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body  RID.Any
		layer int64
	}{body, layer})
}
...
func (self class) BodySetCollisionMask(body RID.Any, mask int64) { //gd:PhysicsServer3D.body_set_collision_mask
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_collision_mask, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body RID.Any
		mask int64
	}{body, mask})
}
...
func (self class) BodySetCollisionPriority(body RID.Any, priority float64) { //gd:PhysicsServer3D.body_set_collision_priority
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_collision_priority, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body     RID.Any
		priority float64
	}{body, priority})
}
...
func (self class) BodyAddShape(body RID.Any, shape RID.Any, transform Transform3D.BasisOrigin, disabled bool) { //gd:PhysicsServer3D.body_add_shape
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_add_shape, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeTransform3D<<12)|(gdextension.SizeBool<<16), &struct {
		body      RID.Any
		shape     RID.Any
		transform Transform3D.BasisOrigin
		disabled  bool
...
func (self class) BodySetShape(body RID.Any, shape_idx int64, shape RID.Any) { //gd:PhysicsServer3D.body_set_shape
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_shape, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeRID<<12), &struct {
		body      RID.Any
		shape_idx int64
		shape     RID.Any
...
func (self class) BodySetShapeTransform(body RID.Any, shape_idx int64, transform Transform3D.BasisOrigin) { //gd:PhysicsServer3D.body_set_shape_transform
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_shape_transform, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeTransform3D<<12), &struct {
		body      RID.Any
		shape_idx int64
		transform Transform3D.BasisOrigin
...
func (self class) BodySetShapeDisabled(body RID.Any, shape_idx int64, disabled bool) { //gd:PhysicsServer3D.body_set_shape_disabled
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_shape_disabled, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), &struct {
		body      RID.Any
		shape_idx int64
		disabled  bool
...
func (self class) BodyGetShape(body RID.Any, shape_idx int64) RID.Any { //gd:PhysicsServer3D.body_get_shape
	once.Do(singleton)
	var r_ret = noescape.Call[RID.Any](gdreference.GetObject(self.AsObject()[0]), methods.body_get_shape, gdextension.SizeRID|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body      RID.Any
		shape_idx int64
	}{body, shape_idx})
	var ret = r_ret
...
func (self class) BodyGetShapeTransform(body RID.Any, shape_idx int64) Transform3D.BasisOrigin { //gd:PhysicsServer3D.body_get_shape_transform
	once.Do(singleton)
	var r_ret = noescape.Call[Transform3D.BasisOrigin](gdreference.GetObject(self.AsObject()[0]), methods.body_get_shape_transform, gdextension.SizeTransform3D|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body      RID.Any
		shape_idx int64
	}{body, shape_idx})
	var ret = gd.Transposed(r_ret)
...
func (self class) BodyRemoveShape(body RID.Any, shape_idx int64) { //gd:PhysicsServer3D.body_remove_shape
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_remove_shape, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body      RID.Any
		shape_idx int64
	}{body, shape_idx})
}
...
func (self class) BodyAttachObjectInstanceId(body RID.Any, id int64) { //gd:PhysicsServer3D.body_attach_object_instance_id
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_attach_object_instance_id, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body RID.Any
		id   int64
	}{body, id})
}
...
func (self class) BodySetEnableContinuousCollisionDetection(body RID.Any, enable bool) { //gd:PhysicsServer3D.body_set_enable_continuous_collision_detection
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_enable_continuous_collision_detection, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		body   RID.Any
		enable bool
	}{body, enable})
}
...
func (self class) BodySetParam(body RID.Any, param BodyParameter, value variant.Any) { //gd:PhysicsServer3D.body_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVariant<<12), &struct {
		body  RID.Any
		param BodyParameter
		value gdextension.Variant
...
func (self class) BodyGetParam(body RID.Any, param BodyParameter) variant.Any { //gd:PhysicsServer3D.body_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[gdextension.Variant](gdreference.GetObject(self.AsObject()[0]), methods.body_get_param, gdextension.SizeVariant|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body  RID.Any
		param BodyParameter
	}{body, param})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
...
func (self class) BodySetState(body RID.Any, state BodyState, value variant.Any) { //gd:PhysicsServer3D.body_set_state
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_state, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVariant<<12), &struct {
		body  RID.Any
		state BodyState
		value gdextension.Variant
...
func (self class) BodyGetState(body RID.Any, state BodyState) variant.Any { //gd:PhysicsServer3D.body_get_state
	once.Do(singleton)
	var r_ret = noescape.Call[gdextension.Variant](gdreference.GetObject(self.AsObject()[0]), methods.body_get_state, gdextension.SizeVariant|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body  RID.Any
		state BodyState
	}{body, state})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
...
func (self class) BodyApplyCentralImpulse(body RID.Any, impulse Vector3.XYZ) { //gd:PhysicsServer3D.body_apply_central_impulse
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_apply_central_impulse, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body    RID.Any
		impulse Vector3.XYZ
	}{body, impulse})
}
func (self class) BodyApplyImpulse(body RID.Any, impulse Vector3.XYZ, position Vector3.XYZ) { //gd:PhysicsServer3D.body_apply_impulse
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_apply_impulse, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeVector3<<12), &struct {
		body     RID.Any
		impulse  Vector3.XYZ
...
func (self class) BodyApplyTorqueImpulse(body RID.Any, impulse Vector3.XYZ) { //gd:PhysicsServer3D.body_apply_torque_impulse
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_apply_torque_impulse, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body    RID.Any
		impulse Vector3.XYZ
	}{body, impulse})
}
func (self class) BodyApplyCentralForce(body RID.Any, force Vector3.XYZ) { //gd:PhysicsServer3D.body_apply_central_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_apply_central_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body  RID.Any
		force Vector3.XYZ
	}{body, force})
}
func (self class) BodyApplyForce(body RID.Any, force Vector3.XYZ, position Vector3.XYZ) { //gd:PhysicsServer3D.body_apply_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_apply_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeVector3<<12), &struct {
		body     RID.Any
		force    Vector3.XYZ
		position Vector3.XYZ
	}{body, force, position})
...
func (self class) BodyApplyTorque(body RID.Any, torque Vector3.XYZ) { //gd:PhysicsServer3D.body_apply_torque
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_apply_torque, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body   RID.Any
		torque Vector3.XYZ
	}{body, torque})
}
func (self class) BodyAddConstantCentralForce(body RID.Any, force Vector3.XYZ) { //gd:PhysicsServer3D.body_add_constant_central_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_add_constant_central_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body  RID.Any
		force Vector3.XYZ
	}{body, force})
}
func (self class) BodyAddConstantForce(body RID.Any, force Vector3.XYZ, position Vector3.XYZ) { //gd:PhysicsServer3D.body_add_constant_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_add_constant_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeVector3<<12), &struct {
		body     RID.Any
		force    Vector3.XYZ
		position Vector3.XYZ
	}{body, force, position})
...
func (self class) BodyAddConstantTorque(body RID.Any, torque Vector3.XYZ) { //gd:PhysicsServer3D.body_add_constant_torque
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_add_constant_torque, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body   RID.Any
		torque Vector3.XYZ
	}{body, torque})
}
func (self class) BodySetConstantForce(body RID.Any, force Vector3.XYZ) { //gd:PhysicsServer3D.body_set_constant_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_constant_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body  RID.Any
		force Vector3.XYZ
	}{body, force})
}
...
func (self class) BodySetConstantTorque(body RID.Any, torque Vector3.XYZ) { //gd:PhysicsServer3D.body_set_constant_torque
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_constant_torque, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body   RID.Any
		torque Vector3.XYZ
	}{body, torque})
}
...
func (self class) BodySetAxisVelocity(body RID.Any, axis_velocity Vector3.XYZ) { //gd:PhysicsServer3D.body_set_axis_velocity
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_axis_velocity, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body          RID.Any
...
func (self class) BodySetAxisLock(body RID.Any, axis BodyAxis, lock bool) { //gd:PhysicsServer3D.body_set_axis_lock
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_axis_lock, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), &struct {
		body RID.Any
		axis BodyAxis
		lock bool
	}{body, axis, lock})
...
func (self class) BodyIsAxisLocked(body RID.Any, axis BodyAxis) bool { //gd:PhysicsServer3D.body_is_axis_locked
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.body_is_axis_locked, gdextension.SizeBool|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body RID.Any
		axis BodyAxis
	}{body, axis})
	var ret = r_ret
...
func (self class) BodyAddCollisionException(body RID.Any, excepted_body RID.Any) { //gd:PhysicsServer3D.body_add_collision_exception
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_add_collision_exception, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body          RID.Any
...
func (self class) BodyRemoveCollisionException(body RID.Any, excepted_body RID.Any) { //gd:PhysicsServer3D.body_remove_collision_exception
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_remove_collision_exception, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body          RID.Any
		excepted_body RID.Any
	}{body, excepted_body})
}
func (self class) BodySetMaxContactsReported(body RID.Any, amount int64) { //gd:PhysicsServer3D.body_set_max_contacts_reported
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_max_contacts_reported, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body   RID.Any
		amount int64
	}{body, amount})
}
...
func (self class) BodySetOmitForceIntegration(body RID.Any, enable bool) { //gd:PhysicsServer3D.body_set_omit_force_integration
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_omit_force_integration, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		body   RID.Any
		enable bool
	}{body, enable})
}
...
func (self class) BodySetStateSyncCallback(body RID.Any, callable Callable.Function) { //gd:PhysicsServer3D.body_set_state_sync_callback
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_state_sync_callback, 0|(gdextension.SizeRID<<4)|(gdextension.SizeCallable<<8), &struct {
		body     RID.Any
...
func (self class) BodySetForceIntegrationCallback(body RID.Any, callable Callable.Function, userdata variant.Any) { //gd:PhysicsServer3D.body_set_force_integration_callback
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_force_integration_callback, 0|(gdextension.SizeRID<<4)|(gdextension.SizeCallable<<8)|(gdextension.SizeVariant<<12), &struct {
		body     RID.Any
		callable gdextension.Callable
...
func (self class) BodySetRayPickable(body RID.Any, enable bool) { //gd:PhysicsServer3D.body_set_ray_pickable
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.body_set_ray_pickable, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		body   RID.Any
		enable bool
	}{body, enable})
}
func (self class) BodyTestMotion(body RID.Any, parameters [1]gdclass.PhysicsTestMotionParameters3D, result [1]gdclass.PhysicsTestMotionResult3D) bool { //gd:PhysicsServer3D.body_test_motion
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.body_test_motion, gdextension.SizeBool|(gdextension.SizeRID<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeObject<<12), &struct {
		body       RID.Any
...
func (self class) SoftBodySetSpace(body RID.Any, space RID.Any) { //gd:PhysicsServer3D.soft_body_set_space
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_space, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body  RID.Any
		space RID.Any
	}{body, space})
}
...
func (self class) SoftBodySetMesh(body RID.Any, mesh RID.Any) { //gd:PhysicsServer3D.soft_body_set_mesh
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_mesh, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body RID.Any
		mesh RID.Any
	}{body, mesh})
}
...
func (self class) SoftBodySetCollisionLayer(body RID.Any, layer int64) { //gd:PhysicsServer3D.soft_body_set_collision_layer
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_collision_layer, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body  RID.Any
		layer int64
	}{body, layer})
}
...
func (self class) SoftBodySetCollisionMask(body RID.Any, mask int64) { //gd:PhysicsServer3D.soft_body_set_collision_mask
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_collision_mask, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body RID.Any
		mask int64
	}{body, mask})
}
...
func (self class) SoftBodyAddCollisionException(body RID.Any, body_b RID.Any) { //gd:PhysicsServer3D.soft_body_add_collision_exception
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_add_collision_exception, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body   RID.Any
		body_b RID.Any
	}{body, body_b})
}
func (self class) SoftBodyRemoveCollisionException(body RID.Any, body_b RID.Any) { //gd:PhysicsServer3D.soft_body_remove_collision_exception
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_remove_collision_exception, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8), &struct {
		body   RID.Any
		body_b RID.Any
	}{body, body_b})
}
func (self class) SoftBodySetState(body RID.Any, state BodyState, v variant.Any) { //gd:PhysicsServer3D.soft_body_set_state
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_state, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVariant<<12), &struct {
		body  RID.Any
		state BodyState
...
func (self class) SoftBodyGetState(body RID.Any, state BodyState) variant.Any { //gd:PhysicsServer3D.soft_body_get_state
	once.Do(singleton)
	var r_ret = noescape.Call[gdextension.Variant](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_get_state, gdextension.SizeVariant|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body  RID.Any
		state BodyState
	}{body, state})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
...
func (self class) SoftBodySetTransform(body RID.Any, transform Transform3D.BasisOrigin) { //gd:PhysicsServer3D.soft_body_set_transform
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_transform, 0|(gdextension.SizeRID<<4)|(gdextension.SizeTransform3D<<8), &struct {
		body      RID.Any
		transform Transform3D.BasisOrigin
...
func (self class) SoftBodySetRayPickable(body RID.Any, enable bool) { //gd:PhysicsServer3D.soft_body_set_ray_pickable
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_ray_pickable, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		body   RID.Any
		enable bool
	}{body, enable})
}
func (self class) SoftBodySetSimulationPrecision(body RID.Any, simulation_precision int64) { //gd:PhysicsServer3D.soft_body_set_simulation_precision
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_simulation_precision, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body                 RID.Any
...
func (self class) SoftBodySetTotalMass(body RID.Any, total_mass float64) { //gd:PhysicsServer3D.soft_body_set_total_mass
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_total_mass, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body       RID.Any
		total_mass float64
	}{body, total_mass})
}
...
func (self class) SoftBodySetLinearStiffness(body RID.Any, stiffness float64) { //gd:PhysicsServer3D.soft_body_set_linear_stiffness
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_linear_stiffness, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body      RID.Any
		stiffness float64
	}{body, stiffness})
}
...
func (self class) SoftBodySetShrinkingFactor(body RID.Any, shrinking_factor float64) { //gd:PhysicsServer3D.soft_body_set_shrinking_factor
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_shrinking_factor, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body             RID.Any
...
func (self class) SoftBodySetPressureCoefficient(body RID.Any, pressure_coefficient float64) { //gd:PhysicsServer3D.soft_body_set_pressure_coefficient
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_pressure_coefficient, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body                 RID.Any
...
func (self class) SoftBodySetDampingCoefficient(body RID.Any, damping_coefficient float64) { //gd:PhysicsServer3D.soft_body_set_damping_coefficient
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_damping_coefficient, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body                RID.Any
...
func (self class) SoftBodySetDragCoefficient(body RID.Any, drag_coefficient float64) { //gd:PhysicsServer3D.soft_body_set_drag_coefficient
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_set_drag_coefficient, 0|(gdextension.SizeRID<<4)|(gdextension.SizeFloat<<8), &struct {
		body             RID.Any
...
func (self class) SoftBodyMovePoint(body RID.Any, point_index int64, global_position Vector3.XYZ) { //gd:PhysicsServer3D.soft_body_move_point
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_move_point, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVector3<<12), &struct {
		body            RID.Any
		point_index     int64
...
func (self class) SoftBodyGetPointGlobalPosition(body RID.Any, point_index int64) Vector3.XYZ { //gd:PhysicsServer3D.soft_body_get_point_global_position
	once.Do(singleton)
	var r_ret = noescape.Call[Vector3.XYZ](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_get_point_global_position, gdextension.SizeVector3|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body        RID.Any
		point_index int64
	}{body, point_index})
	var ret = r_ret
...
func (self class) SoftBodyPinPoint(body RID.Any, point_index int64, pin bool) { //gd:PhysicsServer3D.soft_body_pin_point
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_pin_point, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), &struct {
		body        RID.Any
		point_index int64
		pin         bool
...
func (self class) SoftBodyIsPointPinned(body RID.Any, point_index int64) bool { //gd:PhysicsServer3D.soft_body_is_point_pinned
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_is_point_pinned, gdextension.SizeBool|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		body        RID.Any
		point_index int64
	}{body, point_index})
	var ret = r_ret
...
func (self class) SoftBodyApplyPointImpulse(body RID.Any, point_index int64, impulse Vector3.XYZ) { //gd:PhysicsServer3D.soft_body_apply_point_impulse
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_apply_point_impulse, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVector3<<12), &struct {
		body        RID.Any
		point_index int64
		impulse     Vector3.XYZ
...
func (self class) SoftBodyApplyPointForce(body RID.Any, point_index int64, force Vector3.XYZ) { //gd:PhysicsServer3D.soft_body_apply_point_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_apply_point_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeVector3<<12), &struct {
		body        RID.Any
		point_index int64
		force       Vector3.XYZ
...
func (self class) SoftBodyApplyCentralImpulse(body RID.Any, impulse Vector3.XYZ) { //gd:PhysicsServer3D.soft_body_apply_central_impulse
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_apply_central_impulse, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body    RID.Any
		impulse Vector3.XYZ
	}{body, impulse})
}
func (self class) SoftBodyApplyCentralForce(body RID.Any, force Vector3.XYZ) { //gd:PhysicsServer3D.soft_body_apply_central_force
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.soft_body_apply_central_force, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		body  RID.Any
		force Vector3.XYZ
	}{body, force})
}
...
func (self class) JointMakePin(joint RID.Any, body_A RID.Any, local_A Vector3.XYZ, body_B RID.Any, local_B Vector3.XYZ) { //gd:PhysicsServer3D.joint_make_pin
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_make_pin, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeVector3<<12)|(gdextension.SizeRID<<16)|(gdextension.SizeVector3<<20), &struct {
		joint   RID.Any
		body_A  RID.Any
		local_A Vector3.XYZ
		body_B  RID.Any
...
func (self class) PinJointSetParam(joint RID.Any, param PinJointParam, value float64) { //gd:PhysicsServer3D.pin_joint_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.pin_joint_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeFloat<<12), &struct {
		joint RID.Any
		param PinJointParam
		value float64
	}{joint, param, value})
...
func (self class) PinJointGetParam(joint RID.Any, param PinJointParam) float64 { //gd:PhysicsServer3D.pin_joint_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.pin_joint_get_param, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		joint RID.Any
		param PinJointParam
	}{joint, param})
	var ret = r_ret
...
func (self class) PinJointSetLocalA(joint RID.Any, local_A Vector3.XYZ) { //gd:PhysicsServer3D.pin_joint_set_local_a
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.pin_joint_set_local_a, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		joint   RID.Any
		local_A Vector3.XYZ
	}{joint, local_A})
}
...
func (self class) PinJointSetLocalB(joint RID.Any, local_B Vector3.XYZ) { //gd:PhysicsServer3D.pin_joint_set_local_b
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.pin_joint_set_local_b, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector3<<8), &struct {
		joint   RID.Any
		local_B Vector3.XYZ
	}{joint, local_B})
}
...
func (self class) JointMakeHinge(joint RID.Any, body_A RID.Any, hinge_A Transform3D.BasisOrigin, body_B RID.Any, hinge_B Transform3D.BasisOrigin) { //gd:PhysicsServer3D.joint_make_hinge
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_make_hinge, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeTransform3D<<12)|(gdextension.SizeRID<<16)|(gdextension.SizeTransform3D<<20), &struct {
		joint   RID.Any
		body_A  RID.Any
...
func (self class) HingeJointSetParam(joint RID.Any, param HingeJointParam, value float64) { //gd:PhysicsServer3D.hinge_joint_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.hinge_joint_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeFloat<<12), &struct {
		joint RID.Any
...
func (self class) HingeJointGetParam(joint RID.Any, param HingeJointParam) float64 { //gd:PhysicsServer3D.hinge_joint_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.hinge_joint_get_param, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		joint RID.Any
		param HingeJointParam
	}{joint, param})
	var ret = r_ret
...
func (self class) HingeJointSetFlag(joint RID.Any, flag HingeJointFlag, enabled bool) { //gd:PhysicsServer3D.hinge_joint_set_flag
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.hinge_joint_set_flag, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), &struct {
		joint   RID.Any
		flag    HingeJointFlag
		enabled bool
	}{joint, flag, enabled})
...
func (self class) HingeJointGetFlag(joint RID.Any, flag HingeJointFlag) bool { //gd:PhysicsServer3D.hinge_joint_get_flag
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.hinge_joint_get_flag, gdextension.SizeBool|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		joint RID.Any
		flag  HingeJointFlag
	}{joint, flag})
	var ret = r_ret
...
func (self class) JointMakeSlider(joint RID.Any, body_A RID.Any, local_ref_A Transform3D.BasisOrigin, body_B RID.Any, local_ref_B Transform3D.BasisOrigin) { //gd:PhysicsServer3D.joint_make_slider
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_make_slider, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeTransform3D<<12)|(gdextension.SizeRID<<16)|(gdextension.SizeTransform3D<<20), &struct {
		joint       RID.Any
		body_A      RID.Any
...
func (self class) SliderJointSetParam(joint RID.Any, param SliderJointParam, value float64) { //gd:PhysicsServer3D.slider_joint_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.slider_joint_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeFloat<<12), &struct {
		joint RID.Any
...
func (self class) SliderJointGetParam(joint RID.Any, param SliderJointParam) float64 { //gd:PhysicsServer3D.slider_joint_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.slider_joint_get_param, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		joint RID.Any
		param SliderJointParam
	}{joint, param})
	var ret = r_ret
...
func (self class) JointMakeConeTwist(joint RID.Any, body_A RID.Any, local_ref_A Transform3D.BasisOrigin, body_B RID.Any, local_ref_B Transform3D.BasisOrigin) { //gd:PhysicsServer3D.joint_make_cone_twist
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_make_cone_twist, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeTransform3D<<12)|(gdextension.SizeRID<<16)|(gdextension.SizeTransform3D<<20), &struct {
		joint       RID.Any
		body_A      RID.Any
		local_ref_A Transform3D.BasisOrigin
		body_B      RID.Any
...
func (self class) ConeTwistJointSetParam(joint RID.Any, param ConeTwistJointParam, value float64) { //gd:PhysicsServer3D.cone_twist_joint_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.cone_twist_joint_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeFloat<<12), &struct {
		joint RID.Any
...
func (self class) ConeTwistJointGetParam(joint RID.Any, param ConeTwistJointParam) float64 { //gd:PhysicsServer3D.cone_twist_joint_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.cone_twist_joint_get_param, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		joint RID.Any
		param ConeTwistJointParam
	}{joint, param})
	var ret = r_ret
...
func (self class) JointSetSolverPriority(joint RID.Any, priority int64) { //gd:PhysicsServer3D.joint_set_solver_priority
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_set_solver_priority, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8), &struct {
		joint    RID.Any
		priority int64
	}{joint, priority})
}
...
func (self class) JointDisableCollisionsBetweenBodies(joint RID.Any, disable bool) { //gd:PhysicsServer3D.joint_disable_collisions_between_bodies
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_disable_collisions_between_bodies, 0|(gdextension.SizeRID<<4)|(gdextension.SizeBool<<8), &struct {
		joint   RID.Any
		disable bool
	}{joint, disable})
}
...
func (self class) JointMakeGeneric6dof(joint RID.Any, body_A RID.Any, local_ref_A Transform3D.BasisOrigin, body_B RID.Any, local_ref_B Transform3D.BasisOrigin) { //gd:PhysicsServer3D.joint_make_generic_6dof
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.joint_make_generic_6dof, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRID<<8)|(gdextension.SizeTransform3D<<12)|(gdextension.SizeRID<<16)|(gdextension.SizeTransform3D<<20), &struct {
		joint       RID.Any
		body_A      RID.Any
		local_ref_A Transform3D.BasisOrigin
		body_B      RID.Any
...
func (self class) Generic6dofJointSetParam(joint RID.Any, axis Vector3.Axis, param G6DOFJointAxisParam, value float64) { //gd:PhysicsServer3D.generic_6dof_joint_set_param
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.generic_6dof_joint_set_param, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeFloat<<16), &struct {
		joint RID.Any
		axis  Vector3.Axis
...
func (self class) Generic6dofJointGetParam(joint RID.Any, axis Vector3.Axis, param G6DOFJointAxisParam) float64 { //gd:PhysicsServer3D.generic_6dof_joint_get_param
	once.Do(singleton)
	var r_ret = noescape.Call[float64](gdreference.GetObject(self.AsObject()[0]), methods.generic_6dof_joint_get_param, gdextension.SizeFloat|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12), &struct {
		joint RID.Any
		axis  Vector3.Axis
		param G6DOFJointAxisParam
	}{joint, axis, param})
...
func (self class) Generic6dofJointSetFlag(joint RID.Any, axis Vector3.Axis, flag G6DOFJointAxisFlag, enable bool) { //gd:PhysicsServer3D.generic_6dof_joint_set_flag
	once.Do(singleton)
	noescape.Call[struct{}](gdreference.GetObject(self.AsObject()[0]), methods.generic_6dof_joint_set_flag, 0|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16), &struct {
		joint  RID.Any
		axis   Vector3.Axis
...
func (self class) Generic6dofJointGetFlag(joint RID.Any, axis Vector3.Axis, flag G6DOFJointAxisFlag) bool { //gd:PhysicsServer3D.generic_6dof_joint_get_flag
	once.Do(singleton)
	var r_ret = noescape.Call[bool](gdreference.GetObject(self.AsObject()[0]), methods.generic_6dof_joint_get_flag, gdextension.SizeBool|(gdextension.SizeRID<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12), &struct {
		joint RID.Any
		axis  Vector3.Axis
		flag  G6DOFJointAxisFlag
	}{joint, axis, flag})
