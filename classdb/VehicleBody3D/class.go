...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VehicleBody3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VehicleBody3D{gdclass.NewVehicleBody3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
