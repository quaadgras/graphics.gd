...
/*
[graphics.gd/classdb/RemoteTransform3D] caches the remote node. It may not notice if the remote node disappears; [Instance.ForceUpdateCache] forces it to update the cache again.
*/
