...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RemoteTransform3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RemoteTransform3D{gdclass.NewRemoteTransform3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
