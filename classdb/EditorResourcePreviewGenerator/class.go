...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorResourcePreviewGenerator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourcePreviewGenerator{gdclass.NewEditorResourcePreviewGenerator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
