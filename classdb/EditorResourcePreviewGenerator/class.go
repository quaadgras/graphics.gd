...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorResourcePreviewGenerator{gdclass.NewEditorResourcePreviewGenerator(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
