...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventGesture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventGesture{gdclass.NewInputEventGesture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
