...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ColorPickerButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ColorPickerButton{gdclass.NewColorPickerButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
