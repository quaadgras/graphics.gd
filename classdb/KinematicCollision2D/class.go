...
func New() Instance {
	...
	casted := Instance([1]gdclass.KinematicCollision2D{gdclass.NewKinematicCollision2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
