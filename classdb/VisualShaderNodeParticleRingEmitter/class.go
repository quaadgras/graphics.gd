...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleRingEmitter(self[0])
}
...
func (self class) AsVisualShaderNodeParticleRingEmitter() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleRingEmitter(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleRingEmitter() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleRingEmitter(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleRingEmitter() Instance {
	return self.Super().AsVisualShaderNodeParticleRingEmitter()
}
