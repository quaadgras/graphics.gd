...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleRingEmitter{gdclass.NewVisualShaderNodeParticleRingEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
