...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleRingEmitter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleRingEmitter{gdclass.NewVisualShaderNodeParticleRingEmitter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
