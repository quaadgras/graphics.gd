...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("VisualShaderNodeTexture3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3D{gdclass.NewVisualShaderNodeTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
