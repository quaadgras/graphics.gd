...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTexture3D{gdclass.NewVisualShaderNodeTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
