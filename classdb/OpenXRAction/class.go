...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRAction")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAction{gdclass.NewOpenXRAction(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
