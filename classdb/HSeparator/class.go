...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HSeparator")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HSeparator{gdclass.NewHSeparator(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
