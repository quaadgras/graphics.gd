...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SceneState")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SceneState{gdclass.NewSceneState(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
