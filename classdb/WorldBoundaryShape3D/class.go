...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WorldBoundaryShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WorldBoundaryShape3D{gdclass.NewWorldBoundaryShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
