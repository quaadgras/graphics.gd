...
func (self class) SetPlane(plane Plane.NormalD) { //gd:WorldBoundaryShape3D.set_plane
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_plane, 0|(gdextension.SizePlane<<4), &struct{ plane Plane.NormalD }{plane})
}

//go:nosplit
func (self class) GetPlane() Plane.NormalD { //gd:WorldBoundaryShape3D.get_plane
	var r_ret = mainthread.Call[Plane.NormalD](gd.ObjectChecked(self.AsObject()), methods.get_plane, gdextension.SizePlane, &struct{}{})
	var ret = r_ret
	return ret
}
