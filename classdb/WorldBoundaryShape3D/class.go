...
func New() Instance {
	...
	casted := Instance([1]gdclass.WorldBoundaryShape3D{gdclass.NewWorldBoundaryShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
