...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventJoypadMotion")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventJoypadMotion{gdclass.NewInputEventJoypadMotion(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
