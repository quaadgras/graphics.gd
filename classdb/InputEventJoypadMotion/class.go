...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventJoypadMotion{gdclass.NewInputEventJoypadMotion(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
