...
/*
Stores information about joystick motions. One [graphics.gd/classdb/InputEventJoypadMotion] represents one axis at a time. For gamepad buttons, see [graphics.gd/classdb/InputEventJoypadButton].
*/
