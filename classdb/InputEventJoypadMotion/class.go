...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.InputEventJoypadMotion](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventJoypadMotion{pointers.Add[gdclass.InputEventJoypadMotion]([3]uint64{})})
	...
	casted := Instance([1]gdclass.InputEventJoypadMotion{pointers.New[gdclass.InputEventJoypadMotion]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetAxis(axis Input.JoyAxis) { //gd:InputEventJoypadMotion.set_axis
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_axis, 0|(gdextension.SizeInt<<4), &struct{ axis Input.JoyAxis }{axis})
}

//go:nosplit
func (self class) GetAxis() Input.JoyAxis { //gd:InputEventJoypadMotion.get_axis
	var r_ret = mainthread.Call[Input.JoyAxis](gd.ObjectChecked(self.AsObject()), methods.get_axis, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetAxisValue(axis_value float64) { //gd:InputEventJoypadMotion.set_axis_value
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_axis_value, 0|(gdextension.SizeFloat<<4), &struct{ axis_value float64 }{axis_value})
}

//go:nosplit
func (self class) GetAxisValue() float64 { //gd:InputEventJoypadMotion.get_axis_value
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_axis_value, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsInputEventJoypadMotion() Advanced {
	return Advanced{pointers.AsA[gdclass.InputEventJoypadMotion](self[0])}
}
func (self Instance) AsInputEventJoypadMotion() Instance {
	return Instance{pointers.AsA[gdclass.InputEventJoypadMotion](self[0])}
}
...
func init() {
	gdclass.Register("InputEventJoypadMotion", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.InputEventJoypadMotion](ptr)} })
}
