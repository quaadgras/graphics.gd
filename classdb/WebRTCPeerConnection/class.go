...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCPeerConnection{gdclass.NewWebRTCPeerConnection(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
