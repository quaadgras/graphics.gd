...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("WebRTCPeerConnection")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCPeerConnection{gdclass.NewWebRTCPeerConnection(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
