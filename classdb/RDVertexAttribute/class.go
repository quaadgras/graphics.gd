...
func (self class) AsObject() [1]gd.Object { return gdclass.GetRDVertexAttribute(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetRDVertexAttribute(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RDVertexAttribute{gdclass.NewRDVertexAttribute(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetRDVertexAttribute(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.RDVertexAttribute{gdclass.NewRDVertexAttribute(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsRDVertexAttribute() Advanced {
	return Advanced{gdclass.NewRDVertexAttribute(self.AsObject()[0])}
}
func (self Instance) AsRDVertexAttribute() Instance {
	return Instance{gdclass.NewRDVertexAttribute(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("RDVertexAttribute", func(ptr gd.Object) any { return Instance{gdclass.NewRDVertexAttribute(ptr)} })
}
