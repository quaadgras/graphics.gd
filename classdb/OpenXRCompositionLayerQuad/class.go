...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerQuad{gdclass.NewOpenXRCompositionLayerQuad(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
