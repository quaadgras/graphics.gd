...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRCompositionLayerQuad")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerQuad{gdclass.NewOpenXRCompositionLayerQuad(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
