...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("UDSServer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.UDSServer{gdclass.NewUDSServer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
