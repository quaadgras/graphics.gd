...
func (self class) SetAabb(rect AABB.PositionSize) { //gd:VisibleOnScreenNotifier3D.set_aabb
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_aabb, 0|(gdextension.SizeAABB<<4), &struct{ rect AABB.PositionSize }{rect})
}
...
func (self class) IsOnScreen() bool { //gd:VisibleOnScreenNotifier3D.is_on_screen
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_on_screen, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
