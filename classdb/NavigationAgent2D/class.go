...
func (self class) GetPathfindingAlgorithm() NavigationPathQueryParameters2D.PathfindingAlgorithm { //gd:NavigationAgent2D.get_pathfinding_algorithm
	var r_ret = mainthread.Call[NavigationPathQueryParameters2D.PathfindingAlgorithm](gd.ObjectChecked(self.AsObject()), methods.get_pathfinding_algorithm, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetPathPostprocessing() NavigationPathQueryParameters2D.PathPostProcessing { //gd:NavigationAgent2D.get_path_postprocessing
	var r_ret = mainthread.Call[NavigationPathQueryParameters2D.PathPostProcessing](gd.ObjectChecked(self.AsObject()), methods.get_path_postprocessing, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetPathMetadataFlags() NavigationPathQueryParameters2D.PathMetadataFlags { //gd:NavigationAgent2D.get_path_metadata_flags
	var r_ret = mainthread.Call[NavigationPathQueryParameters2D.PathMetadataFlags](gd.ObjectChecked(self.AsObject()), methods.get_path_metadata_flags, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetTargetPosition(position Vector2.XY) { //gd:NavigationAgent2D.set_target_position
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_target_position, 0|(gdextension.SizeVector2<<4), &struct{ position Vector2.XY }{position})
}
...
func (self class) GetNextPathPosition() Vector2.XY { //gd:NavigationAgent2D.get_next_path_position
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_next_path_position, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetVelocityForced(velocity Vector2.XY) { //gd:NavigationAgent2D.set_velocity_forced
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_velocity_forced, 0|(gdextension.SizeVector2<<4), &struct{ velocity Vector2.XY }{velocity})
}
...
func (self class) GetFinalPosition() Vector2.XY { //gd:NavigationAgent2D.get_final_position
	var r_ret = mainthread.Call[Vector2.XY](gd.ObjectChecked(self.AsObject()), methods.get_final_position, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetDebugPathCustomLineWidth(line_width float64) { //gd:NavigationAgent2D.set_debug_path_custom_line_width
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_debug_path_custom_line_width, 0|(gdextension.SizeFloat<<4), &struct{ line_width float64 }{line_width})
}

//go:nosplit
func (self class) GetDebugPathCustomLineWidth() float64 { //gd:NavigationAgent2D.get_debug_path_custom_line_width
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_debug_path_custom_line_width, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
