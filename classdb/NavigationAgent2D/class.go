...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationAgent2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationAgent2D{gdclass.NewNavigationAgent2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
