...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeBlendTree")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlendTree{gdclass.NewAnimationNodeBlendTree(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
