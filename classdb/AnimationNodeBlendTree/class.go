...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlendTree{gdclass.NewAnimationNodeBlendTree(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
