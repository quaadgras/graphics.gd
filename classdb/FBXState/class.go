...
func (self class) AsObject() [1]gd.Object { return gdclass.GetFBXState(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetFBXState(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.FBXState{gdclass.NewFBXState(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetFBXState(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.FBXState{gdclass.NewFBXState(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsFBXState() Advanced         { return Advanced{gdclass.NewFBXState(self.AsObject()[0])} }
func (self Instance) AsFBXState() Instance      { return Instance{gdclass.NewFBXState(self.AsObject()[0])} }
func (self *Extension[T]) AsFBXState() Instance { return self.Super().AsFBXState() }
func (self class) AsGLTFState() GLTFState.Advanced {
	return GLTFState.Advanced{gdclass.NewGLTFState(self.AsObject()[0])}
}
func (self *Extension[T]) AsGLTFState() GLTFState.Instance { return self.Super().AsGLTFState() }
func (self Instance) AsGLTFState() GLTFState.Instance {
	return GLTFState.Instance{gdclass.NewGLTFState(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("FBXState", func(ptr gd.Object) any { return Instance{gdclass.NewFBXState(ptr)} })
}
