...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.FBXState](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.FBXState{pointers.Add[gdclass.FBXState]([3]uint64{})})
	...
	casted := Instance([1]gdclass.FBXState{pointers.New[gdclass.FBXState]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsGLTFState() GLTFState.Advanced {
	return GLTFState.Advanced{pointers.AsA[gdclass.GLTFState](self[0])}
}
...
func (self Instance) AsGLTFState() GLTFState.Instance {
	return GLTFState.Instance{pointers.AsA[gdclass.GLTFState](self[0])}
}
...
func init() {
	gdclass.Register("FBXState", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.FBXState](ptr)} })
}
