...
/*
A 1D texture that obtains colors from a [graphics.gd/classdb/Gradient] to fill the texture data. The texture is filled by sampling the gradient for each pixel. Therefore, the texture does not necessarily represent an exact copy of the gradient, as it may miss some colors if there are not enough pixels. See also [graphics.gd/classdb/GradientTexture2D], [graphics.gd/classdb/CurveTexture] and [graphics.gd/classdb/CurveXYZTexture].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.GradientTexture1D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.GradientTexture1D{pointers.Add[gdclass.GradientTexture1D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.GradientTexture1D{pointers.New[gdclass.GradientTexture1D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsGradientTexture1D() Advanced {
	return Advanced{pointers.AsA[gdclass.GradientTexture1D](self[0])}
}
func (self Instance) AsGradientTexture1D() Instance {
	return Instance{pointers.AsA[gdclass.GradientTexture1D](self[0])}
}
...
func init() {
	gdclass.Register("GradientTexture1D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.GradientTexture1D](ptr)} })
}
