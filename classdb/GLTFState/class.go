...
/*
Contains all nodes and resources of a glTF file. This is used by [graphics.gd/classdb/GLTFDocument] as data storage, which allows [graphics.gd/classdb/GLTFDocument] and all [graphics.gd/classdb/GLTFDocumentExtension] classes to remain stateless.

GLTFState can be populated by [graphics.gd/classdb/GLTFDocument] reading a file or by converting a Godot scene. Then the data can either be used to create a Godot scene or save to a glTF file. The code that converts to/from a Godot scene can be intercepted at arbitrary points by [graphics.gd/classdb/GLTFDocumentExtension] classes. This allows for custom data to be stored in the glTF file or for custom data to be converted to/from Godot nodes.
*/
package GLTFState
...
/*
Appends an extension to the list of extensions used by this glTF file during serialization. If 'required' is true, the extension will also be added to the list of required extensions. Do not run this in [graphics.gd/classdb/GLTFDocumentExtension.Instance.ExportPost], as that stage is too late to add extensions. The final list is sorted alphabetically.
*/
...
The 'parent_node_index' parameter is the index of the parent [graphics.gd/classdb/GLTFNode] in the state. If -1, the node will be a root node, otherwise the new node will be added to the parent's list of children. The index will also be written to the [graphics.gd/classdb/GLTFNode.Instance.Parent] property of the new node.
*/
...
/*
Returns the number of [graphics.gd/classdb/AnimationPlayer] nodes in this [graphics.gd/classdb/GLTFState]. These nodes are only used during the export process when converting Godot [graphics.gd/classdb/AnimationPlayer] nodes to glTF animations.
*/
...
/*
Returns the [graphics.gd/classdb/AnimationPlayer] node with the given index. These nodes are only used during the export process when converting Godot [graphics.gd/classdb/AnimationPlayer] nodes to glTF animations.
*/
...
/*
Returns the Godot scene node that corresponds to the same index as the [graphics.gd/classdb/GLTFNode] it was generated from. This is the inverse of [Instance.GetNodeIndex]. Useful during the import process.

Note: Not every [graphics.gd/classdb/GLTFNode] will have a scene node generated, and not every generated scene node will have a corresponding [graphics.gd/classdb/GLTFNode]. If there is no scene node for this [graphics.gd/classdb/GLTFNode] index, null is returned.
*/
...
/*
Returns the index of the [graphics.gd/classdb/GLTFNode] corresponding to this Godot scene node. This is the inverse of [Instance.GetSceneNode]. Useful during the export process.

Note: Not every Godot scene node will have a corresponding [graphics.gd/classdb/GLTFNode], and not every [graphics.gd/classdb/GLTFNode] will have a scene node generated. If there is no [graphics.gd/classdb/GLTFNode] index for this scene node, -1 is returned.
*/
...
/*
Gets additional arbitrary data in this [graphics.gd/classdb/GLTFState] instance. This can be used to keep per-file state data in [graphics.gd/classdb/GLTFDocumentExtension] classes, which is important because they are stateless.
...
/*
Sets additional arbitrary data in this [graphics.gd/classdb/GLTFState] instance. This can be used to keep per-file state data in [graphics.gd/classdb/GLTFDocumentExtension] classes, which is important because they are stateless.
...
/*
Returns an array of all [graphics.gd/classdb/GLTFNode]s in the glTF file. These are the nodes that [graphics.gd/classdb/GLTFNode.Instance.Children] and [Instance.RootNodes] refer to. This includes nodes that may not be generated in the Godot scene, or nodes that may generate multiple Godot scene nodes.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFNode]s in the state. These are the nodes that [graphics.gd/classdb/GLTFNode.Instance.Children] and [Instance.RootNodes] refer to. Some of the nodes set here may not be generated in the Godot scene, or may generate multiple Godot scene nodes.
*/
//go:nosplit
...
/*
Returns an array of all [graphics.gd/classdb/GLTFMesh]es in the glTF file. These are the meshes that the [graphics.gd/classdb/GLTFNode.Instance.Mesh] index refers to.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFMesh]es in the state. These are the meshes that the [graphics.gd/classdb/GLTFNode.Instance.Mesh] index refers to.
*/
//go:nosplit
...
/*
Gets the images of the glTF file as an array of [graphics.gd/classdb/Texture2D]s. These are the images that the [graphics.gd/classdb/GLTFTexture.Instance.SrcImage] index refers to.
*/
//go:nosplit
...
/*
Sets the images in the state stored as an array of [graphics.gd/classdb/Texture2D]s. This can be used during export. These are the images that the [graphics.gd/classdb/GLTFTexture.Instance.SrcImage] index refers to.
*/
//go:nosplit
...
/*
Returns an array of all [graphics.gd/classdb/GLTFSkin]s in the glTF file. These are the skins that the [graphics.gd/classdb/GLTFNode.Instance.Skin] index refers to.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFSkin]s in the state. These are the skins that the [graphics.gd/classdb/GLTFNode.Instance.Skin] index refers to.
*/
//go:nosplit
...
/*
Returns an array of all [graphics.gd/classdb/GLTFCamera]s in the glTF file. These are the cameras that the [graphics.gd/classdb/GLTFNode.Instance.Camera] index refers to.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFCamera]s in the state. These are the cameras that the [graphics.gd/classdb/GLTFNode.Instance.Camera] index refers to.
*/
//go:nosplit
...
/*
Returns an array of all [graphics.gd/classdb/GLTFLight]s in the glTF file. These are the lights that the [graphics.gd/classdb/GLTFNode.Instance.Light] index refers to.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFLight]s in the state. These are the lights that the [graphics.gd/classdb/GLTFNode.Instance.Light] index refers to.
*/
//go:nosplit
...
/*
Returns an array of all [graphics.gd/classdb/GLTFSkeleton]s in the glTF file. These are the skeletons that the [graphics.gd/classdb/GLTFNode.Instance.Skeleton] index refers to.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFSkeleton]s in the state. These are the skeletons that the [graphics.gd/classdb/GLTFNode.Instance.Skeleton] index refers to.
*/
//go:nosplit
...
/*
Returns an array of all [graphics.gd/classdb/GLTFAnimation]s in the glTF file. When importing, these will be generated as animations in an [graphics.gd/classdb/AnimationPlayer] node. When exporting, these will be generated from Godot [graphics.gd/classdb/AnimationPlayer] nodes.
*/
//go:nosplit
...
/*
Sets the [graphics.gd/classdb/GLTFAnimation]s in the state. When importing, these will be generated as animations in an [graphics.gd/classdb/AnimationPlayer] node. When exporting, these will be generated from Godot [graphics.gd/classdb/AnimationPlayer] nodes.
*/
//go:nosplit
