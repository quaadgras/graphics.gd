...
/*
Appends an extension to the list of extensions used by this glTF file during serialization. If 'required' is true, the extension will also be added to the list of required extensions. Do not run this in [Instance.Gltfdocumentextension.ExportPost], as that stage is too late to add extensions. The final list is sorted alphabetically.
*/
...
/*
Append the given [GLTFNode] to the state, and return its new index. This can be used to export one Godot node as multiple glTF nodes, or inject new glTF nodes at import time. On import, this must be called before [Instance.Gltfdocumentextension.GenerateSceneNode] finishes for the parent node. On export, this must be called before [Instance.Gltfdocumentextension.ExportNode] runs for the parent node.
...
/*
Returns the Godot scene node that corresponds to the same index as the [GLTFNode] it was generated from. This is the inverse of [Instance.GetNodeIndex]. Useful during the import process.
...
/*
Returns the index of the [GLTFNode] corresponding to this Godot scene node. This is the inverse of [Instance.GetSceneNode]. Useful during the export process.
