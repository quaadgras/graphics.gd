...
func New() Instance {
	...
	casted := Instance([1]gdclass.ImporterMeshInstance3D{gdclass.NewImporterMeshInstance3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
