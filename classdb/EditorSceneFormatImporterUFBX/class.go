...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSceneFormatImporterUFBX")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterUFBX{gdclass.NewEditorSceneFormatImporterUFBX(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
