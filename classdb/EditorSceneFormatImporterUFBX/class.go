...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterUFBX{gdclass.NewEditorSceneFormatImporterUFBX(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
