...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRBindingModifier{gdclass.NewOpenXRBindingModifier(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
