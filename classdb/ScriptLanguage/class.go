...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ScriptLanguage")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ScriptLanguage{gdclass.NewScriptLanguage(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
