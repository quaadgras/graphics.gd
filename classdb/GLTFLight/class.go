...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFLight")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFLight{gdclass.NewGLTFLight(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
