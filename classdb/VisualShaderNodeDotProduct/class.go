...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeDotProduct")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDotProduct{gdclass.NewVisualShaderNodeDotProduct(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
