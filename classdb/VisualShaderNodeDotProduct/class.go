...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDotProduct{gdclass.NewVisualShaderNodeDotProduct(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
