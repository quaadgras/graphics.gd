...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRPose")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRPose{gdclass.NewXRPose(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
