...
Note: For a [graphics.gd/classdb/RichTextEffect] to be usable, a BBCode tag must be defined as a member variable called bbcode in the script.
...
Note: As soon as a [graphics.gd/classdb/RichTextLabel] contains at least one [graphics.gd/classdb/RichTextEffect], it will continuously process the effect unless the project is paused. This may impact battery life negatively.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.RichTextEffect](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.RichTextEffect{pointers.Add[gdclass.RichTextEffect]([3]uint64{})})
	...
	casted := Instance([1]gdclass.RichTextEffect{pointers.New[gdclass.RichTextEffect]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsRichTextEffect() Advanced {
	return Advanced{pointers.AsA[gdclass.RichTextEffect](self[0])}
}
func (self Instance) AsRichTextEffect() Instance {
	return Instance{pointers.AsA[gdclass.RichTextEffect](self[0])}
}
...
func init() {
	gdclass.Register("RichTextEffect", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.RichTextEffect](ptr)} })
}
