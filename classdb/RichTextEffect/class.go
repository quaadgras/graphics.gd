...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("RichTextEffect")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.RichTextEffect{gdclass.NewRichTextEffect(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
