...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("FontFile")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.FontFile{gdclass.NewFontFile(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
