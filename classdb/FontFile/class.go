...
Use [graphics.gd/classdb/FontVariation] to access specific OpenType variation of the font, create simulated bold / slanted version, and draw lines of text.

For more complex text processing, use [graphics.gd/classdb/FontVariation] in conjunction with [graphics.gd/classdb/TextLine] or [graphics.gd/classdb/TextParagraph].
...
/*
Sets variation coordinates for the specified font cache entry. See [graphics.gd/classdb/Font.Instance.GetSupportedVariationList] for more info.
*/
...
/*
Returns variation coordinates for the specified font cache entry. See [graphics.gd/classdb/Font.Instance.GetSupportedVariationList] for more info.
*/
...
Note: This function will not remove glyphs associated with the texture, use [Instance.RemoveGlyph] to remove them manually.
*/
...
Note: This function will not remove glyphs associated with the texture. Remove them manually using [Instance.RemoveGlyph].
*/
...
Note: This function will not remove textures associated with the glyphs, use [Instance.RemoveTexture] to remove them manually.
*/
...
/*
Adds override for [graphics.gd/classdb/Font.Instance.IsLanguageSupported].
*/
...
/*
Adds override for [graphics.gd/classdb/Font.Instance.IsScriptSupported].
*/
...
/*
Returns character code associated with 'glyph_index', or 0 if 'glyph_index' is invalid. See [Instance.GetGlyphIndex].
*/
