...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlaybackResampled")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackResampled{gdclass.NewAudioStreamPlaybackResampled(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
