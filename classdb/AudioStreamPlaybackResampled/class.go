...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackResampled{gdclass.NewAudioStreamPlaybackResampled(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
