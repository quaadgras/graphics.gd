...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFObjectModelProperty")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFObjectModelProperty{gdclass.NewGLTFObjectModelProperty(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
