...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFObjectModelProperty{gdclass.NewGLTFObjectModelProperty(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
