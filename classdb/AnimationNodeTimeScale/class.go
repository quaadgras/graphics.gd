...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationNodeTimeScale")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeTimeScale{gdclass.NewAnimationNodeTimeScale(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
