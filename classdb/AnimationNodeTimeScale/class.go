...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeTimeScale{gdclass.NewAnimationNodeTimeScale(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
