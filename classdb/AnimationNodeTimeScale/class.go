...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAnimationNodeTimeScale(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetAnimationNodeTimeScale(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeTimeScale{gdclass.NewAnimationNodeTimeScale(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAnimationNodeTimeScale(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AnimationNodeTimeScale{gdclass.NewAnimationNodeTimeScale(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsAnimationNodeTimeScale() Advanced {
	return Advanced{gdclass.NewAnimationNodeTimeScale(self.AsObject()[0])}
}
func (self Instance) AsAnimationNodeTimeScale() Instance {
	return Instance{gdclass.NewAnimationNodeTimeScale(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeTimeScale", func(ptr gd.Object) any { return Instance{gdclass.NewAnimationNodeTimeScale(ptr)} })
}
