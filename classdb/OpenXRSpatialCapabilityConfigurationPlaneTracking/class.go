...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRSpatialCapabilityConfigurationPlaneTracking{gdclass.NewOpenXRSpatialCapabilityConfigurationPlaneTracking(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
