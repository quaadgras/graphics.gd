...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectLowPassFilter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectLowPassFilter{gdclass.NewAudioEffectLowPassFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
