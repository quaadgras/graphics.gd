...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectLowPassFilter{gdclass.NewAudioEffectLowPassFilter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
