...
func New() Instance {
	...
	casted := Instance([1]gdclass.RetargetModifier3D{gdclass.NewRetargetModifier3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
