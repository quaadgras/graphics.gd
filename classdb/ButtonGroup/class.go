...
/*
A group of [graphics.gd/classdb/BaseButton]-derived buttons. The buttons in a [graphics.gd/classdb/ButtonGroup] are treated like radio buttons: No more than one button can be pressed at a time. Some types of buttons (such as [graphics.gd/classdb/CheckBox]) may have a special appearance in this state.

Every member of a [graphics.gd/classdb/ButtonGroup] should have [graphics.gd/classdb/BaseButton.Instance.ToggleMode] set to true.
*/
package ButtonGroup
...
/*
Returns an slice of [graphics.gd/classdb/Button]s who have this as their [graphics.gd/classdb/ButtonGroup] (see [graphics.gd/classdb/BaseButton.Instance.ButtonGroup]).
*/
