...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ButtonGroup")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ButtonGroup{gdclass.NewButtonGroup(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
