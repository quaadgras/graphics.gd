...
func (self class) GetPressedButton() [1]gdclass.BaseButton { //gd:ButtonGroup.get_pressed_button
	var r_ret = mainthread.Call[gdextension.Object](gd.ObjectChecked(self.AsObject()), methods.get_pressed_button, gdextension.SizeObject, &struct{}{})
...
func (self class) GetButtons() Array.Contains[[1]gdclass.BaseButton] { //gd:ButtonGroup.get_buttons
	var r_ret = mainthread.Call[gdextension.Array](gd.ObjectChecked(self.AsObject()), methods.get_buttons, gdextension.SizeArray, &struct{}{})
...
func (self class) SetAllowUnpress(enabled bool) { //gd:ButtonGroup.set_allow_unpress
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_allow_unpress, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsAllowUnpress() bool { //gd:ButtonGroup.is_allow_unpress
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_allow_unpress, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
