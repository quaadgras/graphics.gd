...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTexture3D{gdclass.NewCompressedTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
