...
/*
[graphics.gd/classdb/CompressedTexture3D] is the VRAM-compressed counterpart of [graphics.gd/classdb/ImageTexture3D]. The file extension for [graphics.gd/classdb/CompressedTexture3D] files is .ctex3d. This file format is internal to Godot; it is created by importing other image formats with the import system.

[graphics.gd/classdb/CompressedTexture3D] uses VRAM compression, which allows to reduce memory usage on the GPU when rendering the texture. This also improves loading times, as VRAM-compressed textures are faster to load compared to textures using lossless compression. VRAM compression can exhibit noticeable artifacts and is intended to be used for 3D rendering, not 2D.

See [graphics.gd/classdb/Texture3D] for a general description of 3D textures.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.CompressedTexture3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.CompressedTexture3D{pointers.Add[gdclass.CompressedTexture3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.CompressedTexture3D{pointers.New[gdclass.CompressedTexture3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsCompressedTexture3D() Advanced {
	return Advanced{pointers.AsA[gdclass.CompressedTexture3D](self[0])}
}
func (self Instance) AsCompressedTexture3D() Instance {
	return Instance{pointers.AsA[gdclass.CompressedTexture3D](self[0])}
}
...
func init() {
	gdclass.Register("CompressedTexture3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.CompressedTexture3D](ptr)} })
}
