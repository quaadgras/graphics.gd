...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CompressedTexture3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CompressedTexture3D{gdclass.NewCompressedTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
