...
When an object is edited, the [Instance.CanHandle] function is called and must return true if the object type is supported.
If supported, the function [Instance.ParseBegin] will be called, allowing to place custom controls at the beginning of the class.
Subsequently, the [Instance.ParseCategory] and [Instance.ParseProperty] are called for every category and property. They offer the ability to add custom controls to the inspector too.
Finally, [Instance.ParseEnd] will be called.
On each of these calls, the "add" functions can be called.
To use [EditorInspectorPlugin], register it using the [Instance.Editorplugin.AddInspectorPlugin] method first.
*/
