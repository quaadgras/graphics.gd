...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorInspectorPlugin{gdclass.NewEditorInspectorPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
