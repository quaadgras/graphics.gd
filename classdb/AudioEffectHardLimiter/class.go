...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectHardLimiter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectHardLimiter{gdclass.NewAudioEffectHardLimiter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
