...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectHardLimiter{gdclass.NewAudioEffectHardLimiter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
