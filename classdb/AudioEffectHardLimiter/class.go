...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioEffectHardLimiter](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectHardLimiter{pointers.Add[gdclass.AudioEffectHardLimiter]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioEffectHardLimiter{pointers.New[gdclass.AudioEffectHardLimiter]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetPreGainDb(p_pre_gain float64) { //gd:AudioEffectHardLimiter.set_pre_gain_db
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_pre_gain_db, 0|(gdextension.SizeFloat<<4), &struct{ p_pre_gain float64 }{p_pre_gain})
}

//go:nosplit
func (self class) GetPreGainDb() float64 { //gd:AudioEffectHardLimiter.get_pre_gain_db
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_pre_gain_db, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetRelease(p_release float64) { //gd:AudioEffectHardLimiter.set_release
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_release, 0|(gdextension.SizeFloat<<4), &struct{ p_release float64 }{p_release})
}

//go:nosplit
func (self class) GetRelease() float64 { //gd:AudioEffectHardLimiter.get_release
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_release, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsAudioEffectHardLimiter() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioEffectHardLimiter](self[0])}
}
func (self Instance) AsAudioEffectHardLimiter() Instance {
	return Instance{pointers.AsA[gdclass.AudioEffectHardLimiter](self[0])}
}
...
func init() {
	gdclass.Register("AudioEffectHardLimiter", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioEffectHardLimiter](ptr)} })
}
