...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("HMACContext")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.HMACContext{gdclass.NewHMACContext(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
