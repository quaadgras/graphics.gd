...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRInteractionProfileMetadata")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileMetadata{gdclass.NewOpenXRInteractionProfileMetadata(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
