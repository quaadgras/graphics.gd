...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRInteractionProfileMetadata{gdclass.NewOpenXRInteractionProfileMetadata(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
