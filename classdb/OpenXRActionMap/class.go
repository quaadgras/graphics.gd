...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRActionMap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRActionMap{gdclass.NewOpenXRActionMap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
