...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Shader")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Shader{gdclass.NewShader(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
