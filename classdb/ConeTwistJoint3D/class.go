...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConeTwistJoint3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConeTwistJoint3D{gdclass.NewConeTwistJoint3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
