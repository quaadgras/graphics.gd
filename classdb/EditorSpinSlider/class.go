...
/*
This [graphics.gd/classdb/Control] node is used in the editor's Inspector dock to allow editing of numeric values. Can be used with [graphics.gd/classdb/EditorInspectorPlugin] to recreate the same behavior.

If the [graphics.gd/classdb/Range.Instance.Step] value is 1, the [graphics.gd/classdb/EditorSpinSlider] will display up/down arrows, similar to [graphics.gd/classdb/SpinBox]. If the [graphics.gd/classdb/Range.Instance.Step] value is not 1, a slider will be displayed instead.
*/
