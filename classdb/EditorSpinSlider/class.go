...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSpinSlider")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSpinSlider{gdclass.NewEditorSpinSlider(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
