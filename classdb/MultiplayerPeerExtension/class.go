...
/*
Called when a packet needs to be received by the [MultiplayerAPI], if [Instance.GetPacket] isn't implemented. Use this when extending this class via GDScript.
*/
...
/*
Called when a packet needs to be sent by the [MultiplayerAPI], if [Instance.PutPacket] isn't implemented. Use this when extending this class via GDScript.
*/
...
/*
Called to get the channel over which the next available packet was received. See [Instance.Multiplayerpeer.GetPacketChannel].
*/
...
/*
Called to get the transfer mode the remote peer used to send the next available packet. See [Instance.Multiplayerpeer.GetPacketMode].
*/
...
/*
Called when the target peer to use is set for this [MultiplayerPeer] (see [Instance.Multiplayerpeer.SetTargetPeer]).
*/
...
/*
Called when the ID of the [MultiplayerPeer] who sent the most recent packet is requested (see [Instance.Multiplayerpeer.GetPacketPeer]).
*/
...
/*
Called when the "is server" status is requested on the [MultiplayerAPI]. See [Instance.Multiplayerapi.IsServer].
*/
...
/*
Called when the [MultiplayerAPI] is polled. See [Instance.Multiplayerapi.Poll].
*/
...
/*
Called when the multiplayer peer should be immediately closed (see [Instance.Multiplayerpeer.Close]).
*/
...
/*
Called when the connected 'p_peer' should be forcibly disconnected (see [Instance.Multiplayerpeer.DisconnectPeer]).
*/
...
/*
Called when the unique ID of this [MultiplayerPeer] is requested (see [Instance.Multiplayerpeer.GetUniqueId]). The value must be between 1 and 2147483647.
*/
...
/*
Called to check if the server can act as a relay in the current configuration. See [Instance.Multiplayerpeer.IsServerRelaySupported].
*/
...
/*
Called when the connection status is requested on the [MultiplayerPeer] (see [Instance.Multiplayerpeer.GetConnectionStatus]).
*/
