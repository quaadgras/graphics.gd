...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsTestMotionParameters2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionParameters2D{gdclass.NewPhysicsTestMotionParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
