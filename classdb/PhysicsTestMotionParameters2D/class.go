...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsTestMotionParameters2D{gdclass.NewPhysicsTestMotionParameters2D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
