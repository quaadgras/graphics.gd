...
/*
[graphics.gd/classdb/VisibleOnScreenEnabler2D] contains a rectangular region of 2D space and a target node. The target node will be automatically enabled (via its [graphics.gd/classdb/Node.Instance.ProcessMode] property) when any part of this region becomes visible on the screen, and automatically disabled otherwise. This can for example be used to activate enemies only when the player approaches them.

See [graphics.gd/classdb/VisibleOnScreenNotifier2D] if you only want to be notified when the region is visible on screen.

Note: [graphics.gd/classdb/VisibleOnScreenEnabler2D] uses the render culling code to determine whether it's visible on screen, so it won't function unless [graphics.gd/classdb/CanvasItem.Instance.Visible] is set to true.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisibleOnScreenEnabler2D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisibleOnScreenEnabler2D{pointers.Add[gdclass.VisibleOnScreenEnabler2D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisibleOnScreenEnabler2D{pointers.New[gdclass.VisibleOnScreenEnabler2D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisibleOnScreenEnabler2D() Advanced {
	return Advanced{pointers.AsA[gdclass.VisibleOnScreenEnabler2D](self[0])}
}
func (self Instance) AsVisibleOnScreenEnabler2D() Instance {
	return Instance{pointers.AsA[gdclass.VisibleOnScreenEnabler2D](self[0])}
}
...
func (self class) AsVisibleOnScreenNotifier2D() VisibleOnScreenNotifier2D.Advanced {
	return VisibleOnScreenNotifier2D.Advanced{pointers.AsA[gdclass.VisibleOnScreenNotifier2D](self[0])}
}
...
func (self Instance) AsVisibleOnScreenNotifier2D() VisibleOnScreenNotifier2D.Instance {
	return VisibleOnScreenNotifier2D.Instance{pointers.AsA[gdclass.VisibleOnScreenNotifier2D](self[0])}
}
...
func init() {
	gdclass.Register("VisibleOnScreenEnabler2D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisibleOnScreenEnabler2D](ptr)} })
}
