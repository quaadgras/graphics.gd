...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorUndoRedoManager")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorUndoRedoManager{gdclass.NewEditorUndoRedoManager(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
