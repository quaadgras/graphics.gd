...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorUndoRedoManager{gdclass.NewEditorUndoRedoManager(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
