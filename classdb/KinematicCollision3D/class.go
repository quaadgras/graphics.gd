...
func New() Instance {
	...
	casted := Instance([1]gdclass.KinematicCollision3D{gdclass.NewKinematicCollision3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
