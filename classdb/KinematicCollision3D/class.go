...
/*
Holds collision data from the movement of a [PhysicsBody3D], usually from [Instance.Physicsbody3d.MoveAndCollide]. When a [PhysicsBody3D] is moved, it stops if it detects a collision with another body. If a collision is detected, a [KinematicCollision3D] object is returned.
...
/*
Returns the unique instance ID of the colliding body's attached [Object] given a collision index (the deepest collision by default). See [Instance.Object.GetInstanceId].
*/
