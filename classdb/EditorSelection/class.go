...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSelection")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSelection{gdclass.NewEditorSelection(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
