...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CSGPrimitive3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CSGPrimitive3D{gdclass.NewCSGPrimitive3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
