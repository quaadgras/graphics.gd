...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("World3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.World3D{gdclass.NewWorld3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
