...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextServerExtension{gdclass.NewTextServerExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
