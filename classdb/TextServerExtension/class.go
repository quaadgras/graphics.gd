...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextServerExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextServerExtension{gdclass.NewTextServerExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
