...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Popup")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Popup{gdclass.NewPopup(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
