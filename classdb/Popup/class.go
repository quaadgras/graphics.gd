...
func (self class) AsObject() [1]gd.Object { return gdclass.GetPopup(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetPopup(self[0]) }
...
func (self class) AsPopup() Advanced         { return Advanced{gdclass.NewPopup(self.AsObject()[0])} }
func (self Instance) AsPopup() Instance      { return Instance{gdclass.NewPopup(self.AsObject()[0])} }
