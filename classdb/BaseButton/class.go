...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BaseButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BaseButton{gdclass.NewBaseButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
