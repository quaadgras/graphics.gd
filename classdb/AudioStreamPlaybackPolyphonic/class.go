...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackPolyphonic{gdclass.NewAudioStreamPlaybackPolyphonic(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
