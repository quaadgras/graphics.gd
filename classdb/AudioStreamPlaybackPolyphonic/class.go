...
func (self class) AsObject() [1]gd.Object { return gdclass.GetAudioStreamPlaybackPolyphonic(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetAudioStreamPlaybackPolyphonic(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioStreamPlaybackPolyphonic{gdclass.NewAudioStreamPlaybackPolyphonic(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetAudioStreamPlaybackPolyphonic(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackPolyphonic{gdclass.NewAudioStreamPlaybackPolyphonic(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) PlayStream(stream [1]gdclass.AudioStream, from_offset float64, volume_db float64, pitch_scale float64, playback_type AudioServer.PlaybackType, bus String.Name) int64 { //gd:AudioStreamPlaybackPolyphonic.play_stream
	...
	}{gdextension.Object(gd.ObjectChecked(gdclass.GetAudioStream(stream[0]))), from_offset, volume_db, pitch_scale, playback_type, pointers.Get(gd.InternalStringName(bus))})
	var ret = r_ret
	return ret
}
...
func (self class) AsAudioStreamPlaybackPolyphonic() Advanced {
	return Advanced{gdclass.NewAudioStreamPlaybackPolyphonic(self.AsObject()[0])}
}
func (self Instance) AsAudioStreamPlaybackPolyphonic() Instance {
	return Instance{gdclass.NewAudioStreamPlaybackPolyphonic(self.AsObject()[0])}
}
