...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioStreamPlaybackPolyphonic")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioStreamPlaybackPolyphonic{gdclass.NewAudioStreamPlaybackPolyphonic(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
