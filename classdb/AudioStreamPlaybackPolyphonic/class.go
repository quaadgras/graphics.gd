...
/*
Playback instance for [AudioStreamPolyphonic]. After setting the stream property of [AudioStreamPlayer], [AudioStreamPlayer2D], or [AudioStreamPlayer3D], the playback instance can be obtained by calling [Instance.Audiostreamplayer.GetStreamPlayback], [Instance.Audiostreamplayer2d.GetStreamPlayback] or [Instance.Audiostreamplayer3d.GetStreamPlayback] methods.
*/
...
This ID becomes invalid when the stream ends (if it does not loop), when the [AudioStreamPlaybackPolyphonic] is stopped, or when [Instance.StopStream] is called.
This function returns [InvalidId] if the amount of streams currently playing equals [member AudioStreamPolyphonic.polyphony]. If you need a higher amount of maximum polyphony, raise this value.
*/
