...
func (self class) AsObject() [1]gd.Object { return gdclass.GetBitMap(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetBitMap(self[0]) }
...
func (self class) AsBitMap() Advanced         { return Advanced{gdclass.NewBitMap(self.AsObject()[0])} }
func (self Instance) AsBitMap() Instance      { return Instance{gdclass.NewBitMap(self.AsObject()[0])} }
