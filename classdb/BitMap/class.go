...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("BitMap")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.BitMap{gdclass.NewBitMap(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
