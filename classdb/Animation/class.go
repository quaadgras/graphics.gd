...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Animation")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Animation{gdclass.NewAnimation(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
