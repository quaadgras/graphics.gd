...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("InputEventKey")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.InputEventKey{gdclass.NewInputEventKey(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
