...
func (self class) AsObject() [1]gd.Object { return gdclass.GetInputEventKey(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetInputEventKey(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.InputEventKey{gdclass.NewInputEventKey(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetInputEventKey(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.InputEventKey{gdclass.NewInputEventKey(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsInputEventKey() Advanced {
	return Advanced{gdclass.NewInputEventKey(self.AsObject()[0])}
}
func (self Instance) AsInputEventKey() Instance {
	return Instance{gdclass.NewInputEventKey(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("InputEventKey", func(ptr gd.Object) any { return Instance{gdclass.NewInputEventKey(ptr)} })
}
