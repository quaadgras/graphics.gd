...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.XRVRS](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.XRVRS{pointers.Add[gdclass.XRVRS]([3]uint64{})})
	...
	casted := Instance([1]gdclass.XRVRS{pointers.New[gdclass.XRVRS]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsXRVRS() Advanced         { return Advanced{pointers.AsA[gdclass.XRVRS](self[0])} }
func (self Instance) AsXRVRS() Instance      { return Instance{pointers.AsA[gdclass.XRVRS](self[0])} }
...
func init() {
	gdclass.Register("XRVRS", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.XRVRS](ptr)} })
}
