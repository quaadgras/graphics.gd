...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRVRS")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRVRS{gdclass.NewXRVRS(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
