...
You may assign navigation layers to regions with [Instance.Navigationserver2d.RegionSetNavigationLayers], which then can be checked upon when requesting a path with [Instance.Navigationserver2d.MapGetPath]. This can be used to allow or deny certain areas for some objects.
...
/*
Set the region's navigation layers. This allows selecting regions from a path request (when using [Instance.Navigationserver2d.MapGetPath]).
*/
...
/*
Set the links's navigation layers. This allows selecting links from a path request (when using [Instance.Navigationserver2d.MapGetPath]).
*/
...
/*
Sets 'velocity' as the new wanted velocity for the specified 'agent'. The avoidance simulation will try to fulfill this velocity if possible but will modify it to avoid collision with other agent's and obstacles. When an agent is teleported to a new position far away use [Instance.AgentSetVelocityForced] instead to reset the internal velocity state.
*/
