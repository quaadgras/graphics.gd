...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("AnimationNodeBlendSpace1D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlendSpace1D{gdclass.NewAnimationNodeBlendSpace1D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
