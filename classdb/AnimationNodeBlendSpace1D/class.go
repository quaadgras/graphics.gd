...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationNodeBlendSpace1D{gdclass.NewAnimationNodeBlendSpace1D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
