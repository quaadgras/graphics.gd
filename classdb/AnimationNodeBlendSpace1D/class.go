...
[graphics.gd/classdb/AnimationNodeBlendSpace1D] represents a virtual axis on which any type of [graphics.gd/classdb/AnimationRootNode]s can be added using [Instance.AddBlendPoint]. Outputs the linear blend of the two [graphics.gd/classdb/AnimationRootNode]s adjacent to the current value.

You can set the extents of the axis with [Instance.MinSpace] and [Instance.MaxSpace].
*/
...
/*
Returns the [graphics.gd/classdb/AnimationNode] referenced by the point at index 'point'.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AnimationNodeBlendSpace1D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AnimationNodeBlendSpace1D{pointers.Add[gdclass.AnimationNodeBlendSpace1D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AnimationNodeBlendSpace1D{pointers.New[gdclass.AnimationNodeBlendSpace1D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AddBlendPoint(node [1]gdclass.AnimationRootNode, pos float64, at_index int64) { //gd:AnimationNodeBlendSpace1D.add_blend_point
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_blend_point, 0|(gdextension.SizeObject<<4)|(gdextension.SizeFloat<<8)|(gdextension.SizeInt<<12), &struct {
...
func (self class) SetBlendPointPosition(point int64, pos float64) { //gd:AnimationNodeBlendSpace1D.set_blend_point_position
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_blend_point_position, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct {
		point int64
		pos   float64
	}{point, pos})
}
...
func (self class) GetBlendPointPosition(point int64) float64 { //gd:AnimationNodeBlendSpace1D.get_blend_point_position
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_blend_point_position, gdextension.SizeFloat|(gdextension.SizeInt<<4), &struct{ point int64 }{point})
	var ret = r_ret
	return ret
}
...
func (self class) SetMinSpace(min_space float64) { //gd:AnimationNodeBlendSpace1D.set_min_space
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_min_space, 0|(gdextension.SizeFloat<<4), &struct{ min_space float64 }{min_space})
}

//go:nosplit
func (self class) GetMinSpace() float64 { //gd:AnimationNodeBlendSpace1D.get_min_space
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_min_space, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetMaxSpace(max_space float64) { //gd:AnimationNodeBlendSpace1D.set_max_space
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_max_space, 0|(gdextension.SizeFloat<<4), &struct{ max_space float64 }{max_space})
}

//go:nosplit
func (self class) GetMaxSpace() float64 { //gd:AnimationNodeBlendSpace1D.get_max_space
	var r_ret = gdextension.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_max_space, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetValueLabel(text String.Readable) { //gd:AnimationNodeBlendSpace1D.set_value_label
	gdextension.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_value_label, 0|(gdextension.SizeString<<4), &struct{ text gdextension.String }{pointers.Get(gd.InternalString(text))})
}

//go:nosplit
func (self class) GetValueLabel() String.Readable { //gd:AnimationNodeBlendSpace1D.get_value_label
	var r_ret = gdextension.Call[gdextension.String](gd.ObjectChecked(self.AsObject()), methods.get_value_label, gdextension.SizeString, &struct{}{})
...
func (self class) AsAnimationNodeBlendSpace1D() Advanced {
	return Advanced{pointers.AsA[gdclass.AnimationNodeBlendSpace1D](self[0])}
}
func (self Instance) AsAnimationNodeBlendSpace1D() Instance {
	return Instance{pointers.AsA[gdclass.AnimationNodeBlendSpace1D](self[0])}
}
...
func init() {
	gdclass.Register("AnimationNodeBlendSpace1D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AnimationNodeBlendSpace1D](ptr)} })
}
