...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("MultiMeshInstance3D"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiMeshInstance3D{gdclass.NewMultiMeshInstance3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
