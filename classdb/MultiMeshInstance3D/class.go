...
func New() Instance {
	...
	casted := Instance([1]gdclass.MultiMeshInstance3D{gdclass.NewMultiMeshInstance3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
