...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorPlugin{gdclass.NewEditorPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
