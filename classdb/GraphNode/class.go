...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GraphNode")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GraphNode{gdclass.NewGraphNode(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
