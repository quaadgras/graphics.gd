...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRRenderModelManager{gdclass.NewOpenXRRenderModelManager(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
