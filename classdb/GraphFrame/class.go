...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GraphFrame")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GraphFrame{gdclass.NewGraphFrame(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
