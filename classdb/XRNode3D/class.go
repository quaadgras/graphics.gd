...
func (self class) AsObject() [1]gd.Object { return gdclass.GetXRNode3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetXRNode3D(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.XRNode3D{gdclass.NewXRNode3D(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetXRNode3D(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.XRNode3D{gdclass.NewXRNode3D(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnTrackingChanged(cb func(tracking bool), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("tracking_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsXRNode3D() Advanced         { return Advanced{gdclass.NewXRNode3D(self.AsObject()[0])} }
func (self Instance) AsXRNode3D() Instance      { return Instance{gdclass.NewXRNode3D(self.AsObject()[0])} }
...
func init() {
	gdclass.Register("XRNode3D", func(ptr gd.Object) any { return Instance{gdclass.NewXRNode3D(ptr)} })
}
