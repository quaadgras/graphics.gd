...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRNode3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRNode3D{gdclass.NewXRNode3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
