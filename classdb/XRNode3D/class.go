...
/*
This node can be bound to a specific pose of a [graphics.gd/classdb/XRPositionalTracker] and will automatically have its [graphics.gd/classdb/Node3D.Instance.Transform] updated by the [graphics.gd/classdb/XRServer]. Nodes of this type must be added as children of the [graphics.gd/classdb/XROrigin3D] node.
*/
package XRNode3D
