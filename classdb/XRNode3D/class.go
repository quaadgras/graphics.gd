...
/*
This node can be bound to a specific pose of an [graphics.gd/classdb/XRPositionalTracker] and will automatically have its [graphics.gd/classdb/Node3D.Instance.Transform] updated by the [graphics.gd/classdb/XRServer]. Nodes of this type must be added as children of the [graphics.gd/classdb/XROrigin3D] node.
*/
package XRNode3D
...
/*
Returns true if the [Instance.Tracker] has been registered and the [Instance.Pose] is being tracked.
*/
...
/*
Returns true if the [Instance.Tracker] has current tracking data for the [Instance.Pose] being tracked.
*/
...
/*
Returns the [graphics.gd/classdb/XRPose] containing the current state of the pose being tracked. This gives access to additional properties of this pose.
*/
