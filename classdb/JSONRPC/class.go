...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("JSONRPC")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.JSONRPC{gdclass.NewJSONRPC(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
