...
/*
[JSON-RPC] is a standard which wraps a method call in a [graphics.gd/classdb/JSON] object. The object has a particular structure and identifies which method is called, the parameters to that function, and carries an ID to keep track of responses. This class implements that standard on top of data structure; you will have to convert between a data structure and [graphics.gd/classdb/JSON] with other functions.
...
To add new supported methods extend the JSONRPC class and call [Instance.ProcessAction] on your subclass.
...
const (
	// The request could not be parsed as it was not valid by JSON standard ([graphics.gd/classdb/JSON.Instance.Parse] failed).
