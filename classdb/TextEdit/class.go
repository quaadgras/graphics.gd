...
An action will also end after a call to [Instance.EndAction], after [member ProjectSettings.gui/timers/text_edit_idle_detect_sec] is triggered or a new undoable step outside the [Instance.StartAction] and [Instance.EndAction] calls.
*/
