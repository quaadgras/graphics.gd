...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsDirectBodyState3DExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsDirectBodyState3DExtension{gdclass.NewPhysicsDirectBodyState3DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
