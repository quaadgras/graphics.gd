...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsDirectBodyState3DExtension{gdclass.NewPhysicsDirectBodyState3DExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
