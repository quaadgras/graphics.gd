...
func New() Instance {
	...
	casted := Instance([1]gdclass.WebRTCDataChannel{gdclass.NewWebRTCDataChannel(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
