...
/*
Removes the [graphics.gd/classdb/Animation] with the key 'name'.
*/
...
/*
Changes the key of the [graphics.gd/classdb/Animation] associated with the key 'name' to 'newname'.
*/
...
/*
Returns true if the library stores an [graphics.gd/classdb/Animation] with 'name' as the key.
*/
...
/*
Returns the keys for the [graphics.gd/classdb/Animation]s stored in the library.
*/
...
/*
Returns the key count for the [graphics.gd/classdb/Animation]s stored in the library.
*/
