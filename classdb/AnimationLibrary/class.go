...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AnimationLibrary")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AnimationLibrary{gdclass.NewAnimationLibrary(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
