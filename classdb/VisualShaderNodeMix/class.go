...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeMix{gdclass.NewVisualShaderNodeMix(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
