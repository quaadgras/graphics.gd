...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeMix](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeMix{pointers.Add[gdclass.VisualShaderNodeMix]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeMix{pointers.New[gdclass.VisualShaderNodeMix]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeMix() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeMix](self[0])}
}
func (self Instance) AsVisualShaderNodeMix() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeMix](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeMix", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeMix](ptr)} })
}
