...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("Resource")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.Resource{gdclass.NewResource(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
