...
/*
If [Instance.ResourceLocalToScene] is set to true and the resource has been loaded from a [graphics.gd/classdb/PackedScene] instantiation, returns the root [graphics.gd/classdb/Node] of the scene where this resource is used. Otherwise, returns null.
*/
//go:nosplit
