...
/*
[graphics.gd/classdb/EditorTranslationParserPlugin] is invoked when a file is being parsed to extract strings that require translation. To define the parsing and string extraction logic, override the [Interface.ParseFile] method in script.
...
Note: If you override parsing logic for standard script types (GDScript, C#, etc.), it would be better to load the path argument using [graphics.gd/classdb/ResourceLoader.Load]. This is because built-in scripts are loaded as [graphics.gd/classdb/Resource] type, not [graphics.gd/classdb/FileAccess] type. For example:
...
To use [graphics.gd/classdb/EditorTranslationParserPlugin], register it using the [graphics.gd/classdb/EditorPlugin.Instance.AddTranslationParserPlugin] method first.
*/
