...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorTranslationParserPlugin{gdclass.NewEditorTranslationParserPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
