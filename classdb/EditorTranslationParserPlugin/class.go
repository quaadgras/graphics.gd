...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorTranslationParserPlugin")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorTranslationParserPlugin{gdclass.NewEditorTranslationParserPlugin(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
