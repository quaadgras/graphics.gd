...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleMultiplyByAxisAngle(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeParticleMultiplyByAxisAngle(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeParticleMultiplyByAxisAngle() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleMultiplyByAxisAngle() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleMultiplyByAxisAngle", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(ptr)} })
}
