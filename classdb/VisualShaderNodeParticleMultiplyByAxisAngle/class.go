...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleMultiplyByAxisAngle")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
