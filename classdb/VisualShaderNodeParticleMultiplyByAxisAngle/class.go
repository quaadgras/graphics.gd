...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
