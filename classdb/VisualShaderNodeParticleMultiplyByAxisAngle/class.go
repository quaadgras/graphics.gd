...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeParticleMultiplyByAxisAngle](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{pointers.Add[gdclass.VisualShaderNodeParticleMultiplyByAxisAngle]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleMultiplyByAxisAngle{pointers.New[gdclass.VisualShaderNodeParticleMultiplyByAxisAngle]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetDegreesMode(enabled bool) { //gd:VisualShaderNodeParticleMultiplyByAxisAngle.set_degrees_mode
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_degrees_mode, 0|(gdextension.SizeBool<<4), &struct{ enabled bool }{enabled})
}

//go:nosplit
func (self class) IsDegreesMode() bool { //gd:VisualShaderNodeParticleMultiplyByAxisAngle.is_degrees_mode
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_degrees_mode, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeParticleMultiplyByAxisAngle() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeParticleMultiplyByAxisAngle](self[0])}
}
func (self Instance) AsVisualShaderNodeParticleMultiplyByAxisAngle() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeParticleMultiplyByAxisAngle](self[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleMultiplyByAxisAngle() Instance {
	return self.Super().AsVisualShaderNodeParticleMultiplyByAxisAngle()
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleMultiplyByAxisAngle", func(ptr gd.Object) any {
		return Instance{pointers.AsA[gdclass.VisualShaderNodeParticleMultiplyByAxisAngle](ptr)}
	})
}
