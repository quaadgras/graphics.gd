...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PanelContainer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PanelContainer{gdclass.NewPanelContainer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
