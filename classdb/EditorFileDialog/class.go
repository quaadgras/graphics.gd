...
var methods struct {
	...
	set_file_mode                 gdextension.MethodForClass `hash:"274150415"`
	get_file_mode                 gdextension.MethodForClass `hash:"2681044145"`
	get_vbox                      gdextension.MethodForClass `hash:"915758477"`
	get_line_edit                 gdextension.MethodForClass `hash:"4071694264"`
	set_access                    gdextension.MethodForClass `hash:"3882893764"`
	get_access                    gdextension.MethodForClass `hash:"778734016"`
	...
	set_display_mode              gdextension.MethodForClass `hash:"3049004050"`
	get_display_mode              gdextension.MethodForClass `hash:"3517174669"`
...
[EditorFileDialog]: https://pkg.go.dev/graphics.gd/classdb/EditorFileDialog
*/
func (self MoreArgs) AddFilter(filter string, description string) { //gd:EditorFileDialog.add_filter
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.EditorFileDialog](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.EditorFileDialog{pointers.Add[gdclass.EditorFileDialog]([3]uint64{})})
	...
	casted := Instance([1]gdclass.EditorFileDialog{pointers.New[gdclass.EditorFileDialog]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetDisableOverwriteWarning(disable bool) { //gd:EditorFileDialog.set_disable_overwrite_warning
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_disable_overwrite_warning, 0|(gdextension.SizeBool<<4), &struct{ disable bool }{disable})
}

//go:nosplit
func (self class) IsOverwriteWarningDisabled() bool { //gd:EditorFileDialog.is_overwrite_warning_disabled
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_overwrite_warning_disabled, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) AddSideMenu(menu [1]gdclass.Control, title String.Readable) { //gd:EditorFileDialog.add_side_menu
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.add_side_menu, 0|(gdextension.SizeObject<<4)|(gdextension.SizeString<<8), &struct {
		menu  gdextension.Object
		title gdextension.String
	}{gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(menu[0].AsObject()[0])), pointers.Get(gd.InternalString(title))})
}
...
func (self class) PopupFileDialog() { //gd:EditorFileDialog.popup_file_dialog
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.popup_file_dialog, 0, &struct{}{})
}
...
func (self class) AsEditorFileDialog() Advanced {
	return Advanced{pointers.AsA[gdclass.EditorFileDialog](self[0])}
}
func (self Instance) AsEditorFileDialog() Instance {
	return Instance{pointers.AsA[gdclass.EditorFileDialog](self[0])}
}
...
func init() {
	gdclass.Register("EditorFileDialog", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.EditorFileDialog](ptr)} })
}
