...
func New() Instance {
	...
	casted := Instance([1]gdclass.GDScriptSyntaxHighlighter{gdclass.NewGDScriptSyntaxHighlighter(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
