...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GDScriptSyntaxHighlighter")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GDScriptSyntaxHighlighter{gdclass.NewGDScriptSyntaxHighlighter(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
