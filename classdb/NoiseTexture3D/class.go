...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NoiseTexture3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NoiseTexture3D{gdclass.NewNoiseTexture3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
