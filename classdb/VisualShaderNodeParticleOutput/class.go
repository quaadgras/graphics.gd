...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleOutput{gdclass.NewVisualShaderNodeParticleOutput(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
