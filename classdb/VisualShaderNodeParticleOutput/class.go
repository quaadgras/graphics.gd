...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeParticleOutput](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleOutput{pointers.Add[gdclass.VisualShaderNodeParticleOutput]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleOutput{pointers.New[gdclass.VisualShaderNodeParticleOutput]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsVisualShaderNodeParticleOutput() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeParticleOutput](self[0])}
}
func (self Instance) AsVisualShaderNodeParticleOutput() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeParticleOutput](self[0])}
}
...
func (self class) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Advanced {
	return VisualShaderNodeOutput.Advanced{pointers.AsA[gdclass.VisualShaderNodeOutput](self[0])}
}
...
func (self Instance) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance {
	return VisualShaderNodeOutput.Instance{pointers.AsA[gdclass.VisualShaderNodeOutput](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleOutput", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeParticleOutput](ptr)} })
}
