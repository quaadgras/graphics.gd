...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeParticleOutput")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleOutput{gdclass.NewVisualShaderNodeParticleOutput(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
