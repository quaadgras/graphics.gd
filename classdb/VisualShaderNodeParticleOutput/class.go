...
func (self class) AsObject() [1]gd.Object { return gdclass.GetVisualShaderNodeParticleOutput(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeParticleOutput(self[0])
}
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeParticleOutput{gdclass.NewVisualShaderNodeParticleOutput(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeParticleOutput(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeParticleOutput{gdclass.NewVisualShaderNodeParticleOutput(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeParticleOutput() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeParticleOutput(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeParticleOutput() Instance {
	return Instance{gdclass.NewVisualShaderNodeParticleOutput(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeParticleOutput() Instance {
	return self.Super().AsVisualShaderNodeParticleOutput()
}
func (self class) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Advanced {
	return VisualShaderNodeOutput.Advanced{gdclass.NewVisualShaderNodeOutput(self.AsObject()[0])}
}
func (self *Extension[T]) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance {
	return self.Super().AsVisualShaderNodeOutput()
}
func (self Instance) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance {
	return VisualShaderNodeOutput.Instance{gdclass.NewVisualShaderNodeOutput(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeParticleOutput", func(ptr gd.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleOutput(ptr)} })
}
