...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFPhysicsBody")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFPhysicsBody{gdclass.NewGLTFPhysicsBody(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
