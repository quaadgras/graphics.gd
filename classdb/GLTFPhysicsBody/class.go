...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("GLTFPhysicsBody"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFPhysicsBody{gdclass.NewGLTFPhysicsBody(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
