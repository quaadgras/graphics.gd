...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorDock")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorDock{gdclass.NewEditorDock(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
