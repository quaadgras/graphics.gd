...
func (self class) AsObject() [1]gd.Object { return gdclass.GetEditorDock(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetEditorDock(self[0]) }
...
func (self class) AsEditorDock() Advanced { return Advanced{gdclass.NewEditorDock(self.AsObject()[0])} }
func (self Instance) AsEditorDock() Instance {
	return Instance{gdclass.NewEditorDock(self.AsObject()[0])}
}
func (self *Extension[T]) AsEditorDock() Instance { return self.Super().AsEditorDock() }
