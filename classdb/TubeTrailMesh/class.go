...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TubeTrailMesh")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TubeTrailMesh{gdclass.NewTubeTrailMesh(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
