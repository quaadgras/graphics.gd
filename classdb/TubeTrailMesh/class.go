...
func (self class) SetRadialSteps(radial_steps int64) { //gd:TubeTrailMesh.set_radial_steps
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_radial_steps, 0|(gdextension.SizeInt<<4), &struct{ radial_steps int64 }{radial_steps})
}

//go:nosplit
func (self class) GetRadialSteps() int64 { //gd:TubeTrailMesh.get_radial_steps
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_radial_steps, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) SetSectionRings(section_rings int64) { //gd:TubeTrailMesh.set_section_rings
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_section_rings, 0|(gdextension.SizeInt<<4), &struct{ section_rings int64 }{section_rings})
}

//go:nosplit
func (self class) GetSectionRings() int64 { //gd:TubeTrailMesh.get_section_rings
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_section_rings, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
