...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectReverb")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectReverb{gdclass.NewAudioEffectReverb(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
