...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("NavigationLink2D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.NavigationLink2D{gdclass.NewNavigationLink2D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
