...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("XRHandTracker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.XRHandTracker{gdclass.NewXRHandTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
