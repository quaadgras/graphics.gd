...
/*
A hand tracking system will create an instance of this object and add it to the [graphics.gd/classdb/XRServer]. This tracking system will then obtain skeleton data, convert it to the Godot Humanoid hand skeleton and store this data on the [graphics.gd/classdb/XRHandTracker] object.

Use [graphics.gd/classdb/XRHandModifier3D] to animate a hand mesh using hand tracking data.
*/
