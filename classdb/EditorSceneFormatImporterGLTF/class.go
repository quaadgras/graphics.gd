...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("EditorSceneFormatImporterGLTF")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterGLTF{gdclass.NewEditorSceneFormatImporterGLTF(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
