...
func New() Instance {
	...
	casted := Instance([1]gdclass.EditorSceneFormatImporterGLTF{gdclass.NewEditorSceneFormatImporterGLTF(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
