...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDeterminant{gdclass.NewVisualShaderNodeDeterminant(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
