...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeDeterminant")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeDeterminant{gdclass.NewVisualShaderNodeDeterminant(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
