...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ConvexPolygonShape3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConvexPolygonShape3D{gdclass.NewConvexPolygonShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
