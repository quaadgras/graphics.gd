...
func New() Instance {
	...
	casted := Instance([1]gdclass.ConvexPolygonShape3D{gdclass.NewConvexPolygonShape3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
