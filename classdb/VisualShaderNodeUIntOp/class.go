...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntOp{gdclass.NewVisualShaderNodeUIntOp(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
