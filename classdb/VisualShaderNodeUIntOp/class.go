...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeUIntOp")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeUIntOp{gdclass.NewVisualShaderNodeUIntOp(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
