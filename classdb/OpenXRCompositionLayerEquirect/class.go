...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerEquirect{gdclass.NewOpenXRCompositionLayerEquirect(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
