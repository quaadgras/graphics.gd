...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRCompositionLayerEquirect")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRCompositionLayerEquirect{gdclass.NewOpenXRCompositionLayerEquirect(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
