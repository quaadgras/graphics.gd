...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRAnchorTracker")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAnchorTracker{gdclass.NewOpenXRAnchorTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
