...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRAnchorTracker{gdclass.NewOpenXRAnchorTracker(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
