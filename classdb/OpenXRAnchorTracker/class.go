...
func (self class) AsObject() [1]gd.Object { return gdclass.GetOpenXRAnchorTracker(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetOpenXRAnchorTracker(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.OpenXRAnchorTracker{gdclass.NewOpenXRAnchorTracker(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetOpenXRAnchorTracker(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.OpenXRAnchorTracker{gdclass.NewOpenXRAnchorTracker(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self Instance) OnUuidChanged(cb func(), flags ...Signal.Flags) Instance {
	...
	self.AsObject()[0].Connect(gd.NewStringName("uuid_changed"), gd.NewCallable(cb), int64(flags_together))
	return self
}
...
func (self class) AsOpenXRAnchorTracker() Advanced {
	return Advanced{gdclass.NewOpenXRAnchorTracker(self.AsObject()[0])}
}
func (self Instance) AsOpenXRAnchorTracker() Instance {
	return Instance{gdclass.NewOpenXRAnchorTracker(self.AsObject()[0])}
}
func (self *Extension[T]) AsOpenXRAnchorTracker() Instance {
	return self.Super().AsOpenXRAnchorTracker()
}
...
func init() {
	gdclass.Register("OpenXRAnchorTracker", func(ptr gd.Object) any { return Instance{gdclass.NewOpenXRAnchorTracker(ptr)} })
}
