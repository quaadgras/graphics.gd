...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("SpringArm3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.SpringArm3D{gdclass.NewSpringArm3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
