...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRBindingModifierEditor{gdclass.NewOpenXRBindingModifierEditor(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
