...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("OpenXRBindingModifierEditor")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.OpenXRBindingModifierEditor{gdclass.NewOpenXRBindingModifierEditor(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
