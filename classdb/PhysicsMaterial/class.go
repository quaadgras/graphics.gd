...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PhysicsMaterial")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PhysicsMaterial{gdclass.NewPhysicsMaterial(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
