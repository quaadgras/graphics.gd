...
/*
This class is used to store the state of a DTLS server. Upon [Instance.Setup] it converts connected [PacketPeerUDP] to [PacketPeerDTLS] accepting them via [Instance.TakeConnection] as DTLS clients. Under the hood, this class is used to store the DTLS state and cookies of the server. The reason of why the state and cookies are needed is outside of the scope of this documentation.
...
/*
Setup the DTLS server to use the given 'server_options'. See [Instance.Tlsoptions.Server].
*/
...
/*
Try to initiate the DTLS handshake with the given 'udp_peer' which must be already connected (see [Instance.Packetpeerudp.ConnectToHost]).
