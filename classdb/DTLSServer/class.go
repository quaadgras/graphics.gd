...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("DTLSServer")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.DTLSServer{gdclass.NewDTLSServer(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
