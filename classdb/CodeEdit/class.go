...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdextension.StringName{gdextension.Pointer(gdunsafe.UTF8.Intern("CodeEdit"))}
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CodeEdit{gdclass.NewCodeEdit(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(gdunsafe.StringName(sname[0]))), gd.Free))})
