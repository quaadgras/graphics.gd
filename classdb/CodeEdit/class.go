...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("CodeEdit")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.CodeEdit{gdclass.NewCodeEdit(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
