...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformVecMult{gdclass.NewVisualShaderNodeTransformVecMult(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
