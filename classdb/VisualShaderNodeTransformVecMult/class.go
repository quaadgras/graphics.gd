...
func (self class) AsObject() [1]gd.Object {
	return gdclass.GetVisualShaderNodeTransformVecMult(self[0])
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeTransformVecMult{gdclass.NewVisualShaderNodeTransformVecMult(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetVisualShaderNodeTransformVecMult(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformVecMult{gdclass.NewVisualShaderNodeTransformVecMult(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
...
func (self class) AsVisualShaderNodeTransformVecMult() Advanced {
	return Advanced{gdclass.NewVisualShaderNodeTransformVecMult(self.AsObject()[0])}
}
func (self Instance) AsVisualShaderNodeTransformVecMult() Instance {
	return Instance{gdclass.NewVisualShaderNodeTransformVecMult(self.AsObject()[0])}
}
