...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeTransformVecMult")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeTransformVecMult{gdclass.NewVisualShaderNodeTransformVecMult(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
