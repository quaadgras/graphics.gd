...
You may assign navigation layers to regions with [Instance.Navigationserver3d.RegionSetNavigationLayers], which then can be checked upon when requesting a path with [Instance.Navigationserver3d.MapGetPath]. This can be used to allow or deny certain areas for some objects.
...
/*
Set the region's navigation layers. This allows selecting regions from a path request (when using [Instance.Navigationserver3d.MapGetPath]).
*/
...
/*
Returns the starting point of a connection door. 'connection' is an index between 0 and the return value of [Instance.RegionGetConnectionsCount].
*/
...
/*
Returns the ending point of a connection door. 'connection' is an index between 0 and the return value of [Instance.RegionGetConnectionsCount].
*/
...
/*
Set the links's navigation layers. This allows selecting links from a path request (when using [Instance.Navigationserver3d.MapGetPath]).
*/
...
Note: Created callbacks are always processed independently of the SceneTree state as long as the agent is on a navigation map and not freed. To disable the dispatch of a callback from an agent use [Instance.AgentSetAvoidanceCallback] again with an empty [Callable].
*/
...
/*
Parses the [SceneTree] for source geometry according to the properties of 'navigation_mesh'. Updates the provided 'source_geometry_data' resource with the resulting data. The resource can then be used to bake a navigation mesh with [Instance.BakeFromSourceGeometryData]. After the process is finished the optional 'callback' will be called.
...
/*
Creates a new source geometry parser. If a [Callable] is set for the parser with [Instance.SourceGeometryParserSetCallback] the callback will be called for every single node that gets parsed whenever [Instance.ParseSourceGeometryData] is used.
*/
