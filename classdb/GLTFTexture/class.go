...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GLTFTexture")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GLTFTexture{gdclass.NewGLTFTexture(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
