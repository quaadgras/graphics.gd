...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureButton")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureButton{gdclass.NewTextureButton(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
