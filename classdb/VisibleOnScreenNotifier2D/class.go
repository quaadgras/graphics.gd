...
func (self class) SetShowRect(show_rect bool) { //gd:VisibleOnScreenNotifier2D.set_show_rect
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_show_rect, 0|(gdextension.SizeBool<<4), &struct{ show_rect bool }{show_rect})
}

//go:nosplit
func (self class) IsShowingRect() bool { //gd:VisibleOnScreenNotifier2D.is_showing_rect
	var r_ret = mainthread.Call[bool](gd.ObjectChecked(self.AsObject()), methods.is_showing_rect, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
