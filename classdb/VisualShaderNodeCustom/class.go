...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCustom{gdclass.NewVisualShaderNodeCustom(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
