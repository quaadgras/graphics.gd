...
/*
By inheriting this class you can create a custom [graphics.gd/classdb/VisualShader] script addon which will be automatically added to the Visual Shader Editor. The [graphics.gd/classdb/VisualShaderNode]'s behavior is defined by overriding the provided virtual methods.
...
type Interface interface {
	...
	// Override this method to define the names of input ports of the associated custom node. The names are used both for the input slots in the editor and as identifiers in the shader code, and are passed in the input_vars array in [Interface.GetCode].
	//
	// Defining this method is optional, but recommended. If not overridden, input ports are named as "in" + str(port).
	GetInputPortName(port int) string
	// Override this method to define the default value for the specified input port. Prefer use this over [graphics.gd/classdb/VisualShaderNode.Instance.SetInputPortDefaultValue].
	//
	...
	// Override this method to define the names of output ports of the associated custom node. The names are used both for the output slots in the editor and as identifiers in the shader code, and are passed in the output_vars array in [Interface.GetCode].
	//
...
/*
Returns the selected index of the drop-down list option within a graph. You may use this function to define the specific behavior in the [Interface.GetCode] or [Interface.GetGlobalCode].
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.VisualShaderNodeCustom](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.VisualShaderNodeCustom{pointers.Add[gdclass.VisualShaderNodeCustom]([3]uint64{})})
	...
	casted := Instance([1]gdclass.VisualShaderNodeCustom{pointers.New[gdclass.VisualShaderNodeCustom]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) GetOptionIndex(option int64) int64 { //gd:VisualShaderNodeCustom.get_option_index
	var r_ret = gdextension.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_option_index, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ option int64 }{option})
	var ret = r_ret
	return ret
}
func (self class) AsVisualShaderNodeCustom() Advanced {
	return Advanced{pointers.AsA[gdclass.VisualShaderNodeCustom](self[0])}
}
func (self Instance) AsVisualShaderNodeCustom() Instance {
	return Instance{pointers.AsA[gdclass.VisualShaderNodeCustom](self[0])}
}
...
func init() {
	gdclass.Register("VisualShaderNodeCustom", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.VisualShaderNodeCustom](ptr)} })
}
