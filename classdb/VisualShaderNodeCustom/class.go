...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("VisualShaderNodeCustom")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.VisualShaderNodeCustom{gdclass.NewVisualShaderNodeCustom(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
