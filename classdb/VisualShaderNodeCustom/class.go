...
func (self class) GetOptionIndex(option int64) int64 { //gd:VisualShaderNodeCustom.get_option_index
	var r_ret = mainthread.Call[int64](gd.ObjectChecked(self.AsObject()), methods.get_option_index, gdextension.SizeInt|(gdextension.SizeInt<<4), &struct{ option int64 }{option})
	var ret = r_ret
	return ret
}
