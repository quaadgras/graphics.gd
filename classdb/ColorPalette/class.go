...
/*
The [graphics.gd/classdb/ColorPalette] resource is designed to store and manage a collection of colors. This resource is useful in scenarios where a predefined set of colors is required, such as for creating themes, designing user interfaces, or managing game assets. The built-in [graphics.gd/classdb/ColorPicker] control can also make use of [graphics.gd/classdb/ColorPalette] without additional code.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.ColorPalette](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.ColorPalette{pointers.Add[gdclass.ColorPalette]([3]uint64{})})
	...
	casted := Instance([1]gdclass.ColorPalette{pointers.New[gdclass.ColorPalette]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsColorPalette() Advanced {
	return Advanced{pointers.AsA[gdclass.ColorPalette](self[0])}
}
func (self Instance) AsColorPalette() Instance {
	return Instance{pointers.AsA[gdclass.ColorPalette](self[0])}
}
...
func init() {
	gdclass.Register("ColorPalette", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.ColorPalette](ptr)} })
}
