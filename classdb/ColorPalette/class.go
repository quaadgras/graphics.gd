...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("ColorPalette")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.ColorPalette{gdclass.NewColorPalette(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
