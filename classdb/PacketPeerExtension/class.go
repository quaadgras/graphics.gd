...
func New() Instance {
	...
	casted := Instance([1]gdclass.PacketPeerExtension{gdclass.NewPacketPeerExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
