...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.PacketPeerExtension](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.PacketPeerExtension{pointers.Add[gdclass.PacketPeerExtension]([3]uint64{})})
	...
	casted := Instance([1]gdclass.PacketPeerExtension{pointers.New[gdclass.PacketPeerExtension]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsPacketPeerExtension() Advanced {
	return Advanced{pointers.AsA[gdclass.PacketPeerExtension](self[0])}
}
func (self Instance) AsPacketPeerExtension() Instance {
	return Instance{pointers.AsA[gdclass.PacketPeerExtension](self[0])}
}
...
func init() {
	gdclass.Register("PacketPeerExtension", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.PacketPeerExtension](ptr)} })
}
