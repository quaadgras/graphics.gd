...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PacketPeerExtension")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PacketPeerExtension{gdclass.NewPacketPeerExtension(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
