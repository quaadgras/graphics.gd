...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractor3D{gdclass.NewGPUParticlesAttractor3D(gdreference.OwnObject(gdextension.Object(gdunsafe.MakeObject(sname)), gd.Free))})
