...
func (self class) SetAttenuation(attenuation float64) { //gd:GPUParticlesAttractor3D.set_attenuation
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_attenuation, 0|(gdextension.SizeFloat<<4), &struct{ attenuation float64 }{attenuation})
}
...
func (self class) SetDirectionality(amount float64) { //gd:GPUParticlesAttractor3D.set_directionality
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_directionality, 0|(gdextension.SizeFloat<<4), &struct{ amount float64 }{amount})
}

//go:nosplit
func (self class) GetDirectionality() float64 { //gd:GPUParticlesAttractor3D.get_directionality
	var r_ret = mainthread.Call[float64](gd.ObjectChecked(self.AsObject()), methods.get_directionality, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
