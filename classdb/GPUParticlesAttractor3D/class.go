...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("GPUParticlesAttractor3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.GPUParticlesAttractor3D{gdclass.NewGPUParticlesAttractor3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
