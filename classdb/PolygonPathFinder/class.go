...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("PolygonPathFinder")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.PolygonPathFinder{gdclass.NewPolygonPathFinder(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
