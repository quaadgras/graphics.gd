...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("AudioEffectAmplify")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.AudioEffectAmplify{gdclass.NewAudioEffectAmplify(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
