...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.AudioEffectAmplify](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.AudioEffectAmplify{pointers.Add[gdclass.AudioEffectAmplify]([3]uint64{})})
	...
	casted := Instance([1]gdclass.AudioEffectAmplify{pointers.New[gdclass.AudioEffectAmplify]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) SetVolumeDb(volume float64) { //gd:AudioEffectAmplify.set_volume_db
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_volume_db, 0|(gdextension.SizeFloat<<4), &struct{ volume float64 }{volume})
}
...
func (self class) SetVolumeLinear(volume float64) { //gd:AudioEffectAmplify.set_volume_linear
	mainthread.Call[struct{}](gd.ObjectChecked(self.AsObject()), methods.set_volume_linear, 0|(gdextension.SizeFloat<<4), &struct{ volume float64 }{volume})
}
...
func (self class) AsAudioEffectAmplify() Advanced {
	return Advanced{pointers.AsA[gdclass.AudioEffectAmplify](self[0])}
}
func (self Instance) AsAudioEffectAmplify() Instance {
	return Instance{pointers.AsA[gdclass.AudioEffectAmplify](self[0])}
}
...
func init() {
	gdclass.Register("AudioEffectAmplify", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.AudioEffectAmplify](ptr)} })
}
