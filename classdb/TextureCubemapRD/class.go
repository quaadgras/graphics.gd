...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.TextureCubemapRD](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.TextureCubemapRD{pointers.Add[gdclass.TextureCubemapRD]([3]uint64{})})
	...
	casted := Instance([1]gdclass.TextureCubemapRD{pointers.New[gdclass.TextureCubemapRD]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsTextureCubemapRD() Advanced {
	return Advanced{pointers.AsA[gdclass.TextureCubemapRD](self[0])}
}
func (self Instance) AsTextureCubemapRD() Instance {
	return Instance{pointers.AsA[gdclass.TextureCubemapRD](self[0])}
}
...
func (self class) AsTextureLayeredRD() TextureLayeredRD.Advanced {
	return TextureLayeredRD.Advanced{pointers.AsA[gdclass.TextureLayeredRD](self[0])}
}
...
func (self Instance) AsTextureLayeredRD() TextureLayeredRD.Instance {
	return TextureLayeredRD.Instance{pointers.AsA[gdclass.TextureLayeredRD](self[0])}
}
...
func init() {
	gdclass.Register("TextureCubemapRD", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.TextureCubemapRD](ptr)} })
}
