...
func (self class) AsObject() [1]gd.Object { return gdclass.GetTextureCubemapRD(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetTextureCubemapRD(self[0]) }
func (self *Extension[T]) AsObject() [1]gd.Object { return self.Super().AsObject() }
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.TextureCubemapRD{gdclass.NewTextureCubemapRD(pointers.Add[gd.Object]([3]uint64{}))})
		gd.StartupFunctions = append(gd.StartupFunctions, func() {
			if gd.Linked {
				raw, _ := pointers.End(New().AsObject()[0])
				pointers.Set(gdclass.GetTextureCubemapRD(placeholder[0])[0], raw)
				gd.RegisterCleanup(func() {
	...
	casted := Instance([1]gdclass.TextureCubemapRD{gdclass.NewTextureCubemapRD(pointers.New[gd.Object]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))}))})
	casted.AsRefCounted()[0].InitRef()
	casted.AsObject()[0].Notification(0, false)
	return casted
}

func (self class) AsTextureCubemapRD() Advanced {
	return Advanced{gdclass.NewTextureCubemapRD(self.AsObject()[0])}
}
func (self Instance) AsTextureCubemapRD() Instance {
	return Instance{gdclass.NewTextureCubemapRD(self.AsObject()[0])}
}
func (self *Extension[T]) AsTextureCubemapRD() Instance { return self.Super().AsTextureCubemapRD() }
func (self class) AsTextureLayeredRD() TextureLayeredRD.Advanced {
	return TextureLayeredRD.Advanced{gdclass.NewTextureLayeredRD(self.AsObject()[0])}
}
...
func (self Instance) AsTextureLayeredRD() TextureLayeredRD.Instance {
	return TextureLayeredRD.Instance{gdclass.NewTextureLayeredRD(self.AsObject()[0])}
}
...
func init() {
	gdclass.Register("TextureCubemapRD", func(ptr gd.Object) any { return Instance{gdclass.NewTextureCubemapRD(ptr)} })
}
