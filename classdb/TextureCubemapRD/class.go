...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("TextureCubemapRD")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.TextureCubemapRD{gdclass.NewTextureCubemapRD(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
