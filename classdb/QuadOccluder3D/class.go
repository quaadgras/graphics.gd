...
func init() {
	gd.Links = append(gd.Links, func() {
		sname = gdunsafe.UTF8.Intern("QuadOccluder3D")
...
func New() Instance {
	...
	casted := Instance([1]gdclass.QuadOccluder3D{gdclass.NewQuadOccluder3D(gdreference.OwnObject(gdextension.Object(gdunsafe.New(gdunsafe.Class(sname))), gd.Free))})
