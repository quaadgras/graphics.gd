...
func (self class) AsObject() [1]gd.Object { return gdclass.GetQuadOccluder3D(self[0]) }
...
func (self Instance) AsObject() [1]gd.Object      { return gdclass.GetQuadOccluder3D(self[0]) }
...
func (self class) AsQuadOccluder3D() Advanced {
	return Advanced{gdclass.NewQuadOccluder3D(self.AsObject()[0])}
}
func (self Instance) AsQuadOccluder3D() Instance {
	return Instance{gdclass.NewQuadOccluder3D(self.AsObject()[0])}
}
func (self *Extension[T]) AsQuadOccluder3D() Instance { return self.Super().AsQuadOccluder3D() }
