...
/*
[graphics.gd/classdb/QuadOccluder3D] stores a flat plane shape that can be used by the engine's occlusion culling system. See also [graphics.gd/classdb/PolygonOccluder3D] if you need to customize the quad's shape.

See [graphics.gd/classdb/OccluderInstance3D]'s documentation for instructions on setting up occlusion culling.
*/
...
func (self *class) SetObject(obj [1]gd.Object) bool {
	if gdextension.Host.Objects.Cast(gdextension.Object(pointers.Get(obj[0])[0]), otype) != 0 {
		self[0] = pointers.AsA[gdclass.QuadOccluder3D](obj[0])
		return true
	}
	return false
}
...
func New() Instance {
	if !gd.Linked {
		var placeholder = Instance([1]gdclass.QuadOccluder3D{pointers.Add[gdclass.QuadOccluder3D]([3]uint64{})})
	...
	casted := Instance([1]gdclass.QuadOccluder3D{pointers.New[gdclass.QuadOccluder3D]([3]uint64{uint64(gdextension.Host.Objects.Make(sname))})})
...
func (self class) AsQuadOccluder3D() Advanced {
	return Advanced{pointers.AsA[gdclass.QuadOccluder3D](self[0])}
}
func (self Instance) AsQuadOccluder3D() Instance {
	return Instance{pointers.AsA[gdclass.QuadOccluder3D](self[0])}
}
...
func init() {
	gdclass.Register("QuadOccluder3D", func(ptr gd.Object) any { return Instance{pointers.AsA[gdclass.QuadOccluder3D](ptr)} })
}
