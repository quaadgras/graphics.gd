...
/*
Returns [Dictionary] of files selected in the "Resources" tab of the export dialog. Dictionary keys are file names and values are export mode - "strip", "keep", or "remove". See also [Instance.GetFileExportMode].
*/
