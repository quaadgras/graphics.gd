...
func CutVariant(v any, cut bool) Variant {
	...
	case reflect.Bool:
		var arg = value.Bool()
		ret.LoadNative(gdextension.TypeBool, gdextension.SizeBool, unsafe.Pointer(&arg))
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		var arg = Int(value.Int())
		ret.LoadNative(gdextension.TypeInt, gdextension.SizeInt, unsafe.Pointer(&arg))
	...
	case reflect.Uint64:
		if instance := value.MethodByName("Instance"); instance.IsValid() && instance.Type().NumOut() == 2 && instance.Type().NumIn() == 0 {
			...
			ret.LoadNative(gdextension.TypeObject, gdextension.SizeObject, unsafe.Pointer(&arg))
		} else {
			var arg = RID(value.Uint())
			ret.LoadNative(gdextension.TypeRID, gdextension.SizeRID, unsafe.Pointer(&arg))
		}
	case reflect.Float32, reflect.Float64:
		var arg = Float(value.Float())
		ret.LoadNative(gdextension.TypeFloat, gdextension.SizeFloat, unsafe.Pointer(&arg))
	case reflect.Complex64, reflect.Complex128:
		var arg = Vector2{
			X: FloatType.X(real(value.Complex())),
			Y: FloatType.X(imag(value.Complex())),
		}
		ret.LoadNative(gdextension.TypeVector2, gdextension.SizeVector2, unsafe.Pointer(&arg))
	...
	case reflect.Array:
		if rtype.Elem().Implements(reflect.TypeOf([0]IsClass{}).Elem()) {
			...
			ret.LoadNative(gdextension.TypeArray, gdextension.SizeArray, unsafe.Pointer(&arg))
		}
	case reflect.Slice:
		...
		case []int32:
			...
			ret.LoadNative(gdextension.TypePackedInt32Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []int64:
			var arg = pointers.Cut(NewPackedInt64Slice(value), cut)
			ret.LoadNative(gdextension.TypePackedInt64Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []float32:
			var arg = pointers.Cut(NewPackedFloat32Slice(value), cut)
			ret.LoadNative(gdextension.TypePackedFloat32Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []float64:
			var arg = pointers.Cut(NewPackedFloat64Slice(value), cut)
			ret.LoadNative(gdextension.TypePackedFloat64Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []string:
			var arg = pointers.Cut(NewPackedStringSlice(value), cut)
			ret.LoadNative(gdextension.TypePackedStringArray, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		...
		case []Vector2:
			...
			ret.LoadNative(gdextension.TypePackedVector2Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []Vector3:
			var arg = pointers.Cut(NewPackedVector3Slice(value), cut)
			ret.LoadNative(gdextension.TypePackedVector3Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []Color:
			var arg = pointers.Cut(NewPackedColorSlice(value), cut)
			ret.LoadNative(gdextension.TypePackedColorArray, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		case []Vector4:
			var arg = pointers.Cut(NewPackedVector4Slice(value), cut)
			ret.LoadNative(gdextension.TypePackedVector4Array, gdextension.SizePackedArray, unsafe.Pointer(&arg))
		default:
	...
	case reflect.Func:
		...
		ret.LoadNative(gdextension.TypeCallable, gdextension.SizeCallable, unsafe.Pointer(&arg))
	case reflect.Map:
		if value.IsNil() {
			return Variant{}
		}
		var arg = pointers.Cut(newDictionary(value), cut)
		ret.LoadNative(gdextension.TypeDictionary, gdextension.SizeDictionary, unsafe.Pointer(&arg))
	case reflect.String:
		switch rtype {
		case reflect.TypeFor[Path.ToNode]():
			var s = NewString(value.String()).NodePath()
			var arg = pointers.Cut(s, true)
			ret.LoadNative(gdextension.TypeNodePath, gdextension.SizeNodePath, unsafe.Pointer(&arg))
		case reflect.TypeFor[StringType.Name]():
			var s = NewStringName(value.String())
			var arg = pointers.Cut(s, true)
			ret.LoadNative(gdextension.TypeStringName, gdextension.SizeStringName, unsafe.Pointer(&arg))
		case reflect.TypeFor[StringType.Readable]():
			var s = NewString(value.String())
			var arg = pointers.Cut(s, true)
			ret.LoadNative(gdextension.TypeString, gdextension.SizeString, unsafe.Pointer(&arg))
		default:
			var s = NewString(value.String())
	...
	case reflect.Struct:
		...
		case SignalType.Any:
			...
			ret.LoadNative(gdextension.TypeSignal, gdextension.SizeSignal, unsafe.Pointer(&arg))
		case Variant:
			return val
		case VariantPkg.Any:
		...
		case Vector2i:
			var arg = val
			ret.LoadNative(gdextension.TypeVector2i, gdextension.SizeVector2i, unsafe.Pointer(&arg))
		case Rect2:
			var arg = val
			ret.LoadNative(gdextension.TypeRect2, gdextension.SizeRect2, unsafe.Pointer(&arg))
		case Rect2i:
			var arg = val
			ret.LoadNative(gdextension.TypeRect2i, gdextension.SizeRect2i, unsafe.Pointer(&arg))
		case Vector3:
			var arg = val
			ret.LoadNative(gdextension.TypeVector3, gdextension.SizeVector3, unsafe.Pointer(&arg))
		case Euler.Radians:
			var arg = val
			ret.LoadNative(gdextension.TypeVector3, gdextension.SizeVector3, unsafe.Pointer(&arg))
		case Euler.Degrees:
		...
		case Vector3i:
			var arg = val
			ret.LoadNative(gdextension.TypeVector3i, gdextension.SizeVector3i, unsafe.Pointer(&arg))
		case Transform2D:
			var arg = val
			ret.LoadNative(gdextension.TypeTransform2D, gdextension.SizeTransform2D, unsafe.Pointer(&arg))
		case Vector4:
			var arg = val
			ret.LoadNative(gdextension.TypeVector4, gdextension.SizeVector4, unsafe.Pointer(&arg))
		case Vector4i:
			var arg = val
			ret.LoadNative(gdextension.TypeVector4i, gdextension.SizeVector4i, unsafe.Pointer(&arg))
		case Plane:
			var arg = val
			ret.LoadNative(gdextension.TypePlane, gdextension.SizePlane, unsafe.Pointer(&arg))
		case Quaternion:
			var arg = val
			ret.LoadNative(gdextension.TypeQuaternion, gdextension.SizeQuaternion, unsafe.Pointer(&arg))
		case AABB:
			var arg = val
			ret.LoadNative(gdextension.TypeAABB, gdextension.SizeAABB, unsafe.Pointer(&arg))
		case Basis:
			var arg = BasisType.Transposed(val)
			ret.LoadNative(gdextension.TypeBasis, gdextension.SizeBasis, unsafe.Pointer(&arg))
		case Transform3D:
			var arg = Transposed(val)
			ret.LoadNative(gdextension.TypeTransform3D, gdextension.SizeTransform3D, unsafe.Pointer(&arg))
		case Projection:
			var arg = val
			ret.LoadNative(gdextension.TypeProjection, gdextension.SizeProjection, unsafe.Pointer(&arg))
		case Color:
			var arg = val
			ret.LoadNative(gdextension.TypeColor, gdextension.SizeColor, unsafe.Pointer(&arg))
		case String:
...
func VariantAsObject(variant Variant) Object {
	...
	obj := gdextension.LoadNative[gdextension.Object](gdextension.TypeObject, raw)
	switch kind {
