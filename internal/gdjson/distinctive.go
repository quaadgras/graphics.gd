...
var Distinctions = map[string][][3]string{
	...
	"Camera2D":                       {{"get_screen_rotation ", "float", "Angle.Radians"}},
	...
	"CSGPolygon3D":                   {{"angle", "float", "Angle.Radians"}, {"get_path_simplify_angle ", "float", "Angle.Radians"}},
	"CSGShape3D":                     {{"angle", "float", "Angle.Radians"}, {"get_smoothing_angle ", "float", "Angle.Radians"}},
	...
	"Node2D":                         {{"radians", "float", "Angle.Radians"}, {"rotation_degrees", "float", "Angle.Degrees"}, {"rotation", "float", "Angle.Radians"}, {"get_angle_to ", "float", "Angle.Radians"}, {"get_rotation ", "float", "Angle.Radians"}, {"get_rotation_degrees ", "float", "Angle.Degrees"}, {"get_global_rotation ", "float", "Angle.Radians"}, {"get_global_rotation_degrees ", "float", "Angle.Degrees"}},
	"OS":                             {{"is_keycode_unicode code", "int", "Input.Key"}},
	"OpenXRCompositionLayerCylinder": {{"angle", "float", "Angle.Radians"}, {"get_central_angle ", "float", "Angle.Radians"}},
	...
	"ParticleProcessMaterial":        {{"angle", "float", "Angle.Radians"}, {"angle ", "float", "Angle.Radians"}, {"get_rotation_3d ", "Vector3", "Euler.Radians"}, {"get_rotation_velocity_3d ", "Vector3", "Euler.Radians"}},
	...
	"SceneTree":                      {{"call_group_flags flags", "int", "GroupCallFlags"}},
	...
	"TextEdit":                       {{"search flags", "int", "SearchFlags"}},
