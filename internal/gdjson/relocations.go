...
var Relocations = map[string]string{
	...
	"Tween.bind_node":                              "Node.bind_to_tween",
	...
	"FoldableContainer.set_foldable_group":         "FoldableGroup.set",
	"FoldableContainer.get_foldable_group":         "FoldableGroup.get",
	"OpenXRExtensionWrapper.get_openxr_api":        "OpenXRAPIExtension.get_from_wrapper",
}
