...
var Sliceables = map[string]Sliceable{
	...
	"PhysicsDirectSpaceState2DExtension._collide_shape.results": {Elem: "Vector2.XY", Count: "max_results"},
	"PhysicsDirectSpaceState3DExtension._collide_shape.results": {Elem: "Vector3.XYZ", Count: "max_results"},
	"PhysicsServer2DExtension._shape_collide.results":           {Elem: "Vector2.XY", Count: "result_max"},
	"PhysicsServer2DExtension._body_collide_shape.results":      {Elem: "Vector2.XY", Count: "result_max"},

	// Audio buffers.
	"AudioEffectInstance._process.src_buffer":                {Elem: "AudioFrame", Count: "frame_count"},
	"AudioEffectInstance._process.dst_buffer":                {Elem: "AudioFrame", Count: "frame_count"},
	...
	"PhysicsDirectSpaceState2DExtension._intersect_point.results": {Elem: "ShapeResult", Count: "max_results"},
	"PhysicsDirectSpaceState2DExtension._intersect_shape.result":  {Elem: "ShapeResult", Count: "max_results"},

	// Physics 3D — result arrays.
	"PhysicsDirectSpaceState3DExtension._intersect_point.results":      {Elem: "ShapeResult", Count: "max_results"},
	"PhysicsDirectSpaceState3DExtension._intersect_shape.result_count": {Elem: "ShapeResult", Count: "max_results"},
	...
	"StreamPeerExtension._put_data.p_data":           {Elem: "byte", Count: "p_bytes"},
	"StreamPeerExtension._put_partial_data.p_data":   {Elem: "byte", Count: "p_bytes"},

	// Multiplayer/Packet peer — byte buffers.
	"MultiplayerPeerExtension._put_packet.p_buffer": {Elem: "byte", Count: "p_buffer_size"},
	"PacketPeerExtension._put_packet.p_buffer":      {Elem: "byte", Count: "p_buffer_size"},
