...
var Structables = map[string]reflect.Type{
	...
	// --- Godot 4.7 additions ---
	"CameraFeed._get_formats.":                                        reflect.TypeFor[[]Format](),
	"CameraFeed._set_format.parameters":                               reflect.TypeFor[FormatParameters](),
	"GDScriptLanguageProtocol.initialize.params":                      reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.codeLens.":                                  reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.codeLens.params":                            reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.colorPresentation.":                         reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.colorPresentation.params":                   reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.completion.":                                reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.completion.params":                          reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.declaration.params":                         reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.definition.":                                reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.definition.params":                          reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.documentLink.":                              reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.documentLink.params":                        reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.documentSymbol.":                            reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.documentSymbol.params":                      reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.foldingRange.":                              reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.foldingRange.params":                        reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.hover.params":                               reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.nativeSymbol.params":                        reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.prepareRename.params":                       reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.references.":                                reflect.TypeFor[[]map[string]any](),
	"GDScriptTextDocument.references.params":                          reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.rename.":                                    reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.rename.params":                              reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.resolve.":                                   reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.resolve.params":                             reflect.TypeFor[map[string]any](),
	"GDScriptTextDocument.signatureHelp.params":                       reflect.TypeFor[map[string]any](),
	"GDScriptWorkspace.didDeleteFiles.params":                         reflect.TypeFor[map[string]any](),
	"GDScriptWorkspace.generate_script_api.":                          reflect.TypeFor[map[string]any](),
	"GLTFDocumentExtension._export_get_property_list.":                reflect.SliceOf(TypeFromString("Object", "PropertyInfo")),
	"Input.get_joy_motion_sensors_calibration.":                       reflect.TypeFor[map[string]any](),
	"Input.set_joy_motion_sensors_calibration.calibration_info":       reflect.TypeFor[map[string]any](),
	"OpenXRSpatialContextPersistenceConfig.get_persistence_contexts.": reflect.TypeFor[[]RID.PersistenceContext](),
	"WebRTCPeerConnectionExtension._create_data_channel.config":       reflect.TypeFor[map[string]any](),
	"WebRTCPeerConnectionExtension._initialize.config":                reflect.TypeFor[map[string]any](),
}
