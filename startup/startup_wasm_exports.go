...
//go:wasmexport go_on_callable_validation
func go_on_callable_validation(p0 uint32) uint32 {
...
//go:wasmexport go_on_callable_free
func go_on_callable_free(p0 uint32) {
	gdextension.On.Callables.Free(gdextension.FunctionID(p0))
}

//go:wasmexport go_on_callable_hash
func go_on_callable_hash(p0 uint32) uint32 {
	return uint32(gdextension.On.Callables.Hash(gdextension.FunctionID(p0)))
}

//go:wasmexport go_on_callable_compare
func go_on_callable_compare(p0 uint32, p1 uint32) uint32 {
...
func go_on_callable_less_than(p0 uint32, p1 uint32) uint32 {
...
//go:wasmexport go_on_callable_stringify
func go_on_callable_stringify(p0 uint32, p1 uint32) uint32 {
...
//go:wasmexport go_on_callable_get_argument_count
func go_on_callable_get_argument_count(p0 uint32, p1 uint32) int32 {
...
func go_on_extension_binding_created(p0 uint32) uint32 {
...
func go_on_extension_binding_removed(p0 uint32, p1 uint32) {
...
func go_on_extension_binding_reference(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_class_create(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_class_method(p0 uint32, p1 uint32, p2 uint32) uint32 {
...
func go_on_extension_class_caller(p0 uint32, p1 uint32, p2 uint32) uint32 {
...
func go_on_extension_instance_get(p0 uint32, p1 uint32, p2 uint32) uint32 {
...
func go_on_extension_instance_property_has_default(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_instance_property_get_default(p0 uint32, p1 uint32, p2 uint32) uint32 {
...
func go_on_extension_instance_property_validation(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_instance_stringify(p0 uint32) uint32 {
...
func go_on_extension_instance_reference(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_instance_rid(p0 uint32, p1 uint32) {
...
func go_on_extension_instance_variant_call(p0 uint32, p1 uint32, p2 uint32, p3 uint32) {
...
func go_on_extension_instance_dynamic_call(p0 uint32, p1 uint32, p2 uint32, p3 int32, p4 uint32, p5 uint32) {
...
func go_on_extension_script_categorization(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_script_get_property_type(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_script_get_property_state(p0 uint32, p1 uint32, p2 uint32) {
...
func go_on_extension_script_has_method(p0 uint32, p1 uint32) uint32 {
...
func go_on_extension_script_get_method_argument_count(p0 uint32, p1 uint32) int32 {
...
//go:wasmexport go_on_worker_thread_pool_task
func go_on_worker_thread_pool_task(p0 uint32) {
	gdextension.On.Threading.Run(gdextension.TaskID(p0))
}

//go:wasmexport go_on_worker_thread_pool_group_task
